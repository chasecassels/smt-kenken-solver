...
(assert (or (= 2 (- V0 V7)) (= 2 (- V7 V0)))) ; Region 1
(assert (= 3 (+ V1 V2))) ; Region 2
(assert (= 13 (+ V3 V10))) ; Region 3
(assert (= 21 (* V4 V5))) ; Region 4
(assert (= 20 (* V6 V13))) ; Region 5
(assert (= 15 (* V8 V9))) ; Region 6
(assert (or (= 5 (- V11 V12)) (= 5 (- V12 V11)))) ; Region 7
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 9
(assert (= 17 (+ V16 V17 V18))) ; Region 10
(assert (or (= 4 (- V19 V20)) (= 4 (- V20 V19)))) ; Region 11
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 12
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 13
(assert (or (= 4 (- V25 V26)) (= 4 (- V26 V25)))) ; Region 14
(assert (= 5 (+ V27 V34))) ; Region 15
(assert (= 126 (* V29 V36 V43))) ; Region 16
(assert (= 20 (* V30 V37))) ; Region 17
(assert (or (= 6 (- V31 V32)) (= 6 (- V32 V31)))) ; Region 18
(assert (= 5 (+ V33 V40))) ; Region 19
(assert (or (= 5 (- V35 V42)) (= 5 (- V42 V35)))) ; Region 20
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 21
(assert (or (= 4 (- V44 V45)) (= 4 (- V45 V44)))) ; Region 23
(assert (or (= 3 (- V47 V48)) (= 3 (- V48 V47)))) ; Region 25
(check-sat)
