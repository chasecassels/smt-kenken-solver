...
(assert (= 4 (+ V0 V1))) ; Region 1
(assert (= 7 (+ V2 V9))) ; Region 2
(assert (= 13 (+ V3 V4))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 4
(assert (or (= 1 (- V7 V8)) (= 1 (- V8 V7)))) ; Region 5
(assert (= 15 (+ V10 V17 V24))) ; Region 6
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 7
(assert (= 6 (+ V13 V20))) ; Region 8
(assert (or (= 3 (- V14 V21)) (= 3 (- V21 V14)))) ; Region 9
(assert (= 13 (+ V15 V16))) ; Region 10
(assert (= 10 (+ V18 V25))) ; Region 11
(assert (= 4 (+ V19 V26))) ; Region 12
(assert (= 3 (+ V22 V29))) ; Region 13
(assert (or (= 1 (- V23 V30)) (= 1 (- V30 V23)))) ; Region 14
(assert (or (= 6 (- V27 V34)) (= 6 (- V34 V27)))) ; Region 15
(assert (or (= 4 (- V28 V35)) (= 4 (- V35 V28)))) ; Region 16
(assert (= 5 (+ V31 V38))) ; Region 17
(assert (= 10 (+ V32 V33))) ; Region 18
(assert (or (= 3 (- V36 V43)) (= 3 (- V43 V36)))) ; Region 19
(assert (= 3 (+ V37 V44))) ; Region 20
(assert (= 9 (+ V40 V47))) ; Region 22
(assert (= 9 (+ V41 V48))) ; Region 23
(assert (= 6 (+ V45 V46))) ; Region 25
(check-sat)
