...
(assert (= 15 (* V1 V8))) ; Region 2
(assert (= 240 (* V2 V3 V4 V9 V11))) ; Region 3
(assert (= 14 (* V5 V6))) ; Region 4
(assert (= 84 (* V10 V17 V24))) ; Region 5
(assert (= 48 (* V12 V13 V19 V20))) ; Region 6
(assert (= 252 (* V14 V15 V16 V21 V22))) ; Region 7
(assert (= 28 (* V23 V30))) ; Region 9
(assert (= 630 (* V25 V26 V27 V34))) ; Region 10
(assert (= 280 (* V28 V29 V35 V36))) ; Region 11
(assert (= 90 (* V31 V38 V39))) ; Region 12
(assert (= 6 (* V32 V33))) ; Region 13
(assert (= 48 (* V37 V42 V43 V44))) ; Region 14
(assert (= 20 (* V40 V41 V48))) ; Region 15
(assert (= 42 (* V45 V46 V47))) ; Region 16
(check-sat)
