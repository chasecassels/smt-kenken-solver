...
(assert (= 2 (* V2 V9 V10))) ; Region 2
(assert (= 48 (* V4 V5 V6))) ; Region 4
(assert (= 24 (* V7 V8))) ; Region 5
(assert (= 30 (* V12 V18 V19))) ; Region 7
(assert (= 21 (* V13 V20))) ; Region 8
(assert (= 8 (* V14 V21))) ; Region 9
(assert (= 30 (* V15 V22))) ; Region 10
(assert (= 84 (* V16 V17 V23))) ; Region 11
(assert (= 84 (* V24 V25 V31))) ; Region 12
(assert (= 5 (* V26 V27 V34))) ; Region 13
(assert (= 42 (* V28 V29 V35))) ; Region 14
(assert (= 120 (* V30 V37 V38))) ; Region 15
(assert (= 35 (* V32 V33))) ; Region 16
(assert (= 3 (* V36 V42 V43))) ; Region 17
(assert (= 6 (* V39 V40))) ; Region 18
(assert (= 8 (* V41 V48))) ; Region 19
