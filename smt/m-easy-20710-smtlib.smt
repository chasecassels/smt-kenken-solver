...
(assert (= 70 (* V0 V1 V2 V3))) ; Region 1
(assert (= 252 (* V4 V10 V11 V12))) ; Region 2
(assert (= 24 (* V5 V6))) ; Region 3
(assert (= 18 (* V7 V14 V15))) ; Region 4
(assert (= 30 (* V8 V9))) ; Region 5
(assert (= 8 (* V13 V20))) ; Region 6
(assert (= 50 (* V16 V17 V23))) ; Region 7
(assert (= 6 (* V18 V24 V25))) ; Region 8
(assert (= 42 (* V19 V26 V27))) ; Region 9
(assert (= 28 (* V21 V22))) ; Region 10
(assert (= 6 (* V28 V35))) ; Region 11
(assert (= 168 (* V29 V30 V31 V36))) ; Region 12
(assert (= 70 (* V32 V33 V34))) ; Region 13
(assert (= 72 (* V37 V38 V45))) ; Region 14
(assert (= 35 (* V39 V46 V47))) ; Region 15
(assert (= 6 (* V40 V41))) ; Region 16
(assert (= 24 (* V42 V43 V44))) ; Region 17
(check-sat)
