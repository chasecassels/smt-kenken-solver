...
(assert (= 6 (+ V2 V9))) ; Region 3
(assert (= 63 (* V3 V4 V10))) ; Region 4
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 5
(assert (= 10 (+ V11 V12))) ; Region 6
(assert (= 12 (+ V13 V20))) ; Region 7
(assert (= 24 (* V14 V15))) ; Region 8
(assert (= 21 (* V16 V23))) ; Region 9
(assert (= 6 (* V17 V24))) ; Region 10
(assert (= 10 (* V18 V19))) ; Region 11
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 12
(assert (= 6 (+ V25 V26))) ; Region 13
(assert (= 18 (* V27 V34 V41))) ; Region 14
(assert (= 175 (* V28 V29 V36))) ; Region 15
(assert (or (= 2 (- V30 V37)) (= 2 (- V37 V30)))) ; Region 16
(assert (= 5 (+ V32 V33))) ; Region 18
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 19
(assert (= 7 (+ V38 V45))) ; Region 20
(assert (or (= 1 (- V39 V46)) (= 1 (- V46 V39)))) ; Region 21
(assert (or (= 6 (- V40 V47)) (= 6 (- V47 V40)))) ; Region 22
(assert (or (= 1 (- V43 V44)) (= 1 (- V44 V43)))) ; Region 23
(check-sat)
