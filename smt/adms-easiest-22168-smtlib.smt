...
(assert (= 11 (+ V4 V11))) ; Region 3
(assert (= 14 (* V5 V6))) ; Region 4
(assert (= 13 (+ V7 V14))) ; Region 5
(assert (or (= 3 (/ V8 V9)) (= 3 (/ V9 V8)))) ; Region 6
(assert (= 96 (* V10 V16 V17))) ; Region 7
(assert (= 50 (* V12 V13 V20))) ; Region 8
(assert (= 3 (+ V15 V22))) ; Region 9
(assert (= 8 (+ V18 V25))) ; Region 10
(assert (or (= 6 (- V19 V26)) (= 6 (- V26 V19)))) ; Region 11
(assert (= 16 (* V21 V28 V29))) ; Region 12
(assert (= 10 (* V23 V30))) ; Region 13
(assert (= 10 (+ V24 V31))) ; Region 14
(assert (= 108 (* V27 V33 V34))) ; Region 15
(assert (or (= 3 (/ V32 V39)) (= 3 (/ V39 V32)))) ; Region 16
(assert (= 30 (* V35 V36 V42))) ; Region 17
(assert (or (= 5 (- V37 V38)) (= 5 (- V38 V37)))) ; Region 18
(assert (= 12 (* V40 V47))) ; Region 19
(assert (or (= 3 (- V41 V48)) (= 3 (- V48 V41)))) ; Region 20
(assert (= 13 (+ V43 V44))) ; Region 21
