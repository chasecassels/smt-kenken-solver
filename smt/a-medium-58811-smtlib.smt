...
(assert (= 11 (+ V8 V9 V10))) ; Region 5
(assert (= 13 (+ V11 V18))) ; Region 6
(assert (= 6 (+ V12 V19))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 8
(assert (= 16 (+ V15 V16 V23))) ; Region 9
(assert (= 5 (+ V17 V24))) ; Region 10
(assert (= 8 (+ V20 V27))) ; Region 11
(assert (= 13 (+ V22 V28 V29))) ; Region 12
(assert (= 10 (+ V25 V26))) ; Region 13
(assert (= 11 (+ V30 V31 V32))) ; Region 14
(assert (= 16 (+ V33 V34 V40 V41))) ; Region 15
(assert (= 13 (+ V35 V36 V43 V44))) ; Region 16
(assert (= 16 (+ V37 V38 V45 V46))) ; Region 17
(assert (= 11 (+ V47 V48))) ; Region 20
(check-sat)
