...
(assert (= 84 (* V2 V3 V4 V10))) ; Region 2
(assert (= 15 (* V5 V6))) ; Region 3
(assert (= 21 (* V7 V8 V15 V16))) ; Region 4
(assert (= 60 (* V11 V17 V18))) ; Region 6
(assert (= 60 (* V12 V13 V20))) ; Region 7
(assert (= 42 (* V14 V21))) ; Region 8
(assert (= 12 (* V19 V26))) ; Region 9
(assert (= 18 (* V23 V24 V30))) ; Region 11
(assert (= 196 (* V25 V32 V33 V40))) ; Region 12
(assert (= 12 (* V27 V34))) ; Region 13
(assert (= 10 (* V28 V29))) ; Region 14
(assert (= 42 (* V31 V38 V39))) ; Region 15
(assert (= 12 (* V35 V42 V43))) ; Region 16
(assert (= 30 (* V36 V37))) ; Region 17
(assert (= 168 (* V41 V46 V47 V48))) ; Region 18
