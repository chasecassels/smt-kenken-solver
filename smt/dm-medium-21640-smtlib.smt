...
(assert (= 35 (* V9 V16))) ; Region 6
(assert (= 48 (* V10 V17 V18))) ; Region 7
(assert (= 21 (* V11 V12))) ; Region 8
(assert (= 60 (* V13 V20 V27 V34))) ; Region 9
(assert (= 168 (* V14 V21 V22 V29))) ; Region 10
(assert (= 120 (* V23 V24 V30))) ; Region 12
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 13
(assert (= 420 (* V28 V35 V42 V43))) ; Region 14
(assert (= 84 (* V31 V32 V33))) ; Region 15
(assert (= 6 (* V37 V38 V44 V45))) ; Region 17
(assert (= 35 (* V39 V46))) ; Region 18
(assert (= 24 (* V40 V41))) ; Region 19
(assert (= 12 (* V47 V48))) ; Region 20
(check-sat)
