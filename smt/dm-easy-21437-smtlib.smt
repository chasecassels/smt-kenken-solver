...
(assert (= 210 (* V3 V9 V10 V17))) ; Region 3
(assert (= 420 (* V4 V5 V11 V12))) ; Region 4
(assert (= 60 (* V6 V13 V20))) ; Region 5
(assert (= 24 (* V8 V15 V16))) ; Region 6
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 7
(assert (= 120 (* V19 V25 V26))) ; Region 9
(assert (= 168 (* V22 V23 V29))) ; Region 10
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 11
(assert (= 42 (* V27 V34 V41))) ; Region 12
(assert (= 90 (* V28 V35 V42))) ; Region 13
(assert (= 35 (* V30 V36 V37))) ; Region 14
(assert (= 2 (* V32 V33))) ; Region 15
(assert (or (= 2 (/ V38 V45)) (= 2 (/ V45 V38)))) ; Region 16
(assert (= 84 (* V39 V40 V46))) ; Region 17
(assert (= 15 (* V43 V44))) ; Region 18
(assert (= 2 (* V47 V48))) ; Region 19
(check-sat)
