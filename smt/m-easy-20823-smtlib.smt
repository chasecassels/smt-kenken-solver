...
(assert (= 210 (* V2 V3 V4))) ; Region 2
(assert (= 21 (* V5 V12))) ; Region 3
(assert (= 8 (* V6 V13))) ; Region 4
(assert (= 20 (* V8 V9 V15))) ; Region 5
(assert (= 6 (* V10 V11 V18))) ; Region 6
(assert (= 21 (* V14 V21))) ; Region 7
(assert (= 10 (* V16 V17))) ; Region 8
(assert (= 42 (* V19 V20))) ; Region 9
(assert (= 60 (* V22 V28 V29))) ; Region 10
(assert (= 28 (* V23 V24 V30))) ; Region 11
(assert (= 10 (* V25 V26))) ; Region 12
(assert (= 90 (* V27 V34 V41))) ; Region 13
(assert (= 21 (* V31 V38))) ; Region 14
(assert (= 8 (* V32 V33 V39))) ; Region 15
(assert (= 42 (* V35 V36 V42 V43))) ; Region 16
(assert (= 72 (* V37 V44 V45))) ; Region 17
(assert (= 120 (* V40 V46 V47 V48))) ; Region 18
(check-sat)
