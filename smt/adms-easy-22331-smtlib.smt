...
(assert (= 15 (+ V0 V7 V14 V21))) ; Region 1
(assert (or (= 2 (/ V1 V2)) (= 2 (/ V2 V1)))) ; Region 2
(assert (= 15 (* V3 V10 V17))) ; Region 3
(assert (= 210 (* V4 V11 V18))) ; Region 4
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 5
(assert (or (= 3 (/ V8 V9)) (= 3 (/ V9 V8)))) ; Region 6
(assert (= 10 (+ V12 V13 V20))) ; Region 7
(assert (= 11 (+ V15 V16))) ; Region 8
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 9
(assert (or (= 2 (/ V22 V23)) (= 2 (/ V23 V22)))) ; Region 10
(assert (= 196 (* V24 V30 V31))) ; Region 11
(assert (= 4 (+ V25 V32 V33))) ; Region 12
(assert (or (= 2 (/ V27 V34)) (= 2 (/ V34 V27)))) ; Region 13
(assert (= 150 (* V28 V29 V36 V37))) ; Region 14
(assert (= 8 (+ V35 V42))) ; Region 15
(assert (= 5 (+ V38 V39))) ; Region 16
(assert (or (= 2 (/ V40 V47)) (= 2 (/ V47 V40)))) ; Region 17
(assert (= 11 (+ V41 V48))) ; Region 18
(assert (or (= 3 (- V43 V44)) (= 3 (- V44 V43)))) ; Region 19
(assert (= 10 (+ V45 V46))) ; Region 20
(check-sat)
