...
(assert (or (= 2 (/ V2 V9)) (= 2 (/ V9 V2)))) ; Region 3
(assert (= 24 (* V3 V10 V17))) ; Region 4
(assert (= 140 (* V5 V12 V19))) ; Region 6
(assert (or (= 6 (- V6 V13)) (= 6 (- V13 V6)))) ; Region 7
(assert (= 13 (+ V11 V18))) ; Region 8
(assert (= 15 (+ V14 V21 V28))) ; Region 9
(assert (= 3 (+ V15 V16))) ; Region 10
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 11
(assert (or (= 6 (- V22 V23)) (= 6 (- V23 V22)))) ; Region 12
(assert (= 10 (+ V25 V26 V32))) ; Region 14
(assert (or (= 2 (- V29 V30)) (= 2 (- V30 V29)))) ; Region 15
(assert (or (= 6 (- V31 V38)) (= 6 (- V38 V31)))) ; Region 16
(assert (or (= 3 (/ V33 V40)) (= 3 (/ V40 V33)))) ; Region 17
(assert (= 90 (* V34 V41 V48))) ; Region 18
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 19
(assert (= 15 (+ V37 V44 V45))) ; Region 20
(assert (= 4 (+ V39 V46 V47))) ; Region 21
(assert (= 10 (+ V42 V43))) ; Region 22
(check-sat)
