...
(assert (= 18 (+ V0 V1 V2))) ; Region 1
(assert (= 13 (+ V3 V9 V10))) ; Region 2
(assert (= 3 (+ V4 V11))) ; Region 3
(assert (= 5 (+ V5 V6))) ; Region 4
(assert (= 9 (+ V7 V14))) ; Region 5
(assert (or (= 6 (- V8 V15)) (= 6 (- V15 V8)))) ; Region 6
(assert (= 6 (+ V12 V13))) ; Region 7
(assert (or (= 6 (- V17 V24)) (= 6 (- V24 V17)))) ; Region 9
(assert (= 7 (+ V18 V25))) ; Region 10
(assert (= 9 (+ V19 V20))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 13 (+ V22 V23 V30))) ; Region 13
(assert (= 17 (+ V26 V33 V40))) ; Region 14
(assert (or (= 5 (- V27 V34)) (= 5 (- V34 V27)))) ; Region 15
(assert (= 15 (+ V31 V32 V39))) ; Region 17
(assert (= 9 (+ V35 V42))) ; Region 18
(assert (= 5 (+ V36 V43))) ; Region 19
(assert (or (= 6 (- V37 V44)) (= 6 (- V44 V37)))) ; Region 20
(assert (= 7 (+ V38 V45))) ; Region 21
(assert (= 11 (+ V46 V47 V48))) ; Region 23
(check-sat)
