...
(assert (= 140 (* V3 V4 V5 V6))) ; Region 3
(assert (= 24 (* V8 V15 V22))) ; Region 4
(assert (= 840 (* V9 V10 V16 V17))) ; Region 5
(assert (= 108 (* V11 V12 V13 V19))) ; Region 6
(assert (= 420 (* V14 V21 V28 V35))) ; Region 7
(assert (= 14 (* V18 V25 V26))) ; Region 8
(assert (= 4 (* V20 V27))) ; Region 9
(assert (= 588 (* V23 V29 V30 V31 V36))) ; Region 10
(assert (= 20 (* V32 V33))) ; Region 12
(assert (= 1260 (* V34 V40 V41 V47 V48))) ; Region 13
(assert (= 12 (* V37 V38 V39))) ; Region 14
(assert (= 360 (* V42 V43 V44 V45 V46))) ; Region 15
(check-sat)
