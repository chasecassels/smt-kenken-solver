...
(assert (= 180 (* V2 V3 V10 V11))) ; Region 2
(assert (= 24 (* V5 V6 V12 V13))) ; Region 4
(assert (= 28 (* V8 V9 V16))) ; Region 5
(assert (= 12 (* V14 V15))) ; Region 6
(assert (= 14 (* V17 V18))) ; Region 7
(assert (= 30 (* V19 V20))) ; Region 8
(assert (= 6 (* V21 V28 V29))) ; Region 9
(assert (= 60 (* V22 V23 V30))) ; Region 10
(assert (= 24 (* V24 V31))) ; Region 11
(assert (= 105 (* V25 V26 V27 V33))) ; Region 12
(assert (= 12 (* V32 V38 V39))) ; Region 13
(assert (= 84 (* V34 V41 V48))) ; Region 14
(assert (= 210 (* V35 V42 V43))) ; Region 15
(assert (= 60 (* V36 V37 V44))) ; Region 16
(assert (= 28 (* V40 V46 V47))) ; Region 17
(check-sat)
