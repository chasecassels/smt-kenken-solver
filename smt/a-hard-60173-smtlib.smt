...
(assert (= 11 (+ V2 V9))) ; Region 3
(assert (= 9 (+ V3 V4))) ; Region 4
(assert (= 9 (+ V5 V6))) ; Region 5
(assert (= 18 (+ V10 V11 V12 V19))) ; Region 6
(assert (= 4 (+ V13 V20))) ; Region 7
(assert (= 15 (+ V14 V21 V22))) ; Region 8
(assert (= 14 (+ V16 V17 V18 V25))) ; Region 10
(assert (= 6 (+ V23 V24))) ; Region 11
(assert (= 8 (+ V26 V27))) ; Region 12
(assert (= 15 (+ V28 V35 V42))) ; Region 13
(assert (= 14 (+ V29 V30 V31))) ; Region 14
(assert (= 8 (+ V32 V39))) ; Region 15
(assert (= 9 (+ V33 V34))) ; Region 16
(assert (= 6 (+ V36 V37 V38))) ; Region 17
(assert (= 17 (+ V40 V41 V48))) ; Region 18
