...
(assert (= 10 (* V2 V9))) ; Region 3
(assert (= 15 (+ V3 V10 V11))) ; Region 4
(assert (or (= 4 (- V4 V5)) (= 4 (- V5 V4)))) ; Region 5
(assert (= 3 (+ V6 V13))) ; Region 6
(assert (= 3 (+ V12 V19))) ; Region 7
(assert (= 5 (+ V14 V15))) ; Region 8
(assert (= 72 (* V16 V23 V30))) ; Region 9
(assert (or (= 2 (- V17 V18)) (= 2 (- V18 V17)))) ; Region 10
(assert (= 17 (+ V20 V26 V27))) ; Region 11
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 12
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 13
(assert (= 3 (+ V24 V25))) ; Region 14
(assert (= 36 (* V31 V32 V38))) ; Region 15
(assert (= 75 (* V33 V34 V41))) ; Region 16
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 17
(assert (or (= 6 (- V37 V44)) (= 6 (- V44 V37)))) ; Region 18
(assert (= 13 (+ V39 V40))) ; Region 19
(assert (= 5 (+ V42 V43))) ; Region 20
(assert (= 30 (* V45 V46 V47))) ; Region 21
(check-sat)
