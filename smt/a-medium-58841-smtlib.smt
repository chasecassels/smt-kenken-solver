...
(assert (= 20 (+ V0 V7 V14 V15))) ; Region 1
(assert (= 11 (+ V1 V8))) ; Region 2
(assert (= 5 (+ V3 V4))) ; Region 4
(assert (= 8 (+ V5 V6))) ; Region 5
(assert (= 6 (+ V9 V16))) ; Region 6
(assert (= 7 (+ V10 V17))) ; Region 7
(assert (= 8 (+ V11 V12 V18))) ; Region 8
(assert (= 11 (+ V13 V20))) ; Region 9
(assert (= 6 (+ V21 V22 V23))) ; Region 11
(assert (= 11 (+ V24 V25))) ; Region 12
(assert (= 11 (+ V26 V27))) ; Region 13
(assert (= 5 (+ V29 V36))) ; Region 15
(assert (= 18 (+ V30 V31 V32))) ; Region 16
(assert (= 7 (+ V33 V34))) ; Region 17
(assert (= 16 (+ V35 V42 V43))) ; Region 18
(assert (= 8 (+ V37 V44))) ; Region 19
(assert (= 14 (+ V38 V45 V46))) ; Region 20
(assert (= 7 (+ V39 V40 V47))) ; Region 21
