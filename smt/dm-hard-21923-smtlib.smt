...
(assert (= 216 (* V1 V8 V14 V15))) ; Region 2
(assert (= 560 (* V2 V3 V9 V16 V17))) ; Region 3
(assert (= 42 (* V4 V5))) ; Region 4
(assert (= 420 (* V6 V12 V13 V19 V20))) ; Region 5
(assert (= 70 (* V10 V11 V18 V24 V25))) ; Region 6
(assert (= 60 (* V21 V22 V23 V28 V29))) ; Region 7
(assert (= 60 (* V26 V27 V34))) ; Region 8
(assert (= 2940 (* V30 V31 V35 V36 V37))) ; Region 9
(assert (or (= 2 (/ V32 V39)) (= 2 (/ V39 V32)))) ; Region 10
(assert (= 36 (* V33 V40 V41))) ; Region 11
(assert (= 540 (* V38 V43 V44 V45 V46))) ; Region 12
(assert (= 4 (* V47 V48))) ; Region 14
(check-sat)
