...
(assert (= 210 (* V2 V7 V8 V9))) ; Region 2
(assert (= 60 (* V3 V4 V10 V11))) ; Region 3
(assert (= 84 (* V5 V6 V12))) ; Region 4
(assert (= 280 (* V13 V19 V20 V26))) ; Region 5
(assert (or (= 2 (/ V14 V15)) (= 2 (/ V15 V14)))) ; Region 6
(assert (= 28 (* V16 V17 V24))) ; Region 7
(assert (= 72 (* V18 V25 V32))) ; Region 8
(assert (= 2 (* V21 V28))) ; Region 9
(assert (= 15 (* V22 V23))) ; Region 10
(assert (= 30 (* V27 V34 V41))) ; Region 11
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 12
(assert (= 84 (* V30 V31 V37 V38))) ; Region 13
(assert (or (= 3 (/ V33 V40)) (= 3 (/ V40 V33)))) ; Region 14
(assert (= 140 (* V35 V42 V43))) ; Region 15
(assert (or (= 3 (/ V44 V45)) (= 3 (/ V45 V44)))) ; Region 17
(assert (= 15 (* V46 V47 V48))) ; Region 18
(check-sat)
