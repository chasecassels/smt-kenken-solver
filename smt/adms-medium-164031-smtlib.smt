...
(assert (= 8 (* V1 V2 V3))) ; Region 2
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 3
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 4
(assert (= 14 (+ V8 V9 V10))) ; Region 5
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 6
(assert (= 42 (* V14 V15 V16))) ; Region 7
(assert (or (= 1 (- V17 V18)) (= 1 (- V18 V17)))) ; Region 8
(assert (= 12 (* V19 V20 V26))) ; Region 9
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 10
(assert (= 24 (* V22 V29))) ; Region 11
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 12
(assert (= 12 (+ V25 V32 V39))) ; Region 13
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 14
(assert (= 12 (+ V30 V36 V37))) ; Region 15
(assert (or (= 3 (/ V31 V38)) (= 3 (/ V38 V31)))) ; Region 16
(assert (or (= 3 (/ V33 V40)) (= 3 (/ V40 V33)))) ; Region 17
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 18
(assert (or (= 3 (- V41 V48)) (= 3 (- V48 V41)))) ; Region 19
(assert (= 42 (* V44 V45))) ; Region 21
(assert (or (= 2 (/ V46 V47)) (= 2 (/ V47 V46)))) ; Region 22
(check-sat)
