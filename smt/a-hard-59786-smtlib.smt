...
(assert (= 9 (+ V1 V2 V3))) ; Region 2
(assert (= 10 (+ V4 V11))) ; Region 3
(assert (= 12 (+ V6 V13))) ; Region 5
(assert (= 3 (+ V8 V9))) ; Region 6
(assert (= 6 (+ V12 V19 V20))) ; Region 8
(assert (= 11 (+ V16 V17))) ; Region 9
(assert (= 12 (+ V18 V24 V25))) ; Region 10
(assert (= 19 (+ V21 V28 V35 V36))) ; Region 11
(assert (= 12 (+ V22 V23 V29))) ; Region 12
(assert (= 6 (+ V26 V27))) ; Region 13
(assert (= 18 (+ V30 V31 V32))) ; Region 14
(assert (= 10 (+ V33 V39 V40))) ; Region 15
(assert (= 13 (+ V34 V41 V48))) ; Region 16
(assert (= 5 (+ V37 V38))) ; Region 17
(assert (= 14 (+ V42 V43 V44 V45))) ; Region 18
(assert (= 8 (+ V46 V47))) ; Region 19
(check-sat)
