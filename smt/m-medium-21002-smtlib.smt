...
(assert (= 588 (* V0 V1 V8 V9))) ; Region 1
(assert (= 10 (* V3 V4))) ; Region 3
(assert (= 120 (* V5 V6 V12 V13))) ; Region 4
(assert (= 10 (* V7 V14 V15))) ; Region 5
(assert (= 21 (* V10 V16 V17))) ; Region 6
(assert (= 144 (* V11 V18 V19 V20))) ; Region 7
(assert (= 72 (* V21 V28 V29 V30))) ; Region 8
(assert (= 90 (* V22 V23 V24))) ; Region 9
(assert (= 98 (* V25 V26 V27 V33))) ; Region 10
(assert (= 20 (* V31 V32))) ; Region 11
(assert (= 6 (* V34 V41))) ; Region 12
(assert (= 84 (* V35 V36 V42))) ; Region 13
(assert (= 8 (* V37 V38 V44))) ; Region 14
(assert (= 210 (* V39 V40 V47 V48))) ; Region 15
