...
(assert (= 15 (* V2 V9))) ; Region 2
(assert (= 10 (* V4 V11 V12))) ; Region 4
(assert (= 21 (* V5 V6))) ; Region 5
(assert (= 12 (* V7 V8 V14))) ; Region 6
(assert (= 140 (* V10 V17 V24))) ; Region 7
(assert (= 7 (* V13 V20))) ; Region 8
(assert (= 24 (* V15 V16))) ; Region 9
(assert (= 21 (* V18 V19))) ; Region 10
(assert (= 30 (* V21 V22))) ; Region 11
(assert (= 28 (* V23 V30 V31))) ; Region 12
(assert (= 6 (* V25 V26 V32))) ; Region 13
(assert (= 48 (* V27 V33 V34))) ; Region 14
(assert (= 15 (* V28 V29 V35))) ; Region 15
(assert (= 21 (* V36 V43 V44))) ; Region 16
(assert (= 18 (* V38 V39))) ; Region 18
(assert (= 20 (* V40 V47))) ; Region 19
