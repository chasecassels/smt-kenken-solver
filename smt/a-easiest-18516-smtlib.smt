...
(assert (= 7 (+ V15 V22))) ; Region 10
(assert (= 7 (+ V16 V23))) ; Region 11
(assert (= 11 (+ V17 V24))) ; Region 12
(assert (= 3 (+ V18 V19))) ; Region 13
(assert (= 8 (+ V25 V26))) ; Region 14
(assert (= 10 (+ V27 V33 V34))) ; Region 15
(assert (= 5 (+ V28 V35))) ; Region 16
(assert (= 13 (+ V29 V30))) ; Region 17
(assert (= 3 (+ V31 V32))) ; Region 18
(assert (= 7 (+ V37 V38 V45))) ; Region 20
(assert (= 10 (+ V39 V46))) ; Region 21
(assert (= 12 (+ V40 V41))) ; Region 22
(assert (= 6 (+ V42 V43))) ; Region 23
(assert (= 6 (+ V47 V48))) ; Region 25
(check-sat)
