...
(assert (= 96 (* V1 V2 V8))) ; Region 2
(assert (= 10 (+ V3 V10))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 5
(assert (= 210 (* V9 V15 V16))) ; Region 6
(assert (= 24 (* V11 V17 V18))) ; Region 7
(assert (or (= 6 (- V12 V19)) (= 6 (- V19 V12)))) ; Region 8
(assert (or (= 3 (- V13 V20)) (= 3 (- V20 V13)))) ; Region 9
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 10
(assert (= 3 (+ V22 V29))) ; Region 11
(assert (or (= 2 (- V23 V30)) (= 2 (- V30 V23)))) ; Region 12
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 13
(assert (= 16 (+ V26 V27 V34))) ; Region 14
(assert (= 60 (* V28 V35 V36))) ; Region 15
(assert (= 13 (+ V31 V32))) ; Region 16
(assert (= 14 (* V37 V38))) ; Region 18
(assert (= 5 (+ V39 V40))) ; Region 19
(assert (= 10 (+ V41 V48))) ; Region 20
(assert (or (= 2 (- V42 V43)) (= 2 (- V43 V42)))) ; Region 21
(assert (or (= 1 (- V44 V45)) (= 1 (- V45 V44)))) ; Region 22
(assert (or (= 2 (/ V46 V47)) (= 2 (/ V47 V46)))) ; Region 23
(check-sat)
