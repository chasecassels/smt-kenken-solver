...
(assert (= 9 (+ V1 V8))) ; Region 2
(assert (= 6 (+ V2 V9 V16))) ; Region 3
(assert (= 14 (+ V4 V5 V6))) ; Region 5
(assert (= 7 (+ V10 V17))) ; Region 6
(assert (= 15 (+ V11 V18 V25))) ; Region 7
(assert (or (= 5 (- V12 V19)) (= 5 (- V19 V12)))) ; Region 8
(assert (= 11 (+ V13 V20))) ; Region 9
(assert (or (= 4 (- V14 V15)) (= 4 (- V15 V14)))) ; Region 10
(assert (= 10 (+ V22 V29 V36))) ; Region 12
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 13
(assert (or (= 2 (- V26 V27)) (= 2 (- V27 V26)))) ; Region 14
(assert (= 11 (+ V28 V35))) ; Region 15
(assert (= 15 (+ V30 V37 V38))) ; Region 16
(assert (= 6 (+ V31 V32 V33))) ; Region 17
(assert (or (= 1 (- V34 V41)) (= 1 (- V41 V34)))) ; Region 18
(assert (or (= 1 (- V39 V46)) (= 1 (- V46 V39)))) ; Region 19
(assert (= 13 (+ V40 V47 V48))) ; Region 20
(assert (= 10 (+ V42 V43))) ; Region 21
(assert (or (= 2 (- V44 V45)) (= 2 (- V45 V44)))) ; Region 22
(check-sat)
