...
(assert (= 9 (+ V3 V10))) ; Region 3
(assert (= 3 (+ V4 V11))) ; Region 4
(assert (= 13 (+ V6 V13))) ; Region 6
(assert (= 3 (+ V8 V15))) ; Region 7
(assert (= 7 (+ V9 V16))) ; Region 8
(assert (= 18 (+ V12 V18 V19))) ; Region 9
(assert (= 7 (+ V14 V21))) ; Region 10
(assert (= 9 (+ V17 V24))) ; Region 11
(assert (= 5 (+ V20 V27))) ; Region 12
(assert (= 13 (+ V22 V23))) ; Region 13
(assert (= 7 (+ V25 V26))) ; Region 14
(assert (= 12 (+ V28 V29))) ; Region 15
(assert (= 6 (+ V31 V32))) ; Region 17
(assert (= 4 (+ V33 V34))) ; Region 18
(assert (= 6 (+ V35 V42))) ; Region 19
(assert (= 11 (+ V36 V37 V43))) ; Region 20
(assert (= 13 (+ V38 V39))) ; Region 21
(assert (= 14 (+ V40 V46 V47))) ; Region 22
(assert (= 9 (+ V41 V48))) ; Region 23
(assert (= 3 (+ V44 V45))) ; Region 24
(check-sat)
