...
(assert (= 17 (+ V0 V1 V8))) ; Region 1
(assert (= 4 (+ V2 V9))) ; Region 2
(assert (= 10 (+ V4 V5))) ; Region 4
(assert (= 7 (+ V6 V13))) ; Region 5
(assert (= 3 (+ V7 V14))) ; Region 6
(assert (= 13 (+ V10 V17))) ; Region 7
(assert (= 6 (+ V11 V12))) ; Region 8
(assert (= 8 (+ V15 V16))) ; Region 9
(assert (= 5 (+ V18 V19))) ; Region 10
(assert (= 13 (+ V20 V27))) ; Region 11
(assert (= 11 (+ V21 V28))) ; Region 12
(assert (= 3 (+ V23 V24))) ; Region 14
(assert (= 8 (+ V25 V26))) ; Region 15
(assert (= 3 (+ V29 V36))) ; Region 16
(assert (= 12 (+ V30 V31 V32))) ; Region 17
(assert (= 13 (+ V33 V40))) ; Region 18
(assert (= 4 (+ V34 V41))) ; Region 19
(assert (= 8 (+ V35 V42))) ; Region 20
(assert (= 18 (+ V37 V43 V44))) ; Region 21
(assert (= 6 (+ V38 V45))) ; Region 22
(assert (= 8 (+ V39 V46))) ; Region 23
(assert (= 5 (+ V47 V48))) ; Region 24
(check-sat)
