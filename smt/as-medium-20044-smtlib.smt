...
(assert (= 3 (+ V0 V7))) ; Region 1
(assert (or (= 2 (- V1 V2)) (= 2 (- V2 V1)))) ; Region 2
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 3
(assert (= 17 (+ V5 V6 V13))) ; Region 4
(assert (or (= 2 (- V8 V9)) (= 2 (- V9 V8)))) ; Region 5
(assert (= 18 (+ V10 V11 V12))) ; Region 6
(assert (= 13 (+ V14 V15))) ; Region 7
(assert (= 7 (+ V16 V17 V18))) ; Region 8
(assert (= 8 (+ V19 V26 V33))) ; Region 9
(assert (= 7 (+ V20 V27))) ; Region 10
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 11
(assert (or (= 5 (- V23 V30)) (= 5 (- V30 V23)))) ; Region 12
(assert (or (= 6 (- V24 V31)) (= 6 (- V31 V24)))) ; Region 13
(assert (or (= 3 (- V25 V32)) (= 3 (- V32 V25)))) ; Region 14
(assert (= 12 (+ V28 V35))) ; Region 15
(assert (or (= 2 (- V29 V36)) (= 2 (- V36 V29)))) ; Region 16
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 17
(assert (or (= 1 (- V37 V38)) (= 1 (- V38 V37)))) ; Region 18
(assert (= 3 (+ V39 V40))) ; Region 19
(assert (= 13 (+ V42 V43 V44))) ; Region 20
(assert (or (= 3 (- V45 V46)) (= 3 (- V46 V45)))) ; Region 21
(assert (or (= 6 (- V47 V48)) (= 6 (- V48 V47)))) ; Region 22
(check-sat)
