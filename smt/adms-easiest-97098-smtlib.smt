...
(assert (or (= 6 (- V0 V1)) (= 6 (- V1 V0)))) ; Region 1
(assert (= 15 (* V2 V3))) ; Region 2
(assert (or (= 2 (/ V4 V11)) (= 2 (/ V11 V4)))) ; Region 3
(assert (= 10 (+ V5 V6))) ; Region 4
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 5
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 6
(assert (= 15 (* V9 V10 V16))) ; Region 7
(assert (= 35 (* V12 V13))) ; Region 8
(assert (or (= 6 (- V17 V18)) (= 6 (- V18 V17)))) ; Region 9
(assert (or (= 3 (/ V19 V26)) (= 3 (/ V26 V19)))) ; Region 10
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 11
(assert (or (= 4 (- V21 V22)) (= 4 (- V22 V21)))) ; Region 12
(assert (= 13 (+ V23 V30))) ; Region 13
(assert (or (= 2 (- V25 V32)) (= 2 (- V32 V25)))) ; Region 15
(assert (or (= 3 (/ V28 V29)) (= 3 (/ V29 V28)))) ; Region 16
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 17
(assert (= 12 (+ V33 V34 V41))) ; Region 18
(assert (= 28 (* V35 V42))) ; Region 19
(assert (or (= 1 (- V36 V37)) (= 1 (- V37 V36)))) ; Region 20
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 21
(assert (or (= 6 (- V40 V47)) (= 6 (- V47 V40)))) ; Region 22
(assert (= 60 (* V43 V44 V45))) ; Region 23
(check-sat)
