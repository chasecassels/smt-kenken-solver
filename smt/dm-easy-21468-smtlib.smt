...
(assert (= 30 (* V0 V1 V7))) ; Region 1
(assert (= 28 (* V3 V4))) ; Region 3
(assert (= 6 (* V5 V6))) ; Region 4
(assert (= 10 (* V8 V9))) ; Region 5
(assert (= 630 (* V10 V15 V16 V17))) ; Region 6
(assert (= 42 (* V11 V12 V18))) ; Region 7
(assert (= 8 (* V13 V19 V20))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 36 (* V22 V28 V29))) ; Region 10
(assert (= 21 (* V23 V24 V25))) ; Region 11
(assert (= 60 (* V26 V32 V33))) ; Region 12
(assert (= 210 (* V27 V34 V41 V48))) ; Region 13
(assert (= 8 (* V30 V31))) ; Region 14
(assert (or (= 3 (/ V35 V36)) (= 3 (/ V36 V35)))) ; Region 15
(assert (= 210 (* V37 V38 V44 V45))) ; Region 16
(assert (= 20 (* V39 V40))) ; Region 17
(assert (= 28 (* V42 V43))) ; Region 18
(assert (or (= 3 (/ V46 V47)) (= 3 (/ V47 V46)))) ; Region 19
(check-sat)
