...
(assert (= 300 (* V0 V7 V8 V15))) ; Region 1
(assert (= 56 (* V1 V2 V9 V10))) ; Region 2
(assert (= 105 (* V3 V4 V5))) ; Region 3
(assert (= 12 (* V11 V12))) ; Region 5
(assert (= 28 (* V13 V19 V20))) ; Region 6
(assert (= 28 (* V14 V21 V22))) ; Region 7
(assert (= 108 (* V16 V17 V23))) ; Region 8
(assert (= 6 (* V18 V24 V25))) ; Region 9
(assert (= 30 (* V26 V27 V34))) ; Region 10
(assert (= 12 (* V28 V29))) ; Region 11
(assert (= 175 (* V30 V31 V37))) ; Region 12
(assert (= 96 (* V32 V33 V40 V41))) ; Region 13
(assert (= 18 (* V35 V36 V42))) ; Region 14
(assert (= 56 (* V38 V39 V45 V46))) ; Region 15
(assert (= 14 (* V43 V44))) ; Region 16
(assert (= 15 (* V47 V48))) ; Region 17
(check-sat)
