...
(assert (or (= 2 (/ V2 V9)) (= 2 (/ V9 V2)))) ; Region 2
(assert (= 420 (* V3 V4 V10 V11 V12))) ; Region 3
(assert (= 60 (* V5 V6 V13))) ; Region 4
(assert (= 420 (* V7 V8 V14 V15))) ; Region 5
(assert (= 42 (* V16 V17 V24))) ; Region 6
(assert (= 6 (* V19 V20 V27))) ; Region 8
(assert (= 420 (* V21 V22 V23 V30))) ; Region 9
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 10
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 11
(assert (= 20 (* V29 V36 V37))) ; Region 12
(assert (= 90 (* V31 V32 V39))) ; Region 13
(assert (= 294 (* V33 V34 V40))) ; Region 14
(assert (= 28 (* V38 V45 V46))) ; Region 15
(assert (= 30 (* V41 V47 V48))) ; Region 16
(assert (= 18 (* V42 V43 V44))) ; Region 17
(check-sat)
