...
(assert (= 18 (+ V1 V8 V15 V22))) ; Region 2
(assert (= 6 (+ V2 V9))) ; Region 3
(assert (or (= 1 (- V3 V10)) (= 1 (- V10 V3)))) ; Region 4
(assert (= 7 (+ V4 V5))) ; Region 5
(assert (= 11 (+ V6 V13 V20))) ; Region 6
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 7
(assert (= 12 (+ V11 V12 V19))) ; Region 8
(assert (or (= 4 (- V16 V23)) (= 4 (- V23 V16)))) ; Region 9
(assert (= 11 (+ V17 V24))) ; Region 10
(assert (= 6 (+ V21 V28 V35))) ; Region 12
(assert (or (= 6 (- V25 V32)) (= 6 (- V32 V25)))) ; Region 13
(assert (= 10 (+ V26 V33))) ; Region 14
(assert (= 6 (+ V27 V34))) ; Region 15
(assert (= 7 (+ V29 V36))) ; Region 16
(assert (= 7 (+ V30 V31))) ; Region 17
(assert (= 17 (+ V37 V38 V39))) ; Region 18
(assert (= 9 (+ V40 V46 V47))) ; Region 19
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 20
(assert (= 10 (+ V42 V43))) ; Region 21
(assert (= 6 (+ V44 V45))) ; Region 22
(check-sat)
