...
(assert (= 28 (* V0 V7))) ; Region 1
(assert (= 5 (* V1 V8))) ; Region 2
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 3
(assert (= 14 (* V4 V5 V6))) ; Region 4
(assert (= 15 (* V9 V10))) ; Region 5
(assert (or (= 3 (/ V12 V19)) (= 3 (/ V19 V12)))) ; Region 7
(assert (= 4 (* V13 V20))) ; Region 8
(assert (= 126 (* V14 V15 V22))) ; Region 9
(assert (= 4 (* V16 V23))) ; Region 10
(assert (= 10 (* V17 V18))) ; Region 11
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 12
(assert (= 140 (* V24 V31 V32))) ; Region 13
(assert (= 60 (* V25 V26 V27))) ; Region 14
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 15
(assert (= 84 (* V30 V37 V44))) ; Region 16
(assert (= 18 (* V33 V34))) ; Region 17
(assert (or (= 2 (/ V38 V45)) (= 2 (/ V45 V38)))) ; Region 19
(assert (= 21 (* V39 V46))) ; Region 20
(assert (= 4 (* V40 V47))) ; Region 21
(assert (= 35 (* V41 V48))) ; Region 22
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 23
(check-sat)
