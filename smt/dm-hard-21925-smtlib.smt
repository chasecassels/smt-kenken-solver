...
(assert (= 42 (* V0 V1 V7 V8))) ; Region 1
(assert (= 35 (* V2 V3))) ; Region 2
(assert (= 72 (* V4 V5 V6))) ; Region 3
(assert (= 96 (* V9 V10 V17))) ; Region 4
(assert (= 60 (* V11 V12 V13 V20))) ; Region 5
(assert (= 60 (* V14 V21 V22))) ; Region 6
(assert (= 3 (* V15 V16))) ; Region 7
(assert (= 420 (* V18 V19 V24 V25 V26))) ; Region 8
(assert (= 420 (* V23 V30 V31 V32 V39))) ; Region 9
(assert (or (= 2 (/ V27 V34)) (= 2 (/ V34 V27)))) ; Region 10
(assert (= 168 (* V28 V29 V36))) ; Region 11
(assert (or (= 3 (/ V33 V40)) (= 3 (/ V40 V33)))) ; Region 12
(assert (= 360 (* V35 V42 V43 V44))) ; Region 13
(assert (= 84 (* V37 V38 V45 V46))) ; Region 14
(assert (= 35 (* V41 V47 V48))) ; Region 15
(check-sat)
