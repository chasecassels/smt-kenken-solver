...
(assert (= 7 (+ V0 V1))) ; Region 1
(assert (or (= 6 (- V2 V9)) (= 6 (- V9 V2)))) ; Region 2
(assert (= 14 (+ V3 V4 V10))) ; Region 3
(assert (= 11 (+ V5 V12 V13))) ; Region 4
(assert (or (= 4 (- V7 V14)) (= 4 (- V14 V7)))) ; Region 6
(assert (= 11 (+ V8 V15 V22 V23))) ; Region 7
(assert (= 3 (+ V11 V18))) ; Region 8
(assert (= 10 (+ V16 V17))) ; Region 9
(assert (= 14 (+ V19 V20 V27))) ; Region 10
(assert (= 3 (+ V24 V31))) ; Region 12
(assert (or (= 1 (- V25 V32)) (= 1 (- V32 V25)))) ; Region 13
(assert (or (= 4 (- V26 V33)) (= 4 (- V33 V26)))) ; Region 14
(assert (or (= 6 (- V28 V29)) (= 6 (- V29 V28)))) ; Region 15
(assert (= 13 (+ V30 V37 V38))) ; Region 16
(assert (= 7 (+ V34 V41))) ; Region 17
(assert (= 11 (+ V35 V42))) ; Region 18
(assert (or (= 5 (- V36 V43)) (= 5 (- V43 V36)))) ; Region 19
(assert (or (= 6 (- V39 V40)) (= 6 (- V40 V39)))) ; Region 20
(assert (or (= 4 (- V45 V46)) (= 4 (- V46 V45)))) ; Region 22
