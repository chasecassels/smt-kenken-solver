...
(assert (= 28 (* V0 V1))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (= 10 (* V4 V5))) ; Region 3
(assert (= 84 (* V6 V13 V20 V27))) ; Region 4
(assert (= 75 (* V7 V8 V9 V15 V22))) ; Region 5
(assert (= 28 (* V10 V11 V18))) ; Region 6
(assert (or (= 2 (/ V12 V19)) (= 2 (/ V19 V12)))) ; Region 7
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 8
(assert (= 210 (* V16 V17 V23 V24))) ; Region 9
(assert (= 120 (* V25 V26 V33 V34))) ; Region 10
(assert (= 18 (* V28 V35))) ; Region 11
(assert (= 14 (* V29 V36))) ; Region 12
(assert (= 168 (* V30 V31 V37 V38))) ; Region 13
(assert (= 30 (* V32 V39 V40))) ; Region 14
(assert (= 84 (* V41 V47 V48))) ; Region 15
(assert (= 30 (* V42 V43))) ; Region 16
(assert (= 8 (* V45 V46))) ; Region 18
(check-sat)
