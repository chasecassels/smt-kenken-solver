...
(assert (or (= 4 (- V2 V3)) (= 4 (- V3 V2)))) ; Region 2
(assert (or (= 4 (- V4 V11)) (= 4 (- V11 V4)))) ; Region 3
(assert (= 7 (+ V5 V6))) ; Region 4
(assert (= 16 (+ V7 V8 V14))) ; Region 5
(assert (= 12 (+ V10 V17 V18 V24))) ; Region 7
(assert (= 8 (+ V12 V13 V19))) ; Region 8
(assert (= 11 (+ V15 V16 V23))) ; Region 9
(assert (= 8 (+ V20 V27))) ; Region 10
(assert (= 3 (+ V21 V22))) ; Region 11
(assert (= 13 (+ V25 V26))) ; Region 12
(assert (= 5 (+ V28 V35))) ; Region 13
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 14
(assert (= 3 (+ V31 V32))) ; Region 15
(assert (= 11 (+ V33 V40))) ; Region 16
(assert (= 7 (+ V34 V41))) ; Region 17
(assert (or (= 3 (- V36 V37)) (= 3 (- V37 V36)))) ; Region 18
(assert (= 15 (+ V38 V39 V46))) ; Region 19
(assert (or (= 4 (- V42 V43)) (= 4 (- V43 V42)))) ; Region 20
(assert (= 10 (+ V44 V45))) ; Region 21
