...
(assert (= 168 (* V3 V4 V5 V11))) ; Region 3
(assert (= 35 (* V6 V13))) ; Region 4
(assert (= 30 (* V8 V9 V10))) ; Region 5
(assert (= 30 (* V12 V18 V19 V20))) ; Region 6
(assert (= 210 (* V14 V15 V21 V22))) ; Region 7
(assert (= 12 (* V16 V17))) ; Region 8
(assert (= 14 (* V23 V30))) ; Region 9
(assert (= 18 (* V24 V25 V31))) ; Region 10
(assert (= 12 (* V26 V33))) ; Region 11
(assert (= 12 (* V27 V34))) ; Region 12
(assert (= 28 (* V28 V29))) ; Region 13
(assert (= 70 (* V32 V38 V39 V45))) ; Region 14
(assert (= 12 (* V35 V36 V42))) ; Region 15
(assert (= 150 (* V37 V43 V44))) ; Region 16
(assert (= 144 (* V41 V46 V47 V48))) ; Region 18
(check-sat)
