...
(assert (= 21 (* V1 V2))) ; Region 2
(assert (= 140 (* V3 V4 V10 V11))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 10 (* V8 V9))) ; Region 5
(assert (= 24 (* V12 V13))) ; Region 6
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 7
(assert (= 20 (* V15 V22))) ; Region 8
(assert (= 144 (* V16 V23 V30 V31))) ; Region 9
(assert (= 21 (* V17 V24))) ; Region 10
(assert (= 180 (* V18 V19 V20 V27))) ; Region 11
(assert (= 14 (* V25 V26 V32))) ; Region 12
(assert (= 140 (* V28 V35 V42))) ; Region 13
(assert (or (= 3 (/ V29 V36)) (= 3 (/ V36 V29)))) ; Region 14
(assert (= 60 (* V33 V34 V41))) ; Region 15
(assert (= 84 (* V37 V43 V44))) ; Region 16
(assert (= 24 (* V38 V39 V46))) ; Region 17
(assert (= 42 (* V40 V47 V48))) ; Region 18
(check-sat)
