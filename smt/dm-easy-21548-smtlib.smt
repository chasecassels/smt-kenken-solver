...
(assert (= 35 (* V0 V1))) ; Region 1
(assert (or (= 3 (/ V2 V3)) (= 3 (/ V3 V2)))) ; Region 2
(assert (= 84 (* V4 V5 V11))) ; Region 3
(assert (= 20 (* V6 V12 V13))) ; Region 4
(assert (= 84 (* V7 V14 V15))) ; Region 5
(assert (= 2 (* V8 V9))) ; Region 6
(assert (= 30 (* V10 V16 V17))) ; Region 7
(assert (= 12 (* V18 V19))) ; Region 8
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 9
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 10
(assert (= 18 (* V22 V29 V30))) ; Region 11
(assert (= 4 (* V23 V24))) ; Region 12
(assert (= 35 (* V25 V26 V33))) ; Region 13
(assert (= 168 (* V31 V32 V39))) ; Region 14
(assert (= 140 (* V34 V40 V41 V48))) ; Region 15
(assert (= 24 (* V35 V42 V43))) ; Region 16
(assert (= 12 (* V37 V38))) ; Region 18
(assert (= 35 (* V44 V45))) ; Region 19
(assert (or (= 3 (/ V46 V47)) (= 3 (/ V47 V46)))) ; Region 20
(check-sat)
