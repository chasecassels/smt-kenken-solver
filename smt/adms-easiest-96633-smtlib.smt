...
(assert (= 24 (* V16 V17))) ; Region 10
(assert (or (= 6 (- V18 V25)) (= 6 (- V25 V18)))) ; Region 11
(assert (= 40 (* V19 V20 V27))) ; Region 12
(assert (= 11 (+ V21 V22))) ; Region 13
(assert (= 21 (* V23 V24))) ; Region 14
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 15
(assert (= 18 (+ V28 V35 V36 V42))) ; Region 16
(assert (= 3 (+ V29 V30))) ; Region 17
(assert (= 20 (* V31 V32))) ; Region 18
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 19
(assert (= 30 (* V37 V43 V44))) ; Region 20
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 21
(assert (= 30 (* V45 V46))) ; Region 23
(assert (or (= 6 (- V47 V48)) (= 6 (- V48 V47)))) ; Region 24
(check-sat)
