...
(assert (= 48 (* V0 V1 V2 V9))) ; Region 1
(assert (= 42 (* V3 V10 V11))) ; Region 2
(assert (= 60 (* V4 V5 V6))) ; Region 3
(assert (= 21 (* V7 V8))) ; Region 4
(assert (= 60 (* V12 V13 V20))) ; Region 5
(assert (= 20 (* V14 V21))) ; Region 6
(assert (= 210 (* V15 V22 V23))) ; Region 7
(assert (= 28 (* V17 V18 V19 V25))) ; Region 9
(assert (= 12 (* V24 V31))) ; Region 10
(assert (= 48 (* V26 V27 V33 V34))) ; Region 11
(assert (= 3 (* V28 V35))) ; Region 12
(assert (= 14 (* V29 V30 V36))) ; Region 13
(assert (= 630 (* V32 V39 V40 V46))) ; Region 14
(assert (= 30 (* V37 V38 V45))) ; Region 15
(assert (= 28 (* V41 V48))) ; Region 16
(assert (= 40 (* V42 V43 V44))) ; Region 17
(check-sat)
