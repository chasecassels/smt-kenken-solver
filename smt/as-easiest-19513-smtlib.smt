...
(assert (= 11 (+ V17 V24 V25))) ; Region 10
(assert (= 12 (+ V19 V26 V33))) ; Region 11
(assert (= 11 (+ V20 V27))) ; Region 12
(assert (= 4 (+ V21 V22))) ; Region 13
(assert (= 7 (+ V23 V30))) ; Region 14
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 15
(assert (or (= 6 (- V31 V32)) (= 6 (- V32 V31)))) ; Region 16
(assert (= 3 (+ V34 V41))) ; Region 17
(assert (or (= 5 (- V35 V42)) (= 5 (- V42 V35)))) ; Region 18
(assert (= 9 (+ V36 V43))) ; Region 19
(assert (or (= 1 (- V37 V38)) (= 1 (- V38 V37)))) ; Region 20
(assert (= 5 (+ V39 V40))) ; Region 21
(assert (= 8 (+ V44 V45))) ; Region 22
