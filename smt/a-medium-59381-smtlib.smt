...
(assert (= 13 (+ V3 V10 V11))) ; Region 2
(assert (= 9 (+ V4 V5 V6))) ; Region 3
(assert (= 3 (+ V7 V14))) ; Region 4
(assert (= 9 (+ V8 V9))) ; Region 5
(assert (= 14 (+ V12 V19 V26 V33))) ; Region 6
(assert (= 11 (+ V13 V20))) ; Region 7
(assert (= 10 (+ V15 V16))) ; Region 8
(assert (= 14 (+ V17 V23 V24))) ; Region 9
(assert (= 3 (+ V18 V25))) ; Region 10
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (= 9 (+ V27 V34))) ; Region 13
(assert (= 14 (+ V28 V35 V36))) ; Region 14
(assert (= 8 (+ V30 V37))) ; Region 15
(assert (= 15 (+ V31 V32 V38 V39))) ; Region 16
(assert (= 14 (+ V40 V41 V48))) ; Region 17
(assert (= 11 (+ V42 V43 V44))) ; Region 18
(assert (= 10 (+ V45 V46))) ; Region 19
(check-sat)
