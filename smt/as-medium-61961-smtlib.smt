...
(assert (= 13 (+ V4 V11 V12))) ; Region 3
(assert (= 10 (+ V6 V13 V20 V27))) ; Region 5
(assert (= 17 (+ V7 V8 V15))) ; Region 6
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 7
(assert (or (= 3 (- V14 V21)) (= 3 (- V21 V14)))) ; Region 8
(assert (or (= 3 (- V16 V17)) (= 3 (- V17 V16)))) ; Region 9
(assert (= 8 (+ V18 V24 V25))) ; Region 10
(assert (= 11 (+ V19 V26))) ; Region 11
(assert (or (= 6 (- V22 V23)) (= 6 (- V23 V22)))) ; Region 12
(assert (or (= 6 (- V28 V35)) (= 6 (- V35 V28)))) ; Region 13
(assert (= 8 (+ V29 V36 V37))) ; Region 14
(assert (or (= 4 (- V30 V31)) (= 4 (- V31 V30)))) ; Region 15
(assert (= 11 (+ V32 V39))) ; Region 16
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 17
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 18
(assert (= 10 (+ V38 V45 V46))) ; Region 19
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 21
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 22
(check-sat)
