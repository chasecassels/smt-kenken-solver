...
(assert (= 11 (+ V0 V7 V14))) ; Region 1
(assert (= 3 (+ V1 V2))) ; Region 2
(assert (= 13 (+ V3 V4 V10))) ; Region 3
(assert (= 12 (+ V5 V6))) ; Region 4
(assert (or (= 6 (- V8 V15)) (= 6 (- V15 V8)))) ; Region 5
(assert (= 7 (+ V9 V16))) ; Region 6
(assert (= 5 (+ V11 V12))) ; Region 7
(assert (= 7 (+ V13 V20))) ; Region 8
(assert (or (= 2 (- V17 V18)) (= 2 (- V18 V17)))) ; Region 9
(assert (= 13 (+ V19 V26))) ; Region 10
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 11
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (or (= 4 (- V23 V30)) (= 4 (- V30 V23)))) ; Region 13
(assert (= 11 (+ V24 V25))) ; Region 14
(assert (= 7 (+ V27 V34))) ; Region 15
(assert (= 5 (+ V31 V38))) ; Region 16
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 17
(assert (= 7 (+ V33 V40 V41))) ; Region 18
(assert (= 10 (+ V35 V36))) ; Region 19
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 21
(assert (or (= 6 (- V44 V45)) (= 6 (- V45 V44)))) ; Region 22
(assert (= 5 (+ V46 V47))) ; Region 23
(check-sat)
