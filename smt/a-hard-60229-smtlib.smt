...
(assert (= 10 (+ V2 V3 V4))) ; Region 2
(assert (= 11 (+ V5 V6))) ; Region 3
(assert (= 8 (+ V8 V9))) ; Region 4
(assert (= 12 (+ V10 V11 V17))) ; Region 5
(assert (= 16 (+ V12 V13 V20 V27))) ; Region 6
(assert (= 11 (+ V14 V15 V22))) ; Region 7
(assert (= 10 (+ V16 V23))) ; Region 8
(assert (= 12 (+ V18 V24 V25))) ; Region 9
(assert (= 8 (+ V19 V26))) ; Region 10
(assert (= 8 (+ V21 V28))) ; Region 11
(assert (= 18 (+ V29 V30 V31))) ; Region 12
(assert (= 6 (+ V32 V33 V40))) ; Region 13
(assert (= 11 (+ V34 V41 V48))) ; Region 14
(assert (= 16 (+ V35 V36 V37))) ; Region 15
(assert (= 5 (+ V38 V39))) ; Region 16
(assert (= 3 (+ V42 V43))) ; Region 17
(assert (= 10 (+ V44 V45))) ; Region 18
(assert (= 12 (+ V46 V47))) ; Region 19
(check-sat)
