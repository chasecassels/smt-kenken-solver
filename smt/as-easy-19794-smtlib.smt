...
(assert (= 14 (+ V0 V1 V7))) ; Region 1
(assert (= 10 (+ V2 V9))) ; Region 2
(assert (or (= 4 (- V3 V10)) (= 4 (- V10 V3)))) ; Region 3
(assert (= 9 (+ V4 V11))) ; Region 4
(assert (= 4 (+ V5 V12))) ; Region 5
(assert (or (= 6 (- V6 V13)) (= 6 (- V13 V6)))) ; Region 6
(assert (= 14 (+ V8 V15 V22 V29))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 8
(assert (or (= 1 (- V16 V23)) (= 1 (- V23 V16)))) ; Region 9
(assert (= 13 (+ V17 V18))) ; Region 10
(assert (= 8 (+ V19 V20))) ; Region 11
(assert (= 16 (+ V24 V30 V31))) ; Region 12
(assert (or (= 6 (- V25 V32)) (= 6 (- V32 V25)))) ; Region 13
(assert (= 11 (+ V26 V27))) ; Region 14
(assert (or (= 3 (- V28 V35)) (= 3 (- V35 V28)))) ; Region 15
(assert (= 6 (+ V33 V40))) ; Region 16
(assert (= 12 (+ V36 V37))) ; Region 18
(assert (= 4 (+ V38 V39))) ; Region 19
(assert (or (= 4 (- V41 V48)) (= 4 (- V48 V41)))) ; Region 20
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 21
(assert (= 4 (+ V44 V45))) ; Region 22
