...
(assert (= 7 (+ V5 V6 V12))) ; Region 4
(assert (= 8 (+ V7 V8))) ; Region 5
(assert (= 11 (+ V10 V17 V23 V24))) ; Region 7
(assert (= 12 (+ V13 V19 V20))) ; Region 8
(assert (= 3 (+ V14 V21))) ; Region 9
(assert (= 12 (+ V15 V16))) ; Region 10
(assert (= 13 (+ V18 V25))) ; Region 11
(assert (= 11 (+ V22 V29 V36))) ; Region 12
(assert (= 10 (+ V26 V27))) ; Region 13
(assert (= 9 (+ V28 V35))) ; Region 14
(assert (= 11 (+ V30 V31))) ; Region 15
(assert (= 3 (+ V32 V39))) ; Region 16
(assert (= 13 (+ V33 V34 V40))) ; Region 17
(assert (= 7 (+ V37 V38))) ; Region 18
(assert (= 12 (+ V41 V48))) ; Region 19
(assert (= 15 (+ V42 V43 V44))) ; Region 20
(assert (= 4 (+ V45 V46))) ; Region 21
(check-sat)
