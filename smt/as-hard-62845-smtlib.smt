...
(assert (= 13 (+ V0 V1 V2))) ; Region 1
(assert (= 7 (+ V3 V4))) ; Region 2
(assert (or (= 2 (- V5 V6)) (= 2 (- V6 V5)))) ; Region 3
(assert (= 9 (+ V7 V14))) ; Region 4
(assert (= 16 (+ V8 V15 V22))) ; Region 5
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 6
(assert (= 13 (+ V11 V12 V13))) ; Region 7
(assert (= 7 (+ V16 V17))) ; Region 8
(assert (or (= 5 (- V18 V25)) (= 5 (- V25 V18)))) ; Region 9
(assert (or (= 5 (- V19 V20)) (= 5 (- V20 V19)))) ; Region 10
(assert (= 5 (+ V21 V28))) ; Region 11
(assert (or (= 4 (- V23 V24)) (= 4 (- V24 V23)))) ; Region 12
(assert (= 6 (+ V26 V27))) ; Region 13
(assert (= 11 (+ V29 V30))) ; Region 14
(assert (= 13 (+ V31 V32 V39))) ; Region 15
(assert (or (= 6 (- V33 V34)) (= 6 (- V34 V33)))) ; Region 16
(assert (= 9 (+ V35 V36 V42))) ; Region 17
(assert (= 8 (+ V37 V38))) ; Region 18
(assert (= 15 (+ V40 V45 V46 V47))) ; Region 19
(assert (or (= 4 (- V41 V48)) (= 4 (- V48 V41)))) ; Region 20
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 21
(check-sat)
