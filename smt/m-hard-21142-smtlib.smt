...
(assert (= 168 (* V0 V1 V7 V8))) ; Region 1
(assert (= 35 (* V3 V4))) ; Region 3
(assert (= 24 (* V5 V11 V12))) ; Region 4
(assert (= 105 (* V6 V13 V20))) ; Region 5
(assert (= 144 (* V9 V10 V17 V18))) ; Region 6
(assert (= 20 (* V14 V15 V22))) ; Region 7
(assert (= 105 (* V16 V23 V24))) ; Region 8
(assert (= 18 (* V19 V25 V26))) ; Region 9
(assert (= 42 (* V21 V28 V29))) ; Region 10
(assert (= 4 (* V27 V34))) ; Region 11
(assert (= 12 (* V30 V31))) ; Region 12
(assert (= 60 (* V32 V33 V39))) ; Region 13
(assert (= 15 (* V35 V42))) ; Region 14
(assert (= 84 (* V36 V43 V44))) ; Region 15
(assert (= 8 (* V37 V38 V45))) ; Region 16
(assert (= 35 (* V40 V46 V47))) ; Region 17
