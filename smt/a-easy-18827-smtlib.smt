...
(assert (= 13 (+ V1 V8 V15))) ; Region 2
(assert (= 8 (+ V2 V9))) ; Region 3
(assert (= 3 (+ V3 V10))) ; Region 4
(assert (= 13 (+ V4 V5))) ; Region 5
(assert (= 7 (+ V6 V13))) ; Region 6
(assert (= 8 (+ V11 V18))) ; Region 7
(assert (= 5 (+ V12 V19))) ; Region 8
(assert (= 11 (+ V14 V21))) ; Region 9
(assert (= 10 (+ V16 V17))) ; Region 10
(assert (= 3 (+ V20 V27))) ; Region 11
(assert (= 7 (+ V22 V29))) ; Region 12
(assert (= 15 (+ V23 V30 V31))) ; Region 13
(assert (= 5 (+ V24 V25))) ; Region 14
(assert (= 12 (+ V26 V33 V34))) ; Region 15
(assert (= 5 (+ V28 V35))) ; Region 16
(assert (= 11 (+ V32 V39))) ; Region 17
(assert (= 3 (+ V36 V37))) ; Region 18
(assert (= 22 (+ V40 V41 V47 V48))) ; Region 20
