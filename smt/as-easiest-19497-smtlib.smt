...
(assert (= 9 (+ V0 V1))) ; Region 1
(assert (= 6 (+ V2 V3))) ; Region 2
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 4
(assert (= 9 (+ V7 V14))) ; Region 5
(assert (or (= 2 (- V8 V9)) (= 2 (- V9 V8)))) ; Region 6
(assert (= 11 (+ V10 V17))) ; Region 7
(assert (= 13 (+ V11 V18))) ; Region 8
(assert (= 3 (+ V12 V13))) ; Region 9
(assert (= 3 (+ V15 V16))) ; Region 10
(assert (or (= 3 (- V19 V20)) (= 3 (- V20 V19)))) ; Region 11
(assert (or (= 6 (- V21 V22)) (= 6 (- V22 V21)))) ; Region 12
(assert (= 15 (+ V23 V24 V25))) ; Region 13
(assert (= 5 (+ V26 V27))) ; Region 14
(assert (= 7 (+ V28 V29))) ; Region 15
(assert (or (= 6 (- V30 V31)) (= 6 (- V31 V30)))) ; Region 16
(assert (= 6 (+ V32 V39 V46))) ; Region 17
(assert (= 17 (+ V33 V40 V41))) ; Region 18
(assert (or (= 5 (- V36 V37)) (= 5 (- V37 V36)))) ; Region 21
(assert (= 10 (+ V38 V44 V45))) ; Region 22
