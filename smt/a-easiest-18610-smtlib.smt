...
(assert (= 11 (+ V36 V43))) ; Region 19
(assert (= 12 (+ V37 V44))) ; Region 20
(assert (= 8 (+ V38 V45))) ; Region 21
(assert (= 5 (+ V39 V46))) ; Region 22
(assert (= 5 (+ V41 V48))) ; Region 23
(check-sat)
