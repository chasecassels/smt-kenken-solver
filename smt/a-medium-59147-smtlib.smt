...
(assert (= 18 (+ V2 V9 V16))) ; Region 2
(assert (= 9 (+ V3 V10))) ; Region 3
(assert (= 16 (+ V4 V5 V6))) ; Region 4
(assert (= 14 (+ V7 V14 V21))) ; Region 5
(assert (= 14 (+ V8 V15 V22))) ; Region 6
(assert (= 4 (+ V11 V18))) ; Region 7
(assert (= 6 (+ V12 V19))) ; Region 8
(assert (= 7 (+ V13 V20))) ; Region 9
(assert (= 6 (+ V17 V24))) ; Region 10
(assert (= 5 (+ V23 V30))) ; Region 11
(assert (= 18 (+ V25 V32 V39))) ; Region 12
(assert (= 6 (+ V26 V27))) ; Region 13
(assert (= 11 (+ V28 V29))) ; Region 14
(assert (= 8 (+ V31 V38))) ; Region 15
(assert (= 12 (+ V33 V34 V40 V41))) ; Region 16
(assert (= 6 (+ V35 V42))) ; Region 17
(assert (= 10 (+ V36 V37 V44))) ; Region 18
(assert (= 7 (+ V45 V46))) ; Region 20
(assert (= 13 (+ V47 V48))) ; Region 21
(check-sat)
