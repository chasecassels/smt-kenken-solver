...
(assert (= 9 (+ V0 V7 V8))) ; Region 1
(assert (= 13 (+ V1 V2))) ; Region 2
(assert (= 6 (+ V3 V4))) ; Region 3
(assert (= 4 (+ V5 V6))) ; Region 4
(assert (= 5 (+ V9 V16))) ; Region 5
(assert (= 6 (+ V10 V17))) ; Region 6
(assert (= 16 (+ V11 V12 V18))) ; Region 7
(assert (= 13 (+ V13 V20))) ; Region 8
(assert (= 6 (+ V14 V15))) ; Region 9
(assert (or (= 4 (- V19 V26)) (= 4 (- V26 V19)))) ; Region 10
(assert (or (= 1 (- V21 V22)) (= 1 (- V22 V21)))) ; Region 11
(assert (= 13 (+ V23 V24))) ; Region 12
(assert (= 8 (+ V25 V32))) ; Region 13
(assert (= 13 (+ V28 V35))) ; Region 15
(assert (= 10 (+ V30 V31 V38))) ; Region 17
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 18
(assert (= 9 (+ V36 V37))) ; Region 19
(assert (= 9 (+ V39 V46))) ; Region 20
(assert (= 6 (+ V40 V47))) ; Region 21
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 22
(assert (= 8 (+ V42 V43))) ; Region 23
(assert (or (= 6 (- V44 V45)) (= 6 (- V45 V44)))) ; Region 24
(check-sat)
