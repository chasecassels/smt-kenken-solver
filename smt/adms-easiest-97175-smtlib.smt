...
(assert (= 20 (* V2 V3 V4))) ; Region 3
(assert (= 5 (+ V5 V6))) ; Region 4
(assert (or (= 6 (- V8 V9)) (= 6 (- V9 V8)))) ; Region 5
(assert (= 20 (* V10 V11))) ; Region 6
(assert (or (= 3 (/ V12 V13)) (= 3 (/ V13 V12)))) ; Region 7
(assert (= 12 (+ V14 V21))) ; Region 8
(assert (= 15 (* V15 V22))) ; Region 9
(assert (or (= 3 (/ V16 V17)) (= 3 (/ V17 V16)))) ; Region 10
(assert (or (= 6 (- V18 V19)) (= 6 (- V19 V18)))) ; Region 11
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 12
(assert (or (= 3 (/ V23 V30)) (= 3 (/ V30 V23)))) ; Region 13
(assert (or (= 3 (/ V24 V25)) (= 3 (/ V25 V24)))) ; Region 14
(assert (= 9 (+ V26 V33))) ; Region 15
(assert (= 10 (+ V28 V29 V36))) ; Region 16
(assert (= 60 (* V31 V37 V38))) ; Region 17
(assert (= 4 (+ V32 V39))) ; Region 18
(assert (= 13 (+ V34 V41))) ; Region 19
(assert (= 5 (+ V35 V42))) ; Region 20
(assert (= 105 (* V40 V47 V48))) ; Region 21
(assert (or (= 2 (/ V43 V44)) (= 2 (/ V44 V43)))) ; Region 22
(assert (= 13 (+ V45 V46))) ; Region 23
(check-sat)
