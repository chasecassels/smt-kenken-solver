...
(assert (= 245 (* V0 V7 V8))) ; Region 1
(assert (= 6 (* V2 V9 V10))) ; Region 3
(assert (= 12 (* V3 V4))) ; Region 4
(assert (= 60 (* V5 V6 V13 V20))) ; Region 5
(assert (= 504 (* V11 V12 V16 V17 V18))) ; Region 6
(assert (= 24 (* V14 V15 V21))) ; Region 7
(assert (= 42 (* V19 V25 V26))) ; Region 8
(assert (= 40 (* V22 V23 V24 V29))) ; Region 9
(assert (= 84 (* V27 V33 V34))) ; Region 10
(assert (= 12 (* V28 V35))) ; Region 11
(assert (= 72 (* V30 V36 V37 V42 V43))) ; Region 12
(assert (= 840 (* V31 V38 V44 V45))) ; Region 13
(assert (= 15 (* V32 V39))) ; Region 14
