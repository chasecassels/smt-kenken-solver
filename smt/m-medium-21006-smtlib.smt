...
(assert (= 24 (* V1 V2 V3 V9))) ; Region 2
(assert (= 210 (* V4 V5 V6 V11))) ; Region 3
(assert (= 24 (* V7 V14))) ; Region 4
(assert (= 126 (* V8 V15 V16 V22))) ; Region 5
(assert (= 210 (* V10 V17 V18 V25))) ; Region 6
(assert (= 240 (* V12 V13 V19 V26))) ; Region 7
(assert (= 28 (* V20 V27))) ; Region 8
(assert (= 35 (* V21 V28 V29))) ; Region 9
(assert (= 60 (* V23 V24 V30))) ; Region 10
(assert (= 12 (* V31 V32 V38))) ; Region 11
(assert (= 36 (* V33 V34 V40 V41))) ; Region 12
(assert (= 10 (* V35 V42))) ; Region 13
(assert (= 20 (* V36 V37))) ; Region 14
(assert (= 84 (* V39 V46 V47 V48))) ; Region 15
(assert (= 84 (* V43 V44 V45))) ; Region 16
(check-sat)
