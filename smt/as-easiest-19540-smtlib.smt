...
(assert (= 13 (+ V1 V2 V3))) ; Region 2
(assert (= 9 (+ V4 V11))) ; Region 3
(assert (= 3 (+ V5 V12))) ; Region 4
(assert (= 4 (+ V6 V13))) ; Region 5
(assert (= 13 (+ V7 V8))) ; Region 6
(assert (= 11 (+ V9 V16))) ; Region 7
(assert (or (= 1 (- V10 V17)) (= 1 (- V17 V10)))) ; Region 8
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 9
(assert (or (= 6 (- V15 V22)) (= 6 (- V22 V15)))) ; Region 10
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 11
(assert (= 9 (+ V19 V26))) ; Region 12
(assert (or (= 5 (- V20 V27)) (= 5 (- V27 V20)))) ; Region 13
(assert (or (= 4 (- V23 V24)) (= 4 (- V24 V23)))) ; Region 14
(assert (= 3 (+ V28 V35))) ; Region 15
(assert (= 7 (+ V29 V36))) ; Region 16
(assert (or (= 6 (- V30 V37)) (= 6 (- V37 V30)))) ; Region 17
(assert (or (= 4 (- V31 V32)) (= 4 (- V32 V31)))) ; Region 18
(assert (= 14 (+ V33 V34 V40))) ; Region 19
(assert (= 12 (+ V38 V39))) ; Region 20
(assert (= 10 (+ V41 V48))) ; Region 21
(assert (= 9 (+ V42 V43))) ; Region 22
(assert (= 4 (+ V44 V45))) ; Region 23
(assert (= 9 (+ V46 V47))) ; Region 24
(check-sat)
