...
(assert (= 30 (* V0 V7 V8 V14))) ; Region 1
(assert (= 42 (* V1 V2))) ; Region 2
(assert (= 420 (* V3 V4 V10 V11))) ; Region 3
(assert (= 48 (* V5 V6 V13))) ; Region 4
(assert (= 168 (* V12 V18 V19 V20))) ; Region 6
(assert (= 42 (* V15 V21 V22 V23))) ; Region 7
(assert (= 12 (* V16 V17 V24))) ; Region 8
(assert (= 12 (* V25 V26))) ; Region 9
(assert (= 525 (* V27 V33 V34 V41))) ; Region 10
(assert (= 28 (* V28 V35))) ; Region 11
(assert (= 18 (* V29 V30))) ; Region 12
(assert (= 2 (* V31 V32 V39))) ; Region 13
(assert (= 60 (* V36 V37 V44))) ; Region 14
(assert (= 12 (* V40 V47 V48))) ; Region 16
(assert (= 8 (* V42 V43))) ; Region 17
