...
(assert (= 13 (+ V3 V10 V11))) ; Region 3
(assert (= 14 (+ V4 V5 V6 V12))) ; Region 4
(assert (= 13 (+ V7 V14))) ; Region 5
(assert (= 11 (+ V8 V15))) ; Region 6
(assert (= 6 (+ V13 V20))) ; Region 7
(assert (= 3 (+ V16 V17))) ; Region 8
(assert (= 5 (+ V18 V25))) ; Region 9
(assert (= 13 (+ V19 V26))) ; Region 10
(assert (= 13 (+ V21 V22 V23 V28))) ; Region 11
(assert (= 12 (+ V24 V31 V38))) ; Region 12
(assert (= 8 (+ V27 V34))) ; Region 13
(assert (= 10 (+ V29 V35 V36))) ; Region 14
(assert (= 7 (+ V30 V37))) ; Region 15
(assert (= 13 (+ V32 V39))) ; Region 16
(assert (= 8 (+ V33 V40))) ; Region 17
(assert (= 9 (+ V42 V43))) ; Region 19
(assert (= 11 (+ V44 V45))) ; Region 20
(assert (= 8 (+ V46 V47 V48))) ; Region 21
(check-sat)
