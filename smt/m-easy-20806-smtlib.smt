...
(assert (= 540 (* V0 V7 V8 V9))) ; Region 1
(assert (= 8 (* V2 V3 V10 V17))) ; Region 3
(assert (= 30 (* V4 V5 V6))) ; Region 4
(assert (= 28 (* V11 V12 V18))) ; Region 5
(assert (= 20 (* V13 V20))) ; Region 6
(assert (= 42 (* V14 V15 V16))) ; Region 7
(assert (= 12 (* V19 V26 V27))) ; Region 8
(assert (= 40 (* V21 V22 V28))) ; Region 9
(assert (= 126 (* V23 V24 V29 V30))) ; Region 10
(assert (= 30 (* V25 V32))) ; Region 11
(assert (= 18 (* V31 V38 V39))) ; Region 12
(assert (= 84 (* V33 V34 V41))) ; Region 13
(assert (= 10 (* V35 V36 V42))) ; Region 14
(assert (= 126 (* V40 V47 V48))) ; Region 16
(assert (= 280 (* V43 V44 V45 V46))) ; Region 17
(check-sat)
