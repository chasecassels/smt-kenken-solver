...
(assert (or (= 1 (- V2 V3)) (= 1 (- V3 V2)))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (= 70 (* V6 V13 V20))) ; Region 4
(assert (= 11 (+ V7 V14))) ; Region 5
(assert (or (= 3 (- V8 V15)) (= 3 (- V15 V8)))) ; Region 6
(assert (or (= 2 (- V9 V10)) (= 2 (- V10 V9)))) ; Region 7
(assert (or (= 3 (/ V11 V12)) (= 3 (/ V12 V11)))) ; Region 8
(assert (or (= 2 (- V16 V23)) (= 2 (- V23 V16)))) ; Region 9
(assert (or (= 6 (- V17 V24)) (= 6 (- V24 V17)))) ; Region 10
(assert (= 15 (+ V18 V25 V32))) ; Region 11
(assert (= 72 (* V19 V26 V27))) ; Region 12
(assert (= 35 (* V21 V22))) ; Region 13
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 14
(assert (= 18 (+ V29 V30 V36 V37))) ; Region 15
(assert (= 11 (+ V31 V38 V45))) ; Region 16
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 17
(assert (or (= 6 (- V39 V46)) (= 6 (- V46 V39)))) ; Region 18
(assert (or (= 4 (- V40 V47)) (= 4 (- V47 V40)))) ; Region 19
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 20
(assert (= 120 (* V42 V43 V44))) ; Region 21
(check-sat)
