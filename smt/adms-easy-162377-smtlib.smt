...
(assert (= 35 (* V0 V1 V2))) ; Region 1
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 2
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 3
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 4
(assert (= 16 (+ V8 V15 V16))) ; Region 5
(assert (or (= 3 (/ V9 V10)) (= 3 (/ V10 V9)))) ; Region 6
(assert (= 48 (* V11 V12 V19))) ; Region 7
(assert (or (= 3 (- V13 V20)) (= 3 (- V20 V13)))) ; Region 8
(assert (or (= 6 (- V17 V18)) (= 6 (- V18 V17)))) ; Region 9
(assert (= 60 (* V21 V28 V29))) ; Region 10
(assert (or (= 3 (/ V23 V30)) (= 3 (/ V30 V23)))) ; Region 12
(assert (= 24 (* V24 V25 V26))) ; Region 13
(assert (= 8 (+ V27 V34))) ; Region 14
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 15
(assert (= 19 (+ V32 V33 V39))) ; Region 16
(assert (= 24 (* V35 V36 V42 V43))) ; Region 17
(assert (or (= 3 (- V37 V44)) (= 3 (- V44 V37)))) ; Region 18
(assert (= 10 (+ V41 V47 V48))) ; Region 20
(assert (or (= 1 (- V45 V46)) (= 1 (- V46 V45)))) ; Region 21
(check-sat)
