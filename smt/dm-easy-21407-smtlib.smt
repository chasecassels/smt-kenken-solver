...
(assert (= 35 (* V1 V2 V3))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (= 28 (* V6 V13))) ; Region 4
(assert (= 126 (* V8 V15 V16 V17))) ; Region 5
(assert (or (= 2 (/ V9 V10)) (= 2 (/ V10 V9)))) ; Region 6
(assert (= 120 (* V11 V12 V18 V19))) ; Region 7
(assert (= 600 (* V14 V21 V22 V23))) ; Region 8
(assert (= 84 (* V24 V25 V31 V32))) ; Region 10
(assert (= 420 (* V26 V27 V33 V34))) ; Region 11
(assert (= 56 (* V28 V29 V35 V36))) ; Region 12
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 13
(assert (= 35 (* V38 V39 V45))) ; Region 14
(assert (= 6 (* V40 V41))) ; Region 15
(assert (= 30 (* V42 V43 V44))) ; Region 16
(assert (= 24 (* V46 V47 V48))) ; Region 17
(check-sat)
