...
(assert (= 126 (* V2 V9 V16))) ; Region 2
(assert (= 14 (* V3 V10))) ; Region 3
(assert (= 120 (* V4 V5 V6 V11))) ; Region 4
(assert (= 12 (* V7 V8))) ; Region 5
(assert (= 60 (* V13 V18 V19 V20))) ; Region 7
(assert (= 14 (* V14 V15 V22))) ; Region 8
(assert (= 40 (* V17 V23 V24 V25))) ; Region 9
(assert (= 168 (* V21 V28 V35 V36))) ; Region 10
(assert (= 18 (* V26 V27))) ; Region 11
(assert (= 100 (* V29 V30 V37))) ; Region 12
(assert (= 126 (* V31 V38 V39 V40))) ; Region 13
(assert (= 42 (* V33 V34 V41))) ; Region 15
(assert (= 15 (* V42 V43 V44))) ; Region 16
(assert (= 336 (* V45 V46 V47 V48))) ; Region 17
(check-sat)
