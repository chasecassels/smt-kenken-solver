...
(assert (= 120 (* V2 V3 V4 V11))) ; Region 2
(assert (= 12 (* V5 V6 V12))) ; Region 3
(assert (= 105 (* V8 V9 V16))) ; Region 4
(assert (= 14 (* V10 V17 V18))) ; Region 5
(assert (= 12 (* V13 V20))) ; Region 6
(assert (= 24 (* V14 V15))) ; Region 7
(assert (= 140 (* V19 V26 V27))) ; Region 8
(assert (= 60 (* V21 V28 V35))) ; Region 9
(assert (= 84 (* V22 V23 V24 V29))) ; Region 10
(assert (= 180 (* V25 V30 V31 V32))) ; Region 11
(assert (= 60 (* V33 V34 V41 V48))) ; Region 12
(assert (= 10 (* V36 V42 V43))) ; Region 13
(assert (= 24 (* V37 V44 V45))) ; Region 14
(assert (= 588 (* V38 V39 V40 V46))) ; Region 15
(check-sat)
