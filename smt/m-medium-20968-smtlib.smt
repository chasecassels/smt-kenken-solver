...
(assert (= 35 (* V1 V2))) ; Region 2
(assert (= 28 (* V3 V10 V11 V18))) ; Region 3
(assert (= 72 (* V4 V5 V6))) ; Region 4
(assert (= 40 (* V9 V16 V17))) ; Region 5
(assert (= 90 (* V12 V13 V19 V20))) ; Region 6
(assert (= 42 (* V14 V15))) ; Region 7
(assert (= 28 (* V21 V22))) ; Region 8
(assert (= 180 (* V23 V24 V29 V30 V36))) ; Region 9
(assert (= 30 (* V25 V26 V27))) ; Region 10
(assert (= 30 (* V28 V35 V42))) ; Region 11
(assert (= 56 (* V32 V33 V34 V40))) ; Region 13
(assert (= 84 (* V37 V38 V39 V44))) ; Region 14
(assert (= 42 (* V41 V48))) ; Region 15
(assert (= 120 (* V45 V46 V47))) ; Region 17
(check-sat)
