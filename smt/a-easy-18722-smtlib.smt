...
(assert (= 15 (+ V3 V4 V5))) ; Region 3
(assert (= 3 (+ V6 V13))) ; Region 4
(assert (= 7 (+ V8 V15))) ; Region 5
(assert (= 13 (+ V9 V16))) ; Region 6
(assert (= 3 (+ V10 V17))) ; Region 7
(assert (= 15 (+ V11 V12 V19))) ; Region 8
(assert (= 9 (+ V14 V21))) ; Region 9
(assert (= 9 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V22 V29))) ; Region 12
(assert (= 14 (+ V23 V30 V31))) ; Region 13
(assert (= 13 (+ V24 V25 V26))) ; Region 14
(assert (= 10 (+ V28 V35))) ; Region 15
(assert (= 10 (+ V32 V33 V34))) ; Region 16
(assert (= 6 (+ V36 V37))) ; Region 17
(assert (= 13 (+ V38 V39 V46))) ; Region 18
(assert (= 5 (+ V40 V41))) ; Region 19
