...
(assert (= 13 (+ V1 V8 V9))) ; Region 2
(assert (= 11 (+ V2 V3 V4))) ; Region 3
(assert (= 15 (+ V6 V13 V20))) ; Region 5
(assert (= 8 (+ V10 V11))) ; Region 6
(assert (= 12 (+ V12 V19))) ; Region 7
(assert (or (= 1 (- V14 V21)) (= 1 (- V21 V14)))) ; Region 8
(assert (= 14 (+ V15 V22 V28 V29))) ; Region 9
(assert (= 7 (+ V16 V17 V18))) ; Region 10
(assert (= 13 (+ V23 V24 V30))) ; Region 11
(assert (= 9 (+ V25 V26 V33))) ; Region 12
(assert (= 7 (+ V27 V34 V41))) ; Region 13
(assert (or (= 1 (- V31 V32)) (= 1 (- V32 V31)))) ; Region 14
(assert (= 7 (+ V35 V42 V43))) ; Region 15
(assert (= 17 (+ V36 V37 V44))) ; Region 16
(assert (or (= 4 (- V38 V45)) (= 4 (- V45 V38)))) ; Region 17
(assert (= 11 (+ V39 V40))) ; Region 18
(assert (= 7 (+ V46 V47))) ; Region 19
(check-sat)
