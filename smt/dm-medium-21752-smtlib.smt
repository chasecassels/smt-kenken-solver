...
(assert (= 735 (* V3 V4 V11 V12))) ; Region 2
(assert (= 12 (* V5 V6 V13))) ; Region 3
(assert (= 210 (* V8 V15 V16))) ; Region 5
(assert (= 32 (* V9 V10 V17 V18))) ; Region 6
(assert (= 168 (* V14 V21 V22))) ; Region 7
(assert (or (= 3 (/ V19 V20)) (= 3 (/ V20 V19)))) ; Region 8
(assert (or (= 3 (/ V23 V30)) (= 3 (/ V30 V23)))) ; Region 9
(assert (= 30 (* V24 V25 V31 V32))) ; Region 10
(assert (= 24 (* V26 V27 V33))) ; Region 11
(assert (= 60 (* V28 V29 V35 V36))) ; Region 12
(assert (= 700 (* V34 V41 V47 V48))) ; Region 13
(assert (= 42 (* V37 V42 V43 V44))) ; Region 14
(assert (= 84 (* V38 V39 V40))) ; Region 15
(assert (or (= 2 (/ V45 V46)) (= 2 (/ V46 V45)))) ; Region 16
(check-sat)
