...
(assert (= 11 (+ V0 V7))) ; Region 1
(assert (= 13 (+ V1 V2))) ; Region 2
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 3
(assert (= 8 (+ V5 V6 V12))) ; Region 4
(assert (or (= 3 (- V8 V15)) (= 3 (- V15 V8)))) ; Region 5
(assert (= 8 (+ V9 V10 V17))) ; Region 6
(assert (= 9 (+ V11 V18))) ; Region 7
(assert (or (= 1 (- V13 V20)) (= 1 (- V20 V13)))) ; Region 8
(assert (= 7 (+ V14 V21))) ; Region 9
(assert (= 11 (+ V19 V26 V27))) ; Region 11
(assert (= 13 (+ V22 V23 V29 V30))) ; Region 12
(assert (= 13 (+ V24 V31))) ; Region 13
(assert (= 3 (+ V25 V32))) ; Region 14
(assert (= 10 (+ V28 V35 V42))) ; Region 15
(assert (or (= 3 (- V33 V34)) (= 3 (- V34 V33)))) ; Region 16
(assert (or (= 5 (- V36 V43)) (= 5 (- V43 V36)))) ; Region 17
(assert (or (= 1 (- V37 V38)) (= 1 (- V38 V37)))) ; Region 18
(assert (= 12 (+ V40 V46 V47))) ; Region 20
(assert (or (= 2 (- V41 V48)) (= 2 (- V48 V41)))) ; Region 21
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 22
(check-sat)
