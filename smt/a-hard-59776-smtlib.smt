...
(assert (= 18 (+ V12 V19 V26))) ; Region 6
(assert (= 6 (+ V13 V20))) ; Region 7
(assert (= 11 (+ V14 V21 V28))) ; Region 8
(assert (= 11 (+ V15 V16))) ; Region 9
(assert (= 9 (+ V17 V24))) ; Region 10
(assert (= 4 (+ V18 V25))) ; Region 11
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (= 7 (+ V23 V30))) ; Region 13
(assert (= 9 (+ V27 V34))) ; Region 14
(assert (= 8 (+ V31 V38))) ; Region 15
(assert (= 6 (+ V32 V33))) ; Region 16
(assert (= 11 (+ V35 V36 V42 V43))) ; Region 17
(assert (= 9 (+ V37 V44))) ; Region 18
(assert (= 7 (+ V40 V47))) ; Region 20
(assert (= 9 (+ V41 V48))) ; Region 21
(assert (= 7 (+ V45 V46))) ; Region 22
(check-sat)
