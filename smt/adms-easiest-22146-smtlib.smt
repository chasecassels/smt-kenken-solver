...
(assert (= 21 (* V0 V1 V7))) ; Region 1
(assert (= 13 (+ V2 V3))) ; Region 2
(assert (= 40 (* V4 V5 V6))) ; Region 3
(assert (= 3 (+ V8 V9))) ; Region 4
(assert (= 60 (* V10 V11 V18))) ; Region 5
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 6
...
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 12
(assert (= 13 (+ V25 V32))) ; Region 13
(assert (= 8 (+ V26 V33))) ; Region 14
(assert (= 8 (+ V27 V34))) ; Region 15
(assert (= 96 (* V29 V35 V36))) ; Region 16
(assert (= 105 (* V30 V37 V38))) ; Region 17
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 18
(assert (= 9 (+ V40 V47 V48))) ; Region 19
(assert (= 12 (+ V42 V43))) ; Region 21
(assert (= 10 (+ V44 V45))) ; Region 22
(check-sat)
