...
(assert (= 525 (* V0 V1 V7 V8))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (= 48 (* V4 V5 V12))) ; Region 3
(assert (= 72 (* V6 V13 V20 V27))) ; Region 4
(assert (= 84 (* V9 V10 V11))) ; Region 5
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 6
(assert (= 5 (* V15 V16))) ; Region 7
(assert (= 42 (* V17 V24))) ; Region 8
(assert (= 12 (* V18 V19))) ; Region 9
(assert (or (= 2 (/ V22 V23)) (= 2 (/ V23 V22)))) ; Region 10
(assert (= 70 (* V25 V26 V32 V33))) ; Region 11
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 12
(assert (= 126 (* V29 V30 V36))) ; Region 13
(assert (= 360 (* V31 V37 V38 V45))) ; Region 14
(assert (= 105 (* V34 V39 V40 V41))) ; Region 15
(assert (= 24 (* V42 V43 V44))) ; Region 16
(assert (= 14 (* V47 V48))) ; Region 18
(check-sat)
