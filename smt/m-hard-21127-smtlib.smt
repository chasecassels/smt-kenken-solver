...
(assert (= 450 (* V1 V2 V3 V10))) ; Region 2
(assert (= 24 (* V4 V5 V11 V12))) ; Region 3
(assert (= 42 (* V6 V13 V20))) ; Region 4
(assert (= 84 (* V8 V9 V14 V15 V21))) ; Region 5
(assert (= 288 (* V16 V17 V18 V25 V26))) ; Region 6
(assert (= 90 (* V22 V28 V29 V36))) ; Region 8
(assert (= 42 (* V23 V24 V31))) ; Region 9
(assert (= 28 (* V30 V37))) ; Region 11
(assert (= 210 (* V32 V39 V40))) ; Region 12
(assert (= 8 (* V33 V34 V41))) ; Region 13
(assert (= 480 (* V35 V38 V42 V43 V44 V45))) ; Region 14
(assert (= 126 (* V46 V47 V48))) ; Region 15
(check-sat)
