...
(assert (= 420 (* V2 V9 V10 V16))) ; Region 2
(assert (= 30 (* V3 V4 V5 V11))) ; Region 3
(assert (= 14 (* V6 V13))) ; Region 4
(assert (= 35 (* V8 V15))) ; Region 5
(assert (= 12 (* V12 V19))) ; Region 6
(assert (= 24 (* V14 V21 V22))) ; Region 7
(assert (= 168 (* V17 V18 V23 V24 V31))) ; Region 8
(assert (= 120 (* V25 V32 V39))) ; Region 10
(assert (= 105 (* V26 V27 V33))) ; Region 11
(assert (= 14 (* V28 V35))) ; Region 12
(assert (= 36 (* V29 V30 V36 V37))) ; Region 13
(assert (= 12 (* V34 V41))) ; Region 14
(assert (= 70 (* V38 V45 V46))) ; Region 15
(assert (= 4 (* V40 V47 V48))) ; Region 16
(assert (= 90 (* V42 V43 V44))) ; Region 17
(check-sat)
