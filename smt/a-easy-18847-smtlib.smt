...
(assert (= 7 (+ V0 V1 V8))) ; Region 1
(assert (= 9 (+ V2 V9))) ; Region 2
(assert (= 18 (+ V3 V4 V10 V11))) ; Region 3
(assert (= 14 (+ V5 V6 V12))) ; Region 4
(assert (= 13 (+ V7 V14))) ; Region 5
(assert (= 3 (+ V13 V20))) ; Region 6
(assert (= 7 (+ V15 V22))) ; Region 7
(assert (= 10 (+ V16 V17))) ; Region 8
(assert (= 7 (+ V18 V19))) ; Region 9
(assert (= 11 (+ V21 V28 V35))) ; Region 10
(assert (= 4 (+ V23 V30))) ; Region 11
(assert (= 13 (+ V24 V25))) ; Region 12
(assert (= 8 (+ V26 V27))) ; Region 13
(assert (= 13 (+ V29 V36))) ; Region 14
(assert (= 3 (+ V31 V32))) ; Region 15
(assert (= 10 (+ V33 V34))) ; Region 16
(assert (= 7 (+ V37 V38))) ; Region 17
(assert (= 19 (+ V40 V41 V47 V48))) ; Region 19
(assert (= 12 (+ V42 V43 V44))) ; Region 20
(assert (= 5 (+ V45 V46))) ; Region 21
(check-sat)
