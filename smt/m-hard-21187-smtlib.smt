...
(assert (= 84 (* V5 V6 V11 V12 V18))) ; Region 3
(assert (= 4200 (* V8 V9 V16 V17 V23))) ; Region 4
(assert (= 24 (* V13 V19 V20))) ; Region 5
(assert (= 72 (* V14 V15 V21 V22))) ; Region 6
(assert (= 10 (* V24 V31))) ; Region 7
(assert (= 21 (* V25 V32 V33))) ; Region 8
(assert (= 60 (* V26 V27 V34))) ; Region 9
(assert (= 1176 (* V28 V29 V35 V42 V43))) ; Region 10
(assert (= 6 (* V30 V36 V37 V44))) ; Region 11
(assert (= 2400 (* V38 V39 V46 V47 V48))) ; Region 12
(assert (= 42 (* V40 V41))) ; Region 13
(check-sat)
