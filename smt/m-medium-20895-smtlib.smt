...
(assert (= 21 (* V0 V7 V8))) ; Region 1
(assert (= 210 (* V2 V3 V9))) ; Region 3
(assert (= 12 (* V4 V11))) ; Region 4
(assert (= 12 (* V5 V6 V12))) ; Region 5
(assert (= 48 (* V10 V16 V17 V23))) ; Region 6
(assert (= 48 (* V13 V19 V20))) ; Region 7
(assert (= 35 (* V14 V15))) ; Region 8
(assert (= 30 (* V18 V25 V26))) ; Region 9
(assert (= 8 (* V21 V22 V28))) ; Region 10
(assert (= 60 (* V24 V31 V32 V38))) ; Region 11
(assert (= 105 (* V27 V33 V34))) ; Region 12
(assert (= 126 (* V29 V30 V36 V37))) ; Region 13
(assert (= 48 (* V35 V42 V43))) ; Region 14
(assert (= 42 (* V39 V46))) ; Region 15
(assert (= 28 (* V40 V41 V47))) ; Region 16
(assert (= 6 (* V44 V45))) ; Region 17
(check-sat)
