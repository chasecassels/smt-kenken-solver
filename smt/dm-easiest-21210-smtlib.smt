...
(assert (= 14 (* V0 V7))) ; Region 1
(assert (or (= 2 (/ V1 V2)) (= 2 (/ V2 V1)))) ; Region 2
(assert (= 35 (* V3 V10 V17))) ; Region 3
(assert (= 28 (* V4 V5 V6))) ; Region 4
(assert (= 30 (* V8 V15))) ; Region 5
(assert (= 84 (* V9 V16 V23))) ; Region 6
(assert (= 10 (* V11 V18))) ; Region 7
(assert (or (= 2 (/ V12 V13)) (= 2 (/ V13 V12)))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 30 (* V19 V20 V27))) ; Region 10
(assert (= 28 (* V22 V28 V29))) ; Region 11
(assert (= 6 (* V24 V25 V26))) ; Region 12
(assert (= 8 (* V30 V31))) ; Region 13
(assert (= 90 (* V32 V33 V34))) ; Region 14
(assert (= 20 (* V35 V42))) ; Region 15
(assert (or (= 2 (/ V36 V43)) (= 2 (/ V43 V36)))) ; Region 16
(assert (or (= 3 (/ V37 V38)) (= 3 (/ V38 V37)))) ; Region 17
(assert (= 21 (* V39 V46))) ; Region 18
(assert (= 28 (* V40 V47))) ; Region 19
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 20
(assert (= 30 (* V44 V45))) ; Region 21
(check-sat)
