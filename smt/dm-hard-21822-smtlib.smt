...
(assert (= 360 (* V4 V10 V11 V17))) ; Region 3
(assert (= 196 (* V5 V6 V12 V13))) ; Region 4
(assert (= 12 (* V8 V9))) ; Region 5
(assert (= 140 (* V14 V15 V16 V21))) ; Region 6
(assert (= 14 (* V18 V19))) ; Region 7
(assert (= 18 (* V20 V27))) ; Region 8
(assert (= 420 (* V22 V23 V28 V29 V30))) ; Region 9
(assert (= 2 (* V24 V25))) ; Region 10
(assert (= 30 (* V26 V33))) ; Region 11
(assert (= 36 (* V31 V32 V39 V40))) ; Region 12
(assert (= 480 (* V34 V41 V46 V47 V48))) ; Region 13
(assert (= 1008 (* V35 V36 V42 V43 V44))) ; Region 14
(assert (= 35 (* V38 V45))) ; Region 16
(check-sat)
