...
(assert (= 6 (* V2 V9 V16))) ; Region 2
(assert (= 168 (* V3 V4 V11))) ; Region 3
(assert (= 20 (* V5 V12 V13))) ; Region 4
(assert (= 168 (* V7 V8 V14 V15))) ; Region 6
(assert (= 30 (* V10 V17 V18))) ; Region 7
(assert (= 882 (* V19 V20 V26 V27 V33))) ; Region 8
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 9
(assert (= 14 (* V22 V29))) ; Region 10
(assert (= 60 (* V23 V24 V25))) ; Region 11
(assert (= 35 (* V30 V37))) ; Region 12
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 13
(assert (= 6 (* V32 V39))) ; Region 14
(assert (= 24 (* V34 V41 V48))) ; Region 15
(assert (= 60 (* V35 V36 V42))) ; Region 16
(assert (= 12 (* V40 V47))) ; Region 17
(assert (= 30 (* V43 V44))) ; Region 18
(assert (= 7 (* V45 V46))) ; Region 19
(check-sat)
