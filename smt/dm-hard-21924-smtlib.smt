...
(assert (= 36 (* V0 V1 V7 V8))) ; Region 1
(assert (= 140 (* V2 V9 V10))) ; Region 2
(assert (= 6 (* V3 V4))) ; Region 3
(assert (= 168 (* V5 V6 V12))) ; Region 4
(assert (= 600 (* V11 V13 V18 V19 V20))) ; Region 5
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 6
(assert (= 21 (* V15 V16 V22))) ; Region 7
(assert (= 180 (* V17 V24 V31 V32))) ; Region 8
(assert (= 42 (* V23 V30 V37))) ; Region 9
(assert (= 12 (* V25 V26 V27 V34))) ; Region 10
(assert (= 210 (* V28 V35 V42))) ; Region 11
(assert (= 480 (* V29 V36 V43 V44 V45))) ; Region 12
(assert (= 35 (* V38 V39 V46))) ; Region 14
(assert (= 126 (* V40 V41 V47 V48))) ; Region 15
(check-sat)
