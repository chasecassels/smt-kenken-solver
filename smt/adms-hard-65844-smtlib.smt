...
(assert (= 30 (* V0 V1 V7 V8))) ; Region 1
...
(assert (= 140 (* V12 V13 V20))) ; Region 6
(assert (= 10 (+ V14 V21))) ; Region 7
(assert (= 10 (* V15 V22))) ; Region 8
(assert (= 6 (+ V16 V17))) ; Region 9
(assert (or (= 1 (- V18 V19)) (= 1 (- V19 V18)))) ; Region 10
(assert (= 10 (+ V23 V30))) ; Region 11
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 12
(assert (= 8 (+ V25 V26 V27))) ; Region 13
(assert (or (= 2 (- V28 V35)) (= 2 (- V35 V28)))) ; Region 14
(assert (= 42 (* V29 V36))) ; Region 15
(assert (= 11 (+ V32 V33 V34 V41))) ; Region 16
(assert (= 13 (+ V38 V45))) ; Region 18
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 19
