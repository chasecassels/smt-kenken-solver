...
(assert (or (= 1 (- V1 V2)) (= 1 (- V2 V1)))) ; Region 2
(assert (= 30 (* V3 V4 V11))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 4
(assert (or (= 6 (- V8 V15)) (= 6 (- V15 V8)))) ; Region 5
(assert (or (= 1 (- V9 V10)) (= 1 (- V10 V9)))) ; Region 6
(assert (or (= 1 (- V12 V13)) (= 1 (- V13 V12)))) ; Region 7
(assert (= 7 (+ V14 V21))) ; Region 8
(assert (or (= 4 (- V16 V17)) (= 4 (- V17 V16)))) ; Region 9
(assert (= 20 (* V18 V19))) ; Region 10
(assert (= 6 (* V20 V27))) ; Region 11
(assert (or (= 1 (- V22 V23)) (= 1 (- V23 V22)))) ; Region 12
(assert (= 630 (* V24 V25 V32 V39))) ; Region 13
(assert (= 10 (+ V26 V33 V40))) ; Region 14
(assert (= 8 (+ V28 V29))) ; Region 15
(assert (= 13 (+ V30 V31 V37))) ; Region 16
(assert (= 12 (* V34 V41))) ; Region 17
(assert (= 13 (+ V35 V42))) ; Region 18
(assert (= 100 (* V36 V43 V44))) ; Region 19
(assert (or (= 5 (- V38 V45)) (= 5 (- V45 V38)))) ; Region 20
