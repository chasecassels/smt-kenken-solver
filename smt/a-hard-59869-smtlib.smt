...
(assert (= 13 (+ V7 V14 V21))) ; Region 5
(assert (= 6 (+ V8 V9 V10))) ; Region 6
(assert (= 15 (+ V12 V13 V20))) ; Region 7
(assert (= 5 (+ V15 V16))) ; Region 8
(assert (= 16 (+ V17 V18 V19))) ; Region 9
(assert (= 8 (+ V22 V23))) ; Region 10
(assert (= 10 (+ V24 V31))) ; Region 11
(assert (= 3 (+ V25 V32))) ; Region 12
(assert (= 7 (+ V26 V27))) ; Region 13
(assert (= 7 (+ V28 V35))) ; Region 14
(assert (= 13 (+ V29 V30))) ; Region 15
(assert (= 14 (+ V33 V40 V41))) ; Region 16
(assert (= 12 (+ V36 V43 V44))) ; Region 18
(assert (= 12 (+ V37 V38 V39))) ; Region 19
