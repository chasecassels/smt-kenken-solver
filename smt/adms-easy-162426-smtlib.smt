...
(assert (= 42 (* V2 V9 V10))) ; Region 2
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 3
(assert (= 42 (* V5 V12))) ; Region 4
(assert (= 6 (+ V6 V13))) ; Region 5
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 6
(assert (= 8 (+ V14 V21))) ; Region 8
(assert (or (= 2 (/ V17 V18)) (= 2 (/ V18 V17)))) ; Region 10
(assert (= 15 (* V19 V26))) ; Region 11
(assert (or (= 5 (- V20 V27)) (= 5 (- V27 V20)))) ; Region 12
(assert (= 72 (* V23 V24 V25))) ; Region 14
(assert (= 30 (* V28 V29 V36))) ; Region 15
(assert (or (= 6 (- V30 V37)) (= 6 (- V37 V30)))) ; Region 16
(assert (= 12 (+ V31 V38 V45))) ; Region 17
(assert (or (= 2 (/ V32 V33)) (= 2 (/ V33 V32)))) ; Region 18
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 19
(assert (= 7 (+ V35 V42))) ; Region 20
