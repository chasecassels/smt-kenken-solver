...
(assert (= 10 (* V1 V7 V8))) ; Region 2
(assert (= 210 (* V2 V9 V16 V17))) ; Region 3
(assert (= 12 (* V3 V4))) ; Region 4
(assert (= 12 (* V5 V6 V12))) ; Region 5
(assert (= 420 (* V10 V11 V18 V25))) ; Region 6
(assert (= 336 (* V13 V19 V20 V27))) ; Region 7
(assert (= 240 (* V14 V15 V21 V28))) ; Region 8
(assert (= 84 (* V22 V29 V30 V31 V37))) ; Region 9
(assert (= 18 (* V23 V24))) ; Region 10
(assert (= 70 (* V26 V33 V34))) ; Region 11
(assert (= 12 (* V32 V39 V40))) ; Region 12
(assert (= 84 (* V35 V36 V42))) ; Region 13
(assert (= 420 (* V38 V43 V44 V45))) ; Region 14
(assert (= 15 (* V41 V47 V48))) ; Region 15
(check-sat)
