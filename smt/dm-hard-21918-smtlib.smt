...
(assert (= 35 (* V1 V8))) ; Region 2
(assert (= 84 (* V2 V3 V4 V5))) ; Region 3
(assert (= 360 (* V6 V12 V13 V19))) ; Region 4
(assert (= 540 (* V9 V16 V17 V23 V24 V31))) ; Region 5
(assert (= 72 (* V10 V11 V18 V25))) ; Region 6
(assert (= 12 (* V14 V15))) ; Region 7
(assert (= 7 (* V20 V27))) ; Region 8
(assert (= 40 (* V21 V22 V29 V30))) ; Region 9
(assert (= 1680 (* V26 V32 V33 V34 V41))) ; Region 10
(assert (= 756 (* V35 V36 V37 V42 V43))) ; Region 12
(assert (= 5 (* V38 V39))) ; Region 13
(assert (= 210 (* V40 V46 V47 V48))) ; Region 14
(assert (= 8 (* V44 V45))) ; Region 15
(check-sat)
