...
(assert (= 9 (+ V2 V8 V9))) ; Region 2
(assert (= 9 (+ V3 V4 V10))) ; Region 3
(assert (= 13 (+ V5 V12))) ; Region 4
(assert (= 14 (+ V6 V13 V20))) ; Region 5
(assert (= 16 (+ V7 V14 V21))) ; Region 6
(assert (= 13 (+ V15 V22 V29))) ; Region 8
(assert (= 10 (+ V16 V23 V30))) ; Region 9
(assert (= 13 (+ V17 V18 V19))) ; Region 10
(assert (= 7 (+ V24 V31))) ; Region 11
(assert (= 7 (+ V25 V32))) ; Region 12
(assert (= 11 (+ V26 V27))) ; Region 13
(assert (= 9 (+ V28 V35))) ; Region 14
(assert (= 5 (+ V33 V40))) ; Region 15
(assert (= 3 (+ V34 V41))) ; Region 16
(assert (= 9 (+ V36 V37))) ; Region 17
(assert (= 13 (+ V38 V39))) ; Region 18
(assert (= 15 (+ V42 V43 V44))) ; Region 19
(assert (= 4 (+ V45 V46))) ; Region 20
