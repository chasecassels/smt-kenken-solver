...
(assert (= 30 (* V0 V7))) ; Region 1
(assert (= 5 (+ V1 V2))) ; Region 2
(assert (= 13 (+ V3 V10))) ; Region 3
(assert (= 12 (+ V4 V5 V6))) ; Region 4
(assert (= 9 (+ V8 V9))) ; Region 5
(assert (or (= 3 (/ V11 V18)) (= 3 (/ V18 V11)))) ; Region 6
(assert (or (= 4 (- V12 V19)) (= 4 (- V19 V12)))) ; Region 7
(assert (or (= 1 (- V13 V20)) (= 1 (- V20 V13)))) ; Region 8
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 9
(assert (= 15 (+ V15 V16 V23))) ; Region 10
(assert (= 60 (* V17 V24 V25))) ; Region 11
(assert (= 6 (* V22 V28 V29))) ; Region 12
(assert (= 13 (+ V26 V32 V33))) ; Region 13
(assert (= 28 (* V30 V31 V38))) ; Region 15
(assert (or (= 1 (- V34 V41)) (= 1 (- V41 V34)))) ; Region 16
(assert (or (= 3 (/ V36 V37)) (= 3 (/ V37 V36)))) ; Region 18
(assert (= 13 (+ V39 V40 V46))) ; Region 19
