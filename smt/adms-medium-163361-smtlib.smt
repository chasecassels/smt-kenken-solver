...
(assert (or (= 6 (- V4 V11)) (= 6 (- V11 V4)))) ; Region 3
(assert (= 6 (+ V5 V6))) ; Region 4
(assert (= 12 (* V8 V14 V15))) ; Region 5
(assert (or (= 3 (- V9 V10)) (= 3 (- V10 V9)))) ; Region 6
(assert (= 7 (+ V12 V13))) ; Region 7
(assert (= 9 (+ V16 V22 V23))) ; Region 8
(assert (or (= 2 (- V17 V18)) (= 2 (- V18 V17)))) ; Region 9
(assert (or (= 3 (- V19 V20)) (= 3 (- V20 V19)))) ; Region 10
(assert (= 8 (+ V21 V28))) ; Region 11
(assert (or (= 3 (- V24 V31)) (= 3 (- V31 V24)))) ; Region 12
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 13
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 14
(assert (= 140 (* V29 V30 V37))) ; Region 15
(assert (or (= 2 (/ V32 V33)) (= 2 (/ V33 V32)))) ; Region 16
(assert (= 28 (* V35 V36 V42))) ; Region 17
(assert (or (= 3 (/ V38 V39)) (= 3 (/ V39 V38)))) ; Region 18
(assert (or (= 2 (- V40 V41)) (= 2 (- V41 V40)))) ; Region 19
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 20
(assert (= 13 (+ V45 V46))) ; Region 21
(assert (or (= 2 (/ V47 V48)) (= 2 (/ V48 V47)))) ; Region 22
(check-sat)
