...
(assert (= 12 (* V1 V2))) ; Region 2
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 3
(assert (= 28 (* V5 V6))) ; Region 4
(assert (= 42 (* V8 V15))) ; Region 5
(assert (= 5 (* V9 V16))) ; Region 6
(assert (= 12 (* V10 V17))) ; Region 7
(assert (= 35 (* V11 V18))) ; Region 8
(assert (or (= 3 (/ V12 V13)) (= 3 (/ V13 V12)))) ; Region 9
(assert (= 28 (* V14 V21))) ; Region 10
(assert (= 30 (* V19 V26 V27))) ; Region 11
(assert (= 20 (* V22 V29))) ; Region 13
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 14
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 15
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 16
(assert (= 14 (* V30 V31))) ; Region 17
(assert (= 120 (* V33 V34 V41))) ; Region 18
(assert (= 6 (* V36 V43 V44))) ; Region 19
(assert (= 140 (* V37 V38 V45))) ; Region 20
(assert (or (= 3 (/ V39 V40)) (= 3 (/ V40 V39)))) ; Region 21
(assert (= 84 (* V46 V47 V48))) ; Region 23
(check-sat)
