...
(assert (= 28 (* V0 V1 V8))) ; Region 1
(assert (= 20 (* V2 V9))) ; Region 2
(assert (= 6 (* V3 V10))) ; Region 3
(assert (= 14 (* V4 V5))) ; Region 4
(assert (= 18 (* V6 V13))) ; Region 5
(assert (= 15 (* V7 V14))) ; Region 6
(assert (= 72 (* V11 V17 V18))) ; Region 7
(assert (= 4 (* V12 V19 V20))) ; Region 8
(assert (= 35 (* V15 V16))) ; Region 9
(assert (= 28 (* V21 V28))) ; Region 10
(assert (= 6 (* V22 V23 V29))) ; Region 11
(assert (= 100 (* V24 V25 V31))) ; Region 12
(assert (= 18 (* V26 V33))) ; Region 13
(assert (= 14 (* V27 V34))) ; Region 14
(assert (= 18 (* V30 V37))) ; Region 15
(assert (= 4 (* V32 V38 V39))) ; Region 16
(assert (= 12 (* V35 V42 V43))) ; Region 17
(assert (= 35 (* V40 V47))) ; Region 19
(assert (= 20 (* V41 V48))) ; Region 20
(assert (= 42 (* V44 V45 V46))) ; Region 21
(check-sat)
