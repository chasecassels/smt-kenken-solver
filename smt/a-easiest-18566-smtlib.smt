...
(assert (= 16 (+ V2 V8 V9))) ; Region 3
(assert (= 7 (+ V3 V4 V11))) ; Region 4
(assert (= 8 (+ V5 V6))) ; Region 5
(assert (= 13 (+ V10 V17))) ; Region 6
(assert (= 3 (+ V12 V19))) ; Region 7
(assert (= 9 (+ V13 V20))) ; Region 8
(assert (= 5 (+ V14 V21))) ; Region 9
(assert (= 6 (+ V15 V16))) ; Region 10
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (= 8 (+ V23 V24))) ; Region 13
(assert (= 13 (+ V25 V26))) ; Region 14
(assert (= 5 (+ V27 V34))) ; Region 15
(assert (= 10 (+ V30 V37))) ; Region 17
(assert (= 7 (+ V31 V32))) ; Region 18
(assert (= 8 (+ V33 V40))) ; Region 19
(assert (= 3 (+ V35 V36))) ; Region 20
(assert (= 7 (+ V38 V39))) ; Region 21
(assert (= 12 (+ V41 V48))) ; Region 22
(assert (= 9 (+ V42 V43))) ; Region 23
(assert (= 3 (+ V44 V45))) ; Region 24
(assert (= 11 (+ V46 V47))) ; Region 25
(check-sat)
