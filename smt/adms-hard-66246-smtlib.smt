...
(assert (= 252 (* V2 V8 V9 V10))) ; Region 2
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 3
(assert (or (= 1 (- V5 V12)) (= 1 (- V12 V5)))) ; Region 4
(assert (or (= 5 (- V6 V13)) (= 5 (- V13 V6)))) ; Region 5
(assert (or (= 3 (/ V7 V14)) (= 3 (/ V14 V7)))) ; Region 6
(assert (or (= 2 (- V15 V22)) (= 2 (- V22 V15)))) ; Region 8
(assert (= 24 (* V16 V23 V30))) ; Region 9
(assert (or (= 1 (- V17 V24)) (= 1 (- V24 V17)))) ; Region 10
(assert (= 12 (+ V18 V19 V20))) ; Region 11
(assert (= 14 (+ V21 V28 V29))) ; Region 12
(assert (= 16 (+ V25 V31 V32))) ; Region 13
(assert (or (= 2 (/ V26 V27)) (= 2 (/ V27 V26)))) ; Region 14
(assert (= 18 (* V33 V40 V47))) ; Region 15
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 16
(assert (= 11 (+ V35 V36))) ; Region 17
(assert (= 6 (+ V37 V38 V39))) ; Region 18
(assert (= 11 (+ V42 V43 V44))) ; Region 19
(assert (or (= 5 (- V45 V46)) (= 5 (- V46 V45)))) ; Region 20
(check-sat)
