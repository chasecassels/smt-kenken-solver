...
(assert (= 168 (* V0 V1 V7))) ; Region 1
(assert (or (= 3 (/ V3 V10)) (= 3 (/ V10 V3)))) ; Region 3
(assert (= 35 (* V4 V11))) ; Region 4
(assert (= 6 (* V5 V6))) ; Region 5
(assert (= 4 (* V8 V15))) ; Region 6
(assert (= 84 (* V9 V16 V23))) ; Region 7
(assert (or (= 3 (/ V12 V13)) (= 3 (/ V13 V12)))) ; Region 8
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 9
(assert (= 6 (* V17 V18))) ; Region 10
(assert (= 5 (* V19 V20))) ; Region 11
(assert (= 70 (* V22 V29 V36))) ; Region 12
(assert (= 6 (* V25 V26))) ; Region 14
(assert (= 80 (* V27 V33 V34))) ; Region 15
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 16
(assert (or (= 3 (/ V30 V37)) (= 3 (/ V37 V30)))) ; Region 17
(assert (= 120 (* V31 V38 V45))) ; Region 18
(assert (= 4 (* V32 V39))) ; Region 19
(assert (= 126 (* V40 V41 V48))) ; Region 20
(assert (or (= 3 (/ V43 V44)) (= 3 (/ V44 V43)))) ; Region 22
(assert (= 14 (* V46 V47))) ; Region 23
(check-sat)
