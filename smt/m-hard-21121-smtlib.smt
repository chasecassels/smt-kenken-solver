...
(assert (= 168 (* V0 V1 V2))) ; Region 1
(assert (= 21 (* V3 V4 V11))) ; Region 2
(assert (= 30 (* V5 V6 V13))) ; Region 3
(assert (= 70 (* V7 V8 V15))) ; Region 4
(assert (= 24 (* V9 V16 V17 V18))) ; Region 5
(assert (= 24 (* V12 V19 V20))) ; Region 7
(assert (= 60 (* V14 V21 V22 V28))) ; Region 8
(assert (= 35 (* V23 V30))) ; Region 9
(assert (= 336 (* V24 V25 V26 V27 V31))) ; Region 10
(assert (= 6 (* V29 V36))) ; Region 11
(assert (= 90 (* V32 V33 V34 V40))) ; Region 12
(assert (= 288 (* V35 V37 V42 V43 V44))) ; Region 13
(assert (= 30 (* V38 V39 V45))) ; Region 14
(assert (= 140 (* V46 V47 V48))) ; Region 16
(check-sat)
