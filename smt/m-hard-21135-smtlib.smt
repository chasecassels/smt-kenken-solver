...
(assert (= 20 (* V1 V2 V8))) ; Region 2
(assert (= 84 (* V3 V4 V5))) ; Region 3
(assert (= 10 (* V9 V16))) ; Region 5
(assert (= 90 (* V10 V11 V12 V17))) ; Region 6
(assert (= 336 (* V13 V18 V19 V20 V27))) ; Region 7
(assert (= 6 (* V14 V15 V21))) ; Region 8
(assert (= 756 (* V22 V29 V30 V36))) ; Region 9
(assert (= 336 (* V23 V24 V31 V38))) ; Region 10
(assert (= 140 (* V25 V26 V32 V33 V39))) ; Region 11
(assert (= 20 (* V28 V35))) ; Region 12
(assert (= 30 (* V34 V40 V41))) ; Region 13
(assert (= 126 (* V37 V42 V43 V44))) ; Region 14
(assert (= 6 (* V45 V46))) ; Region 15
