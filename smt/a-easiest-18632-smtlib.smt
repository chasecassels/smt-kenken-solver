...
(assert (= 13 (+ V2 V3))) ; Region 3
(assert (= 11 (+ V4 V5 V12))) ; Region 4
(assert (= 8 (+ V9 V10))) ; Region 6
(assert (= 9 (+ V11 V18 V25))) ; Region 7
(assert (= 13 (+ V13 V20))) ; Region 8
(assert (= 5 (+ V15 V16))) ; Region 10
(assert (= 7 (+ V17 V24))) ; Region 11
(assert (= 5 (+ V19 V26))) ; Region 12
(assert (= 11 (+ V21 V28))) ; Region 13
(assert (= 13 (+ V22 V23))) ; Region 14
(assert (= 9 (+ V27 V34))) ; Region 15
(assert (= 16 (+ V29 V35 V36))) ; Region 16
(assert (= 3 (+ V30 V31))) ; Region 17
(assert (= 9 (+ V32 V33))) ; Region 18
(assert (= 9 (+ V37 V44))) ; Region 19
(assert (= 7 (+ V38 V45))) ; Region 20
(assert (= 9 (+ V39 V40))) ; Region 21
(assert (= 4 (+ V41 V48))) ; Region 22
(assert (= 3 (+ V42 V43))) ; Region 23
(assert (= 13 (+ V46 V47))) ; Region 24
(check-sat)
