...
(assert (= 8 (+ V5 V6 V12))) ; Region 5
(assert (= 8 (+ V8 V14 V15))) ; Region 6
(assert (= 6 (+ V9 V16))) ; Region 7
(assert (= 12 (+ V17 V18))) ; Region 9
(assert (= 13 (+ V19 V26))) ; Region 10
(assert (= 8 (+ V20 V27))) ; Region 11
(assert (= 7 (+ V21 V28))) ; Region 12
(assert (= 15 (+ V22 V29 V36))) ; Region 13
(assert (= 9 (+ V23 V24))) ; Region 14
(assert (= 3 (+ V25 V32))) ; Region 15
(assert (= 13 (+ V30 V37))) ; Region 16
(assert (= 6 (+ V31 V38))) ; Region 17
(assert (= 4 (+ V33 V34))) ; Region 18
(assert (= 13 (+ V35 V42))) ; Region 19
(assert (= 10 (+ V39 V45 V46))) ; Region 20
(assert (= 6 (+ V40 V47))) ; Region 21
(assert (= 11 (+ V41 V48))) ; Region 22
(assert (= 3 (+ V43 V44))) ; Region 23
(check-sat)
