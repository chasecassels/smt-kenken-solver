...
(assert (= 24 (* V2 V9 V16 V17))) ; Region 2
(assert (or (= 2 (/ V3 V10)) (= 2 (/ V10 V3)))) ; Region 3
(assert (= 6 (* V4 V11))) ; Region 4
(assert (= 175 (* V5 V6 V12))) ; Region 5
(assert (or (= 2 (/ V7 V8)) (= 2 (/ V8 V7)))) ; Region 6
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 8
(assert (= 315 (* V15 V22 V23 V30))) ; Region 9
(assert (= 120 (* V18 V19 V20 V27))) ; Region 10
(assert (= 42 (* V24 V25 V26))) ; Region 11
(assert (= 70 (* V28 V29 V35))) ; Region 12
(assert (= 120 (* V31 V32 V33 V38))) ; Region 13
(assert (= 504 (* V34 V39 V40 V41))) ; Region 14
(assert (= 20 (* V36 V42 V43))) ; Region 15
(assert (= 252 (* V37 V44 V45 V46))) ; Region 16
(assert (or (= 2 (/ V47 V48)) (= 2 (/ V48 V47)))) ; Region 17
(check-sat)
