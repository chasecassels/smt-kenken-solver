...
(assert (= 19 (+ V0 V1 V7 V8))) ; Region 1
(assert (= 3 (+ V2 V3))) ; Region 2
(assert (= 17 (+ V4 V5 V6))) ; Region 3
(assert (= 11 (+ V9 V16))) ; Region 4
(assert (= 8 (+ V10 V17))) ; Region 5
(assert (= 4 (+ V11 V18))) ; Region 6
(assert (= 13 (+ V12 V19))) ; Region 7
(assert (= 3 (+ V13 V20))) ; Region 8
(assert (= 6 (+ V14 V15))) ; Region 9
(assert (= 13 (+ V21 V28 V35 V42))) ; Region 10
(assert (= 6 (+ V23 V30))) ; Region 12
(assert (= 13 (+ V24 V31))) ; Region 13
(assert (= 7 (+ V25 V32))) ; Region 14
(assert (= 7 (+ V26 V27 V33))) ; Region 15
(assert (= 14 (+ V29 V36 V43))) ; Region 16
(assert (= 9 (+ V34 V41))) ; Region 17
(assert (= 11 (+ V37 V44 V45))) ; Region 18
