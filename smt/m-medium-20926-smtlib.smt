...
(assert (= 70 (* V2 V9 V10 V11))) ; Region 2
(assert (= 28 (* V3 V4))) ; Region 3
(assert (= 120 (* V5 V6 V12 V13))) ; Region 4
(assert (= 6 (* V7 V8))) ; Region 5
(assert (= 30 (* V14 V21))) ; Region 6
(assert (= 28 (* V15 V16 V22))) ; Region 7
(assert (= 36 (* V17 V18 V23 V24))) ; Region 8
(assert (= 60 (* V19 V20 V26))) ; Region 9
(assert (= 84 (* V27 V33 V34))) ; Region 11
(assert (= 40 (* V28 V29 V36 V43 V44))) ; Region 12
(assert (= 180 (* V30 V31 V32 V37))) ; Region 13
(assert (= 28 (* V35 V42))) ; Region 14
(assert (= 120 (* V38 V45 V46))) ; Region 15
(assert (= 6 (* V39 V40))) ; Region 16
(assert (= 21 (* V41 V47 V48))) ; Region 17
(check-sat)
