...
(assert (or (= 6 (- V3 V10)) (= 6 (- V10 V3)))) ; Region 3
(assert (= 7 (+ V4 V11))) ; Region 4
(assert (or (= 5 (- V5 V6)) (= 5 (- V6 V5)))) ; Region 5
(assert (= 22 (+ V7 V8 V9 V14))) ; Region 6
(assert (or (= 2 (- V12 V13)) (= 2 (- V13 V12)))) ; Region 7
(assert (= 5 (+ V15 V22))) ; Region 8
(assert (= 9 (+ V16 V23))) ; Region 9
(assert (or (= 1 (- V17 V24)) (= 1 (- V24 V17)))) ; Region 10
(assert (= 3 (+ V18 V25))) ; Region 11
(assert (= 13 (+ V19 V26))) ; Region 12
(assert (= 9 (+ V21 V28))) ; Region 14
(assert (= 6 (+ V27 V34))) ; Region 15
(assert (= 10 (+ V29 V35 V36))) ; Region 16
(assert (or (= 2 (- V30 V37)) (= 2 (- V37 V30)))) ; Region 17
(assert (= 5 (+ V31 V38))) ; Region 18
(assert (= 18 (+ V32 V39 V46))) ; Region 19
(assert (= 12 (+ V40 V41))) ; Region 21
(assert (or (= 6 (- V42 V43)) (= 6 (- V43 V42)))) ; Region 22
