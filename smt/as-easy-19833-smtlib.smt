...
(assert (= 5 (+ V0 V7))) ; Region 1
(assert (= 11 (+ V1 V8))) ; Region 2
(assert (= 6 (+ V2 V3))) ; Region 3
(assert (or (= 1 (- V4 V5)) (= 1 (- V5 V4)))) ; Region 4
(assert (= 5 (+ V9 V10))) ; Region 6
(assert (= 13 (+ V11 V12))) ; Region 7
(assert (= 6 (+ V13 V20))) ; Region 8
(assert (= 5 (+ V14 V15))) ; Region 9
(assert (or (= 2 (- V16 V23)) (= 2 (- V23 V16)))) ; Region 10
(assert (= 13 (+ V17 V24))) ; Region 11
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 12
(assert (or (= 1 (- V19 V26)) (= 1 (- V26 V19)))) ; Region 13
(assert (or (= 4 (- V21 V22)) (= 4 (- V22 V21)))) ; Region 14
(assert (= 11 (+ V27 V33 V34))) ; Region 15
(assert (= 13 (+ V28 V35))) ; Region 16
(assert (or (= 3 (- V29 V30)) (= 3 (- V30 V29)))) ; Region 17
(assert (= 5 (+ V31 V38))) ; Region 18
(assert (= 3 (+ V32 V39))) ; Region 19
(assert (= 13 (+ V36 V42 V43))) ; Region 20
(assert (= 9 (+ V37 V44 V45))) ; Region 21
(assert (or (= 6 (- V40 V47)) (= 6 (- V47 V40)))) ; Region 22
(assert (= 10 (+ V41 V48))) ; Region 23
(check-sat)
