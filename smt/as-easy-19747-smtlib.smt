...
(assert (or (= 3 (- V2 V9)) (= 3 (- V9 V2)))) ; Region 2
(assert (= 11 (+ V3 V10))) ; Region 3
(assert (= 7 (+ V4 V5))) ; Region 4
(assert (or (= 3 (- V6 V13)) (= 3 (- V13 V6)))) ; Region 5
(assert (or (= 4 (- V7 V8)) (= 4 (- V8 V7)))) ; Region 6
(assert (or (= 4 (- V11 V12)) (= 4 (- V12 V11)))) ; Region 7
(assert (= 14 (+ V14 V15 V22))) ; Region 8
(assert (= 5 (+ V16 V17))) ; Region 9
(assert (= 13 (+ V18 V25))) ; Region 10
(assert (= 12 (+ V19 V26 V33))) ; Region 11
(assert (= 3 (+ V20 V27))) ; Region 12
(assert (or (= 4 (- V21 V28)) (= 4 (- V28 V21)))) ; Region 13
(assert (or (= 6 (- V23 V24)) (= 6 (- V24 V23)))) ; Region 14
(assert (= 15 (+ V29 V30 V31))) ; Region 15
(assert (= 5 (+ V32 V39))) ; Region 16
(assert (= 9 (+ V34 V40 V41))) ; Region 17
(assert (= 6 (+ V35 V42))) ; Region 18
(assert (or (= 6 (- V36 V43)) (= 6 (- V43 V36)))) ; Region 19
(assert (= 8 (+ V37 V44))) ; Region 20
(assert (= 15 (+ V38 V45 V46))) ; Region 21
(assert (= 9 (+ V47 V48))) ; Region 22
(check-sat)
