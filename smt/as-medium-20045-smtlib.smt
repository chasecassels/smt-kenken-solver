...
(assert (= 11 (+ V2 V3 V9))) ; Region 2
(assert (= 13 (+ V4 V5))) ; Region 3
(assert (= 11 (+ V6 V12 V13))) ; Region 4
(assert (= 10 (+ V7 V14))) ; Region 5
(assert (= 13 (+ V8 V15 V16 V17))) ; Region 6
(assert (= 10 (+ V10 V11 V18))) ; Region 7
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 8
(assert (= 5 (+ V20 V27))) ; Region 9
(assert (= 7 (+ V21 V28 V29))) ; Region 10
(assert (= 13 (+ V23 V30))) ; Region 12
(assert (= 14 (+ V24 V25 V31))) ; Region 13
(assert (= 9 (+ V32 V33))) ; Region 14
(assert (= 14 (+ V34 V41 V48))) ; Region 15
(assert (= 11 (+ V35 V36))) ; Region 16
(assert (= 7 (+ V37 V44))) ; Region 17
(assert (or (= 1 (- V38 V45)) (= 1 (- V45 V38)))) ; Region 18
(assert (= 11 (+ V39 V40))) ; Region 19
(assert (= 13 (+ V42 V43))) ; Region 20
