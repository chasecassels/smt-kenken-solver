...
(assert (= 12 (+ V0 V1 V7))) ; Region 1
(assert (= 13 (+ V2 V3))) ; Region 2
(assert (= 7 (+ V4 V5 V6))) ; Region 3
(assert (= 15 (+ V8 V9 V16))) ; Region 4
(assert (= 10 (+ V10 V11))) ; Region 5
(assert (= 9 (+ V12 V18 V19))) ; Region 6
(assert (or (= 1 (- V13 V20)) (= 1 (- V20 V13)))) ; Region 7
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 8
(assert (= 15 (+ V15 V22 V23))) ; Region 9
(assert (= 14 (+ V24 V31 V38))) ; Region 11
(assert (= 15 (+ V25 V26 V27))) ; Region 12
(assert (= 3 (+ V29 V30))) ; Region 14
(assert (= 9 (+ V32 V39))) ; Region 15
(assert (= 9 (+ V33 V34))) ; Region 16
(assert (= 5 (+ V35 V42))) ; Region 17
(assert (= 5 (+ V36 V43))) ; Region 18
(assert (= 8 (+ V37 V44))) ; Region 19
(assert (or (= 6 (- V40 V41)) (= 6 (- V41 V40)))) ; Region 20
(assert (= 9 (+ V45 V46))) ; Region 21
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 22
(check-sat)
