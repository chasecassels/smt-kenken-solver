...
(assert (= 10 (+ V5 V12))) ; Region 3
(assert (= 10 (+ V6 V13 V20))) ; Region 4
(assert (= 14 (+ V7 V14 V21))) ; Region 5
(assert (= 6 (+ V8 V15 V22))) ; Region 6
(assert (= 19 (+ V9 V10 V16))) ; Region 7
(assert (= 6 (+ V17 V24))) ; Region 9
(assert (= 5 (+ V18 V19))) ; Region 10
(assert (= 9 (+ V23 V29 V30))) ; Region 11
(assert (= 8 (+ V25 V26))) ; Region 12
(assert (= 15 (+ V27 V34 V41))) ; Region 13
(assert (= 12 (+ V28 V35 V36))) ; Region 14
(assert (= 11 (+ V31 V32 V33))) ; Region 15
(assert (= 14 (+ V38 V45 V46))) ; Region 17
(assert (= 8 (+ V39 V40))) ; Region 18
(assert (= 10 (+ V43 V44))) ; Region 20
(assert (= 8 (+ V47 V48))) ; Region 21
(check-sat)
