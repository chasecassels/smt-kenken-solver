...
(assert (= 168 (* V2 V9 V16 V23))) ; Region 2
(assert (= 980 (* V3 V4 V10 V11))) ; Region 3
(assert (= 12 (* V5 V6 V12))) ; Region 4
(assert (= 3150 (* V7 V8 V14 V15 V21))) ; Region 5
(assert (= 20 (* V17 V24 V25))) ; Region 7
(assert (= 12 (* V18 V19 V26))) ; Region 8
(assert (= 15 (* V20 V27 V34))) ; Region 9
(assert (= 84 (* V22 V29 V30 V36))) ; Region 10
(assert (= 24 (* V28 V35 V42 V43))) ; Region 11
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 12
(assert (= 12 (* V32 V33 V39))) ; Region 13
(assert (= 360 (* V37 V44 V45 V46))) ; Region 14
(assert (= 980 (* V40 V41 V47 V48))) ; Region 15
(check-sat)
