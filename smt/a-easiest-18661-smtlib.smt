...
(assert (= 12 (+ V2 V3 V10))) ; Region 3
(assert (= 12 (+ V4 V5 V11))) ; Region 4
(assert (= 13 (+ V6 V13))) ; Region 5
(assert (= 3 (+ V8 V15))) ; Region 6
(assert (= 6 (+ V9 V16))) ; Region 7
(assert (= 13 (+ V12 V19))) ; Region 8
(assert (= 8 (+ V14 V21))) ; Region 9
(assert (= 10 (+ V17 V18))) ; Region 10
(assert (= 5 (+ V20 V27))) ; Region 11
(assert (= 13 (+ V22 V23))) ; Region 12
(assert (= 15 (+ V24 V30 V31))) ; Region 13
(assert (= 6 (+ V25 V26))) ; Region 14
(assert (= 10 (+ V28 V29))) ; Region 15
(assert (= 11 (+ V32 V39))) ; Region 16
(assert (= 4 (+ V33 V40))) ; Region 17
(assert (= 11 (+ V35 V36))) ; Region 19
(assert (= 3 (+ V37 V38))) ; Region 20
(assert (= 8 (+ V41 V48))) ; Region 21
(assert (= 12 (+ V42 V43))) ; Region 22
(assert (= 10 (+ V44 V45))) ; Region 23
(assert (= 3 (+ V46 V47))) ; Region 24
(check-sat)
