...
(assert (= 420 (* V4 V5 V6 V11 V13))) ; Region 3
(assert (= 14 (* V7 V14))) ; Region 4
(assert (= 35 (* V8 V15))) ; Region 5
(assert (= 120 (* V9 V10 V16 V17))) ; Region 6
(assert (= 36 (* V12 V18 V19))) ; Region 7
(assert (= 90 (* V20 V26 V27 V33))) ; Region 8
(assert (= 20 (* V21 V22 V28))) ; Region 9
(assert (= 126 (* V23 V30 V37))) ; Region 10
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 11
(assert (or (= 3 (/ V29 V36)) (= 3 (/ V36 V29)))) ; Region 12
(assert (= 147 (* V31 V32 V38))) ; Region 13
(assert (= 20 (* V34 V41))) ; Region 14
(assert (= 12 (* V35 V42 V43))) ; Region 15
(assert (= 2 (* V39 V40))) ; Region 16
(assert (= 10 (* V44 V45))) ; Region 17
(assert (= 42 (* V47 V48))) ; Region 19
(check-sat)
