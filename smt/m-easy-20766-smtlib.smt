...
(assert (= 105 (* V1 V2 V3))) ; Region 2
(assert (= 16 (* V4 V5 V11))) ; Region 3
(assert (= 24 (* V6 V13))) ; Region 4
(assert (= 56 (* V9 V10 V16 V23))) ; Region 5
(assert (= 35 (* V12 V19 V20))) ; Region 6
(assert (= 36 (* V14 V15 V21))) ; Region 7
(assert (= 30 (* V17 V18))) ; Region 8
(assert (= 196 (* V22 V28 V29 V35))) ; Region 9
(assert (= 20 (* V24 V25 V31))) ; Region 10
(assert (= 12 (* V26 V27))) ; Region 11
(assert (= 30 (* V30 V37))) ; Region 12
(assert (= 252 (* V32 V33 V34 V39))) ; Region 13
(assert (= 40 (* V36 V42 V43))) ; Region 14
(assert (= 18 (* V38 V44 V45 V46))) ; Region 15
(assert (= 210 (* V40 V41 V47 V48))) ; Region 16
(check-sat)
