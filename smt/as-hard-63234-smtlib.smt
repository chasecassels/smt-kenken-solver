...
(assert (= 10 (+ V0 V7))) ; Region 1
(assert (or (= 6 (- V1 V2)) (= 6 (- V2 V1)))) ; Region 2
(assert (= 11 (+ V3 V10 V17))) ; Region 3
(assert (= 11 (+ V4 V5 V11))) ; Region 4
(assert (or (= 5 (- V6 V13)) (= 5 (- V13 V6)))) ; Region 5
(assert (= 12 (+ V8 V15))) ; Region 6
(assert (or (= 1 (- V9 V16)) (= 1 (- V16 V9)))) ; Region 7
(assert (= 10 (+ V12 V19))) ; Region 8
(assert (= 7 (+ V14 V21))) ; Region 9
(assert (or (= 3 (- V18 V25)) (= 3 (- V25 V18)))) ; Region 10
(assert (= 14 (+ V20 V27 V34))) ; Region 11
(assert (or (= 5 (- V22 V23)) (= 5 (- V23 V22)))) ; Region 12
(assert (or (= 3 (- V24 V31)) (= 3 (- V31 V24)))) ; Region 13
(assert (= 8 (+ V26 V33))) ; Region 14
(assert (= 11 (+ V28 V35 V42))) ; Region 15
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 16
(assert (or (= 4 (- V32 V39)) (= 4 (- V39 V32)))) ; Region 17
(assert (or (= 2 (- V36 V43)) (= 2 (- V43 V36)))) ; Region 18
(assert (= 12 (+ V37 V38))) ; Region 19
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 20
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 21
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 23
(check-sat)
