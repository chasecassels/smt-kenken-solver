...
(assert (= 252 (* V1 V2 V8 V15))) ; Region 2
(assert (= 14 (* V3 V4))) ; Region 3
(assert (= 28 (* V5 V12))) ; Region 4
(assert (= 5 (* V6 V13))) ; Region 5
(assert (= 24 (* V9 V10 V16 V17))) ; Region 6
(assert (= 15 (* V11 V18))) ; Region 7
(assert (= 84 (* V14 V21 V28))) ; Region 8
(assert (= 12 (* V20 V27))) ; Region 10
(assert (= 15 (* V22 V23))) ; Region 11
(assert (= 60 (* V24 V31 V38))) ; Region 12
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 13
(assert (or (= 2 (/ V29 V30)) (= 2 (/ V30 V29)))) ; Region 14
(assert (or (= 3 (/ V32 V39)) (= 3 (/ V39 V32)))) ; Region 15
(assert (= 140 (* V33 V34 V40 V41))) ; Region 16
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 17
(assert (= 42 (* V36 V37 V43))) ; Region 18
(assert (= 504 (* V45 V46 V47 V48))) ; Region 20
(check-sat)
