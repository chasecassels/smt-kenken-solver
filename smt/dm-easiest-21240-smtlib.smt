...
(assert (= 126 (* V3 V9 V10))) ; Region 3
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 4
(assert (= 35 (* V6 V13))) ; Region 5
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 6
(assert (= 28 (* V8 V15))) ; Region 7
(assert (= 25 (* V11 V12 V18))) ; Region 8
(assert (or (= 2 (/ V16 V17)) (= 2 (/ V17 V16)))) ; Region 9
(assert (or (= 2 (/ V19 V20)) (= 2 (/ V20 V19)))) ; Region 10
(assert (= 21 (* V21 V22))) ; Region 11
(assert (= 35 (* V23 V30))) ; Region 12
(assert (= 48 (* V24 V25 V26))) ; Region 13
(assert (= 4 (* V27 V34))) ; Region 14
(assert (= 15 (* V28 V29 V35))) ; Region 15
(assert (= 18 (* V32 V33))) ; Region 17
(assert (or (= 2 (/ V36 V37)) (= 2 (/ V37 V36)))) ; Region 18
(assert (= 5 (* V38 V45))) ; Region 19
(assert (= 28 (* V39 V40))) ; Region 20
(assert (= 12 (* V41 V48))) ; Region 21
(assert (= 120 (* V42 V43 V44))) ; Region 22
(assert (= 21 (* V46 V47))) ; Region 23
(check-sat)
