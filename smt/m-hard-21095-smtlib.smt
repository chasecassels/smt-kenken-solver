...
(assert (= 245 (* V2 V3 V10))) ; Region 2
(assert (= 24 (* V4 V5 V6))) ; Region 3
(assert (= 30 (* V9 V15 V16))) ; Region 4
(assert (= 24 (* V11 V12))) ; Region 5
(assert (= 48 (* V13 V19 V20 V27))) ; Region 6
(assert (= 630 (* V14 V21 V22 V28))) ; Region 7
(assert (= 12 (* V17 V24))) ; Region 8
(assert (= 245 (* V18 V25 V26 V32))) ; Region 9
(assert (= 24 (* V23 V30 V31 V38))) ; Region 10
(assert (= 28 (* V29 V35 V36))) ; Region 11
(assert (= 18 (* V33 V39 V40))) ; Region 12
(assert (= 15 (* V34 V41))) ; Region 13
(assert (= 24 (* V37 V44 V45))) ; Region 14
(assert (= 12 (* V42 V43))) ; Region 15
