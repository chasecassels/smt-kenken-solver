...
(assert (= 28 (* V2 V9))) ; Region 3
(assert (or (= 2 (/ V3 V10)) (= 2 (/ V10 V3)))) ; Region 4
(assert (= 30 (* V4 V11 V12))) ; Region 5
(assert (= 14 (* V5 V6))) ; Region 6
(assert (= 12 (* V7 V14 V21))) ; Region 7
(assert (= 28 (* V13 V20))) ; Region 8
(assert (= 30 (* V15 V16))) ; Region 9
(assert (= 36 (* V17 V18 V24))) ; Region 10
(assert (or (= 2 (/ V19 V26)) (= 2 (/ V26 V19)))) ; Region 11
(assert (= 20 (* V22 V23))) ; Region 12
(assert (= 140 (* V25 V32 V39))) ; Region 13
(assert (= 18 (* V27 V34))) ; Region 14
(assert (= 49 (* V28 V29 V36))) ; Region 15
(assert (= 10 (* V30 V31))) ; Region 16
(assert (or (= 2 (/ V33 V40)) (= 2 (/ V40 V33)))) ; Region 17
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 18
(assert (= 12 (* V37 V38))) ; Region 19
(assert (= 5 (* V41 V48))) ; Region 20
(assert (or (= 2 (/ V43 V44)) (= 2 (/ V44 V43)))) ; Region 21
(assert (= 84 (* V45 V46 V47))) ; Region 22
(check-sat)
