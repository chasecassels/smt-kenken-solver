...
(assert (= 4 (+ V3 V10))) ; Region 3
(assert (= 8 (+ V4 V5))) ; Region 4
(assert (= 7 (+ V6 V13))) ; Region 5
(assert (= 8 (+ V8 V14 V15))) ; Region 6
(assert (= 13 (+ V9 V16 V17))) ; Region 7
(assert (= 13 (+ V11 V12))) ; Region 8
(assert (= 11 (+ V18 V24 V25))) ; Region 9
(assert (= 9 (+ V19 V20))) ; Region 10
(assert (= 13 (+ V21 V28))) ; Region 11
(assert (= 9 (+ V22 V23 V29))) ; Region 12
(assert (= 8 (+ V26 V27))) ; Region 13
(assert (= 10 (+ V30 V31))) ; Region 14
(assert (= 12 (+ V32 V33 V39))) ; Region 15
(assert (= 16 (+ V34 V40 V41 V48))) ; Region 16
(assert (= 12 (+ V35 V36))) ; Region 17
(assert (= 3 (+ V37 V38))) ; Region 18
(assert (= 10 (+ V42 V43 V44))) ; Region 19
