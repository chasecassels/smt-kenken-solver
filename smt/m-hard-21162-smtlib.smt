...
(assert (= 48 (* V0 V7 V14))) ; Region 1
(assert (= 28 (* V1 V8))) ; Region 2
(assert (= 14 (* V2 V3 V9))) ; Region 3
(assert (= 30 (* V4 V11 V12))) ; Region 4
(assert (= 150 (* V5 V6 V13 V20))) ; Region 5
(assert (= 252 (* V10 V17 V18 V19))) ; Region 6
(assert (= 18 (* V15 V16 V21 V22))) ; Region 7
(assert (= 60 (* V23 V24 V31))) ; Region 8
(assert (= 24 (* V25 V32 V39))) ; Region 9
(assert (= 168 (* V26 V27 V33 V34))) ; Region 10
(assert (= 35 (* V28 V35))) ; Region 11
(assert (= 20 (* V29 V30 V36))) ; Region 12
(assert (= 126 (* V37 V38 V45 V46))) ; Region 13
(assert (= 48 (* V40 V47 V48))) ; Region 14
