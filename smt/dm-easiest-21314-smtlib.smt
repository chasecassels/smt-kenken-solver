...
(assert (= 20 (* V3 V4))) ; Region 3
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 4
(assert (or (= 3 (/ V7 V14)) (= 3 (/ V14 V7)))) ; Region 5
(assert (= 30 (* V8 V15))) ; Region 6
(assert (or (= 3 (/ V9 V10)) (= 3 (/ V10 V9)))) ; Region 7
(assert (= 196 (* V11 V17 V18))) ; Region 8
(assert (or (= 2 (/ V12 V19)) (= 2 (/ V19 V12)))) ; Region 9
(assert (= 12 (* V13 V20))) ; Region 10
(assert (= 10 (* V16 V23 V24))) ; Region 11
(assert (= 21 (* V21 V22))) ; Region 12
(assert (= 18 (* V25 V32))) ; Region 13
(assert (= 20 (* V26 V27))) ; Region 14
(assert (= 20 (* V28 V29 V30))) ; Region 15
(assert (= 42 (* V33 V34))) ; Region 17
(assert (= 16 (* V35 V36 V42))) ; Region 18
(assert (= 90 (* V37 V38 V45))) ; Region 19
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 20
(assert (= 35 (* V40 V47))) ; Region 21
(assert (= 12 (* V41 V48))) ; Region 22
(assert (= 21 (* V43 V44))) ; Region 23
(check-sat)
