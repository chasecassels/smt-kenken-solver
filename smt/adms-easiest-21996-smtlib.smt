...
(assert (= 140 (* V0 V1 V7))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 12 (+ V8 V15 V16))) ; Region 5
(assert (= 7 (+ V9 V10))) ; Region 6
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 9
(assert (= 11 (+ V17 V23 V24))) ; Region 10
(assert (= 30 (* V18 V25))) ; Region 11
(assert (or (= 4 (- V19 V26)) (= 4 (- V26 V19)))) ; Region 12
(assert (= 13 (+ V20 V27))) ; Region 13
(assert (= 126 (* V28 V35 V42))) ; Region 15
(assert (or (= 3 (/ V29 V36)) (= 3 (/ V36 V29)))) ; Region 16
(assert (or (= 5 (- V30 V31)) (= 5 (- V31 V30)))) ; Region 17
(assert (or (= 2 (/ V32 V39)) (= 2 (/ V39 V32)))) ; Region 18
(assert (= 11 (+ V33 V34))) ; Region 19
(assert (or (= 5 (- V37 V38)) (= 5 (- V38 V37)))) ; Region 20
(assert (= 10 (* V40 V47))) ; Region 21
(assert (= 5 (+ V41 V48))) ; Region 22
(assert (or (= 3 (- V43 V44)) (= 3 (- V44 V43)))) ; Region 23
(assert (= 15 (* V45 V46))) ; Region 24
(check-sat)
