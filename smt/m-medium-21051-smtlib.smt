...
(assert (= 36 (* V0 V7 V8))) ; Region 1
(assert (= 24 (* V1 V2 V9))) ; Region 2
(assert (= 35 (* V3 V4))) ; Region 3
(assert (= 12 (* V5 V6))) ; Region 4
(assert (= 120 (* V10 V16 V17 V18 V23))) ; Region 5
(assert (= 35 (* V12 V13))) ; Region 7
(assert (= 28 (* V14 V15 V21))) ; Region 8
(assert (= 12 (* V19 V20 V26))) ; Region 9
(assert (= 175 (* V22 V28 V29))) ; Region 10
(assert (= 12 (* V24 V31))) ; Region 11
(assert (= 12 (* V25 V32 V33))) ; Region 12
(assert (= 42 (* V27 V34))) ; Region 13
(assert (= 6 (* V30 V37))) ; Region 14
(assert (= 144 (* V35 V36 V42 V43))) ; Region 15
(assert (= 15 (* V38 V45 V46))) ; Region 16
(assert (= 35 (* V39 V40))) ; Region 17
