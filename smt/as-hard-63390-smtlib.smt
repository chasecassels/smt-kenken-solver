...
(assert (= 9 (+ V0 V1 V7))) ; Region 1
(assert (or (= 3 (- V2 V3)) (= 3 (- V3 V2)))) ; Region 2
(assert (or (= 1 (- V4 V11)) (= 1 (- V11 V4)))) ; Region 3
(assert (or (= 2 (- V5 V6)) (= 2 (- V6 V5)))) ; Region 4
(assert (= 17 (+ V8 V9 V10))) ; Region 5
(assert (= 6 (+ V12 V13))) ; Region 6
(assert (= 6 (+ V14 V15 V16))) ; Region 7
(assert (= 11 (+ V17 V18))) ; Region 8
(assert (= 11 (+ V19 V20))) ; Region 9
(assert (or (= 1 (- V21 V22)) (= 1 (- V22 V21)))) ; Region 10
(assert (= 7 (+ V23 V30))) ; Region 11
(assert (= 8 (+ V24 V31 V32))) ; Region 12
(assert (= 15 (+ V25 V26 V27 V34))) ; Region 13
(assert (= 8 (+ V29 V36))) ; Region 15
(assert (or (= 1 (- V33 V40)) (= 1 (- V40 V33)))) ; Region 16
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 17
(assert (= 14 (+ V37 V38 V39))) ; Region 18
(assert (or (= 5 (- V41 V48)) (= 5 (- V48 V41)))) ; Region 19
(assert (= 9 (+ V43 V44))) ; Region 20
(assert (= 6 (+ V45 V46 V47))) ; Region 21
(check-sat)
