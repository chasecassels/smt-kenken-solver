...
(assert (= 120 (* V4 V10 V11 V17 V18))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 288 (* V9 V16 V23 V24 V25))) ; Region 5
(assert (= 7 (* V12 V13))) ; Region 6
(assert (= 126 (* V14 V15 V21 V22))) ; Region 7
(assert (= 35 (* V19 V20))) ; Region 8
(assert (= 40 (* V26 V27 V34))) ; Region 9
(assert (= 24 (* V28 V35 V42))) ; Region 10
(assert (= 200 (* V29 V30 V36 V43))) ; Region 11
(assert (= 63 (* V31 V32 V33 V38))) ; Region 12
(assert (= 4410 (* V37 V39 V44 V45 V46))) ; Region 13
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 14
(assert (= 6 (* V47 V48))) ; Region 15
(check-sat)
