...
(assert (= 120 (* V1 V8 V15 V22))) ; Region 2
(assert (= 120 (* V2 V9 V16))) ; Region 3
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 4
(assert (= 13 (+ V5 V6 V13 V20))) ; Region 5
(assert (= 175 (* V10 V11 V18))) ; Region 6
(assert (or (= 3 (/ V12 V19)) (= 3 (/ V19 V12)))) ; Region 7
(assert (= 13 (+ V14 V21))) ; Region 8
(assert (= 98 (* V17 V23 V24 V31))) ; Region 9
(assert (or (= 3 (/ V25 V32)) (= 3 (/ V32 V25)))) ; Region 10
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 11
(assert (= 5 (+ V27 V34))) ; Region 12
(assert (= 20 (* V28 V35 V42 V43))) ; Region 13
(assert (= 13 (+ V29 V36))) ; Region 14
(assert (= 3 (+ V30 V37))) ; Region 15
(assert (= 10 (+ V38 V39))) ; Region 16
(assert (or (= 2 (- V40 V41)) (= 2 (- V41 V40)))) ; Region 17
(assert (or (= 1 (- V44 V45)) (= 1 (- V45 V44)))) ; Region 18
(assert (= 13 (+ V47 V48))) ; Region 20
(check-sat)
