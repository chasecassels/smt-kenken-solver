...
(assert (= 30 (* V1 V2))) ; Region 2
(assert (or (= 1 (- V3 V4)) (= 1 (- V4 V3)))) ; Region 3
(assert (or (= 1 (- V5 V12)) (= 1 (- V12 V5)))) ; Region 4
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 5
(assert (= 6 (+ V8 V15 V22))) ; Region 6
(assert (= 13 (+ V9 V10 V11))) ; Region 7
(assert (= 13 (+ V16 V17 V23 V24))) ; Region 8
(assert (or (= 2 (- V18 V19)) (= 2 (- V19 V18)))) ; Region 9
(assert (= 18 (+ V20 V27 V34))) ; Region 10
(assert (or (= 3 (- V21 V28)) (= 3 (- V28 V21)))) ; Region 11
(assert (= 7 (+ V25 V26 V32))) ; Region 12
(assert (= 13 (+ V29 V36))) ; Region 13
(assert (= 10 (* V30 V31))) ; Region 14
(assert (= 6 (+ V33 V40 V41))) ; Region 15
(assert (or (= 2 (- V37 V44)) (= 2 (- V44 V37)))) ; Region 17
(assert (= 18 (+ V38 V39 V45))) ; Region 18
