...
(assert (= 16 (+ V0 V7 V8 V14))) ; Region 1
(assert (= 18 (+ V1 V2 V3))) ; Region 2
(assert (= 5 (+ V4 V11))) ; Region 3
(assert (= 7 (+ V5 V6))) ; Region 4
(assert (= 9 (+ V9 V10))) ; Region 5
(assert (= 8 (+ V12 V13))) ; Region 6
(assert (= 15 (+ V15 V16 V22 V23))) ; Region 7
(assert (= 13 (+ V17 V18 V24))) ; Region 8
(assert (= 9 (+ V19 V20))) ; Region 9
(assert (= 8 (+ V21 V28))) ; Region 10
(assert (= 6 (+ V25 V26))) ; Region 11
(assert (= 10 (+ V29 V35 V36))) ; Region 13
(assert (= 11 (+ V31 V32))) ; Region 15
(assert (= 15 (+ V33 V34 V41))) ; Region 16
(assert (= 10 (+ V37 V38))) ; Region 17
(assert (= 8 (+ V39 V46))) ; Region 18
(assert (= 14 (+ V40 V47 V48))) ; Region 19
(assert (= 9 (+ V42 V43))) ; Region 20
(assert (= 3 (+ V44 V45))) ; Region 21
(check-sat)
