...
(assert (= 15 (* V0 V7))) ; Region 1
(assert (= 24 (* V1 V2 V9))) ; Region 2
(assert (= 14 (* V3 V10))) ; Region 3
...
(assert (= 16 (* V16 V17 V24))) ; Region 9
(assert (= 12 (* V18 V19 V25))) ; Region 10
(assert (= 30 (* V22 V23 V30))) ; Region 11
(assert (= 14 (* V26 V27))) ; Region 12
(assert (= 24 (* V28 V29 V35))) ; Region 13
(assert (= 35 (* V31 V32 V33))) ; Region 14
(assert (= 21 (* V34 V41))) ; Region 15
(assert (= 4 (* V36 V42 V43))) ; Region 16
(assert (= 35 (* V37 V44))) ; Region 17
(assert (= 54 (* V38 V45 V46))) ; Region 18
(assert (= 120 (* V40 V47 V48))) ; Region 20
(check-sat)
