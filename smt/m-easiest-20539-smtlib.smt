...
(assert (= 30 (* V0 V1 V8))) ; Region 1
(assert (= 15 (* V2 V3))) ; Region 2
(assert (= 8 (* V4 V5))) ; Region 3
(assert (= 42 (* V6 V13))) ; Region 4
(assert (= 21 (* V7 V14))) ; Region 5
(assert (= 28 (* V9 V15 V16))) ; Region 6
(assert (= 24 (* V10 V11 V12))) ; Region 7
(assert (= 24 (* V17 V23 V24))) ; Region 8
(assert (= 2 (* V18 V25))) ; Region 9
(assert (= 30 (* V19 V20))) ; Region 10
(assert (= 35 (* V21 V22 V29))) ; Region 11
(assert (= 30 (* V26 V27 V33))) ; Region 12
(assert (= 48 (* V28 V35 V42))) ; Region 13
(assert (= 12 (* V30 V37))) ; Region 14
(assert (= 21 (* V31 V38))) ; Region 15
(assert (= 12 (* V34 V41))) ; Region 17
(assert (= 6 (* V36 V43))) ; Region 18
(assert (= 30 (* V39 V46))) ; Region 19
(assert (= 7 (* V40 V47 V48))) ; Region 20
(assert (= 20 (* V44 V45))) ; Region 21
(check-sat)
