...
(assert (= 3 (+ V3 V4))) ; Region 3
(assert (or (= 6 (- V5 V12)) (= 6 (- V12 V5)))) ; Region 4
(assert (= 12 (* V6 V13))) ; Region 5
(assert (= 12 (+ V8 V9 V16))) ; Region 6
(assert (or (= 1 (- V10 V11)) (= 1 (- V11 V10)))) ; Region 7
(assert (= 13 (+ V14 V15))) ; Region 8
(assert (or (= 1 (- V17 V18)) (= 1 (- V18 V17)))) ; Region 9
(assert (= 40 (* V19 V20 V26))) ; Region 10
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 11
(assert (= 120 (* V23 V24 V25))) ; Region 13
(assert (= 15 (+ V27 V34 V41))) ; Region 14
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 15
(assert (= 17 (+ V31 V32 V39))) ; Region 16
(assert (or (= 1 (- V33 V40)) (= 1 (- V40 V33)))) ; Region 17
(assert (= 28 (* V35 V42))) ; Region 18
(assert (or (= 1 (- V36 V43)) (= 1 (- V43 V36)))) ; Region 19
(assert (= 3 (+ V37 V38))) ; Region 20
(assert (or (= 2 (- V44 V45)) (= 2 (- V45 V44)))) ; Region 21
(assert (= 15 (* V46 V47 V48))) ; Region 22
(check-sat)
