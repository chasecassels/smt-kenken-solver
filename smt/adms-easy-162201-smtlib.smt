...
(assert (= 13 (+ V3 V4))) ; Region 3
(assert (= 7 (+ V5 V6 V13))) ; Region 4
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 5
(assert (= 20 (* V9 V10))) ; Region 6
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 7
(assert (or (= 4 (- V14 V21)) (= 4 (- V21 V14)))) ; Region 8
(assert (or (= 3 (- V17 V18)) (= 3 (- V18 V17)))) ; Region 10
(assert (= 10 (+ V19 V20))) ; Region 11
(assert (= 10 (+ V22 V28 V29))) ; Region 12
(assert (= 13 (+ V23 V30))) ; Region 13
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 14
(assert (or (= 3 (/ V26 V27)) (= 3 (/ V27 V26)))) ; Region 15
(assert (or (= 3 (/ V31 V38)) (= 3 (/ V38 V31)))) ; Region 16
(assert (= 9 (+ V32 V33 V39))) ; Region 17
(assert (or (= 5 (- V35 V42)) (= 5 (- V42 V35)))) ; Region 19
(assert (= 12 (* V37 V43 V44))) ; Region 21
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 22
(assert (= 6 (* V45 V46))) ; Region 23
