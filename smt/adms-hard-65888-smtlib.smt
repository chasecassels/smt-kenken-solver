...
(assert (= 12 (* V0 V7 V14))) ; Region 1
(assert (= 18 (+ V1 V8 V15))) ; Region 2
(assert (= 15 (+ V2 V3 V4))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 4
(assert (or (= 3 (- V9 V10)) (= 3 (- V10 V9)))) ; Region 5
(assert (= 5 (+ V11 V12))) ; Region 6
(assert (= 70 (* V13 V20 V27))) ; Region 7
(assert (or (= 3 (/ V16 V17)) (= 3 (/ V17 V16)))) ; Region 8
(assert (= 12 (+ V18 V19 V25))) ; Region 9
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 10
(assert (or (= 2 (- V23 V24)) (= 2 (- V24 V23)))) ; Region 11
(assert (or (= 5 (- V26 V33)) (= 5 (- V33 V26)))) ; Region 12
(assert (= 70 (* V28 V35 V42))) ; Region 13
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 14
(assert (= 15 (+ V30 V31 V32))) ; Region 15
(assert (= 7 (+ V34 V41))) ; Region 16
(assert (= 42 (* V37 V38 V45))) ; Region 17
(assert (or (= 2 (- V39 V40)) (= 2 (- V40 V39)))) ; Region 18
(assert (= 5 (+ V43 V44))) ; Region 19
(assert (or (= 5 (- V47 V48)) (= 5 (- V48 V47)))) ; Region 21
(check-sat)
