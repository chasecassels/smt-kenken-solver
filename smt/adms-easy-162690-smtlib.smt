...
(assert (= 13 (+ V4 V5))) ; Region 3
(assert (or (= 3 (/ V6 V13)) (= 3 (/ V13 V6)))) ; Region 4
(assert (or (= 2 (- V7 V8)) (= 2 (- V8 V7)))) ; Region 5
(assert (= 10 (+ V9 V16 V17))) ; Region 6
(assert (= 5 (+ V11 V18))) ; Region 8
(assert (= 18 (* V12 V19 V26))) ; Region 9
(assert (= 112 (* V14 V15 V21 V22))) ; Region 10
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 11
(assert (= 28 (* V23 V30))) ; Region 12
(assert (= 13 (+ V24 V31))) ; Region 13
(assert (= 70 (* V25 V32 V39))) ; Region 14
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 15
(assert (= 175 (* V33 V34 V41 V48))) ; Region 16
(assert (= 6 (* V35 V42))) ; Region 17
(assert (or (= 3 (- V36 V43)) (= 3 (- V43 V36)))) ; Region 18
(assert (or (= 2 (/ V37 V38)) (= 2 (/ V38 V37)))) ; Region 19
(assert (or (= 2 (/ V40 V47)) (= 2 (/ V47 V40)))) ; Region 20
