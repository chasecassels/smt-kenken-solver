...
(assert (= 15 (* V0 V1 V7))) ; Region 1
(assert (or (= 3 (/ V2 V3)) (= 3 (/ V3 V2)))) ; Region 2
(assert (or (= 6 (- V4 V5)) (= 6 (- V5 V4)))) ; Region 3
(assert (= 56 (* V6 V12 V13))) ; Region 4
(assert (or (= 3 (/ V8 V15)) (= 3 (/ V15 V8)))) ; Region 5
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 6
(assert (or (= 3 (- V10 V17)) (= 3 (- V17 V10)))) ; Region 7
(assert (= 40 (* V11 V18 V19))) ; Region 8
(assert (= 13 (+ V14 V21))) ; Region 9
(assert (or (= 4 (- V20 V27)) (= 4 (- V27 V20)))) ; Region 10
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 11
(assert (= 90 (* V24 V31 V32))) ; Region 12
(assert (or (= 3 (- V25 V26)) (= 3 (- V26 V25)))) ; Region 13
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 14
(assert (or (= 6 (- V29 V30)) (= 6 (- V30 V29)))) ; Region 15
(assert (= 12 (* V33 V34))) ; Region 16
(assert (= 8 (+ V36 V37 V38))) ; Region 17
(assert (or (= 2 (/ V39 V40)) (= 2 (/ V40 V39)))) ; Region 18
(assert (= 9 (+ V42 V43))) ; Region 20
(assert (= 10 (+ V44 V45 V46))) ; Region 21
