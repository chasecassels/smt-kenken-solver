...
(assert (= 6 (+ V2 V9))) ; Region 2
(assert (= 15 (+ V4 V11 V12))) ; Region 4
(assert (= 16 (+ V5 V6 V13))) ; Region 5
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 6
(assert (= 8 (+ V8 V15))) ; Region 7
(assert (or (= 1 (- V10 V17)) (= 1 (- V17 V10)))) ; Region 8
(assert (= 3 (+ V18 V25))) ; Region 10
(assert (or (= 6 (- V19 V20)) (= 6 (- V20 V19)))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (or (= 1 (- V22 V29)) (= 1 (- V29 V22)))) ; Region 13
(assert (= 13 (+ V23 V24))) ; Region 14
(assert (= 8 (+ V26 V27))) ; Region 15
(assert (= 13 (+ V30 V36 V37))) ; Region 16
(assert (or (= 6 (- V31 V38)) (= 6 (- V38 V31)))) ; Region 17
(assert (= 9 (+ V32 V39))) ; Region 18
(assert (or (= 1 (- V33 V34)) (= 1 (- V34 V33)))) ; Region 19
(assert (or (= 5 (- V40 V41)) (= 5 (- V41 V40)))) ; Region 21
(assert (or (= 4 (- V42 V43)) (= 4 (- V43 V42)))) ; Region 22
(assert (or (= 3 (- V44 V45)) (= 3 (- V45 V44)))) ; Region 23
(assert (= 5 (+ V47 V48))) ; Region 25
(check-sat)
