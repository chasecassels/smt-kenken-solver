...
(assert (= 180 (* V0 V1 V8 V15))) ; Region 1
(assert (= 24 (* V2 V3 V4 V9))) ; Region 2
(assert (= 35 (* V5 V6))) ; Region 3
(assert (= 6 (* V7 V14))) ; Region 4
(assert (= 14 (* V10 V17))) ; Region 5
(assert (= 2016 (* V11 V12 V13 V18 V19 V20))) ; Region 6
(assert (= 15 (* V16 V23))) ; Region 7
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 8
(assert (= 4200 (* V24 V25 V30 V31 V32))) ; Region 9
(assert (= 252 (* V26 V27 V33 V34 V41))) ; Region 10
(assert (= 420 (* V28 V29 V35 V42))) ; Region 11
(assert (= 28 (* V36 V37))) ; Region 12
(assert (= 72 (* V38 V43 V44 V45))) ; Region 13
(assert (= 12 (* V39 V40))) ; Region 14
(assert (= 10 (* V47 V48))) ; Region 16
(check-sat)
