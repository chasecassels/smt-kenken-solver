...
(assert (= 120 (* V0 V1 V2))) ; Region 1
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 2
(assert (= 15 (+ V5 V6 V12 V13))) ; Region 3
(assert (or (= 3 (- V7 V8)) (= 3 (- V8 V7)))) ; Region 4
(assert (= 70 (* V9 V15 V16))) ; Region 5
(assert (or (= 3 (- V10 V11)) (= 3 (- V11 V10)))) ; Region 6
(assert (= 126 (* V14 V21 V22))) ; Region 7
(assert (= 12 (+ V17 V18 V19))) ; Region 8
(assert (= 24 (* V20 V27 V34))) ; Region 9
(assert (= 9 (+ V23 V29 V30))) ; Region 10
(assert (= 42 (* V24 V31 V38))) ; Region 11
(assert (= 30 (* V25 V32 V39))) ; Region 12
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 13
(assert (= 8 (* V28 V35 V42))) ; Region 14
(assert (= 10 (+ V36 V37 V43))) ; Region 15
(assert (= 30 (* V40 V41 V48))) ; Region 16
(assert (= 18 (+ V45 V46 V47))) ; Region 18
(check-sat)
