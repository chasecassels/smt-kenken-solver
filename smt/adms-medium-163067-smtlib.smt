...
(assert (= 84 (* V1 V8 V9))) ; Region 2
(assert (= 16 (+ V2 V3 V4 V10))) ; Region 3
(assert (= 9 (+ V5 V6 V13))) ; Region 4
(assert (= 6 (+ V11 V12))) ; Region 5
(assert (or (= 2 (/ V14 V15)) (= 2 (/ V15 V14)))) ; Region 6
(assert (= 30 (* V16 V23))) ; Region 7
(assert (= 14 (+ V17 V24 V25))) ; Region 8
(assert (= 10 (+ V18 V19))) ; Region 9
(assert (= 15 (* V20 V27))) ; Region 10
(assert (or (= 6 (- V21 V22)) (= 6 (- V22 V21)))) ; Region 11
(assert (or (= 3 (- V26 V33)) (= 3 (- V33 V26)))) ; Region 12
(assert (= 10 (+ V28 V35 V42))) ; Region 13
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 14
(assert (= 12 (* V31 V32 V39))) ; Region 15
(assert (= 42 (* V34 V41 V48))) ; Region 16
(assert (= 9 (+ V36 V43))) ; Region 17
(assert (= 10 (+ V37 V44))) ; Region 18
(assert (or (= 2 (/ V38 V45)) (= 2 (/ V45 V38)))) ; Region 19
(assert (or (= 1 (- V40 V47)) (= 1 (- V47 V40)))) ; Region 20
(check-sat)
