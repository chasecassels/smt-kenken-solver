...
(assert (= 16 (+ V4 V5 V6 V11))) ; Region 3
(assert (or (= 2 (- V7 V14)) (= 2 (- V14 V7)))) ; Region 4
(assert (= 13 (+ V8 V9))) ; Region 5
(assert (= 8 (+ V10 V17 V18))) ; Region 6
(assert (or (= 1 (- V12 V13)) (= 1 (- V13 V12)))) ; Region 7
(assert (= 8 (+ V16 V22 V23))) ; Region 9
(assert (= 9 (+ V19 V26))) ; Region 10
(assert (= 18 (+ V20 V27 V34))) ; Region 11
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 12
(assert (= 10 (+ V24 V25 V32))) ; Region 13
(assert (= 17 (+ V29 V30 V31 V37))) ; Region 14
(assert (= 11 (+ V33 V40 V41))) ; Region 15
(assert (= 6 (+ V35 V36))) ; Region 16
(assert (= 13 (+ V39 V46))) ; Region 18
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 19
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 20
(assert (= 6 (+ V47 V48))) ; Region 21
(check-sat)
