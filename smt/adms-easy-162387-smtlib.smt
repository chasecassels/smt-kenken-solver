...
(assert (= 112 (* V0 V1 V8 V15))) ; Region 1
(assert (= 13 (+ V2 V3))) ; Region 2
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 3
(assert (or (= 4 (- V6 V13)) (= 4 (- V13 V6)))) ; Region 4
(assert (or (= 4 (- V7 V14)) (= 4 (- V14 V7)))) ; Region 5
(assert (= 3 (+ V9 V10))) ; Region 6
(assert (= 21 (* V11 V12))) ; Region 7
(assert (= 11 (+ V16 V17 V24))) ; Region 8
(assert (= 13 (+ V18 V25))) ; Region 9
(assert (= 6 (+ V19 V26))) ; Region 10
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 11
(assert (or (= 3 (/ V22 V29)) (= 3 (/ V29 V22)))) ; Region 13
(assert (= 126 (* V23 V30 V31))) ; Region 14
(assert (= 84 (* V28 V35 V42))) ; Region 15
(assert (or (= 3 (- V32 V33)) (= 3 (- V33 V32)))) ; Region 16
(assert (= 6 (+ V36 V37))) ; Region 18
(assert (or (= 1 (- V38 V45)) (= 1 (- V45 V38)))) ; Region 19
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 20
(assert (= 9 (+ V40 V41))) ; Region 21
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 22
(assert (or (= 5 (- V47 V48)) (= 5 (- V48 V47)))) ; Region 23
(check-sat)
