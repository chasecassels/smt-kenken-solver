...
(assert (= 12 (+ V2 V3 V4))) ; Region 2
(assert (= 17 (+ V6 V13 V20))) ; Region 4
(assert (= 15 (+ V7 V14 V15))) ; Region 5
(assert (= 12 (+ V8 V9 V16))) ; Region 6
(assert (or (= 2 (- V10 V17)) (= 2 (- V17 V10)))) ; Region 7
(assert (= 12 (+ V11 V12 V19))) ; Region 8
(assert (= 3 (+ V18 V25))) ; Region 9
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 10
(assert (= 18 (+ V22 V23 V24))) ; Region 11
(assert (= 15 (+ V26 V27 V33 V34))) ; Region 12
(assert (or (= 4 (- V29 V30)) (= 4 (- V30 V29)))) ; Region 13
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 15
(assert (= 10 (+ V35 V36))) ; Region 16
(assert (or (= 5 (- V37 V44)) (= 5 (- V44 V37)))) ; Region 17
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 18
(assert (= 12 (+ V40 V46 V47))) ; Region 19
