...
(assert (= 19 (+ V18 V25 V26 V27))) ; Region 11
(assert (= 13 (+ V21 V28))) ; Region 12
(assert (or (= 6 (- V22 V23)) (= 6 (- V23 V22)))) ; Region 13
(assert (= 13 (+ V29 V30 V31))) ; Region 14
(assert (= 8 (+ V32 V33 V34))) ; Region 15
(assert (= 11 (+ V35 V36 V42))) ; Region 16
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 17
(assert (= 11 (+ V39 V45 V46))) ; Region 18
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 19
(assert (or (= 4 (- V43 V44)) (= 4 (- V44 V43)))) ; Region 20
