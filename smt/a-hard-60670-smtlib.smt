...
(assert (= 7 (+ V4 V11))) ; Region 3
(assert (= 8 (+ V5 V6))) ; Region 4
(assert (= 15 (+ V7 V14 V21))) ; Region 5
(assert (= 7 (+ V8 V9))) ; Region 6
(assert (= 12 (+ V10 V17))) ; Region 7
(assert (= 13 (+ V12 V13 V19 V20))) ; Region 8
(assert (= 6 (+ V15 V16))) ; Region 9
(assert (= 9 (+ V18 V25))) ; Region 10
(assert (= 17 (+ V22 V29 V36))) ; Region 11
(assert (= 6 (+ V23 V30 V37))) ; Region 12
(assert (= 7 (+ V24 V31))) ; Region 13
(assert (= 8 (+ V26 V27 V34))) ; Region 14
(assert (= 6 (+ V28 V35))) ; Region 15
(assert (= 10 (+ V32 V38 V39))) ; Region 16
(assert (= 11 (+ V33 V40))) ; Region 17
(assert (= 9 (+ V41 V48))) ; Region 18
(assert (= 6 (+ V42 V43))) ; Region 19
(assert (= 9 (+ V44 V45))) ; Region 20
