...
(assert (= 168 (* V0 V1 V8 V15))) ; Region 1
(assert (= 90 (* V3 V4 V5 V11))) ; Region 3
(assert (= 40 (* V6 V12 V13))) ; Region 4
(assert (= 210 (* V7 V14 V21 V22))) ; Region 5
(assert (= 15 (* V9 V16))) ; Region 6
(assert (= 24 (* V10 V17 V18 V25))) ; Region 7
(assert (= 72 (* V19 V20 V26 V27))) ; Region 8
(assert (= 48 (* V23 V28 V29 V30))) ; Region 9
(assert (= 21 (* V24 V31))) ; Region 10
(assert (= 140 (* V32 V33 V34 V41))) ; Region 11
(assert (= 24 (* V35 V42))) ; Region 12
(assert (= 15 (* V36 V43 V44))) ; Region 13
(assert (= 280 (* V37 V38 V39 V46))) ; Region 14
(assert (= 42 (* V40 V47 V48))) ; Region 15
(check-sat)
