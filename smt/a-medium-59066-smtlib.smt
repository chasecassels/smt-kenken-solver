...
(assert (= 14 (+ V2 V8 V9))) ; Region 2
(assert (= 8 (+ V3 V10))) ; Region 3
(assert (= 12 (+ V4 V5 V6))) ; Region 4
(assert (= 6 (+ V7 V14))) ; Region 5
(assert (= 10 (+ V11 V18))) ; Region 6
(assert (= 7 (+ V12 V13 V19))) ; Region 7
(assert (= 18 (+ V15 V16 V17))) ; Region 8
(assert (= 7 (+ V20 V27))) ; Region 9
(assert (= 18 (+ V21 V28 V35))) ; Region 10
(assert (= 10 (+ V22 V23 V30))) ; Region 11
(assert (= 9 (+ V24 V31 V32))) ; Region 12
(assert (= 10 (+ V25 V26))) ; Region 13
(assert (= 5 (+ V29 V36))) ; Region 14
(assert (= 9 (+ V33 V34))) ; Region 15
(assert (= 16 (+ V37 V38 V44))) ; Region 16
(assert (= 9 (+ V40 V41))) ; Region 18
(assert (= 4 (+ V42 V43))) ; Region 19
