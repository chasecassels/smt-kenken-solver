...
(assert (= 11 (+ V2 V9))) ; Region 2
(assert (= 7 (+ V3 V10))) ; Region 3
(assert (= 10 (+ V4 V5))) ; Region 4
(assert (= 10 (+ V6 V13))) ; Region 5
(assert (= 9 (+ V7 V8))) ; Region 6
(assert (= 6 (+ V11 V12))) ; Region 7
(assert (= 11 (+ V14 V15))) ; Region 8
(assert (= 8 (+ V16 V17))) ; Region 9
(assert (= 12 (+ V18 V19 V25))) ; Region 10
(assert (= 4 (+ V20 V27))) ; Region 11
(assert (= 12 (+ V21 V28 V35))) ; Region 12
(assert (= 7 (+ V22 V23))) ; Region 13
(assert (= 18 (+ V24 V31 V32))) ; Region 14
(assert (= 9 (+ V26 V33))) ; Region 15
(assert (= 3 (+ V29 V30))) ; Region 16
(assert (= 7 (+ V34 V41))) ; Region 17
(assert (= 10 (+ V36 V37))) ; Region 18
(assert (= 7 (+ V38 V39))) ; Region 19
(assert (= 16 (+ V40 V47 V48))) ; Region 20
(assert (= 13 (+ V42 V43 V44))) ; Region 21
