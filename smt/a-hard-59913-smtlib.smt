...
(assert (= 12 (+ V4 V5))) ; Region 3
(assert (= 10 (+ V6 V13))) ; Region 4
(assert (= 12 (+ V8 V9 V10))) ; Region 5
(assert (= 10 (+ V11 V12 V18))) ; Region 6
(assert (= 3 (+ V14 V15))) ; Region 7
(assert (= 10 (+ V16 V23))) ; Region 8
(assert (= 16 (+ V19 V20 V25 V26))) ; Region 10
(assert (= 10 (+ V21 V22))) ; Region 11
(assert (= 8 (+ V24 V31))) ; Region 12
(assert (= 15 (+ V27 V32 V33 V34))) ; Region 13
(assert (= 10 (+ V28 V35 V42))) ; Region 14
(assert (= 8 (+ V29 V30))) ; Region 15
(assert (= 12 (+ V36 V43 V44))) ; Region 16
(assert (= 18 (+ V37 V38 V39))) ; Region 17
(assert (= 6 (+ V40 V41))) ; Region 18
(assert (= 9 (+ V45 V46))) ; Region 19
(assert (= 6 (+ V47 V48))) ; Region 20
(check-sat)
