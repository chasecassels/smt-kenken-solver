...
(assert (= 3 (+ V1 V8))) ; Region 2
(assert (= 16 (+ V2 V3 V4))) ; Region 3
(assert (or (= 1 (- V5 V12)) (= 1 (- V12 V5)))) ; Region 4
(assert (= 9 (+ V6 V13))) ; Region 5
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 6
(assert (= 7 (+ V11 V18))) ; Region 7
(assert (or (= 1 (- V14 V15)) (= 1 (- V15 V14)))) ; Region 8
(assert (= 12 (+ V17 V23 V24))) ; Region 10
(assert (= 11 (+ V19 V20 V27))) ; Region 11
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 12
(assert (or (= 2 (- V25 V32)) (= 2 (- V32 V25)))) ; Region 13
(assert (= 8 (+ V26 V33))) ; Region 14
(assert (= 6 (+ V28 V29 V35))) ; Region 15
(assert (or (= 3 (- V30 V31)) (= 3 (- V31 V30)))) ; Region 16
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 17
(assert (= 15 (+ V36 V37 V44))) ; Region 18
(assert (= 16 (+ V38 V39 V40))) ; Region 19
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 20
(assert (= 3 (+ V45 V46))) ; Region 21
(assert (= 12 (+ V47 V48))) ; Region 22
(check-sat)
