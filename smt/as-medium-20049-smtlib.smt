...
(assert (= 14 (+ V1 V2 V9 V16))) ; Region 2
(assert (or (= 6 (- V3 V4)) (= 6 (- V4 V3)))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 4
(assert (or (= 2 (- V10 V11)) (= 2 (- V11 V10)))) ; Region 5
(assert (or (= 6 (- V12 V19)) (= 6 (- V19 V12)))) ; Region 6
(assert (= 12 (+ V13 V20 V27))) ; Region 7
(assert (= 13 (+ V14 V15))) ; Region 8
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 9
(assert (= 16 (+ V18 V25 V26))) ; Region 10
(assert (= 4 (+ V21 V28))) ; Region 11
(assert (= 3 (+ V22 V29))) ; Region 12
(assert (= 10 (+ V23 V30))) ; Region 13
(assert (= 19 (+ V31 V32 V38 V39))) ; Region 14
(assert (or (= 1 (- V33 V34)) (= 1 (- V34 V33)))) ; Region 15
(assert (= 12 (+ V35 V42))) ; Region 16
(assert (or (= 1 (- V36 V37)) (= 1 (- V37 V36)))) ; Region 17
(assert (= 8 (+ V40 V47))) ; Region 18
