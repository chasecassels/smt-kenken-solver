...
(assert (= 60 (* V2 V9 V16))) ; Region 2
(assert (= 72 (* V3 V4 V5 V10))) ; Region 3
(assert (= 35 (* V6 V13))) ; Region 4
(assert (= 210 (* V11 V17 V18))) ; Region 5
(assert (= 8 (* V12 V19))) ; Region 6
(assert (= 60 (* V14 V15 V22 V23))) ; Region 7
(assert (= 8 (* V20 V27))) ; Region 8
(assert (= 72 (* V21 V28 V29))) ; Region 9
(assert (= 210 (* V24 V30 V31 V36 V37))) ; Region 10
(assert (= 42 (* V25 V26))) ; Region 11
(assert (= 24 (* V32 V38 V39))) ; Region 12
(assert (= 15 (* V34 V40 V41 V47))) ; Region 14
(assert (= 10 (* V35 V42))) ; Region 15
(assert (= 28 (* V43 V44))) ; Region 16
(assert (= 6 (* V45 V46))) ; Region 17
(check-sat)
