...
(assert (= 126 (* V0 V1 V2 V9))) ; Region 1
(assert (= 4200 (* V3 V4 V10 V11 V18))) ; Region 2
(assert (= 30 (* V5 V6 V12 V13))) ; Region 3
(assert (or (= 2 (/ V7 V8)) (= 2 (/ V8 V7)))) ; Region 4
(assert (= 28 (* V14 V15))) ; Region 5
(assert (= 6 (* V16 V17))) ; Region 6
(assert (= 168 (* V19 V20 V26 V27))) ; Region 7
(assert (= 42 (* V21 V22 V28 V29))) ; Region 8
(assert (= 120 (* V23 V30 V31))) ; Region 9
(assert (= 6 (* V24 V25))) ; Region 10
(assert (= 6 (* V32 V33))) ; Region 11
(assert (= 630 (* V34 V41 V47 V48))) ; Region 12
(assert (= 300 (* V35 V36 V37 V42))) ; Region 13
(assert (= 12 (* V38 V39 V40))) ; Region 14
(assert (= 56 (* V43 V44 V45 V46))) ; Region 15
(check-sat)
