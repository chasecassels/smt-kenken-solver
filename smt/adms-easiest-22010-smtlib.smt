...
(assert (= 60 (* V3 V4 V10))) ; Region 3
(assert (= 11 (+ V5 V11 V12))) ; Region 4
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 5
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 6
(assert (= 11 (+ V9 V16))) ; Region 7
(assert (= 13 (+ V14 V21))) ; Region 8
(assert (or (= 6 (- V17 V24)) (= 6 (- V24 V17)))) ; Region 9
(assert (= 10 (* V18 V25 V26))) ; Region 10
(assert (or (= 2 (/ V19 V20)) (= 2 (/ V20 V19)))) ; Region 11
(assert (= 75 (* V22 V23 V29))) ; Region 12
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 14
(assert (= 12 (+ V30 V31 V38))) ; Region 15
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 16
(assert (= 17 (+ V33 V34 V41))) ; Region 17
(assert (= 3 (+ V36 V37))) ; Region 18
(assert (= 175 (* V40 V47 V48))) ; Region 19
(assert (= 18 (* V42 V43 V44))) ; Region 20
(assert (or (= 2 (/ V45 V46)) (= 2 (/ V46 V45)))) ; Region 21
(check-sat)
