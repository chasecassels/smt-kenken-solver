...
(assert (= 6 (+ V8 V14 V15))) ; Region 6
(assert (= 6 (+ V10 V11))) ; Region 7
(assert (= 8 (+ V16 V23))) ; Region 8
(assert (= 4 (+ V17 V24))) ; Region 9
(assert (= 11 (+ V18 V19))) ; Region 10
(assert (= 9 (+ V20 V27))) ; Region 11
(assert (= 11 (+ V21 V22))) ; Region 12
(assert (= 11 (+ V25 V26 V32))) ; Region 13
(assert (= 20 (+ V28 V29 V30 V35))) ; Region 14
(assert (= 7 (+ V31 V38))) ; Region 15
(assert (= 11 (+ V33 V39 V40))) ; Region 16
(assert (= 9 (+ V34 V41))) ; Region 17
(assert (= 12 (+ V36 V37 V42 V43))) ; Region 18
(assert (= 18 (+ V44 V45 V46))) ; Region 19
(assert (= 4 (+ V47 V48))) ; Region 20
(check-sat)
