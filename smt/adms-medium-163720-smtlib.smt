...
(assert (= 20 (* V2 V3 V10))) ; Region 2
(assert (= 14 (+ V4 V11 V18))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 4
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 5
(assert (or (= 5 (- V8 V9)) (= 5 (- V9 V8)))) ; Region 6
(assert (or (= 3 (/ V12 V19)) (= 3 (/ V19 V12)))) ; Region 7
(assert (= 21 (* V13 V20 V27))) ; Region 8
(assert (= 10 (+ V15 V16 V17))) ; Region 9
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 10
(assert (or (= 1 (- V22 V29)) (= 1 (- V29 V22)))) ; Region 11
(assert (or (= 4 (- V23 V30)) (= 4 (- V30 V23)))) ; Region 12
(assert (= 14 (+ V24 V25 V26 V32))) ; Region 13
(assert (= 42 (* V31 V38 V45 V46))) ; Region 14
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 15
(assert (or (= 1 (- V35 V36)) (= 1 (- V36 V35)))) ; Region 16
(assert (= 120 (* V37 V43 V44))) ; Region 17
(assert (= 210 (* V39 V40 V41))) ; Region 18
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 20
(check-sat)
