...
(assert (= 11 (+ V4 V11 V12))) ; Region 3
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 4
(assert (= 12 (+ V8 V9))) ; Region 6
(assert (= 7 (+ V10 V17 V18))) ; Region 7
(assert (= 13 (+ V13 V20))) ; Region 8
(assert (= 10 (+ V14 V15))) ; Region 9
(assert (= 14 (+ V16 V23 V30))) ; Region 10
(assert (= 3 (+ V19 V26))) ; Region 11
(assert (= 5 (+ V21 V22))) ; Region 12
(assert (= 11 (+ V24 V25))) ; Region 13
(assert (= 9 (+ V27 V34))) ; Region 14
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 15
(assert (= 13 (+ V31 V32))) ; Region 16
(assert (or (= 1 (- V33 V40)) (= 1 (- V40 V33)))) ; Region 17
(assert (= 12 (+ V35 V42))) ; Region 18
(assert (= 6 (+ V36 V37))) ; Region 19
