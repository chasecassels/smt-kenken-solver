...
(assert (= 6 (* V0 V7))) ; Region 1
(assert (or (= 3 (- V1 V8)) (= 3 (- V8 V1)))) ; Region 2
(assert (or (= 4 (- V2 V9)) (= 4 (- V9 V2)))) ; Region 3
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 4
(assert (or (= 2 (- V5 V6)) (= 2 (- V6 V5)))) ; Region 5
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 6
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 7
(assert (= 5 (+ V13 V20))) ; Region 8
(assert (= 14 (* V14 V15))) ; Region 9
(assert (or (= 2 (/ V16 V17)) (= 2 (/ V17 V16)))) ; Region 10
(assert (or (= 4 (- V21 V28)) (= 4 (- V28 V21)))) ; Region 12
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 13
(assert (or (= 1 (- V23 V30)) (= 1 (- V30 V23)))) ; Region 14
(assert (= 980 (* V24 V31 V37 V38))) ; Region 15
(assert (= 3 (+ V25 V26))) ; Region 16
(assert (= 36 (* V27 V34 V41))) ; Region 17
(assert (= 13 (+ V32 V33))) ; Region 18
(assert (= 24 (* V36 V42 V43))) ; Region 20
(assert (or (= 2 (/ V39 V40)) (= 2 (/ V40 V39)))) ; Region 21
(assert (= 8 (+ V44 V45 V46))) ; Region 22
(assert (= 21 (* V47 V48))) ; Region 23
(check-sat)
