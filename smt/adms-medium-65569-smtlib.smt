...
(assert (= 42 (* V1 V2))) ; Region 2
(assert (= 11 (+ V3 V4 V10))) ; Region 3
(assert (= 5 (+ V5 V6))) ; Region 4
(assert (or (= 4 (- V8 V9)) (= 4 (- V9 V8)))) ; Region 5
(assert (= 10 (* V11 V12 V13))) ; Region 6
(assert (= 24 (* V14 V15 V22))) ; Region 7
(assert (= 12 (+ V16 V23 V30))) ; Region 8
(assert (or (= 4 (- V17 V18)) (= 4 (- V18 V17)))) ; Region 9
(assert (or (= 3 (- V19 V20)) (= 3 (- V20 V19)))) ; Region 10
(assert (= 13 (+ V21 V28))) ; Region 11
(assert (= 12 (* V24 V31 V38))) ; Region 12
(assert (or (= 3 (/ V25 V26)) (= 3 (/ V26 V25)))) ; Region 13
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 14
(assert (or (= 2 (- V29 V36)) (= 2 (- V36 V29)))) ; Region 15
(assert (= 35 (* V32 V33))) ; Region 16
(assert (or (= 2 (/ V37 V44)) (= 2 (/ V44 V37)))) ; Region 18
(assert (or (= 2 (- V39 V40)) (= 2 (- V40 V39)))) ; Region 19
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 20
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 21
(assert (= 15 (+ V45 V46 V47))) ; Region 22
(check-sat)
