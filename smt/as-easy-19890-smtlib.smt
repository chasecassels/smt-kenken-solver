...
(assert (= 12 (+ V0 V7))) ; Region 1
(assert (= 9 (+ V1 V8))) ; Region 2
(assert (or (= 3 (- V3 V4)) (= 3 (- V4 V3)))) ; Region 4
(assert (= 12 (+ V5 V6 V12))) ; Region 5
(assert (= 8 (+ V9 V10 V17))) ; Region 6
(assert (= 4 (+ V11 V18))) ; Region 7
(assert (= 12 (+ V13 V19 V20))) ; Region 8
(assert (= 6 (+ V14 V21))) ; Region 9
(assert (= 13 (+ V15 V16))) ; Region 10
(assert (= 14 (+ V22 V23 V24))) ; Region 11
(assert (or (= 6 (- V25 V26)) (= 6 (- V26 V25)))) ; Region 12
(assert (= 12 (+ V27 V33 V34))) ; Region 13
(assert (= 10 (+ V28 V35 V36))) ; Region 14
(assert (or (= 6 (- V29 V30)) (= 6 (- V30 V29)))) ; Region 15
(assert (= 9 (+ V31 V32))) ; Region 16
(assert (= 7 (+ V37 V44))) ; Region 17
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 18
(assert (= 7 (+ V39 V46))) ; Region 19
(assert (= 11 (+ V40 V47))) ; Region 20
(assert (= 8 (+ V41 V48))) ; Region 21
