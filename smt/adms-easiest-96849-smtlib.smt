...
(assert (= 14 (* V0 V1))) ; Region 1
(assert (= 60 (* V2 V3 V9))) ; Region 2
(assert (= 15 (+ V4 V11 V12))) ; Region 3
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 4
(assert (or (= 6 (- V7 V8)) (= 6 (- V8 V7)))) ; Region 5
(assert (= 5 (+ V10 V16 V17))) ; Region 6
(assert (= 30 (* V13 V20))) ; Region 7
(assert (or (= 2 (/ V14 V15)) (= 2 (/ V15 V14)))) ; Region 8
(assert (= 12 (* V18 V25))) ; Region 9
(assert (= 70 (* V19 V26 V27))) ; Region 10
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 11
(assert (= 12 (+ V22 V29 V30))) ; Region 12
(assert (= 13 (+ V23 V24))) ; Region 13
(assert (or (= 3 (/ V32 V33)) (= 3 (/ V33 V32)))) ; Region 15
(assert (= 28 (* V34 V41 V48))) ; Region 16
(assert (= 15 (* V35 V42))) ; Region 17
(assert (= 20 (* V36 V43))) ; Region 18
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 19
(assert (or (= 3 (/ V39 V40)) (= 3 (/ V40 V39)))) ; Region 20
(assert (or (= 3 (- V44 V45)) (= 3 (- V45 V44)))) ; Region 21
(assert (or (= 5 (- V46 V47)) (= 5 (- V47 V46)))) ; Region 22
(check-sat)
