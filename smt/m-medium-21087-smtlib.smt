...
(assert (= 54 (* V1 V2 V7 V8))) ; Region 2
(assert (= 40 (* V3 V9 V10 V11 V17))) ; Region 3
(assert (= 70 (* V4 V5 V6))) ; Region 4
(assert (= 28 (* V12 V13))) ; Region 5
(assert (= 60 (* V14 V15 V16))) ; Region 6
(assert (= 24 (* V18 V19 V26))) ; Region 7
(assert (= 126 (* V20 V27 V34))) ; Region 8
(assert (= 10 (* V21 V28 V29))) ; Region 9
(assert (= 240 (* V23 V30 V36 V37))) ; Region 11
(assert (= 42 (* V24 V31))) ; Region 12
(assert (= 12 (* V25 V32 V33))) ; Region 13
(assert (= 28 (* V35 V42 V43))) ; Region 14
(assert (= 42 (* V38 V44 V45))) ; Region 15
(assert (= 30 (* V39 V46))) ; Region 16
(assert (= 60 (* V40 V41 V47 V48))) ; Region 17
(check-sat)
