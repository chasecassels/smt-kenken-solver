...
(assert (= 168 (* V1 V2 V8))) ; Region 2
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 3
(assert (= 75 (* V5 V11 V12))) ; Region 4
(assert (or (= 3 (/ V6 V13)) (= 3 (/ V13 V6)))) ; Region 5
(assert (= 42 (* V9 V16))) ; Region 6
(assert (= 4 (* V10 V17))) ; Region 7
(assert (= 28 (* V14 V15))) ; Region 8
(assert (= 14 (* V19 V26 V33))) ; Region 10
(assert (= 140 (* V20 V27 V34))) ; Region 11
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 12
(assert (or (= 3 (/ V22 V29)) (= 3 (/ V29 V22)))) ; Region 13
(assert (= 10 (* V23 V30))) ; Region 14
(assert (= 12 (* V24 V25))) ; Region 15
(assert (= 10 (* V31 V38))) ; Region 16
(assert (= 28 (* V32 V39))) ; Region 17
(assert (= 100 (* V35 V36 V42))) ; Region 18
(assert (= 6 (* V37 V43 V44))) ; Region 19
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 20
(assert (= 42 (* V45 V46))) ; Region 21
(assert (= 4 (* V47 V48))) ; Region 22
(check-sat)
