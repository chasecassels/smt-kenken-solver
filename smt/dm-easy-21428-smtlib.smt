...
(assert (= 28 (* V0 V7 V8))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (= 24 (* V3 V10 V11))) ; Region 3
(assert (= 630 (* V4 V5 V6 V12))) ; Region 4
(assert (= 120 (* V9 V14 V15 V16))) ; Region 5
(assert (= 120 (* V13 V19 V20 V26))) ; Region 6
(assert (= 49 (* V17 V23 V24))) ; Region 7
(assert (or (= 3 (/ V18 V25)) (= 3 (/ V25 V18)))) ; Region 8
(assert (= 12 (* V21 V22))) ; Region 9
(assert (= 40 (* V27 V33 V34 V40))) ; Region 10
(assert (= 30 (* V28 V35))) ; Region 11
(assert (= 35 (* V29 V36))) ; Region 12
(assert (or (= 3 (/ V30 V37)) (= 3 (/ V37 V30)))) ; Region 13
(assert (= 336 (* V31 V32 V38 V39))) ; Region 14
(assert (= 6 (* V41 V48))) ; Region 15
(assert (or (= 3 (/ V42 V43)) (= 3 (/ V43 V42)))) ; Region 16
(assert (= 210 (* V45 V46 V47))) ; Region 18
(check-sat)
