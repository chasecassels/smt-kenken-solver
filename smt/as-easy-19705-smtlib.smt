...
(assert (= 12 (+ V1 V8 V9))) ; Region 2
(assert (= 11 (+ V2 V3 V4))) ; Region 3
(assert (= 22 (+ V5 V11 V12 V13))) ; Region 4
(assert (= 13 (+ V14 V15))) ; Region 7
(assert (= 9 (+ V16 V23 V30))) ; Region 8
(assert (= 5 (+ V17 V18))) ; Region 9
(assert (= 9 (+ V19 V26))) ; Region 10
(assert (= 10 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V21 V22))) ; Region 12
(assert (= 10 (+ V24 V25))) ; Region 13
(assert (= 13 (+ V28 V35 V42))) ; Region 14
(assert (or (= 2 (- V29 V36)) (= 2 (- V36 V29)))) ; Region 15
(assert (= 11 (+ V31 V32))) ; Region 16
(assert (= 12 (+ V33 V39 V40))) ; Region 17
(assert (= 3 (+ V34 V41))) ; Region 18
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 19
(assert (= 5 (+ V43 V44))) ; Region 20
(assert (= 11 (+ V45 V46))) ; Region 21
