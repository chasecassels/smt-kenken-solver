...
(assert (= 360 (* V2 V3 V10 V11))) ; Region 2
(assert (= 140 (* V4 V5 V6 V13))) ; Region 3
(assert (= 21 (* V8 V9 V16))) ; Region 4
(assert (= 12 (* V12 V19 V20))) ; Region 5
(assert (= 84 (* V14 V15 V21))) ; Region 6
(assert (= 120 (* V17 V18 V24 V25))) ; Region 7
(assert (= 140 (* V22 V23 V30))) ; Region 8
(assert (= 15 (* V26 V27 V34))) ; Region 9
(assert (= 60 (* V28 V29 V36))) ; Region 10
(assert (= 42 (* V31 V32 V39))) ; Region 11
(assert (= 1176 (* V33 V40 V41 V48))) ; Region 12
(assert (= 20 (* V35 V42 V43))) ; Region 13
(assert (= 6 (* V37 V38 V44))) ; Region 14
(assert (= 72 (* V45 V46 V47))) ; Region 15
(check-sat)
