...
(assert (= 8 (+ V1 V8))) ; Region 2
(assert (= 13 (+ V2 V3 V10 V17))) ; Region 3
(assert (or (= 3 (- V4 V11)) (= 3 (- V11 V4)))) ; Region 4
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 5
(assert (= 6 (+ V9 V16 V23))) ; Region 6
(assert (or (= 1 (- V12 V13)) (= 1 (- V13 V12)))) ; Region 7
(assert (= 15 (* V14 V21))) ; Region 8
(assert (= 42 (* V15 V22))) ; Region 9
(assert (or (= 2 (- V18 V19)) (= 2 (- V19 V18)))) ; Region 10
(assert (= 12 (+ V20 V27 V34))) ; Region 11
(assert (= 210 (* V24 V31 V38 V45))) ; Region 12
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 14
(assert (= 13 (+ V28 V35 V42))) ; Region 15
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 16
(assert (= 7 (+ V32 V39))) ; Region 17
(assert (= 16 (+ V36 V37 V43 V44))) ; Region 18
(assert (= 30 (* V40 V41 V48))) ; Region 19
(assert (or (= 1 (- V46 V47)) (= 1 (- V47 V46)))) ; Region 20
(check-sat)
