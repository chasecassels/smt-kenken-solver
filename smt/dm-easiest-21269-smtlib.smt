...
(assert (= 210 (* V1 V8 V15))) ; Region 2
(assert (= 75 (* V2 V3 V9))) ; Region 3
(assert (= 12 (* V4 V5 V12))) ; Region 4
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 6
(assert (= 12 (* V13 V20))) ; Region 7
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 8
(assert (= 84 (* V16 V23 V30))) ; Region 9
(assert (or (= 2 (/ V18 V19)) (= 2 (/ V19 V18)))) ; Region 11
(assert (or (= 2 (/ V22 V29)) (= 2 (/ V29 V22)))) ; Region 12
(assert (= 24 (* V24 V31))) ; Region 13
(assert (= 7 (* V25 V26))) ; Region 14
(assert (= 5 (* V27 V34))) ; Region 15
(assert (= 18 (* V32 V33))) ; Region 17
(assert (= 84 (* V35 V42 V43))) ; Region 18
(assert (= 12 (* V37 V38))) ; Region 20
(assert (= 30 (* V39 V46))) ; Region 21
(assert (= 35 (* V40 V47))) ; Region 22
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 23
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 24
(check-sat)
