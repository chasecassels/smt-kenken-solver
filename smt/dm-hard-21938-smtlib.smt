...
(assert (= 280 (* V0 V1 V7 V8))) ; Region 1
(assert (= 108 (* V2 V9 V10 V17))) ; Region 2
(assert (= 28 (* V3 V4 V11))) ; Region 3
(assert (= 36 (* V5 V6 V12))) ; Region 4
(assert (= 20 (* V13 V20 V27))) ; Region 5
(assert (= 630 (* V14 V15 V16 V21))) ; Region 6
(assert (= 120 (* V18 V19 V25 V26))) ; Region 7
(assert (= 14 (* V22 V23))) ; Region 8
(assert (= 360 (* V24 V31 V32 V39 V46))) ; Region 9
(assert (= 96 (* V28 V29 V30 V37))) ; Region 10
(assert (= 14 (* V33 V34))) ; Region 11
(assert (= 5 (* V35 V42))) ; Region 12
(assert (or (= 3 (/ V36 V43)) (= 3 (/ V43 V36)))) ; Region 13
(assert (= 84 (* V38 V44 V45))) ; Region 14
(assert (= 30 (* V40 V47 V48))) ; Region 15
(check-sat)
