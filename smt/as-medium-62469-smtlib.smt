...
(assert (= 13 (+ V3 V4 V5))) ; Region 4
(assert (or (= 4 (- V6 V13)) (= 4 (- V13 V6)))) ; Region 5
(assert (= 17 (+ V9 V10 V17))) ; Region 6
(assert (= 8 (+ V11 V12))) ; Region 7
(assert (or (= 6 (- V15 V16)) (= 6 (- V16 V15)))) ; Region 8
(assert (= 13 (+ V18 V19 V26))) ; Region 9
(assert (= 9 (+ V20 V27))) ; Region 10
(assert (or (= 1 (- V21 V22)) (= 1 (- V22 V21)))) ; Region 11
(assert (= 6 (+ V23 V24 V25))) ; Region 12
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 13
(assert (= 15 (+ V30 V36 V37))) ; Region 14
(assert (or (= 3 (- V32 V39)) (= 3 (- V39 V32)))) ; Region 16
(assert (= 15 (+ V33 V34 V40 V41))) ; Region 17
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 18
(assert (or (= 3 (- V38 V45)) (= 3 (- V45 V38)))) ; Region 19
(assert (or (= 1 (- V43 V44)) (= 1 (- V44 V43)))) ; Region 20
