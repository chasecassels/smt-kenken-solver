...
(assert (= 10 (+ V1 V8))) ; Region 2
(assert (= 6 (+ V2 V3 V4))) ; Region 3
(assert (or (= 4 (- V5 V12)) (= 4 (- V12 V5)))) ; Region 4
(assert (= 6 (+ V6 V13))) ; Region 5
(assert (or (= 1 (- V9 V10)) (= 1 (- V10 V9)))) ; Region 6
(assert (= 9 (+ V11 V18))) ; Region 7
(assert (= 5 (+ V14 V15))) ; Region 8
(assert (or (= 3 (- V16 V17)) (= 3 (- V17 V16)))) ; Region 9
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 10
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 11
(assert (= 14 (+ V23 V29 V30))) ; Region 12
(assert (or (= 2 (- V24 V31)) (= 2 (- V31 V24)))) ; Region 13
(assert (= 6 (+ V25 V26))) ; Region 14
(assert (or (= 2 (- V28 V35)) (= 2 (- V35 V28)))) ; Region 16
(assert (= 8 (+ V32 V33))) ; Region 17
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 18
(assert (or (= 6 (- V36 V37)) (= 6 (- V37 V36)))) ; Region 19
(assert (= 15 (+ V38 V45 V46))) ; Region 20
(assert (= 8 (+ V39 V40))) ; Region 21
(assert (= 7 (+ V42 V43 V44))) ; Region 22
(assert (or (= 3 (- V47 V48)) (= 3 (- V48 V47)))) ; Region 23
(check-sat)
