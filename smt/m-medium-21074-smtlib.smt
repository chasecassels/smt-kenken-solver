...
(assert (= 40 (* V2 V3 V10 V11))) ; Region 2
(assert (= 84 (* V4 V5 V6))) ; Region 3
(assert (= 140 (* V8 V14 V15 V21))) ; Region 4
(assert (= 72 (* V12 V13 V20))) ; Region 6
(assert (= 120 (* V16 V22 V23 V30))) ; Region 7
(assert (= 6 (* V17 V24))) ; Region 8
(assert (= 12 (* V18 V19 V25))) ; Region 9
(assert (= 30 (* V26 V33))) ; Region 10
(assert (= 70 (* V27 V34 V40 V41))) ; Region 11
(assert (= 21 (* V28 V29))) ; Region 12
(assert (= 12 (* V31 V32))) ; Region 13
(assert (= 12 (* V35 V42))) ; Region 14
(assert (= 24 (* V36 V43 V44))) ; Region 15
(assert (= 105 (* V37 V38 V39 V45))) ; Region 16
(assert (= 84 (* V46 V47 V48))) ; Region 17
(check-sat)
