...
(assert (= 40 (* V1 V2 V3))) ; Region 2
(assert (= 28 (* V4 V10 V11 V12))) ; Region 3
(assert (= 84 (* V5 V6 V13))) ; Region 4
(assert (= 18 (* V8 V9 V15))) ; Region 5
(assert (= 1008 (* V14 V21 V28 V29))) ; Region 6
(assert (= 28 (* V16 V22 V23))) ; Region 7
(assert (= 30 (* V17 V18))) ; Region 8
(assert (= 12 (* V19 V20 V27))) ; Region 9
(assert (= 12 (* V24 V25 V31))) ; Region 10
(assert (= 420 (* V26 V32 V33 V40))) ; Region 11
(assert (= 5 (* V30 V37))) ; Region 12
(assert (= 105 (* V34 V41 V48))) ; Region 13
(assert (= 56 (* V35 V36 V42 V43))) ; Region 14
(assert (= 15 (* V38 V39))) ; Region 15
(assert (= 18 (* V44 V45))) ; Region 16
(assert (= 8 (* V46 V47))) ; Region 17
(check-sat)
