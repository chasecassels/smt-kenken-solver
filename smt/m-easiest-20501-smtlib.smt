...
(assert (= 72 (* V0 V1 V2))) ; Region 1
(assert (= 48 (* V3 V10 V17))) ; Region 2
(assert (= 7 (* V4 V11))) ; Region 3
(assert (= 35 (* V5 V6))) ; Region 4
(assert (= 6 (* V8 V9))) ; Region 6
(assert (= 35 (* V12 V18 V19))) ; Region 7
(assert (= 15 (* V13 V20))) ; Region 8
(assert (= 20 (* V14 V21))) ; Region 9
(assert (= 14 (* V15 V16 V22))) ; Region 10
(assert (= 12 (* V23 V24 V25))) ; Region 11
(assert (= 12 (* V26 V27))) ; Region 12
(assert (= 56 (* V28 V29 V35))) ; Region 13
(assert (= 30 (* V30 V31 V32))) ; Region 14
(assert (= 18 (* V33 V34 V40))) ; Region 15
(assert (= 5 (* V36 V42 V43))) ; Region 16
(assert (= 245 (* V37 V38 V45))) ; Region 17
