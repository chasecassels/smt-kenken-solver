...
(assert (= 7 (+ V1 V2))) ; Region 2
(assert (= 7 (+ V3 V10))) ; Region 3
(assert (= 13 (+ V4 V5))) ; Region 4
(assert (= 10 (+ V6 V13))) ; Region 5
(assert (= 9 (+ V8 V15))) ; Region 6
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 7
(assert (= 10 (+ V11 V17 V18))) ; Region 8
(assert (= 9 (+ V12 V19))) ; Region 9
(assert (= 5 (+ V14 V21))) ; Region 10
(assert (= 3 (+ V20 V27))) ; Region 11
(assert (= 13 (+ V22 V29))) ; Region 12
(assert (or (= 2 (- V23 V24)) (= 2 (- V24 V23)))) ; Region 13
(assert (or (= 4 (- V25 V26)) (= 4 (- V26 V25)))) ; Region 14
(assert (= 11 (+ V28 V35))) ; Region 15
(assert (= 5 (+ V30 V37))) ; Region 16
(assert (= 11 (+ V31 V32))) ; Region 17
(assert (= 4 (+ V33 V34))) ; Region 18
(assert (or (= 5 (- V38 V39)) (= 5 (- V39 V38)))) ; Region 20
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 21
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 22
(assert (= 6 (+ V45 V46))) ; Region 24
(assert (or (= 5 (- V47 V48)) (= 5 (- V48 V47)))) ; Region 25
(check-sat)
