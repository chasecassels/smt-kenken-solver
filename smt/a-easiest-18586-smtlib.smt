...
(assert (= 5 (+ V0 V1))) ; Region 1
(assert (= 10 (+ V2 V9))) ; Region 2
(assert (= 6 (+ V3 V10))) ; Region 3
(assert (= 7 (+ V4 V11))) ; Region 4
(assert (= 10 (+ V5 V6))) ; Region 5
(assert (= 13 (+ V7 V8))) ; Region 6
(assert (= 3 (+ V12 V19))) ; Region 7
(assert (= 9 (+ V13 V20))) ; Region 8
(assert (= 11 (+ V14 V15 V16))) ; Region 9
(assert (= 8 (+ V18 V25))) ; Region 11
(assert (= 14 (+ V21 V22 V28))) ; Region 12
(assert (= 13 (+ V23 V24))) ; Region 13
(assert (= 6 (+ V26 V27))) ; Region 14
(assert (= 10 (+ V29 V36))) ; Region 15
(assert (= 3 (+ V30 V31))) ; Region 16
(assert (= 7 (+ V32 V39))) ; Region 17
(assert (= 13 (+ V33 V40))) ; Region 18
(assert (= 6 (+ V34 V41))) ; Region 19
(assert (= 3 (+ V35 V42))) ; Region 20
(assert (= 9 (+ V37 V38))) ; Region 21
(assert (= 5 (+ V43 V44))) ; Region 22
