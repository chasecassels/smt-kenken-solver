...
(assert (= 140 (* V3 V4 V10 V11))) ; Region 2
(assert (= 12 (* V5 V6 V12))) ; Region 3
(assert (= 21 (* V7 V14 V15))) ; Region 4
(assert (= 12 (* V8 V9))) ; Region 5
(assert (= 20 (* V13 V20))) ; Region 6
(assert (= 60 (* V16 V17 V23))) ; Region 7
(assert (= 12 (* V18 V19))) ; Region 8
(assert (= 60 (* V21 V22 V29))) ; Region 9
(assert (= 48 (* V24 V25 V30 V31))) ; Region 10
(assert (= 21 (* V26 V27))) ; Region 11
(assert (= 35 (* V28 V35 V36))) ; Region 12
(assert (= 42 (* V32 V39 V46))) ; Region 13
(assert (= 90 (* V33 V34 V41))) ; Region 14
(assert (= 40 (* V37 V42 V43 V44))) ; Region 15
(assert (= 18 (* V38 V45))) ; Region 16
(assert (= 28 (* V40 V47 V48))) ; Region 17
(check-sat)
