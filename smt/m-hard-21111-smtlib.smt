...
(assert (= 525 (* V2 V3 V9 V16))) ; Region 2
(assert (= 144 (* V4 V5 V6 V12))) ; Region 3
(assert (= 168 (* V7 V8 V14 V15))) ; Region 4
(assert (= 168 (* V10 V17 V24 V25))) ; Region 5
(assert (= 35 (* V11 V18))) ; Region 6
(assert (= 6 (* V13 V19 V20))) ; Region 7
(assert (= 144 (* V21 V22 V23 V29))) ; Region 8
(assert (= 140 (* V26 V32 V33 V34))) ; Region 9
(assert (= 210 (* V28 V35 V36 V37 V43))) ; Region 11
(assert (= 36 (* V30 V31 V38))) ; Region 12
(assert (= 48 (* V39 V44 V45 V46))) ; Region 13
(assert (= 8 (* V40 V41))) ; Region 14
(assert (= 21 (* V47 V48))) ; Region 16
(check-sat)
