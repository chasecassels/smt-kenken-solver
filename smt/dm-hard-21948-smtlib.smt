...
(assert (= 840 (* V0 V7 V8 V14 V15))) ; Region 1
(assert (= 756 (* V1 V2 V3 V4 V11))) ; Region 2
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 3
(assert (= 15 (* V9 V10))) ; Region 4
(assert (= 120 (* V12 V13 V18 V19 V20))) ; Region 5
(assert (= 28 (* V16 V17 V22 V23))) ; Region 6
(assert (= 24 (* V21 V28 V29))) ; Region 7
(assert (= 70 (* V24 V25 V31))) ; Region 8
(assert (or (= 2 (/ V26 V27)) (= 2 (/ V27 V26)))) ; Region 9
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 10
(assert (= 56 (* V32 V39 V40))) ; Region 11
(assert (= 105 (* V33 V34 V41))) ; Region 12
(assert (= 210 (* V35 V36 V42 V43))) ; Region 13
(assert (= 16 (* V38 V44 V45))) ; Region 14
(assert (= 30 (* V46 V47 V48))) ; Region 15
(check-sat)
