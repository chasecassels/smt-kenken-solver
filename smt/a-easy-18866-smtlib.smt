...
(assert (= 8 (+ V11 V12 V18))) ; Region 7
(assert (= 3 (+ V15 V22))) ; Region 8
(assert (= 13 (+ V16 V17))) ; Region 9
(assert (= 9 (+ V19 V26))) ; Region 10
(assert (= 11 (+ V20 V27))) ; Region 11
(assert (= 11 (+ V21 V28 V35))) ; Region 12
(assert (= 5 (+ V23 V24))) ; Region 13
(assert (= 14 (+ V25 V31 V32))) ; Region 14
(assert (= 8 (+ V29 V36))) ; Region 15
(assert (= 11 (+ V30 V37))) ; Region 16
(assert (= 9 (+ V33 V34 V41))) ; Region 17
(assert (= 8 (+ V38 V39))) ; Region 18
(assert (= 14 (+ V40 V46 V47 V48))) ; Region 19
(assert (= 11 (+ V42 V43))) ; Region 20
(assert (= 9 (+ V44 V45))) ; Region 21
(check-sat)
