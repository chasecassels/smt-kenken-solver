...
(assert (= 35 (* V0 V7))) ; Region 1
(assert (= 6 (* V1 V8))) ; Region 2
(assert (= 84 (* V2 V3 V4))) ; Region 3
(assert (or (= 3 (/ V5 V12)) (= 3 (/ V12 V5)))) ; Region 4
(assert (= 12 (* V6 V13))) ; Region 5
(assert (= 28 (* V9 V16))) ; Region 6
(assert (= 10 (* V10 V11 V17))) ; Region 7
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 8
(assert (= 20 (* V15 V22))) ; Region 9
(assert (or (= 2 (/ V18 V25)) (= 2 (/ V25 V18)))) ; Region 10
(assert (= 30 (* V19 V26))) ; Region 11
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 12
(assert (= 21 (* V23 V24))) ; Region 13
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 14
(assert (= 10 (* V29 V30))) ; Region 15
(assert (= 6 (* V31 V32))) ; Region 16
(assert (or (= 2 (/ V33 V40)) (= 2 (/ V40 V33)))) ; Region 17
(assert (= 35 (* V34 V41))) ; Region 18
(assert (= 7 (* V36 V37))) ; Region 19
(assert (= 24 (* V38 V44 V45))) ; Region 20
(assert (= 20 (* V39 V46))) ; Region 21
(assert (= 3 (* V42 V43))) ; Region 22
(assert (= 42 (* V47 V48))) ; Region 23
(check-sat)
