...
(assert (= 11 (+ V2 V3 V4))) ; Region 2
(assert (= 7 (+ V5 V12))) ; Region 3
(assert (= 9 (+ V6 V13))) ; Region 4
(assert (= 8 (+ V7 V14))) ; Region 5
(assert (= 9 (+ V8 V15 V16))) ; Region 6
(assert (= 13 (+ V9 V10))) ; Region 7
(assert (= 3 (+ V11 V18))) ; Region 8
(assert (= 11 (+ V17 V24 V31))) ; Region 9
(assert (= 13 (+ V19 V26))) ; Region 10
(assert (= 9 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 10 (+ V22 V29))) ; Region 13
(assert (= 6 (+ V23 V30))) ; Region 14
(assert (= 11 (+ V25 V32))) ; Region 15
(assert (= 9 (+ V33 V39 V40))) ; Region 16
(assert (= 9 (+ V34 V41))) ; Region 17
(assert (= 13 (+ V35 V36))) ; Region 18
(assert (= 5 (+ V37 V44))) ; Region 19
(assert (= 9 (+ V38 V45))) ; Region 20
