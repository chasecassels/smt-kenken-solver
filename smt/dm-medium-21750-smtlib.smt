...
(assert (= 735 (* V0 V1 V2 V3 V10))) ; Region 1
(assert (or (= 3 (/ V4 V5)) (= 3 (/ V5 V4)))) ; Region 2
(assert (= 48 (* V6 V13 V20))) ; Region 3
(assert (= 210 (* V7 V8 V14 V21))) ; Region 4
(assert (= 24 (* V9 V16 V17 V18))) ; Region 5
(assert (= 20 (* V11 V12))) ; Region 6
(assert (= 168 (* V15 V22 V23 V24))) ; Region 7
(assert (= 90 (* V19 V25 V26 V27))) ; Region 8
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 9
(assert (= 2 (* V30 V37))) ; Region 10
(assert (= 35 (* V31 V32))) ; Region 11
(assert (= 140 (* V33 V34 V40 V41))) ; Region 12
(assert (= 48 (* V35 V36 V42 V43))) ; Region 13
(assert (= 72 (* V38 V39 V45))) ; Region 14
(assert (= 42 (* V46 V47 V48))) ; Region 16
(check-sat)
