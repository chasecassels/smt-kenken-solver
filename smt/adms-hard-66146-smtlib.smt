...
(assert (= 30 (* V2 V3 V10))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (= 11 (+ V6 V12 V13))) ; Region 4
(assert (= 24 (* V7 V14 V15))) ; Region 5
(assert (= 175 (* V8 V9 V16))) ; Region 6
(assert (or (= 3 (- V11 V18)) (= 3 (- V18 V11)))) ; Region 7
(assert (= 36 (* V17 V24 V25))) ; Region 8
(assert (= 10 (+ V19 V20 V27))) ; Region 9
(assert (= 13 (+ V21 V28))) ; Region 10
(assert (= 17 (+ V22 V23 V30 V37))) ; Region 11
(assert (or (= 2 (- V26 V33)) (= 2 (- V33 V26)))) ; Region 12
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 13
(assert (= 6 (+ V31 V32))) ; Region 14
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 16
(assert (= 13 (+ V38 V39 V46))) ; Region 17
(assert (or (= 2 (- V40 V47)) (= 2 (- V47 V40)))) ; Region 18
(assert (= 7 (+ V41 V48))) ; Region 19
(assert (= 42 (* V43 V44 V45))) ; Region 20
(check-sat)
