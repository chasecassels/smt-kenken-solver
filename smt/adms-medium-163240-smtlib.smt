...
(assert (= 13 (+ V0 V1 V2 V7))) ; Region 1
(assert (= 210 (* V3 V4 V5 V6))) ; Region 2
(assert (= 14 (+ V8 V14 V15))) ; Region 3
(assert (or (= 3 (- V9 V10)) (= 3 (- V10 V9)))) ; Region 4
(assert (= 45 (* V11 V18 V19))) ; Region 5
(assert (or (= 6 (- V12 V13)) (= 6 (- V13 V12)))) ; Region 6
(assert (or (= 2 (- V16 V17)) (= 2 (- V17 V16)))) ; Region 7
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 8
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 9
(assert (= 11 (+ V22 V23))) ; Region 10
(assert (or (= 2 (- V24 V31)) (= 2 (- V31 V24)))) ; Region 11
(assert (= 14 (+ V25 V26 V32 V33))) ; Region 12
(assert (= 30 (* V29 V35 V36))) ; Region 13
(assert (= 16 (+ V34 V41 V48))) ; Region 15
(assert (or (= 2 (/ V37 V44)) (= 2 (/ V44 V37)))) ; Region 16
(assert (= 5 (+ V38 V45))) ; Region 17
(assert (or (= 3 (/ V39 V46)) (= 3 (/ V46 V39)))) ; Region 18
(assert (or (= 1 (- V40 V47)) (= 1 (- V47 V40)))) ; Region 19
(assert (= 42 (* V42 V43))) ; Region 20
(check-sat)
