...
(assert (or (= 6 (- V1 V2)) (= 6 (- V2 V1)))) ; Region 2
(assert (or (= 1 (- V3 V10)) (= 1 (- V10 V3)))) ; Region 3
(assert (or (= 2 (- V4 V11)) (= 2 (- V11 V4)))) ; Region 4
(assert (or (= 4 (- V5 V12)) (= 4 (- V12 V5)))) ; Region 5
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 6
(assert (= 13 (+ V7 V14))) ; Region 7
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 8
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 9
(assert (= 20 (* V17 V18))) ; Region 10
(assert (or (= 6 (- V19 V20)) (= 6 (- V20 V19)))) ; Region 11
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 12
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 13
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 14
(assert (= 10 (+ V25 V26 V33))) ; Region 15
(assert (= 90 (* V27 V34 V41))) ; Region 16
(assert (= 24 (* V29 V30))) ; Region 17
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 18
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 19
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 20
(assert (= 16 (+ V40 V46 V47 V48))) ; Region 21
(assert (= 6 (+ V42 V43))) ; Region 22
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 23
(check-sat)
