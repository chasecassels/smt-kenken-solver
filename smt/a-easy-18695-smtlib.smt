...
(assert (= 12 (+ V5 V6 V13))) ; Region 4
(assert (= 11 (+ V7 V14 V15))) ; Region 5
(assert (= 9 (+ V8 V9 V10))) ; Region 6
(assert (= 13 (+ V12 V19))) ; Region 7
(assert (= 8 (+ V16 V17))) ; Region 8
(assert (= 8 (+ V18 V25))) ; Region 9
(assert (= 11 (+ V20 V26 V27 V34))) ; Region 10
(assert (= 14 (+ V21 V22 V29 V30))) ; Region 11
(assert (= 11 (+ V23 V24))) ; Region 12
(assert (= 10 (+ V28 V35))) ; Region 13
(assert (= 6 (+ V31 V32))) ; Region 14
(assert (= 6 (+ V33 V40))) ; Region 15
(assert (= 10 (+ V37 V38 V39))) ; Region 17
(assert (= 11 (+ V41 V48))) ; Region 18
(assert (= 12 (+ V42 V43))) ; Region 19
(assert (= 5 (+ V44 V45))) ; Region 20
