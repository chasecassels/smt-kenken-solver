...
(assert (= 60 (* V2 V3 V4))) ; Region 3
(assert (= 20 (* V5 V12 V13))) ; Region 4
(assert (= 84 (* V9 V16 V23))) ; Region 6
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 7
(assert (= 21 (* V14 V15))) ; Region 8
(assert (= 10 (* V17 V18 V19))) ; Region 9
(assert (= 24 (* V20 V27))) ; Region 10
(assert (= 60 (* V21 V22 V28))) ; Region 11
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 12
(assert (= 28 (* V25 V26 V32))) ; Region 13
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 14
(assert (= 6 (* V30 V37))) ; Region 15
(assert (= 35 (* V33 V34 V41))) ; Region 16
(assert (= 20 (* V35 V42 V43))) ; Region 17
(assert (= 42 (* V38 V39 V46))) ; Region 18
(assert (= 36 (* V40 V47 V48))) ; Region 19
(assert (= 35 (* V44 V45))) ; Region 20
(check-sat)
