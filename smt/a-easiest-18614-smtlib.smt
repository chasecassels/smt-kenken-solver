...
(assert (= 9 (+ V5 V12))) ; Region 4
(assert (= 13 (+ V6 V13))) ; Region 5
(assert (= 9 (+ V8 V9))) ; Region 6
(assert (= 5 (+ V10 V11))) ; Region 7
(assert (= 11 (+ V14 V15))) ; Region 8
(assert (= 3 (+ V16 V23))) ; Region 9
(assert (= 12 (+ V17 V24))) ; Region 10
(assert (= 7 (+ V18 V25))) ; Region 11
(assert (= 4 (+ V19 V20))) ; Region 12
(assert (= 6 (+ V21 V28))) ; Region 13
(assert (= 13 (+ V22 V29))) ; Region 14
(assert (= 11 (+ V26 V27))) ; Region 15
(assert (= 15 (+ V30 V37 V44))) ; Region 16
(assert (= 9 (+ V31 V38))) ; Region 17
(assert (= 13 (+ V32 V39))) ; Region 18
(assert (= 7 (+ V33 V40))) ; Region 19
(assert (= 3 (+ V34 V41))) ; Region 20
(assert (= 10 (+ V35 V42))) ; Region 21
(assert (= 4 (+ V36 V43))) ; Region 22
(assert (= 3 (+ V45 V46))) ; Region 23
(assert (= 9 (+ V47 V48))) ; Region 24
(check-sat)
