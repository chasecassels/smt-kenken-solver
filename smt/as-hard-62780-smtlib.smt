...
(assert (= 18 (+ V0 V1 V8))) ; Region 1
(assert (= 8 (+ V2 V9 V10))) ; Region 2
(assert (= 11 (+ V3 V4 V11))) ; Region 3
(assert (= 18 (+ V5 V6 V12 V13))) ; Region 4
(assert (= 6 (+ V7 V14))) ; Region 5
(assert (or (= 6 (- V15 V22)) (= 6 (- V22 V15)))) ; Region 6
(assert (= 13 (+ V17 V23 V24))) ; Region 8
(assert (= 8 (+ V18 V25))) ; Region 9
(assert (or (= 2 (- V19 V20)) (= 2 (- V20 V19)))) ; Region 10
(assert (or (= 4 (- V21 V28)) (= 4 (- V28 V21)))) ; Region 11
(assert (or (= 2 (- V26 V33)) (= 2 (- V33 V26)))) ; Region 12
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 13
(assert (or (= 1 (- V29 V36)) (= 1 (- V36 V29)))) ; Region 14
(assert (or (= 1 (- V30 V37)) (= 1 (- V37 V30)))) ; Region 15
(assert (or (= 3 (- V31 V32)) (= 3 (- V32 V31)))) ; Region 16
(assert (= 7 (+ V35 V42))) ; Region 17
(assert (= 15 (+ V38 V39 V40))) ; Region 18
(assert (or (= 2 (- V41 V48)) (= 2 (- V48 V41)))) ; Region 19
(assert (= 13 (+ V44 V45))) ; Region 21
(assert (= 6 (+ V46 V47))) ; Region 22
(check-sat)
