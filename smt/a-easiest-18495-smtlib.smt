...
(assert (= 18 (+ V5 V6 V13))) ; Region 4
(assert (= 11 (+ V8 V9))) ; Region 5
(assert (= 3 (+ V10 V11))) ; Region 6
(assert (= 12 (+ V14 V21))) ; Region 8
(assert (= 5 (+ V15 V22))) ; Region 9
(assert (= 12 (+ V16 V17 V23))) ; Region 10
(assert (= 9 (+ V19 V20))) ; Region 12
(assert (= 6 (+ V24 V31))) ; Region 13
(assert (= 11 (+ V25 V26))) ; Region 14
(assert (= 6 (+ V27 V34))) ; Region 15
(assert (= 10 (+ V28 V29))) ; Region 16
(assert (= 9 (+ V30 V37))) ; Region 17
(assert (= 3 (+ V32 V33))) ; Region 18
(assert (= 7 (+ V35 V36))) ; Region 19
(assert (= 13 (+ V38 V39))) ; Region 20
(assert (= 6 (+ V40 V47))) ; Region 21
(assert (= 8 (+ V41 V48))) ; Region 22
(assert (= 7 (+ V42 V43))) ; Region 23
(assert (= 7 (+ V45 V46))) ; Region 25
(check-sat)
