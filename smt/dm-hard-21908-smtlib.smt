...
(assert (= 180 (* V1 V2 V8 V9))) ; Region 2
(assert (= 120 (* V3 V10 V17 V18))) ; Region 3
(assert (= 140 (* V4 V5 V6 V13))) ; Region 4
(assert (= 42 (* V11 V12))) ; Region 5
(assert (= 84 (* V14 V21 V22 V28))) ; Region 6
(assert (= 21 (* V15 V16))) ; Region 7
(assert (= 360 (* V19 V20 V25 V26 V27))) ; Region 8
(assert (= 28 (* V23 V24))) ; Region 9
(assert (= 20 (* V29 V30))) ; Region 10
(assert (= 6 (* V31 V32))) ; Region 11
(assert (= 72 (* V33 V34 V40 V41))) ; Region 12
(assert (= 180 (* V35 V36 V37 V42))) ; Region 13
(assert (= 168 (* V38 V39 V46 V47))) ; Region 14
(assert (= 14 (* V43 V44 V45))) ; Region 15
(check-sat)
