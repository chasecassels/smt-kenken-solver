...
(assert (= 18 (+ V8 V15 V16))) ; Region 6
(assert (= 17 (+ V10 V11 V12 V17))) ; Region 7
(assert (= 3 (+ V18 V19))) ; Region 9
(assert (= 13 (+ V20 V27 V34))) ; Region 10
(assert (= 4 (+ V21 V28))) ; Region 11
(assert (= 10 (+ V22 V23))) ; Region 12
(assert (= 7 (+ V24 V25))) ; Region 13
(assert (= 9 (+ V26 V33))) ; Region 14
(assert (= 11 (+ V29 V30))) ; Region 15
(assert (= 8 (+ V31 V32))) ; Region 16
(assert (= 3 (+ V35 V36))) ; Region 17
(assert (= 9 (+ V37 V38))) ; Region 18
(assert (= 16 (+ V39 V40 V41))) ; Region 19
(assert (= 8 (+ V42 V43))) ; Region 20
(assert (= 10 (+ V44 V45 V46))) ; Region 21
(assert (= 10 (+ V47 V48))) ; Region 22
(check-sat)
