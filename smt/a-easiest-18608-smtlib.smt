...
(assert (= 8 (+ V6 V13 V20))) ; Region 4
(assert (= 8 (+ V7 V14))) ; Region 5
(assert (= 13 (+ V8 V15))) ; Region 6
(assert (= 11 (+ V9 V10))) ; Region 7
(assert (= 10 (+ V11 V18 V19))) ; Region 8
(assert (= 6 (+ V16 V23))) ; Region 10
(assert (= 9 (+ V17 V24))) ; Region 11
(assert (= 3 (+ V21 V22))) ; Region 12
(assert (= 9 (+ V25 V32))) ; Region 13
(assert (= 13 (+ V26 V27))) ; Region 14
(assert (= 9 (+ V28 V29))) ; Region 15
(assert (= 13 (+ V30 V37))) ; Region 16
(assert (= 8 (+ V31 V38 V39))) ; Region 17
(assert (= 6 (+ V33 V40))) ; Region 18
(assert (= 7 (+ V35 V42))) ; Region 20
(assert (= 5 (+ V36 V43))) ; Region 21
