...
(assert (= 70 (* V0 V7 V14))) ; Region 1
(assert (= 84 (* V1 V2 V3))) ; Region 2
(assert (= 60 (* V4 V11 V18))) ; Region 3
(assert (= 168 (* V5 V6 V12 V19))) ; Region 4
(assert (or (= 3 (/ V8 V15)) (= 3 (/ V15 V8)))) ; Region 5
(assert (= 30 (* V9 V10))) ; Region 6
(assert (= 6 (* V13 V20 V27))) ; Region 7
(assert (= 7 (* V16 V23))) ; Region 8
(assert (or (= 3 (/ V17 V24)) (= 3 (/ V24 V17)))) ; Region 9
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 10
(assert (= 60 (* V22 V29 V36 V43))) ; Region 11
(assert (= 42 (* V25 V32 V39))) ; Region 12
(assert (= 56 (* V30 V31 V37 V38))) ; Region 14
(assert (= 10 (* V33 V34))) ; Region 15
(assert (= 4 (* V35 V42))) ; Region 16
