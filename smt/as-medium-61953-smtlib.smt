...
(assert (= 6 (+ V6 V13 V20))) ; Region 4
(assert (= 15 (+ V8 V9 V16))) ; Region 5
(assert (= 11 (+ V10 V11 V17))) ; Region 6
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 7
(assert (= 19 (+ V14 V21 V28 V29))) ; Region 8
(assert (or (= 4 (- V15 V22)) (= 4 (- V22 V15)))) ; Region 9
(assert (or (= 4 (- V18 V25)) (= 4 (- V25 V18)))) ; Region 10
(assert (or (= 4 (- V23 V24)) (= 4 (- V24 V23)))) ; Region 11
(assert (or (= 5 (- V26 V27)) (= 5 (- V27 V26)))) ; Region 12
(assert (= 17 (+ V30 V31 V37 V38))) ; Region 13
(assert (= 8 (+ V32 V33 V34))) ; Region 14
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 15
(assert (or (= 4 (- V36 V43)) (= 4 (- V43 V36)))) ; Region 16
(assert (or (= 6 (- V39 V40)) (= 6 (- V40 V39)))) ; Region 17
(assert (= 16 (+ V41 V47 V48))) ; Region 18
(assert (= 14 (+ V44 V45 V46))) ; Region 19
(check-sat)
