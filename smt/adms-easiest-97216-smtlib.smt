...
(assert (= 105 (* V4 V11 V18))) ; Region 4
(assert (= 112 (* V5 V6 V12))) ; Region 5
(assert (= 13 (+ V9 V10))) ; Region 6
(assert (= 12 (+ V13 V19 V20))) ; Region 7
(assert (= 28 (* V14 V21))) ; Region 8
(assert (or (= 2 (/ V16 V23)) (= 2 (/ V23 V16)))) ; Region 10
(assert (= 72 (* V17 V24 V25))) ; Region 11
(assert (= 56 (* V22 V29 V36))) ; Region 12
(assert (= 11 (+ V26 V27 V34))) ; Region 13
(assert (or (= 2 (- V28 V35)) (= 2 (- V35 V28)))) ; Region 14
(assert (or (= 6 (- V30 V31)) (= 6 (- V31 V30)))) ; Region 15
(assert (or (= 3 (/ V32 V33)) (= 3 (/ V33 V32)))) ; Region 16
(assert (= 100 (* V37 V38 V45))) ; Region 17
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 18
(assert (or (= 3 (/ V40 V41)) (= 3 (/ V41 V40)))) ; Region 19
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 20
