...
(assert (= 24 (* V0 V1 V2))) ; Region 1
(assert (or (= 5 (- V3 V4)) (= 5 (- V4 V3)))) ; Region 2
(assert (= 12 (+ V5 V6))) ; Region 3
(assert (= 10 (+ V7 V8 V9))) ; Region 4
(assert (or (= 4 (- V10 V11)) (= 4 (- V11 V10)))) ; Region 5
(assert (or (= 3 (- V12 V19)) (= 3 (- V19 V12)))) ; Region 6
(assert (= 42 (* V13 V20))) ; Region 7
(assert (= 9 (+ V14 V15 V22))) ; Region 8
(assert (= 168 (* V16 V23 V24))) ; Region 9
(assert (= 7 (+ V17 V18 V25))) ; Region 10
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 11
(assert (= 7 (+ V26 V33))) ; Region 12
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 13
(assert (= 13 (+ V29 V36))) ; Region 14
(assert (or (= 4 (- V30 V31)) (= 4 (- V31 V30)))) ; Region 15
(assert (or (= 2 (- V32 V39)) (= 2 (- V39 V32)))) ; Region 16
(assert (or (= 3 (/ V37 V38)) (= 3 (/ V38 V37)))) ; Region 18
(assert (or (= 5 (- V40 V47)) (= 5 (- V47 V40)))) ; Region 19
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 20
(assert (or (= 3 (- V42 V43)) (= 3 (- V43 V42)))) ; Region 21
(assert (= 10 (* V45 V46))) ; Region 23
(check-sat)
