...
(assert (= 10 (* V0 V1 V7))) ; Region 1
(assert (= 18 (* V2 V3 V9))) ; Region 2
(assert (= 840 (* V4 V5 V6 V12))) ; Region 3
(assert (= 24 (* V8 V14 V15))) ; Region 4
(assert (= 42 (* V10 V11 V17))) ; Region 5
(assert (= 35 (* V13 V20))) ; Region 6
(assert (= 42 (* V16 V23))) ; Region 7
(assert (= 24 (* V18 V19 V25))) ; Region 8
(assert (= 20 (* V21 V22))) ; Region 9
(assert (= 60 (* V24 V31 V32))) ; Region 10
(assert (= 84 (* V26 V27 V33 V34))) ; Region 11
(assert (= 252 (* V28 V35 V36 V42))) ; Region 12
(assert (= 20 (* V30 V37 V38 V39))) ; Region 14
(assert (= 36 (* V40 V41 V46 V47))) ; Region 15
(assert (= 140 (* V43 V44 V45))) ; Region 16
(check-sat)
