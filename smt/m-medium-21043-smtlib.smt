...
(assert (= 28 (* V1 V2 V8))) ; Region 2
(assert (= 48 (* V3 V9 V10))) ; Region 3
(assert (= 630 (* V4 V5 V6 V13))) ; Region 4
(assert (= 30 (* V11 V12 V18))) ; Region 5
(assert (= 28 (* V14 V21 V22 V28))) ; Region 6
(assert (= 84 (* V15 V16 V17))) ; Region 7
(assert (= 60 (* V19 V25 V26))) ; Region 8
(assert (= 24 (* V20 V27 V34))) ; Region 9
(assert (= 60 (* V23 V29 V30))) ; Region 10
(assert (= 35 (* V24 V31))) ; Region 11
(assert (= 21 (* V32 V38 V39))) ; Region 12
(assert (= 12 (* V33 V40))) ; Region 13
(assert (= 180 (* V36 V42 V43))) ; Region 15
(assert (= 24 (* V37 V44 V45 V46))) ; Region 16
(assert (= 14 (* V41 V47 V48))) ; Region 17
(check-sat)
