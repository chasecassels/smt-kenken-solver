...
(assert (= 48 (* V2 V3 V10))) ; Region 2
(assert (= 20 (* V4 V11))) ; Region 3
(assert (= 105 (* V5 V6 V13))) ; Region 4
(assert (= 12 (* V7 V14))) ; Region 5
(assert (= 35 (* V9 V16 V17))) ; Region 6
(assert (= 168 (* V12 V19 V20))) ; Region 7
(assert (= 14 (* V15 V22 V23))) ; Region 8
(assert (= 18 (* V18 V24 V25))) ; Region 9
(assert (= 120 (* V21 V28 V29))) ; Region 10
(assert (= 12 (* V26 V27 V33))) ; Region 11
(assert (= 100 (* V30 V36 V37))) ; Region 12
(assert (= 21 (* V31 V38 V39))) ; Region 13
(assert (= 12 (* V34 V41))) ; Region 15
(assert (= 21 (* V35 V42))) ; Region 16
(assert (= 10 (* V40 V47 V48))) ; Region 17
(assert (= 12 (* V43 V44))) ; Region 18
(assert (= 12 (* V45 V46))) ; Region 19
(check-sat)
