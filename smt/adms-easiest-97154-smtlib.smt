...
(assert (= 120 (* V0 V1 V2 V9))) ; Region 1
(assert (= 12 (* V3 V10))) ; Region 2
(assert (= 10 (+ V4 V5 V11))) ; Region 3
(assert (= 9 (+ V6 V13))) ; Region 4
(assert (or (= 3 (/ V7 V14)) (= 3 (/ V14 V7)))) ; Region 5
(assert (or (= 4 (- V8 V15)) (= 4 (- V15 V8)))) ; Region 6
(assert (or (= 5 (- V12 V19)) (= 5 (- V19 V12)))) ; Region 7
(assert (or (= 6 (- V16 V17)) (= 6 (- V17 V16)))) ; Region 8
(assert (= 12 (* V18 V25))) ; Region 9
(assert (= 35 (* V20 V26 V27))) ; Region 10
(assert (= 80 (* V21 V22 V28))) ; Region 11
(assert (= 13 (+ V23 V30))) ; Region 12
(assert (or (= 3 (/ V24 V31)) (= 3 (/ V31 V24)))) ; Region 13
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 15
(assert (or (= 2 (/ V33 V40)) (= 2 (/ V40 V33)))) ; Region 16
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 17
(assert (or (= 4 (- V35 V42)) (= 4 (- V42 V35)))) ; Region 18
(assert (= 20 (* V36 V37 V38 V43))) ; Region 19
(assert (or (= 2 (- V44 V45)) (= 2 (- V45 V44)))) ; Region 20
(assert (= 15 (+ V46 V47 V48))) ; Region 21
(check-sat)
