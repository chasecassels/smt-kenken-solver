...
(assert (= 140 (* V0 V7 V14))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 4
(assert (or (= 2 (- V8 V9)) (= 2 (- V9 V8)))) ; Region 5
(assert (= 13 (+ V10 V11))) ; Region 6
(assert (or (= 2 (/ V12 V13)) (= 2 (/ V13 V12)))) ; Region 7
(assert (= 9 (+ V15 V16))) ; Region 8
(assert (or (= 1 (- V17 V18)) (= 1 (- V18 V17)))) ; Region 9
(assert (= 11 (+ V19 V26))) ; Region 10
(assert (= 42 (* V20 V27 V34))) ; Region 11
(assert (= 12 (* V21 V22))) ; Region 12
(assert (or (= 6 (- V23 V30)) (= 6 (- V30 V23)))) ; Region 13
(assert (= 3 (+ V24 V25))) ; Region 14
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 15
(assert (or (= 5 (- V29 V36)) (= 5 (- V36 V29)))) ; Region 16
(assert (= 9 (+ V31 V38))) ; Region 17
(assert (or (= 3 (- V32 V39)) (= 3 (- V39 V32)))) ; Region 18
(assert (or (= 4 (- V33 V40)) (= 4 (- V40 V33)))) ; Region 19
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 20
(assert (or (= 3 (/ V42 V43)) (= 3 (/ V43 V42)))) ; Region 22
(assert (= 12 (+ V46 V47 V48))) ; Region 24
(check-sat)
