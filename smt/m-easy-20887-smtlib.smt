...
(assert (= 14 (* V2 V9))) ; Region 2
(assert (= 42 (* V3 V10))) ; Region 3
(assert (= 10 (* V4 V5))) ; Region 4
(assert (= 45 (* V6 V12 V13 V20))) ; Region 5
(assert (= 20 (* V7 V14))) ; Region 6
(assert (= 42 (* V11 V18 V19 V26))) ; Region 7
(assert (= 30 (* V15 V16 V23))) ; Region 8
(assert (= 8 (* V17 V24))) ; Region 9
(assert (= 84 (* V21 V22 V28))) ; Region 10
(assert (= 105 (* V25 V31 V32 V33))) ; Region 11
(assert (= 24 (* V27 V34))) ; Region 12
(assert (= 72 (* V29 V30 V37 V44))) ; Region 13
(assert (= 105 (* V35 V36 V42 V43))) ; Region 14
(assert (= 24 (* V38 V39 V46))) ; Region 15
(assert (= 12 (* V40 V41))) ; Region 16
(assert (= 28 (* V47 V48))) ; Region 18
(check-sat)
