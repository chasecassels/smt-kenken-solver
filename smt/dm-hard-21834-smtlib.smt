...
(assert (= 840 (* V0 V1 V8 V9 V10))) ; Region 1
(assert (= 42 (* V2 V3))) ; Region 2
(assert (= 144 (* V4 V5 V6 V11 V12))) ; Region 3
(assert (= 630 (* V7 V14 V21 V28))) ; Region 4
(assert (= 210 (* V13 V17 V18 V19 V20))) ; Region 5
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 6
(assert (= 72 (* V16 V23 V24 V25))) ; Region 7
(assert (= 20 (* V26 V27 V33))) ; Region 8
(assert (= 5 (* V30 V37))) ; Region 10
(assert (= 120 (* V31 V38 V45 V46))) ; Region 11
(assert (= 42 (* V32 V39))) ; Region 12
(assert (= 2940 (* V34 V40 V41 V47 V48))) ; Region 13
(assert (= 12 (* V35 V36))) ; Region 14
(assert (= 12 (* V42 V43 V44))) ; Region 15
(check-sat)
