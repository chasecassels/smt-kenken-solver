...
(assert (= 8 (+ V2 V9))) ; Region 3
(assert (= 13 (+ V3 V10))) ; Region 4
(assert (= 13 (+ V4 V5 V6))) ; Region 5
(assert (= 18 (+ V12 V13 V19 V20))) ; Region 7
(assert (= 13 (+ V14 V15))) ; Region 8
(assert (= 7 (+ V16 V17 V18))) ; Region 9
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 10
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 11
(assert (= 15 (+ V23 V24 V25))) ; Region 12
(assert (= 6 (+ V26 V32 V33))) ; Region 13
(assert (or (= 5 (- V27 V34)) (= 5 (- V34 V27)))) ; Region 14
(assert (or (= 5 (- V30 V37)) (= 5 (- V37 V30)))) ; Region 15
(assert (= 3 (+ V31 V38))) ; Region 16
(assert (= 9 (+ V35 V36))) ; Region 17
(assert (= 11 (+ V39 V46))) ; Region 18
(assert (= 6 (+ V40 V47))) ; Region 19
(assert (= 11 (+ V41 V48))) ; Region 20
(assert (or (= 4 (- V42 V43)) (= 4 (- V43 V42)))) ; Region 21
(assert (or (= 4 (- V44 V45)) (= 4 (- V45 V44)))) ; Region 22
(check-sat)
