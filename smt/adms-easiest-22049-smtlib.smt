...
(assert (= 11 (+ V2 V9 V10))) ; Region 2
(assert (= 35 (* V3 V4 V5))) ; Region 3
(assert (= 24 (* V6 V13))) ; Region 4
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 5
(assert (= 13 (+ V8 V15))) ; Region 6
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 7
(assert (= 24 (* V17 V18 V19))) ; Region 9
(assert (= 15 (* V20 V26 V27))) ; Region 10
(assert (or (= 3 (- V22 V23)) (= 3 (- V23 V22)))) ; Region 12
(assert (= 13 (+ V24 V25))) ; Region 13
(assert (or (= 6 (- V28 V35)) (= 6 (- V35 V28)))) ; Region 14
(assert (= 90 (* V29 V30 V37))) ; Region 15
(assert (= 5 (+ V31 V38))) ; Region 16
(assert (or (= 3 (/ V32 V33)) (= 3 (/ V33 V32)))) ; Region 17
(assert (= 12 (* V39 V46))) ; Region 20
(assert (= 10 (* V40 V41))) ; Region 21
(assert (= 35 (* V42 V43 V44))) ; Region 22
(assert (or (= 2 (/ V47 V48)) (= 2 (/ V48 V47)))) ; Region 24
(check-sat)
