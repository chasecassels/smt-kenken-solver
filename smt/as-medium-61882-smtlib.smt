...
(assert (= 5 (+ V2 V9))) ; Region 2
(assert (or (= 3 (- V3 V10)) (= 3 (- V10 V3)))) ; Region 3
(assert (or (= 4 (- V4 V5)) (= 4 (- V5 V4)))) ; Region 4
(assert (= 18 (+ V6 V13 V20))) ; Region 5
(assert (= 12 (+ V7 V8 V15))) ; Region 6
(assert (= 7 (+ V11 V12))) ; Region 7
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 8
(assert (= 14 (+ V16 V17 V24))) ; Region 9
(assert (or (= 6 (- V18 V19)) (= 6 (- V19 V18)))) ; Region 10
(assert (or (= 4 (- V22 V23)) (= 4 (- V23 V22)))) ; Region 11
(assert (= 10 (+ V25 V26 V27))) ; Region 12
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 13
(assert (= 6 (+ V30 V31 V32))) ; Region 14
(assert (or (= 3 (- V33 V34)) (= 3 (- V34 V33)))) ; Region 15
(assert (or (= 5 (- V35 V42)) (= 5 (- V42 V35)))) ; Region 16
(assert (= 6 (+ V36 V43))) ; Region 17
(assert (= 20 (+ V37 V44 V45))) ; Region 18
(assert (= 11 (+ V38 V39 V46))) ; Region 19
(assert (= 5 (+ V40 V41))) ; Region 20
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 21
(check-sat)
