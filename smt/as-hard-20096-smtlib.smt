...
(assert (= 8 (+ V3 V4 V5))) ; Region 2
(assert (= 15 (+ V6 V12 V13))) ; Region 3
(assert (= 11 (+ V7 V8 V14))) ; Region 4
(assert (= 10 (+ V9 V10 V17))) ; Region 5
(assert (= 10 (+ V11 V18 V19))) ; Region 6
(assert (= 8 (+ V15 V16))) ; Region 7
(assert (= 9 (+ V20 V27))) ; Region 8
(assert (= 7 (+ V21 V28))) ; Region 9
(assert (= 4 (+ V22 V29))) ; Region 10
(assert (= 21 (+ V23 V24 V30 V31))) ; Region 11
(assert (= 11 (+ V25 V26 V32))) ; Region 12
(assert (or (= 6 (- V33 V34)) (= 6 (- V34 V33)))) ; Region 13
(assert (= 16 (+ V36 V42 V43))) ; Region 15
(assert (= 9 (+ V37 V44 V45))) ; Region 16
(assert (or (= 4 (- V38 V39)) (= 4 (- V39 V38)))) ; Region 17
(assert (= 20 (+ V40 V41 V46 V47))) ; Region 18
(check-sat)
