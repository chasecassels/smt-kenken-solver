...
(assert (= 7 (+ V3 V10))) ; Region 2
(assert (= 14 (+ V5 V6 V13))) ; Region 4
(assert (= 8 (+ V7 V8))) ; Region 5
(assert (= 13 (+ V9 V16))) ; Region 6
(assert (= 3 (+ V11 V12))) ; Region 7
(assert (= 4 (+ V14 V15))) ; Region 8
(assert (= 8 (+ V17 V23 V24))) ; Region 9
(assert (= 16 (+ V18 V19 V20))) ; Region 10
(assert (= 13 (+ V21 V28))) ; Region 11
(assert (= 5 (+ V22 V29))) ; Region 12
(assert (= 7 (+ V25 V32))) ; Region 13
(assert (= 10 (+ V26 V27 V34))) ; Region 14
(assert (= 8 (+ V30 V31))) ; Region 15
(assert (= 13 (+ V33 V40))) ; Region 16
(assert (= 7 (+ V35 V36))) ; Region 17
(assert (= 5 (+ V37 V44))) ; Region 18
(assert (= 10 (+ V38 V39))) ; Region 19
(assert (= 4 (+ V41 V48))) ; Region 20
(assert (= 10 (+ V42 V43))) ; Region 21
(assert (= 14 (+ V45 V46 V47))) ; Region 22
(check-sat)
