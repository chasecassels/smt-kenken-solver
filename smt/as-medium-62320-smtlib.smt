...
(assert (= 12 (+ V0 V1 V2))) ; Region 1
(assert (or (= 3 (- V3 V4)) (= 3 (- V4 V3)))) ; Region 2
(assert (= 14 (+ V5 V6 V12))) ; Region 3
(assert (= 10 (+ V7 V14 V21))) ; Region 4
(assert (= 13 (+ V8 V9))) ; Region 5
(assert (= 9 (+ V10 V11))) ; Region 6
(assert (= 8 (+ V13 V19 V20))) ; Region 7
(assert (= 11 (+ V15 V16 V22))) ; Region 8
(assert (= 13 (+ V17 V18))) ; Region 9
(assert (= 16 (+ V23 V30 V37))) ; Region 10
(assert (= 3 (+ V24 V25))) ; Region 11
(assert (or (= 4 (- V26 V27)) (= 4 (- V27 V26)))) ; Region 12
(assert (= 13 (+ V28 V29 V35))) ; Region 13
(assert (or (= 1 (- V32 V33)) (= 1 (- V33 V32)))) ; Region 15
(assert (= 7 (+ V34 V40 V41))) ; Region 16
(assert (= 8 (+ V36 V42 V43))) ; Region 17
(assert (= 11 (+ V38 V39 V46))) ; Region 18
(assert (or (= 4 (- V44 V45)) (= 4 (- V45 V44)))) ; Region 19
