...
(assert (= 180 (* V0 V1 V2 V9))) ; Region 1
(assert (= 10 (+ V3 V10))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (or (= 5 (- V6 V13)) (= 5 (- V13 V6)))) ; Region 4
(assert (or (= 6 (- V7 V14)) (= 6 (- V14 V7)))) ; Region 5
(assert (= 42 (* V11 V12))) ; Region 7
(assert (= 3 (+ V15 V16))) ; Region 8
(assert (= 15 (* V17 V18 V25))) ; Region 9
(assert (= 96 (* V19 V20 V26))) ; Region 10
(assert (= 15 (+ V21 V22 V28))) ; Region 11
(assert (= 5 (+ V23 V24))) ; Region 12
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 13
(assert (= 24 (* V29 V30))) ; Region 14
(assert (= 3 (+ V31 V38))) ; Region 15
(assert (= 18 (+ V32 V33 V39 V40))) ; Region 16
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 17
(assert (= 14 (+ V36 V37 V43))) ; Region 18
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 19
(assert (= 28 (* V44 V45))) ; Region 20
(assert (or (= 2 (- V46 V47)) (= 2 (- V47 V46)))) ; Region 21
(check-sat)
