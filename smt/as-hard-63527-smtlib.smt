...
(assert (= 14 (+ V3 V4 V5))) ; Region 3
(assert (= 11 (+ V6 V13 V20))) ; Region 4
(assert (= 4 (+ V8 V9))) ; Region 5
(assert (= 17 (+ V10 V11 V18))) ; Region 6
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 7
(assert (= 11 (+ V15 V22))) ; Region 8
(assert (or (= 3 (- V16 V17)) (= 3 (- V17 V16)))) ; Region 9
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 10
(assert (= 6 (+ V23 V24 V25))) ; Region 11
(assert (or (= 2 (- V26 V27)) (= 2 (- V27 V26)))) ; Region 12
(assert (or (= 3 (- V29 V30)) (= 3 (- V30 V29)))) ; Region 13
(assert (= 8 (+ V31 V38))) ; Region 14
(assert (= 14 (+ V33 V39 V40))) ; Region 16
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 17
(assert (or (= 3 (- V35 V36)) (= 3 (- V36 V35)))) ; Region 18
(assert (= 10 (+ V37 V42 V43 V44))) ; Region 19
(assert (= 16 (+ V46 V47 V48))) ; Region 21
(check-sat)
