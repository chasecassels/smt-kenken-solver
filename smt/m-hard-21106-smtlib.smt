...
(assert (= 420 (* V2 V3 V4 V10))) ; Region 2
(assert (= 48 (* V5 V6 V12 V19))) ; Region 3
(assert (= 210 (* V9 V11 V16 V17 V18))) ; Region 5
(assert (= 36 (* V13 V20 V27))) ; Region 6
(assert (= 120 (* V14 V15 V21 V28))) ; Region 7
(assert (= 36 (* V23 V24 V30))) ; Region 9
(assert (= 420 (* V25 V26 V31 V32))) ; Region 10
(assert (= 24 (* V29 V36))) ; Region 11
(assert (= 140 (* V33 V34 V40 V41))) ; Region 12
(assert (= 90 (* V35 V37 V42 V43 V44))) ; Region 13
(assert (= 10 (* V38 V39))) ; Region 14
(assert (= 168 (* V45 V46 V47 V48))) ; Region 15
(check-sat)
