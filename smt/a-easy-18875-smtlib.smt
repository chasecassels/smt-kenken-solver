...
(assert (= 14 (+ V0 V7 V14))) ; Region 1
(assert (= 3 (+ V1 V2))) ; Region 2
(assert (= 12 (+ V3 V4))) ; Region 3
(assert (= 10 (+ V5 V6))) ; Region 4
(assert (= 9 (+ V8 V9))) ; Region 5
(assert (= 4 (+ V10 V17))) ; Region 6
(assert (= 9 (+ V11 V12))) ; Region 7
(assert (= 3 (+ V13 V20))) ; Region 8
(assert (= 11 (+ V15 V16))) ; Region 9
(assert (= 13 (+ V18 V25))) ; Region 10
(assert (= 8 (+ V19 V26 V27))) ; Region 11
(assert (= 7 (+ V21 V22))) ; Region 12
(assert (= 9 (+ V23 V24))) ; Region 13
(assert (= 9 (+ V28 V35))) ; Region 14
(assert (= 10 (+ V29 V36))) ; Region 15
(assert (= 19 (+ V30 V37 V38 V39))) ; Region 16
(assert (= 3 (+ V31 V32))) ; Region 17
(assert (= 14 (+ V33 V34 V41))) ; Region 18
(assert (= 17 (+ V40 V46 V47 V48))) ; Region 19
(assert (= 6 (+ V42 V43))) ; Region 20
(assert (= 6 (+ V44 V45))) ; Region 21
(check-sat)
