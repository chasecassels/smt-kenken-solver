...
(assert (= 20 (* V0 V7))) ; Region 1
(assert (or (= 3 (/ V1 V8)) (= 3 (/ V8 V1)))) ; Region 2
(assert (= 13 (+ V3 V10))) ; Region 4
(assert (or (= 1 (- V4 V5)) (= 1 (- V5 V4)))) ; Region 5
(assert (= 35 (* V6 V13))) ; Region 6
(assert (or (= 5 (- V9 V16)) (= 5 (- V16 V9)))) ; Region 7
(assert (= 12 (+ V11 V12 V18))) ; Region 8
(assert (or (= 1 (- V14 V15)) (= 1 (- V15 V14)))) ; Region 9
(assert (= 10 (+ V17 V24 V25))) ; Region 10
(assert (= 28 (* V19 V26 V33))) ; Region 11
(assert (or (= 4 (- V21 V22)) (= 4 (- V22 V21)))) ; Region 13
(assert (= 7 (+ V23 V30))) ; Region 14
(assert (= 3 (+ V27 V34))) ; Region 15
(assert (= 60 (* V28 V29 V36))) ; Region 16
(assert (or (= 6 (- V31 V32)) (= 6 (- V32 V31)))) ; Region 17
(assert (= 8 (+ V35 V42))) ; Region 18
(assert (= 10 (+ V37 V38 V39))) ; Region 19
(assert (= 12 (+ V40 V41 V48))) ; Region 20
