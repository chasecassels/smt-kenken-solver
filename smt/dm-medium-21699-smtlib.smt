...
(assert (= 630 (* V2 V3 V9 V16))) ; Region 2
(assert (= 240 (* V4 V10 V11 V12 V13))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 21 (* V7 V8 V15 V22))) ; Region 5
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 6
(assert (= 2940 (* V17 V18 V19 V20 V27))) ; Region 7
(assert (= 60 (* V23 V30 V31))) ; Region 8
(assert (= 60 (* V24 V25 V32))) ; Region 9
(assert (or (= 2 (/ V26 V33)) (= 2 (/ V33 V26)))) ; Region 10
(assert (= 840 (* V28 V29 V35 V36))) ; Region 11
(assert (= 336 (* V34 V40 V41 V46 V47))) ; Region 12
(assert (= 14 (* V37 V38 V39))) ; Region 13
(assert (= 30 (* V42 V43 V44 V45))) ; Region 14
(check-sat)
