...
(assert (= 6 (* V2 V3 V10))) ; Region 2
(assert (= 420 (* V5 V6 V11 V12))) ; Region 4
(assert (= 30 (* V7 V8 V14))) ; Region 5
(assert (= 48 (* V9 V16 V17))) ; Region 6
(assert (= 35 (* V13 V20))) ; Region 7
(assert (= 36 (* V18 V19 V25 V26))) ; Region 9
(assert (= 35 (* V21 V22))) ; Region 10
(assert (= 72 (* V23 V24 V29 V30))) ; Region 11
(assert (= 48 (* V27 V34 V41))) ; Region 12
(assert (= 8 (* V28 V35 V36))) ; Region 13
(assert (= 70 (* V31 V32 V33))) ; Region 14
(assert (= 35 (* V37 V38))) ; Region 15
(assert (= 24 (* V39 V45 V46))) ; Region 16
(assert (= 21 (* V40 V47 V48))) ; Region 17
(assert (= 30 (* V42 V43 V44))) ; Region 18
(check-sat)
