...
(assert (= 9 (+ V2 V3 V9))) ; Region 2
(assert (= 9 (+ V4 V5 V6))) ; Region 3
(assert (= 7 (+ V7 V14))) ; Region 4
(assert (= 10 (+ V10 V17))) ; Region 5
(assert (= 11 (+ V11 V18))) ; Region 6
(assert (= 8 (+ V12 V13))) ; Region 7
(assert (= 18 (+ V16 V23 V30))) ; Region 9
(assert (= 9 (+ V19 V20 V27))) ; Region 10
(assert (= 11 (+ V21 V22))) ; Region 11
(assert (= 12 (+ V24 V31 V38))) ; Region 12
(assert (= 12 (+ V25 V26 V32))) ; Region 13
(assert (= 3 (+ V28 V29))) ; Region 14
(assert (= 12 (+ V33 V40))) ; Region 15
(assert (= 7 (+ V34 V41))) ; Region 16
(assert (= 12 (+ V35 V36 V37))) ; Region 17
(assert (= 12 (+ V42 V43 V44))) ; Region 19
