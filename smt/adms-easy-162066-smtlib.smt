...
(assert (= 10 (* V2 V3))) ; Region 2
(assert (= 18 (* V4 V11 V12))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 4
(assert (= 15 (+ V8 V9 V10))) ; Region 6
(assert (= 4 (* V13 V19 V20))) ; Region 7
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 8
(assert (or (= 1 (- V15 V16)) (= 1 (- V16 V15)))) ; Region 9
(assert (= 140 (* V17 V18 V24))) ; Region 10
(assert (= 210 (* V22 V29 V36 V37))) ; Region 11
(assert (or (= 3 (/ V23 V30)) (= 3 (/ V30 V23)))) ; Region 12
(assert (or (= 2 (- V25 V26)) (= 2 (- V26 V25)))) ; Region 13
(assert (= 13 (+ V27 V34))) ; Region 14
(assert (= 12 (+ V28 V35 V42))) ; Region 15
(assert (= 6 (* V31 V38))) ; Region 16
(assert (or (= 2 (/ V32 V33)) (= 2 (/ V33 V32)))) ; Region 17
(assert (= 3 (+ V39 V40))) ; Region 18
(assert (= 16 (+ V41 V47 V48))) ; Region 19
(assert (or (= 3 (/ V43 V44)) (= 3 (/ V44 V43)))) ; Region 20
