...
(assert (= 9 (+ V1 V2 V9))) ; Region 2
(assert (= 35 (* V3 V10))) ; Region 3
(assert (= 24 (* V4 V11))) ; Region 4
(assert (or (= 3 (/ V5 V12)) (= 3 (/ V12 V5)))) ; Region 5
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 6
(assert (= 16 (+ V8 V14 V15))) ; Region 7
(assert (= 13 (+ V17 V18 V25))) ; Region 9
(assert (or (= 3 (/ V19 V26)) (= 3 (/ V26 V19)))) ; Region 10
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 11
(assert (= 54 (* V21 V28 V29))) ; Region 12
(assert (= 13 (+ V22 V23))) ; Region 13
(assert (= 3 (+ V24 V31))) ; Region 14
(assert (= 10 (* V30 V37))) ; Region 15
(assert (= 196 (* V32 V33 V40))) ; Region 16
(assert (= 18 (+ V34 V41 V48))) ; Region 17
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 18
(assert (or (= 3 (/ V38 V39)) (= 3 (/ V39 V38)))) ; Region 19
(assert (= 3 (+ V42 V43))) ; Region 20
(assert (= 72 (* V44 V45 V46))) ; Region 21
(check-sat)
