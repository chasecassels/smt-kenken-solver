...
(assert (= 42 (* V1 V2 V8))) ; Region 2
(assert (= 60 (* V4 V11 V12))) ; Region 4
(assert (= 12 (* V5 V6))) ; Region 5
(assert (= 42 (* V9 V10 V16 V17))) ; Region 6
(assert (= 40 (* V13 V20 V27))) ; Region 7
(assert (= 12 (* V15 V21 V22))) ; Region 8
(assert (= 30 (* V18 V19 V25))) ; Region 9
(assert (= 10 (* V23 V30))) ; Region 10
(assert (= 147 (* V24 V31 V32))) ; Region 11
(assert (= 12 (* V26 V33 V34 V40))) ; Region 12
(assert (= 24 (* V28 V29))) ; Region 13
(assert (= 90 (* V35 V36 V37 V42))) ; Region 14
(assert (= 20 (* V38 V45))) ; Region 15
(assert (= 42 (* V39 V46 V47))) ; Region 16
(assert (= 42 (* V41 V48))) ; Region 17
(assert (= 8 (* V43 V44))) ; Region 18
(check-sat)
