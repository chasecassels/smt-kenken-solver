...
(assert (= 56 (* V4 V10 V11))) ; Region 3
(assert (= 24 (* V5 V6 V13 V20))) ; Region 4
(assert (= 30 (* V7 V8 V15))) ; Region 5
(assert (= 72 (* V9 V16 V23))) ; Region 6
(assert (= 20 (* V14 V21 V22))) ; Region 8
(assert (= 35 (* V17 V18))) ; Region 9
(assert (= 6 (* V19 V26))) ; Region 10
(assert (= 840 (* V24 V25 V30 V31 V37 V38 V44))) ; Region 11
(assert (= 210 (* V27 V34 V41 V48))) ; Region 12
(assert (= 12 (* V28 V29 V35))) ; Region 13
(assert (= 21 (* V32 V33))) ; Region 14
(assert (= 168 (* V36 V42 V43))) ; Region 15
(assert (= 36 (* V39 V45 V46))) ; Region 16
(assert (= 20 (* V40 V47))) ; Region 17
(check-sat)
