...
(assert (= 13 (+ V0 V1))) ; Region 1
(assert (= 10 (+ V2 V3 V9))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (or (= 3 (- V6 V13)) (= 3 (- V13 V6)))) ; Region 4
(assert (= 6 (+ V7 V8))) ; Region 5
(assert (= 13 (+ V10 V11 V12))) ; Region 6
(assert (= 11 (+ V14 V21))) ; Region 7
(assert (or (= 1 (- V15 V16)) (= 1 (- V16 V15)))) ; Region 8
(assert (or (= 1 (- V17 V18)) (= 1 (- V18 V17)))) ; Region 9
(assert (or (= 4 (- V19 V20)) (= 4 (- V20 V19)))) ; Region 10
(assert (or (= 1 (- V22 V23)) (= 1 (- V23 V22)))) ; Region 11
(assert (or (= 4 (- V24 V25)) (= 4 (- V25 V24)))) ; Region 12
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 13
(assert (or (= 2 (- V28 V29)) (= 2 (- V29 V28)))) ; Region 15
(assert (= 12 (+ V31 V32))) ; Region 17
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 18
(assert (or (= 1 (- V35 V36)) (= 1 (- V36 V35)))) ; Region 19
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 20
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 21
(assert (= 11 (+ V40 V47 V48))) ; Region 22
(assert (or (= 4 (- V42 V43)) (= 4 (- V43 V42)))) ; Region 23
(assert (= 10 (+ V44 V45))) ; Region 24
(check-sat)
