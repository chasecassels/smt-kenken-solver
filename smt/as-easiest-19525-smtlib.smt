...
(assert (= 7 (+ V3 V4))) ; Region 3
(assert (= 10 (+ V5 V6))) ; Region 4
(assert (= 8 (+ V9 V10))) ; Region 6
(assert (= 9 (+ V11 V18))) ; Region 7
(assert (or (= 5 (- V12 V13)) (= 5 (- V13 V12)))) ; Region 8
(assert (= 7 (+ V14 V15))) ; Region 9
(assert (= 7 (+ V16 V23))) ; Region 10
(assert (or (= 6 (- V17 V24)) (= 6 (- V24 V17)))) ; Region 11
(assert (= 6 (+ V19 V20))) ; Region 12
(assert (= 11 (+ V21 V22))) ; Region 13
(assert (= 9 (+ V25 V32))) ; Region 14
(assert (or (= 2 (- V26 V33)) (= 2 (- V33 V26)))) ; Region 15
(assert (or (= 5 (- V27 V34)) (= 5 (- V34 V27)))) ; Region 16
(assert (= 7 (+ V28 V29))) ; Region 17
(assert (= 3 (+ V30 V31))) ; Region 18
(assert (= 15 (+ V35 V36 V37))) ; Region 19
(assert (= 10 (+ V38 V45))) ; Region 20
(assert (or (= 6 (- V39 V46)) (= 6 (- V46 V39)))) ; Region 21
(assert (or (= 2 (- V40 V47)) (= 2 (- V47 V40)))) ; Region 22
(assert (or (= 2 (- V41 V48)) (= 2 (- V48 V41)))) ; Region 23
(assert (= 9 (+ V42 V43))) ; Region 24
(check-sat)
