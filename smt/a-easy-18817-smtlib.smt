...
(assert (= 13 (+ V5 V6 V12))) ; Region 3
(assert (= 13 (+ V7 V14))) ; Region 4
(assert (= 4 (+ V8 V15))) ; Region 5
(assert (= 9 (+ V9 V16))) ; Region 6
(assert (= 5 (+ V10 V11))) ; Region 7
(assert (= 7 (+ V13 V20))) ; Region 8
(assert (= 12 (+ V17 V24 V31))) ; Region 9
(assert (= 8 (+ V18 V25))) ; Region 10
(assert (= 16 (+ V19 V26 V27))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 10 (+ V22 V23))) ; Region 13
(assert (= 9 (+ V29 V30))) ; Region 14
(assert (= 13 (+ V32 V39))) ; Region 15
(assert (= 7 (+ V33 V40))) ; Region 16
(assert (= 4 (+ V34 V41))) ; Region 17
(assert (= 6 (+ V35 V36))) ; Region 18
(assert (= 18 (+ V37 V38 V44 V45))) ; Region 19
(assert (= 12 (+ V42 V43))) ; Region 20
