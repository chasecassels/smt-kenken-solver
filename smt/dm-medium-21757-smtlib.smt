...
(assert (= 1470 (* V1 V8 V9 V16 V17))) ; Region 2
(assert (= 15 (* V2 V3 V10))) ; Region 3
(assert (= 840 (* V4 V11 V12 V13))) ; Region 4
(assert (= 6 (* V5 V6))) ; Region 5
(assert (= 180 (* V14 V15 V21 V22))) ; Region 6
(assert (= 504 (* V18 V19 V26 V27 V34))) ; Region 7
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 9
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 10
(assert (= 1470 (* V28 V29 V30 V35 V42))) ; Region 11
(assert (= 168 (* V31 V38 V39 V46))) ; Region 12
(assert (or (= 2 (/ V33 V40)) (= 2 (/ V40 V33)))) ; Region 13
(assert (= 16 (* V36 V37 V43))) ; Region 14
(assert (= 50 (* V41 V47 V48))) ; Region 15
(assert (= 18 (* V44 V45))) ; Region 16
(check-sat)
