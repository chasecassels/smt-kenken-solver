...
(assert (= 140 (* V4 V11 V12))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 30 (* V7 V14))) ; Region 5
(assert (= 42 (* V9 V10 V17))) ; Region 6
(assert (= 60 (* V13 V18 V19 V20))) ; Region 7
(assert (= 144 (* V15 V16 V23 V29 V30))) ; Region 8
(assert (= 14 (* V21 V22))) ; Region 9
(assert (= 20 (* V24 V31))) ; Region 10
(assert (= 1260 (* V25 V26 V27 V33 V34))) ; Region 11
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 12
(assert (= 84 (* V32 V39 V46 V47))) ; Region 13
(assert (= 700 (* V36 V37 V43 V44))) ; Region 14
(assert (or (= 3 (/ V38 V45)) (= 3 (/ V45 V38)))) ; Region 15
(assert (= 18 (* V40 V41 V48))) ; Region 16
(check-sat)
