...
(assert (= 6 (+ V3 V10))) ; Region 3
(assert (or (= 3 (- V4 V11)) (= 3 (- V11 V4)))) ; Region 4
(assert (= 11 (+ V5 V6 V12))) ; Region 5
(assert (or (= 6 (- V8 V9)) (= 6 (- V9 V8)))) ; Region 6
(assert (= 11 (+ V13 V20))) ; Region 7
(assert (= 11 (+ V15 V22 V29))) ; Region 9
(assert (= 10 (+ V16 V17))) ; Region 10
(assert (= 3 (+ V18 V19))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 15 (+ V23 V30 V37))) ; Region 13
(assert (= 11 (+ V24 V25))) ; Region 14
(assert (or (= 6 (- V26 V27)) (= 6 (- V27 V26)))) ; Region 15
(assert (= 16 (+ V31 V32 V33))) ; Region 16
(assert (= 14 (+ V34 V41 V48))) ; Region 17
(assert (= 10 (+ V35 V36))) ; Region 18
(assert (= 4 (+ V38 V45))) ; Region 19
(assert (= 9 (+ V39 V46))) ; Region 20
(assert (= 7 (+ V40 V47))) ; Region 21
