...
(assert (= 7 (+ V2 V9))) ; Region 3
(assert (= 7 (+ V3 V10))) ; Region 4
(assert (= 19 (+ V5 V6 V12 V13))) ; Region 6
(assert (= 15 (+ V11 V17 V18))) ; Region 7
...
(assert (= 8 (+ V33 V34))) ; Region 17
(assert (= 3 (+ V38 V39))) ; Region 18
(assert (= 9 (+ V40 V47))) ; Region 19
(assert (= 8 (+ V41 V48))) ; Region 20
(assert (= 13 (+ V43 V44))) ; Region 21
(assert (= 8 (+ V45 V46))) ; Region 22
(check-sat)
