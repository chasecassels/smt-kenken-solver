...
(assert (= 120 (* V0 V1 V8 V15))) ; Region 1
(assert (= 252 (* V2 V3 V4 V5))) ; Region 2
(assert (= 280 (* V6 V11 V12 V13))) ; Region 3
(assert (= 7 (* V7 V14))) ; Region 4
(assert (= 504 (* V9 V10 V16 V23 V24))) ; Region 5
(assert (= 6 (* V18 V19))) ; Region 7
(assert (= 6 (* V20 V27))) ; Region 8
(assert (= 40 (* V21 V22 V28))) ; Region 9
(assert (= 24 (* V25 V31 V32))) ; Region 10
(assert (= 15 (* V26 V33 V34))) ; Region 11
(assert (= 588 (* V29 V30 V36 V37))) ; Region 12
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 13
(assert (= 5 (* V38 V39))) ; Region 14
(assert (= 336 (* V40 V41 V46 V47 V48))) ; Region 15
(assert (= 60 (* V43 V44 V45))) ; Region 16
(check-sat)
