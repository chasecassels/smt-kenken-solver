...
(assert (= 30 (* V1 V2 V9))) ; Region 2
(assert (= 20 (* V3 V4))) ; Region 3
(assert (= 12 (* V5 V12))) ; Region 4
(assert (= 28 (* V6 V13))) ; Region 5
(assert (= 42 (* V10 V11 V17))) ; Region 6
(assert (= 210 (* V14 V21 V22))) ; Region 7
(assert (= 10 (* V15 V16))) ; Region 8
(assert (= 12 (* V18 V19))) ; Region 9
(assert (= 6 (* V20 V26 V27))) ; Region 10
(assert (= 56 (* V23 V28 V29 V30 V36))) ; Region 11
(assert (= 28 (* V24 V25))) ; Region 12
(assert (= 30 (* V31 V38 V39 V46 V47))) ; Region 13
(assert (= 630 (* V32 V33 V34 V40))) ; Region 14
(assert (= 48 (* V35 V42 V43))) ; Region 15
(assert (= 84 (* V37 V44 V45))) ; Region 16
(assert (= 30 (* V41 V48))) ; Region 17
(check-sat)
