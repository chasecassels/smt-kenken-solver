...
(assert (= 90 (* V0 V1 V2))) ; Region 1
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 2
(assert (= 4 (* V6 V12 V13))) ; Region 4
(assert (or (= 3 (/ V7 V14)) (= 3 (/ V14 V7)))) ; Region 5
(assert (= 14 (* V8 V15))) ; Region 6
(assert (= 35 (* V9 V16))) ; Region 7
(assert (= 15 (* V10 V11))) ; Region 8
(assert (or (= 3 (/ V17 V18)) (= 3 (/ V18 V17)))) ; Region 9
(assert (= 120 (* V19 V20 V27))) ; Region 10
(assert (= 35 (* V21 V28))) ; Region 11
(assert (= 4 (* V22 V23))) ; Region 12
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 13
(assert (= 126 (* V25 V26 V32))) ; Region 14
(assert (= 12 (* V29 V30))) ; Region 15
(assert (= 84 (* V33 V34 V41))) ; Region 16
(assert (= 4 (* V35 V36 V42))) ; Region 17
(assert (or (= 2 (/ V37 V38)) (= 2 (/ V38 V37)))) ; Region 18
(assert (= 10 (* V39 V40))) ; Region 19
(assert (or (= 3 (/ V43 V44)) (= 3 (/ V44 V43)))) ; Region 20
(assert (= 140 (* V45 V46 V47))) ; Region 21
(check-sat)
