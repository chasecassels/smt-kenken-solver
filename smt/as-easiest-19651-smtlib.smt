...
(assert (= 13 (+ V3 V4 V5 V12))) ; Region 3
(assert (= 5 (+ V6 V13))) ; Region 4
(assert (= 13 (+ V9 V10))) ; Region 6
(assert (= 8 (+ V11 V18))) ; Region 7
(assert (or (= 1 (- V15 V22)) (= 1 (- V22 V15)))) ; Region 8
(assert (or (= 6 (- V16 V17)) (= 6 (- V17 V16)))) ; Region 9
(assert (= 11 (+ V19 V20))) ; Region 10
(assert (= 10 (+ V21 V28))) ; Region 11
(assert (= 13 (+ V23 V29 V30))) ; Region 12
(assert (or (= 4 (- V24 V25)) (= 4 (- V25 V24)))) ; Region 13
(assert (or (= 6 (- V26 V27)) (= 6 (- V27 V26)))) ; Region 14
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 16
(assert (= 8 (+ V33 V40))) ; Region 17
(assert (= 9 (+ V34 V41))) ; Region 18
(assert (= 6 (+ V35 V42))) ; Region 19
(assert (= 3 (+ V36 V37))) ; Region 20
(assert (= 5 (+ V38 V45))) ; Region 21
