...
(assert (= 16 (+ V2 V3 V9))) ; Region 2
(assert (= 11 (+ V4 V5 V12))) ; Region 3
(assert (= 3 (+ V6 V13))) ; Region 4
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 5
(assert (= 13 (+ V8 V15))) ; Region 6
(assert (= 7 (+ V10 V11))) ; Region 7
(assert (= 6 (+ V16 V23 V30))) ; Region 8
(assert (= 7 (+ V17 V18))) ; Region 9
(assert (= 17 (+ V19 V26 V33))) ; Region 10
(assert (= 8 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V21 V22))) ; Region 12
(assert (or (= 2 (- V24 V31)) (= 2 (- V31 V24)))) ; Region 13
(assert (= 8 (+ V28 V29))) ; Region 15
(assert (= 3 (+ V32 V39))) ; Region 16
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 18
(assert (= 12 (+ V36 V43 V44))) ; Region 19
(assert (or (= 5 (- V37 V38)) (= 5 (- V38 V37)))) ; Region 20
(assert (or (= 4 (- V40 V47)) (= 4 (- V47 V40)))) ; Region 21
(assert (= 13 (+ V41 V48))) ; Region 22
