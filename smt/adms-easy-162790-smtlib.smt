...
(assert (= 10 (* V4 V5))) ; Region 3
(assert (= 72 (* V6 V12 V13))) ; Region 4
(assert (or (= 2 (- V7 V14)) (= 2 (- V14 V7)))) ; Region 5
(assert (or (= 2 (/ V8 V9)) (= 2 (/ V9 V8)))) ; Region 6
(assert (= 18 (+ V10 V11 V18))) ; Region 7
(assert (= 24 (* V15 V16 V17 V23))) ; Region 8
(assert (= 150 (* V19 V26 V27 V33))) ; Region 9
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 11
(assert (= 105 (* V22 V29 V30))) ; Region 12
(assert (= 16 (+ V24 V25 V31 V32))) ; Region 13
(assert (= 6 (+ V34 V41 V48))) ; Region 14
(assert (= 9 (+ V35 V36))) ; Region 15
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 16
(assert (or (= 1 (- V38 V39)) (= 1 (- V39 V38)))) ; Region 17
(assert (= 11 (+ V40 V47))) ; Region 18
(assert (= 42 (* V42 V43))) ; Region 19
