...
(assert (= 420 (* V0 V1 V7 V14))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (or (= 2 (/ V4 V11)) (= 2 (/ V11 V4)))) ; Region 3
(assert (= 30 (* V5 V12 V13 V19))) ; Region 4
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 6
(assert (= 42 (* V9 V10 V16))) ; Region 7
(assert (= 5 (* V17 V18))) ; Region 8
(assert (or (= 3 (/ V20 V27)) (= 3 (/ V27 V20)))) ; Region 9
(assert (= 288 (* V21 V28 V29 V30))) ; Region 10
(assert (= 5 (* V22 V23))) ; Region 11
(assert (= 84 (* V24 V25 V26))) ; Region 12
(assert (= 30 (* V31 V37 V38))) ; Region 13
(assert (= 6 (* V32 V39))) ; Region 14
(assert (= 35 (* V33 V40))) ; Region 15
(assert (= 12 (* V34 V41 V48))) ; Region 16
(assert (= 7 (* V35 V36))) ; Region 17
(assert (= 15 (* V42 V43))) ; Region 18
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 19
(assert (= 42 (* V46 V47))) ; Region 20
(check-sat)
