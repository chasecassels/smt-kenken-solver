...
(assert (= 420 (* V2 V3 V4 V9))) ; Region 2
(assert (= 12 (* V5 V12))) ; Region 3
(assert (= 8 (* V6 V13))) ; Region 4
(assert (= 12 (* V7 V14 V21))) ; Region 5
(assert (= 42 (* V10 V11 V18))) ; Region 6
(assert (= 168 (* V15 V16 V22 V23))) ; Region 7
(assert (= 18 (* V17 V24 V25))) ; Region 8
(assert (= 35 (* V19 V20))) ; Region 9
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 10
(assert (= 15 (* V27 V34))) ; Region 11
(assert (= 168 (* V28 V29 V30 V36))) ; Region 12
(assert (= 10 (* V31 V32))) ; Region 13
(assert (= 30 (* V35 V42 V43))) ; Region 14
(assert (= 35 (* V37 V44))) ; Region 15
(assert (or (= 2 (/ V38 V45)) (= 2 (/ V45 V38)))) ; Region 16
(assert (= 12 (* V39 V46 V47))) ; Region 17
(assert (= 42 (* V40 V41 V48))) ; Region 18
(check-sat)
