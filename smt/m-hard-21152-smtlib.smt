...
(assert (= 140 (* V0 V7 V8 V15 V16))) ; Region 1
(assert (= 140 (* V1 V2 V3))) ; Region 2
(assert (= 18 (* V4 V5 V11))) ; Region 3
(assert (= 24 (* V6 V12 V13))) ; Region 4
(assert (= 12 (* V9 V10))) ; Region 5
(assert (= 120 (* V14 V21 V22 V23))) ; Region 6
(assert (= 21 (* V17 V18))) ; Region 7
(assert (= 12 (* V19 V20 V27))) ; Region 8
(assert (= 420 (* V24 V25 V26 V32))) ; Region 9
(assert (= 24 (* V28 V29 V36))) ; Region 10
(assert (= 126 (* V30 V31 V37 V44))) ; Region 11
(assert (= 35 (* V33 V40 V41))) ; Region 12
(assert (= 18 (* V35 V42))) ; Region 14
(assert (= 120 (* V38 V39 V45 V46))) ; Region 15
