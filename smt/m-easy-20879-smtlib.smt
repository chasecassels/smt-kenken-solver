...
(assert (= 140 (* V0 V1 V7 V8))) ; Region 1
(assert (= 168 (* V2 V9 V10))) ; Region 2
(assert (= 36 (* V3 V4 V11))) ; Region 3
(assert (= 15 (* V6 V13))) ; Region 5
(assert (= 168 (* V12 V19 V20 V26))) ; Region 6
(assert (= 18 (* V14 V15 V21))) ; Region 7
(assert (= 20 (* V16 V22 V23))) ; Region 8
(assert (= 35 (* V17 V18))) ; Region 9
(assert (= 3 (* V24 V25))) ; Region 10
(assert (= 24 (* V27 V33 V34))) ; Region 11
(assert (= 20 (* V28 V35))) ; Region 12
(assert (= 42 (* V29 V36))) ; Region 13
(assert (= 28 (* V30 V31))) ; Region 14
(assert (= 30 (* V32 V39 V40 V41))) ; Region 15
(assert (= 6 (* V37 V38 V44))) ; Region 16
(assert (= 6 (* V42 V43))) ; Region 17
(assert (= 24 (* V45 V46))) ; Region 18
(assert (= 35 (* V47 V48))) ; Region 19
(check-sat)
