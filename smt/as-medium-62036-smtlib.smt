...
(assert (= 14 (+ V1 V2 V3))) ; Region 2
(assert (or (= 4 (- V4 V5)) (= 4 (- V5 V4)))) ; Region 3
(assert (or (= 3 (- V6 V13)) (= 3 (- V13 V6)))) ; Region 4
(assert (= 11 (+ V9 V15 V16))) ; Region 5
(assert (or (= 6 (- V10 V11)) (= 6 (- V11 V10)))) ; Region 6
(assert (= 18 (+ V14 V21 V28))) ; Region 8
(assert (or (= 3 (- V17 V18)) (= 3 (- V18 V17)))) ; Region 9
(assert (= 7 (+ V19 V20))) ; Region 10
(assert (= 11 (+ V22 V23))) ; Region 11
(assert (= 8 (+ V24 V31 V38))) ; Region 12
(assert (= 8 (+ V25 V26 V32))) ; Region 13
(assert (= 11 (+ V27 V34))) ; Region 14
(assert (= 9 (+ V29 V35 V36))) ; Region 15
(assert (= 14 (+ V30 V37 V44 V45))) ; Region 16
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 17
(assert (= 7 (+ V41 V48))) ; Region 19
(assert (or (= 6 (- V42 V43)) (= 6 (- V43 V42)))) ; Region 20
(assert (= 6 (+ V46 V47))) ; Region 21
(check-sat)
