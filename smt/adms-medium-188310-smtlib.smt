...
(assert (= 24 (* V2 V3 V4))) ; Region 2
(assert (or (= 4 (- V5 V6)) (= 4 (- V6 V5)))) ; Region 3
...
(assert (or (= 5 (- V13 V20)) (= 5 (- V20 V13)))) ; Region 8
(assert (or (= 1 (- V15 V16)) (= 1 (- V16 V15)))) ; Region 9
(assert (or (= 5 (- V18 V19)) (= 5 (- V19 V18)))) ; Region 10
(assert (= 14 (+ V21 V22 V23))) ; Region 11
(assert (= 72 (* V24 V25 V26 V27))) ; Region 12
(assert (= 15 (+ V28 V29 V36 V43))) ; Region 13
(assert (= 336 (* V30 V31 V32 V37))) ; Region 14
(assert (or (= 1 (- V33 V34)) (= 1 (- V34 V33)))) ; Region 15
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 16
(assert (or (= 3 (/ V38 V39)) (= 3 (/ V39 V38)))) ; Region 17
(assert (= 18 (+ V40 V41 V47 V48))) ; Region 18
(assert (= 35 (* V44 V45 V46))) ; Region 19
(check-sat)
