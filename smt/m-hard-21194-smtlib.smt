...
(assert (= 105 (* V2 V8 V9))) ; Region 2
(assert (= 120 (* V3 V4 V5 V11))) ; Region 3
(assert (= 84 (* V10 V17 V18))) ; Region 5
(assert (= 120 (* V12 V13 V19 V20))) ; Region 6
(assert (= 30 (* V14 V21 V22))) ; Region 7
(assert (= 42 (* V15 V16 V23))) ; Region 8
(assert (= 21 (* V24 V25 V31))) ; Region 9
(assert (= 48 (* V26 V32 V33))) ; Region 10
(assert (= 30 (* V27 V34 V41))) ; Region 11
(assert (= 48 (* V28 V35 V36))) ; Region 12
(assert (= 24 (* V29 V30 V37 V44 V45))) ; Region 13
(assert (= 30 (* V38 V39 V46))) ; Region 14
(assert (= 84 (* V40 V47 V48))) ; Region 15
(assert (= 35 (* V42 V43))) ; Region 16
(check-sat)
