...
(assert (= 175 (* V6 V12 V13))) ; Region 6
(assert (= 18 (+ V8 V15 V22))) ; Region 7
(assert (or (= 3 (/ V9 V16)) (= 3 (/ V16 V9)))) ; Region 8
(assert (= 12 (+ V17 V23 V24))) ; Region 9
(assert (or (= 5 (- V18 V25)) (= 5 (- V25 V18)))) ; Region 10
(assert (= 24 (* V19 V20 V27))) ; Region 11
(assert (= 18 (+ V21 V28 V29 V35))) ; Region 12
(assert (or (= 5 (- V26 V33)) (= 5 (- V33 V26)))) ; Region 13
(assert (= 13 (+ V30 V36 V37))) ; Region 14
(assert (= 19 (+ V31 V38 V45 V46))) ; Region 15
(assert (or (= 4 (- V32 V39)) (= 4 (- V39 V32)))) ; Region 16
(assert (= 5 (+ V34 V41))) ; Region 17
(assert (= 6 (* V40 V47))) ; Region 18
(assert (= 8 (* V42 V43 V44))) ; Region 19
(check-sat)
