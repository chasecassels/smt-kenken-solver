...
(assert (= 240 (* V0 V1 V2 V7))) ; Region 1
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 2
(assert (= 21 (* V5 V12))) ; Region 3
(assert (= 60 (* V6 V13 V20))) ; Region 4
(assert (= 252 (* V8 V9 V10 V16))) ; Region 5
(assert (= 24 (* V11 V18 V19))) ; Region 6
(assert (= 35 (* V15 V21 V22))) ; Region 8
(assert (= 120 (* V17 V24 V31))) ; Region 9
(assert (= 210 (* V23 V30 V37 V44))) ; Region 10
(assert (= 180 (* V25 V26 V32 V33))) ; Region 11
(assert (= 12 (* V27 V34 V41))) ; Region 12
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 13
(assert (= 24 (* V29 V36 V42 V43))) ; Region 14
(assert (= 6 (* V38 V45))) ; Region 15
(assert (= 28 (* V39 V40 V46))) ; Region 16
(assert (= 35 (* V47 V48))) ; Region 17
(check-sat)
