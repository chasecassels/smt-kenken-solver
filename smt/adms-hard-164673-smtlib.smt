...
(assert (= 6 (* V0 V1))) ; Region 1
(assert (or (= 3 (- V2 V3)) (= 3 (- V3 V2)))) ; Region 2
(assert (= 21 (* V4 V5))) ; Region 3
(assert (= 9 (+ V6 V13 V20))) ; Region 4
(assert (= 10 (+ V7 V14 V21))) ; Region 5
(assert (= 18 (+ V8 V9 V10))) ; Region 6
(assert (= 12 (+ V11 V12 V19))) ; Region 7
(assert (= 16 (+ V15 V16 V23))) ; Region 8
(assert (or (= 3 (/ V17 V24)) (= 3 (/ V24 V17)))) ; Region 9
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 10
(assert (= 24 (* V22 V28 V29))) ; Region 11
(assert (= 20 (+ V27 V33 V34 V41))) ; Region 13
(assert (or (= 5 (- V30 V31)) (= 5 (- V31 V30)))) ; Region 14
