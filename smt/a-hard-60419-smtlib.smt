...
(assert (= 9 (+ V6 V12 V13))) ; Region 5
(assert (= 6 (+ V9 V16 V23))) ; Region 6
(assert (= 12 (+ V10 V11))) ; Region 7
(assert (= 7 (+ V14 V15))) ; Region 8
(assert (= 10 (+ V17 V24))) ; Region 9
(assert (= 17 (+ V19 V20 V26 V27))) ; Region 11
(assert (= 9 (+ V21 V22))) ; Region 12
(assert (= 4 (+ V25 V32))) ; Region 13
(assert (= 9 (+ V28 V35 V42))) ; Region 14
(assert (= 11 (+ V29 V30))) ; Region 15
(assert (= 14 (+ V31 V38 V39))) ; Region 16
(assert (= 5 (+ V33 V40))) ; Region 17
(assert (= 11 (+ V34 V41))) ; Region 18
(assert (= 8 (+ V36 V43))) ; Region 19
(assert (= 11 (+ V37 V44 V45))) ; Region 20
