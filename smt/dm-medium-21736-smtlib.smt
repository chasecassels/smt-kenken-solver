...
(assert (= 12 (* V1 V2 V3))) ; Region 2
(assert (= 210 (* V4 V5 V6))) ; Region 3
(assert (or (= 2 (/ V7 V8)) (= 2 (/ V8 V7)))) ; Region 4
(assert (or (= 2 (/ V9 V10)) (= 2 (/ V10 V9)))) ; Region 5
(assert (= 210 (* V11 V17 V18))) ; Region 6
(assert (= 140 (* V12 V13 V19 V20))) ; Region 7
(assert (= 105 (* V14 V15 V21 V22))) ; Region 8
(assert (= 1344 (* V16 V23 V24 V30 V31))) ; Region 9
(assert (= 6 (* V26 V32 V33))) ; Region 11
(assert (= 120 (* V27 V34 V41 V48))) ; Region 12
(assert (= 630 (* V28 V29 V35 V42 V43))) ; Region 13
(assert (= 84 (* V36 V37 V38))) ; Region 14
(assert (= 20 (* V39 V44 V45 V46))) ; Region 15
(assert (or (= 2 (/ V40 V47)) (= 2 (/ V47 V40)))) ; Region 16
(check-sat)
