...
(assert (= 3 (+ V2 V3))) ; Region 3
(assert (or (= 2 (/ V4 V11)) (= 2 (/ V11 V4)))) ; Region 4
(assert (or (= 4 (- V5 V6)) (= 4 (- V6 V5)))) ; Region 5
(assert (= 13 (+ V7 V14))) ; Region 6
(assert (= 36 (* V9 V10 V16 V17))) ; Region 7
(assert (or (= 1 (- V12 V13)) (= 1 (- V13 V12)))) ; Region 8
(assert (= 15 (* V18 V24 V25))) ; Region 10
(assert (= 7 (+ V19 V20 V27))) ; Region 11
(assert (or (= 1 (- V21 V22)) (= 1 (- V22 V21)))) ; Region 12
(assert (= 980 (* V23 V29 V30 V31))) ; Region 13
(assert (= 72 (* V26 V32 V33))) ; Region 14
(assert (or (= 1 (- V28 V35)) (= 1 (- V35 V28)))) ; Region 15
(assert (= 14 (+ V34 V41 V48))) ; Region 16
(assert (= 12 (+ V36 V42 V43 V44))) ; Region 17
(assert (= 80 (* V37 V38 V45))) ; Region 18
(assert (= 21 (* V39 V46))) ; Region 19
(assert (= 8 (+ V40 V47))) ; Region 20
(check-sat)
