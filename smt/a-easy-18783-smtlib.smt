...
(assert (= 5 (+ V8 V9))) ; Region 5
(assert (= 13 (+ V12 V13 V20))) ; Region 6
(assert (= 13 (+ V14 V21))) ; Region 7
(assert (= 3 (+ V15 V22))) ; Region 8
(assert (= 11 (+ V16 V23))) ; Region 9
(assert (= 8 (+ V17 V18 V24))) ; Region 10
(assert (= 10 (+ V19 V26))) ; Region 11
(assert (= 10 (+ V25 V32))) ; Region 12
(assert (= 3 (+ V27 V34))) ; Region 13
(assert (= 13 (+ V28 V29 V36))) ; Region 14
(assert (= 9 (+ V30 V37))) ; Region 15
(assert (= 3 (+ V31 V38))) ; Region 16
(assert (= 16 (+ V33 V40 V41))) ; Region 17
(assert (= 7 (+ V35 V42))) ; Region 18
(assert (= 8 (+ V39 V46))) ; Region 19
(assert (= 16 (+ V43 V44 V45))) ; Region 20
(assert (= 5 (+ V47 V48))) ; Region 21
(check-sat)
