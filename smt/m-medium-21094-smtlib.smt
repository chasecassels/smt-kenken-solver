...
(assert (= 168 (* V4 V5 V6))) ; Region 4
(assert (= 168 (* V9 V15 V16 V17 V23))) ; Region 5
(assert (= 300 (* V10 V11 V12 V18))) ; Region 6
(assert (= 168 (* V13 V19 V20 V26))) ; Region 7
(assert (= 36 (* V14 V21 V22))) ; Region 8
(assert (= 28 (* V25 V31 V32))) ; Region 10
(assert (= 30 (* V27 V33 V34))) ; Region 11
(assert (= 42 (* V28 V29 V30))) ; Region 12
(assert (= 20 (* V35 V42 V43))) ; Region 13
(assert (= 35 (* V36 V37))) ; Region 14
(assert (= 168 (* V38 V44 V45))) ; Region 15
(assert (= 18 (* V39 V40 V46 V47))) ; Region 16
(assert (= 12 (* V41 V48))) ; Region 17
(check-sat)
