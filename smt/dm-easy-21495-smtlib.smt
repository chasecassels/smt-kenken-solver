...
(assert (= 42 (* V2 V3))) ; Region 2
(assert (= 120 (* V4 V11 V12))) ; Region 3
(assert (= 60 (* V5 V6 V13 V20))) ; Region 4
(assert (= 84 (* V7 V8 V14))) ; Region 5
(assert (= 30 (* V9 V10 V17))) ; Region 6
(assert (= 42 (* V15 V16 V22))) ; Region 7
(assert (or (= 3 (/ V18 V19)) (= 3 (/ V19 V18)))) ; Region 8
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 9
(assert (= 6 (* V23 V24 V30))) ; Region 10
(assert (= 140 (* V25 V31 V32))) ; Region 11
(assert (= 5 (* V26 V33))) ; Region 12
(assert (= 14 (* V27 V34))) ; Region 13
(assert (= 40 (* V29 V35 V36 V42))) ; Region 14
(assert (= 84 (* V38 V39 V45))) ; Region 16
(assert (= 14 (* V40 V46 V47))) ; Region 17
(assert (or (= 2 (/ V41 V48)) (= 2 (/ V48 V41)))) ; Region 18
(assert (= 30 (* V43 V44))) ; Region 19
(check-sat)
