...
(assert (= 30 (* V0 V1 V7 V14))) ; Region 1
(assert (= 30 (* V2 V3 V4))) ; Region 2
(assert (= 28 (* V5 V6 V13))) ; Region 3
(assert (= 6 (* V8 V15))) ; Region 4
(assert (= 18 (* V9 V16))) ; Region 5
(assert (= 84 (* V10 V17 V24))) ; Region 6
(assert (= 8 (* V11 V12))) ; Region 7
(assert (= 30 (* V18 V25))) ; Region 8
(assert (= 12 (* V19 V26))) ; Region 9
(assert (= 35 (* V20 V27))) ; Region 10
(assert (= 420 (* V21 V28 V35 V36))) ; Region 11
(assert (= 42 (* V22 V23 V29))) ; Region 12
(assert (= 4 (* V30 V31))) ; Region 13
(assert (= 35 (* V32 V33))) ; Region 14
(assert (= 24 (* V34 V39 V40 V41))) ; Region 15
(assert (= 60 (* V37 V38 V45 V46))) ; Region 16
(assert (= 56 (* V42 V43 V44))) ; Region 17
(assert (= 18 (* V47 V48))) ; Region 18
(check-sat)
