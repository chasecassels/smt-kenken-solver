...
(assert (= 30 (* V1 V2 V8 V9))) ; Region 2
(assert (= 5040 (* V3 V10 V11 V12 V17))) ; Region 3
...
(assert (= 336 (* V18 V23 V24 V25))) ; Region 8
(assert (= 30 (* V19 V26 V27 V34))) ; Region 9
(assert (= 105 (* V21 V22 V28))) ; Region 10
(assert (= 210 (* V30 V31 V37 V38))) ; Region 12
(assert (= 216 (* V32 V33 V39 V45 V46))) ; Region 13
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 14
(assert (= 392 (* V40 V41 V47 V48))) ; Region 15
