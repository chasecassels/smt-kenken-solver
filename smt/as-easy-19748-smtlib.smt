...
(assert (= 13 (+ V2 V3 V8 V9))) ; Region 2
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 3
(assert (= 11 (+ V6 V13 V20))) ; Region 4
(assert (= 11 (+ V7 V14))) ; Region 5
(assert (or (= 5 (- V10 V11)) (= 5 (- V11 V10)))) ; Region 6
(assert (= 8 (+ V12 V19))) ; Region 7
(assert (or (= 6 (- V15 V16)) (= 6 (- V16 V15)))) ; Region 8
(assert (= 8 (+ V17 V18))) ; Region 9
(assert (= 6 (+ V21 V28))) ; Region 10
(assert (or (= 1 (- V22 V29)) (= 1 (- V29 V22)))) ; Region 11
(assert (= 9 (+ V23 V24))) ; Region 12
(assert (or (= 6 (- V25 V26)) (= 6 (- V26 V25)))) ; Region 13
(assert (= 8 (+ V27 V33 V34))) ; Region 14
(assert (= 7 (+ V30 V37))) ; Region 15
(assert (= 13 (+ V31 V32))) ; Region 16
(assert (= 10 (+ V35 V42))) ; Region 17
(assert (= 10 (+ V36 V43 V44))) ; Region 18
(assert (= 6 (+ V38 V39))) ; Region 19
(assert (= 16 (+ V41 V47 V48))) ; Region 21
(assert (or (= 5 (- V45 V46)) (= 5 (- V46 V45)))) ; Region 22
(check-sat)
