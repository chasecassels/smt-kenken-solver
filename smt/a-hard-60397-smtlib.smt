...
(assert (= 7 (+ V10 V11 V12))) ; Region 6
(assert (= 7 (+ V14 V21))) ; Region 7
(assert (= 9 (+ V15 V16))) ; Region 8
(assert (= 8 (+ V17 V24))) ; Region 9
(assert (= 7 (+ V18 V19))) ; Region 10
(assert (= 5 (+ V20 V27))) ; Region 11
(assert (= 10 (+ V22 V23))) ; Region 12
(assert (= 10 (+ V25 V26))) ; Region 13
(assert (= 16 (+ V28 V29 V30))) ; Region 14
(assert (= 5 (+ V31 V38))) ; Region 15
(assert (= 18 (+ V32 V33 V34 V41))) ; Region 16
(assert (= 10 (+ V35 V36 V42 V43))) ; Region 17
