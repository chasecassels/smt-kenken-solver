...
(assert (= 100 (* V1 V2 V9))) ; Region 2
(assert (= 144 (* V3 V4 V5 V10))) ; Region 3
(assert (= 588 (* V6 V12 V13 V20))) ; Region 4
(assert (= 30 (* V11 V18 V19 V25))) ; Region 5
(assert (= 56 (* V14 V21 V28))) ; Region 6
(assert (= 630 (* V15 V16 V17 V23))) ; Region 7
(assert (= 24 (* V22 V29 V30))) ; Region 8
(assert (= 126 (* V24 V31 V32 V38))) ; Region 9
(assert (= 24 (* V26 V27 V34))) ; Region 10
(assert (= 120 (* V33 V39 V40 V47 V48))) ; Region 11
(assert (= 105 (* V35 V36 V42))) ; Region 12
(assert (= 12 (* V37 V43 V44))) ; Region 13
(assert (= 28 (* V45 V46))) ; Region 15
(check-sat)
