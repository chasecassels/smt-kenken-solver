...
(assert (= 140 (* V4 V5 V6))) ; Region 3
(assert (= 168 (* V7 V8 V9))) ; Region 4
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 5
(assert (= 15 (* V12 V13))) ; Region 6
(assert (= 210 (* V14 V15 V22))) ; Region 7
(assert (= 140 (* V16 V17 V23))) ; Region 8
(assert (or (= 3 (/ V18 V19)) (= 3 (/ V19 V18)))) ; Region 9
(assert (= 2 (* V20 V27))) ; Region 10
(assert (= 28 (* V21 V28))) ; Region 11
(assert (= 36 (* V24 V25 V26))) ; Region 12
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 13
(assert (or (= 3 (/ V30 V37)) (= 3 (/ V37 V30)))) ; Region 14
(assert (= 40 (* V31 V38 V39))) ; Region 15
(assert (= 30 (* V32 V33))) ; Region 16
(assert (= 24 (* V34 V41))) ; Region 17
(assert (= 30 (* V35 V42 V43))) ; Region 18
(assert (= 72 (* V44 V45 V46))) ; Region 20
(assert (= 7 (* V47 V48))) ; Region 21
(check-sat)
