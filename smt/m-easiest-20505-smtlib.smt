...
(assert (= 36 (* V0 V1 V7))) ; Region 1
(assert (= 70 (* V3 V9 V10))) ; Region 3
(assert (= 42 (* V4 V11 V12))) ; Region 4
(assert (= 12 (* V5 V6))) ; Region 5
(assert (= 21 (* V8 V15 V16))) ; Region 6
(assert (= 20 (* V13 V20))) ; Region 7
(assert (= 42 (* V14 V21))) ; Region 8
(assert (= 12 (* V17 V24))) ; Region 9
(assert (= 2 (* V18 V19))) ; Region 10
(assert (= 24 (* V22 V23))) ; Region 11
(assert (= 15 (* V25 V32))) ; Region 12
(assert (= 2 (* V26 V27))) ; Region 13
(assert (= 8 (* V28 V29 V35))) ; Region 14
(assert (= 7 (* V30 V31))) ; Region 15
(assert (= 30 (* V33 V34))) ; Region 16
(assert (= 20 (* V36 V37))) ; Region 17
(assert (= 12 (* V38 V44 V45))) ; Region 18
(assert (= 18 (* V39 V40))) ; Region 19
(assert (= 98 (* V41 V47 V48))) ; Region 20
(assert (= 15 (* V42 V43))) ; Region 21
(check-sat)
