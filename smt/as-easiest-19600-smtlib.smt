...
(assert (= 9 (+ V2 V9))) ; Region 2
(assert (or (= 6 (- V3 V4)) (= 6 (- V4 V3)))) ; Region 3
(assert (= 8 (+ V5 V6))) ; Region 4
(assert (= 5 (+ V7 V14))) ; Region 5
(assert (or (= 1 (- V8 V15)) (= 1 (- V15 V8)))) ; Region 6
(assert (= 13 (+ V11 V12 V13))) ; Region 8
(assert (= 9 (+ V16 V23))) ; Region 9
(assert (= 13 (+ V17 V24))) ; Region 10
(assert (= 3 (+ V18 V19))) ; Region 11
(assert (= 6 (+ V20 V27))) ; Region 12
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 13
(assert (= 13 (+ V25 V31 V32))) ; Region 14
(assert (= 10 (+ V26 V33))) ; Region 15
(assert (= 13 (+ V28 V35))) ; Region 16
(assert (= 5 (+ V29 V36))) ; Region 17
(assert (= 3 (+ V30 V37))) ; Region 18
(assert (= 10 (+ V34 V41))) ; Region 19
(assert (= 6 (+ V38 V45))) ; Region 20
(assert (= 12 (+ V39 V40 V46))) ; Region 21
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 23
(assert (= 7 (+ V47 V48))) ; Region 24
(check-sat)
