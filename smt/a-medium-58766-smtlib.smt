...
(assert (= 5 (+ V2 V9))) ; Region 3
(assert (= 10 (+ V3 V4))) ; Region 4
(assert (= 7 (+ V5 V6))) ; Region 5
(assert (= 11 (+ V10 V11))) ; Region 6
(assert (= 8 (+ V12 V13))) ; Region 7
(assert (= 13 (+ V14 V21))) ; Region 8
(assert (= 15 (+ V15 V16 V22))) ; Region 9
(assert (= 3 (+ V17 V18))) ; Region 10
(assert (= 7 (+ V19 V20))) ; Region 11
(assert (= 9 (+ V23 V30))) ; Region 12
(assert (= 7 (+ V24 V25))) ; Region 13
(assert (= 17 (+ V26 V27 V33 V34))) ; Region 14
(assert (= 3 (+ V28 V29))) ; Region 15
(assert (= 11 (+ V31 V37 V38))) ; Region 16
(assert (= 11 (+ V32 V39 V40))) ; Region 17
(assert (= 13 (+ V35 V36 V42))) ; Region 18
(assert (= 10 (+ V41 V48))) ; Region 19
(assert (= 10 (+ V43 V44 V45))) ; Region 20
(assert (= 11 (+ V46 V47))) ; Region 21
(check-sat)
