...
(assert (= 882 (* V0 V7 V14 V15))) ; Region 1
(assert (or (= 2 (/ V1 V8)) (= 2 (/ V8 V1)))) ; Region 2
(assert (= 36 (* V2 V3 V9))) ; Region 3
(assert (= 60 (* V4 V11 V12))) ; Region 4
(assert (= 35 (* V5 V6))) ; Region 5
(assert (= 240 (* V13 V17 V18 V19 V20))) ; Region 7
(assert (= 7 (* V16 V23))) ; Region 8
(assert (= 480 (* V21 V22 V28 V29 V30))) ; Region 9
(assert (or (= 3 (/ V24 V31)) (= 3 (/ V31 V24)))) ; Region 10
(assert (= 35 (* V25 V32 V39))) ; Region 11
(assert (or (= 3 (/ V26 V27)) (= 3 (/ V27 V26)))) ; Region 12
(assert (= 144 (* V33 V34 V40 V41))) ; Region 13
(assert (= 150 (* V35 V36 V42 V43))) ; Region 14
(assert (= 84 (* V37 V38 V44))) ; Region 15
(assert (or (= 3 (/ V45 V46)) (= 3 (/ V46 V45)))) ; Region 16
(assert (= 28 (* V47 V48))) ; Region 17
(check-sat)
