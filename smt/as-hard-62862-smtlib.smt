...
(assert (= 10 (+ V2 V8 V9))) ; Region 2
(assert (or (= 2 (- V4 V11)) (= 2 (- V11 V4)))) ; Region 4
(assert (= 9 (+ V5 V6))) ; Region 5
(assert (or (= 5 (- V7 V14)) (= 5 (- V14 V7)))) ; Region 6
(assert (or (= 4 (- V10 V17)) (= 4 (- V17 V10)))) ; Region 7
(assert (= 10 (+ V12 V13 V20))) ; Region 8
(assert (= 14 (+ V15 V21 V22))) ; Region 9
(assert (or (= 4 (- V16 V23)) (= 4 (- V23 V16)))) ; Region 10
(assert (= 14 (+ V19 V26 V27))) ; Region 12
(assert (= 3 (+ V24 V25))) ; Region 13
(assert (= 9 (+ V28 V29 V35))) ; Region 14
(assert (or (= 1 (- V30 V31)) (= 1 (- V31 V30)))) ; Region 15
(assert (or (= 4 (- V32 V39)) (= 4 (- V39 V32)))) ; Region 16
(assert (= 12 (+ V33 V40 V47 V48))) ; Region 17
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 18
(assert (= 18 (+ V36 V37 V38))) ; Region 19
(assert (= 10 (+ V42 V43 V44))) ; Region 20
