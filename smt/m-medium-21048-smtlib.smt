...
(assert (= 144 (* V0 V1 V2 V8))) ; Region 1
(assert (= 28 (* V3 V4 V11))) ; Region 2
(assert (= 70 (* V5 V12 V19 V20))) ; Region 3
(assert (= 15 (* V6 V13))) ; Region 4
(assert (= 24 (* V7 V14 V15))) ; Region 5
(assert (= 280 (* V9 V10 V16 V23))) ; Region 6
(assert (= 36 (* V17 V18 V24 V25))) ; Region 7
(assert (= 15 (* V21 V22))) ; Region 8
(assert (= 168 (* V26 V27 V33))) ; Region 9
(assert (= 30 (* V28 V29 V35))) ; Region 10
(assert (= 21 (* V30 V31))) ; Region 11
(assert (= 60 (* V32 V39 V46))) ; Region 12
(assert (= 8 (* V34 V40 V41))) ; Region 13
(assert (= 294 (* V36 V37 V42 V43))) ; Region 14
(assert (= 20 (* V38 V44 V45))) ; Region 15
(assert (= 18 (* V47 V48))) ; Region 16
(check-sat)
