...
(assert (= 35 (* V3 V4 V10))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (or (= 3 (/ V8 V15)) (= 3 (/ V15 V8)))) ; Region 5
(assert (= 15 (* V9 V16))) ; Region 6
(assert (or (= 2 (/ V11 V12)) (= 2 (/ V12 V11)))) ; Region 7
(assert (= 30 (* V13 V19 V20))) ; Region 8
(assert (= 7 (* V14 V21))) ; Region 9
(assert (= 112 (* V17 V18 V25))) ; Region 10
(assert (= 60 (* V22 V23 V24))) ; Region 11
(assert (= 30 (* V26 V32 V33))) ; Region 12
(assert (= 21 (* V27 V34))) ; Region 13
(assert (= 280 (* V28 V35 V42 V43))) ; Region 14
(assert (= 48 (* V29 V30 V31 V36))) ; Region 15
(assert (= 60 (* V37 V38 V44 V45))) ; Region 16
(assert (= 3 (* V39 V46))) ; Region 17
(assert (= 42 (* V40 V41 V47))) ; Region 18
(check-sat)
