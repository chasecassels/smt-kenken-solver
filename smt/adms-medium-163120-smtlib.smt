...
(assert (or (= 3 (- V0 V7)) (= 3 (- V7 V0)))) ; Region 1
(assert (= 24 (* V1 V8))) ; Region 2
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 3
(assert (= 12 (+ V4 V11 V18))) ; Region 4
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 5
(assert (or (= 3 (/ V9 V16)) (= 3 (/ V16 V9)))) ; Region 6
(assert (or (= 6 (- V10 V17)) (= 6 (- V17 V10)))) ; Region 7
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 8
(assert (or (= 2 (- V13 V20)) (= 2 (- V20 V13)))) ; Region 9
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 10
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 11
(assert (= 140 (* V23 V24 V30))) ; Region 12
(assert (= 3 (+ V25 V32))) ; Region 13
(assert (= 15 (+ V26 V27 V33 V34))) ; Region 14
(assert (= 10 (+ V28 V29 V35))) ; Region 15
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 16
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 18
(assert (= 168 (* V39 V40 V47))) ; Region 19
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 20
(assert (or (= 6 (- V42 V43)) (= 6 (- V43 V42)))) ; Region 21
(assert (or (= 1 (- V45 V46)) (= 1 (- V46 V45)))) ; Region 22
(check-sat)
