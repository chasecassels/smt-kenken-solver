...
(assert (= 294 (* V0 V1 V2 V9))) ; Region 1
(assert (= 15 (* V3 V4))) ; Region 2
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 3
(assert (= 600 (* V7 V8 V14 V15 V16))) ; Region 4
(assert (= 84 (* V10 V11 V12 V18))) ; Region 5
(assert (or (= 3 (/ V13 V20)) (= 3 (/ V20 V13)))) ; Region 6
(assert (= 12 (* V17 V24 V25))) ; Region 7
(assert (= 42 (* V19 V26 V33))) ; Region 8
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 9
(assert (= 20 (* V22 V23))) ; Region 10
(assert (= 105 (* V27 V34 V41 V48))) ; Region 11
(assert (= 12 (* V29 V30 V37))) ; Region 12
(assert (= 28 (* V31 V38))) ; Region 13
(assert (or (= 3 (/ V32 V39)) (= 3 (/ V39 V32)))) ; Region 14
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 15
(assert (= 84 (* V36 V43 V44))) ; Region 16
(assert (= 100 (* V40 V46 V47))) ; Region 17
(check-sat)
