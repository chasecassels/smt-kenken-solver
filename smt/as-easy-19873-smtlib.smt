...
(assert (= 7 (+ V4 V5))) ; Region 3
(assert (= 7 (+ V6 V12 V13))) ; Region 4
(assert (= 13 (+ V7 V8))) ; Region 5
(assert (= 8 (+ V9 V16 V23))) ; Region 6
(assert (= 5 (+ V10 V11))) ; Region 7
(assert (= 12 (+ V14 V15))) ; Region 8
(assert (or (= 3 (- V17 V24)) (= 3 (- V24 V17)))) ; Region 9
(assert (= 6 (+ V18 V19))) ; Region 10
(assert (= 8 (+ V20 V27))) ; Region 11
(assert (or (= 4 (- V21 V22)) (= 4 (- V22 V21)))) ; Region 12
(assert (= 11 (+ V25 V26))) ; Region 13
(assert (= 5 (+ V28 V35))) ; Region 14
(assert (= 3 (+ V29 V36))) ; Region 15
(assert (= 12 (+ V30 V37))) ; Region 16
(assert (or (= 6 (- V31 V32)) (= 6 (- V32 V31)))) ; Region 17
(assert (= 10 (+ V33 V34))) ; Region 18
(assert (= 15 (+ V38 V39 V45))) ; Region 19
(assert (= 9 (+ V40 V46 V47))) ; Region 20
(assert (or (= 4 (- V41 V48)) (= 4 (- V48 V41)))) ; Region 21
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 23
(check-sat)
