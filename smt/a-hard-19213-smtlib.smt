...
(assert (= 15 (+ V0 V7 V14))) ; Region 1
(assert (= 6 (+ V1 V2 V3))) ; Region 2
(assert (= 11 (+ V4 V11))) ; Region 3
(assert (= 13 (+ V5 V6 V12))) ; Region 4
(assert (= 8 (+ V8 V15))) ; Region 5
(assert (= 11 (+ V9 V10))) ; Region 6
(assert (= 4 (+ V13 V20))) ; Region 7
(assert (= 11 (+ V16 V23))) ; Region 8
(assert (= 10 (+ V17 V24 V25))) ; Region 9
(assert (= 8 (+ V19 V26))) ; Region 11
(assert (= 14 (+ V21 V22 V28 V29))) ; Region 12
(assert (= 13 (+ V27 V34))) ; Region 13
(assert (= 8 (+ V30 V37))) ; Region 14
(assert (= 10 (+ V31 V38 V39))) ; Region 15
(assert (= 9 (+ V32 V33))) ; Region 16
(assert (= 7 (+ V35 V36))) ; Region 17
(assert (= 9 (+ V40 V41))) ; Region 18
(assert (= 9 (+ V42 V43))) ; Region 19
(assert (= 16 (+ V44 V45 V46))) ; Region 20
(assert (= 3 (+ V47 V48))) ; Region 21
(check-sat)
