...
(assert (= 6 (+ V1 V8 V9))) ; Region 2
(assert (= 35 (* V2 V3))) ; Region 3
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 4
(assert (= 5 (+ V6 V13))) ; Region 5
(assert (= 13 (+ V10 V11 V18))) ; Region 6
(assert (= 54 (* V12 V19 V20))) ; Region 7
(assert (or (= 1 (- V14 V15)) (= 1 (- V15 V14)))) ; Region 8
(assert (or (= 6 (- V16 V17)) (= 6 (- V17 V16)))) ; Region 9
(assert (= 12 (+ V21 V28 V29))) ; Region 10
(assert (= 30 (* V22 V23))) ; Region 11
(assert (or (= 3 (/ V24 V25)) (= 3 (/ V25 V24)))) ; Region 12
(assert (or (= 6 (- V26 V33)) (= 6 (- V33 V26)))) ; Region 13
(assert (or (= 3 (/ V27 V34)) (= 3 (/ V34 V27)))) ; Region 14
(assert (= 32 (* V30 V31 V38))) ; Region 15
(assert (= 42 (* V32 V39))) ; Region 16
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 17
(assert (or (= 5 (- V36 V43)) (= 5 (- V43 V36)))) ; Region 18
(assert (= 12 (+ V37 V44 V45))) ; Region 19
(assert (= 15 (+ V40 V46 V47 V48))) ; Region 20
(check-sat)
