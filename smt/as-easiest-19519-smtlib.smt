...
(assert (= 18 (+ V0 V7 V8 V14))) ; Region 1
(assert (or (= 6 (- V1 V2)) (= 6 (- V2 V1)))) ; Region 2
(assert (= 8 (+ V3 V4))) ; Region 3
(assert (= 13 (+ V5 V12))) ; Region 4
(assert (= 7 (+ V6 V13))) ; Region 5
(assert (= 3 (+ V9 V10))) ; Region 6
(assert (= 10 (+ V15 V16))) ; Region 8
(assert (= 3 (+ V17 V18))) ; Region 9
(assert (= 10 (+ V19 V20))) ; Region 10
(assert (= 5 (+ V21 V22))) ; Region 11
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 12
(assert (= 13 (+ V25 V32))) ; Region 13
(assert (= 6 (+ V26 V33))) ; Region 14
(assert (= 3 (+ V27 V34))) ; Region 15
(assert (= 10 (+ V28 V29))) ; Region 16
(assert (= 12 (+ V30 V31 V38))) ; Region 17
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 18
(assert (= 7 (+ V36 V37))) ; Region 19
(assert (= 10 (+ V39 V40 V41))) ; Region 20
(assert (= 7 (+ V43 V44))) ; Region 21
(assert (= 11 (+ V45 V46))) ; Region 22
(assert (= 9 (+ V47 V48))) ; Region 23
(check-sat)
