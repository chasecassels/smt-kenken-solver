...
(assert (= 42 (* V0 V1 V2 V8))) ; Region 1
(assert (= 180 (* V3 V4 V11 V18))) ; Region 2
(assert (= 60 (* V5 V6 V13))) ; Region 3
(assert (= 30 (* V7 V14))) ; Region 4
(assert (= 168 (* V9 V10 V16 V23))) ; Region 5
(assert (= 7 (* V12 V19 V20))) ; Region 6
(assert (= 168 (* V15 V21 V22))) ; Region 7
(assert (= 20 (* V17 V24 V25))) ; Region 8
(assert (= 36 (* V26 V27 V34))) ; Region 9
(assert (= 4 (* V28 V29 V35))) ; Region 10
(assert (= 72 (* V30 V31 V38))) ; Region 11
(assert (= 35 (* V32 V33))) ; Region 12
(assert (= 35 (* V36 V37))) ; Region 13
(assert (= 12 (* V39 V45 V46))) ; Region 14
(assert (= 12 (* V40 V41))) ; Region 15
