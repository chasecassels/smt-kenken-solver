...
(assert (= 28 (* V2 V9 V10))) ; Region 2
(assert (= 24 (* V3 V4))) ; Region 3
(assert (= 20 (* V5 V6 V11 V12))) ; Region 4
(assert (= 18 (* V7 V8))) ; Region 5
(assert (= 120 (* V13 V20 V27))) ; Region 6
(assert (= 14 (* V14 V15 V21))) ; Region 7
(assert (= 6 (* V16 V17))) ; Region 8
(assert (= 20 (* V18 V19))) ; Region 9
(assert (= 140 (* V22 V28 V29 V30))) ; Region 10
(assert (= 30 (* V23 V24 V31))) ; Region 11
(assert (= 126 (* V25 V26 V33 V34))) ; Region 12
(assert (= 12 (* V32 V39))) ; Region 13
(assert (= 48 (* V35 V36 V43))) ; Region 14
(assert (= 30 (* V37 V38 V44))) ; Region 15
(assert (= 21 (* V40 V41 V48))) ; Region 16
(assert (= 84 (* V45 V46 V47))) ; Region 18
(check-sat)
