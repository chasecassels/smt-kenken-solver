...
(assert (= 16 (+ V21 V22 V29))) ; Region 12
(assert (= 7 (+ V24 V31))) ; Region 13
(assert (= 10 (+ V25 V26 V32))) ; Region 14
(assert (= 11 (+ V27 V34 V41))) ; Region 15
(assert (= 3 (+ V28 V35))) ; Region 16
(assert (= 11 (+ V30 V37))) ; Region 17
(assert (= 7 (+ V33 V40))) ; Region 18
(assert (= 14 (+ V36 V42 V43 V44))) ; Region 19
