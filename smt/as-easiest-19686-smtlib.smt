...
(assert (= 8 (+ V1 V2))) ; Region 2
(assert (= 3 (+ V3 V10))) ; Region 3
(assert (or (= 3 (- V4 V11)) (= 3 (- V11 V4)))) ; Region 4
(assert (= 9 (+ V5 V6 V13))) ; Region 5
(assert (= 19 (+ V8 V9 V15))) ; Region 6
(assert (= 9 (+ V12 V19))) ; Region 7
(assert (= 3 (+ V16 V23))) ; Region 8
(assert (= 7 (+ V17 V18))) ; Region 9
(assert (= 13 (+ V20 V27))) ; Region 10
(assert (= 12 (+ V21 V28 V29))) ; Region 11
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 13
(assert (= 3 (+ V26 V33))) ; Region 14
(assert (= 13 (+ V30 V31))) ; Region 15
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 16
(assert (= 3 (+ V35 V36))) ; Region 18
(assert (= 10 (+ V37 V38))) ; Region 19
(assert (= 10 (+ V40 V41 V48))) ; Region 20
(assert (or (= 5 (- V42 V43)) (= 5 (- V43 V42)))) ; Region 21
(assert (= 7 (+ V44 V45))) ; Region 22
(assert (= 12 (+ V46 V47))) ; Region 23
(check-sat)
