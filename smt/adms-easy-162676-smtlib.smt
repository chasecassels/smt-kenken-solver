...
(assert (= 210 (* V0 V1 V2))) ; Region 1
(assert (= 17 (+ V3 V9 V10 V17))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (= 15 (* V6 V13))) ; Region 4
(assert (= 3 (+ V7 V8))) ; Region 5
(assert (or (= 2 (/ V11 V12)) (= 2 (/ V12 V11)))) ; Region 6
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 7
(assert (or (= 1 (- V15 V16)) (= 1 (- V16 V15)))) ; Region 8
(assert (= 11 (+ V18 V19 V20))) ; Region 9
(assert (or (= 2 (/ V22 V23)) (= 2 (/ V23 V22)))) ; Region 10
(assert (= 15 (* V24 V31 V38))) ; Region 11
(assert (or (= 2 (- V25 V26)) (= 2 (- V26 V25)))) ; Region 12
(assert (= 24 (* V27 V34))) ; Region 13
(assert (or (= 3 (/ V28 V29)) (= 3 (/ V29 V28)))) ; Region 14
(assert (or (= 6 (- V30 V37)) (= 6 (- V37 V30)))) ; Region 15
(assert (= 10 (+ V32 V33 V39))) ; Region 16
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 17
(assert (or (= 4 (- V36 V43)) (= 4 (- V43 V36)))) ; Region 18
(assert (= 9 (+ V41 V48))) ; Region 20
(assert (or (= 3 (/ V44 V45)) (= 3 (/ V45 V44)))) ; Region 21
(assert (or (= 4 (- V46 V47)) (= 4 (- V47 V46)))) ; Region 22
(check-sat)
