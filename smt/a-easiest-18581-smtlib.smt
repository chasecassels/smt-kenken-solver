...
(assert (= 17 (+ V1 V2 V8))) ; Region 2
(assert (= 8 (+ V3 V10))) ; Region 3
(assert (= 5 (+ V4 V5))) ; Region 4
(assert (= 3 (+ V6 V13))) ; Region 5
(assert (= 9 (+ V9 V16))) ; Region 6
(assert (= 11 (+ V11 V18))) ; Region 7
(assert (= 3 (+ V12 V19))) ; Region 8
(assert (= 5 (+ V14 V15))) ; Region 9
(assert (= 12 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 16 (+ V22 V29 V30))) ; Region 13
(assert (= 7 (+ V24 V25))) ; Region 15
(assert (= 12 (+ V26 V33))) ; Region 16
(assert (= 9 (+ V31 V32))) ; Region 17
(assert (= 13 (+ V34 V41 V48))) ; Region 18
(assert (= 6 (+ V35 V36))) ; Region 19
(assert (= 10 (+ V37 V38))) ; Region 20
(assert (= 8 (+ V39 V40))) ; Region 21
(assert (= 12 (+ V42 V43))) ; Region 22
(assert (= 3 (+ V44 V45))) ; Region 23
(assert (= 7 (+ V46 V47))) ; Region 24
(check-sat)
