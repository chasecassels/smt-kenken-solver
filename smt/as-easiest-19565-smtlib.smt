...
(assert (= 8 (+ V0 V7))) ; Region 1
(assert (= 7 (+ V1 V2))) ; Region 2
(assert (= 5 (+ V3 V4))) ; Region 3
(assert (= 6 (+ V6 V13))) ; Region 5
(assert (or (= 1 (- V8 V15)) (= 1 (- V15 V8)))) ; Region 6
(assert (= 13 (+ V9 V10))) ; Region 7
(assert (or (= 4 (- V11 V12)) (= 4 (- V12 V11)))) ; Region 8
(assert (or (= 5 (- V16 V17)) (= 5 (- V17 V16)))) ; Region 10
(assert (= 9 (+ V18 V25))) ; Region 11
(assert (= 9 (+ V19 V20))) ; Region 12
(assert (or (= 3 (- V21 V28)) (= 3 (- V28 V21)))) ; Region 13
(assert (= 3 (+ V22 V29))) ; Region 14
(assert (= 16 (+ V23 V24 V31))) ; Region 15
(assert (or (= 6 (- V26 V27)) (= 6 (- V27 V26)))) ; Region 16
(assert (= 9 (+ V30 V37 V44))) ; Region 17
(assert (or (= 4 (- V33 V40)) (= 4 (- V40 V33)))) ; Region 19
(assert (= 9 (+ V34 V41))) ; Region 20
(assert (or (= 3 (- V35 V36)) (= 3 (- V36 V35)))) ; Region 21
(assert (or (= 6 (- V38 V39)) (= 6 (- V39 V38)))) ; Region 22
(assert (= 13 (+ V42 V43))) ; Region 23
(assert (= 9 (+ V45 V46))) ; Region 24
(assert (= 4 (+ V47 V48))) ; Region 25
(check-sat)
