...
(assert (= 70 (* V0 V1 V7))) ; Region 1
(assert (= 8 (* V2 V3 V9))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 5
(assert (or (= 3 (- V10 V11)) (= 3 (- V11 V10)))) ; Region 6
(assert (or (= 2 (- V13 V20)) (= 2 (- V20 V13)))) ; Region 8
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 9
(assert (or (= 4 (- V16 V17)) (= 4 (- V17 V16)))) ; Region 10
(assert (or (= 1 (- V18 V19)) (= 1 (- V19 V18)))) ; Region 11
(assert (= 17 (+ V22 V23 V28 V29))) ; Region 12
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 13
(assert (or (= 3 (- V25 V26)) (= 3 (- V26 V25)))) ; Region 14
(assert (= 8 (+ V27 V34))) ; Region 15
(assert (= 14 (+ V30 V37 V44))) ; Region 16
(assert (= 3 (+ V32 V39))) ; Region 17
(assert (= 8 (+ V33 V40))) ; Region 18
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 19
(assert (or (= 1 (- V36 V43)) (= 1 (- V43 V36)))) ; Region 20
(assert (or (= 2 (/ V38 V45)) (= 2 (/ V45 V38)))) ; Region 21
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 22
(assert (or (= 3 (- V46 V47)) (= 3 (- V47 V46)))) ; Region 23
(check-sat)
