...
(assert (= 13 (+ V1 V8))) ; Region 2
(assert (= 30 (* V2 V3 V10 V11))) ; Region 3
(assert (or (= 6 (- V4 V5)) (= 6 (- V5 V4)))) ; Region 4
(assert (= 17 (+ V6 V12 V13 V19))) ; Region 5
(assert (= 140 (* V9 V16 V17))) ; Region 6
(assert (= 20 (* V14 V21))) ; Region 7
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 8
(assert (= 3 (+ V18 V25))) ; Region 9
(assert (or (= 3 (/ V20 V27)) (= 3 (/ V27 V20)))) ; Region 10
(assert (= 72 (* V23 V24 V31))) ; Region 11
(assert (= 12 (+ V26 V33))) ; Region 12
(assert (or (= 6 (- V28 V35)) (= 6 (- V35 V28)))) ; Region 13
(assert (or (= 3 (/ V29 V30)) (= 3 (/ V30 V29)))) ; Region 14
(assert (= 10 (+ V32 V39))) ; Region 15
(assert (or (= 3 (/ V34 V41)) (= 3 (/ V41 V34)))) ; Region 16
(assert (or (= 2 (- V36 V37)) (= 2 (- V37 V36)))) ; Region 17
(assert (= 13 (+ V38 V45 V46))) ; Region 18
(assert (= 14 (+ V40 V47 V48))) ; Region 19
