...
(assert (= 6 (+ V10 V11))) ; Region 7
(assert (= 12 (+ V15 V22 V23 V29))) ; Region 9
(assert (or (= 4 (- V16 V17)) (= 4 (- V17 V16)))) ; Region 10
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 12
(assert (= 13 (+ V24 V25))) ; Region 13
(assert (or (= 3 (- V26 V27)) (= 3 (- V27 V26)))) ; Region 14
(assert (= 13 (+ V30 V37))) ; Region 16
(assert (= 5 (+ V31 V38))) ; Region 17
(assert (= 16 (+ V32 V33 V34))) ; Region 18
(assert (= 17 (+ V35 V36 V42))) ; Region 19
(assert (= 5 (+ V39 V40))) ; Region 20
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 22
(assert (= 7 (+ V45 V46))) ; Region 23
