...
(assert (= 42 (* V0 V7 V8))) ; Region 1
(assert (= 24 (* V1 V2))) ; Region 2
(assert (= 15 (* V3 V10))) ; Region 3
(assert (= 70 (* V4 V11 V12))) ; Region 4
(assert (= 48 (* V6 V13 V20))) ; Region 6
(assert (= 21 (* V9 V15 V16))) ; Region 7
(assert (= 35 (* V14 V21))) ; Region 8
(assert (= 12 (* V17 V24 V25))) ; Region 9
(assert (= 40 (* V18 V19 V26))) ; Region 10
(assert (= 8 (* V22 V29))) ; Region 11
(assert (= 15 (* V23 V30))) ; Region 12
(assert (= 7 (* V27 V34))) ; Region 13
(assert (= 24 (* V28 V35 V42))) ; Region 14
(assert (= 168 (* V31 V38 V45))) ; Region 15
(assert (= 4 (* V32 V33 V39))) ; Region 16
(assert (= 12 (* V37 V43 V44))) ; Region 18
(assert (= 21 (* V40 V41))) ; Region 19
