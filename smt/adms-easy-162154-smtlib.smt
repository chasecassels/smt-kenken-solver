...
(assert (= 350 (* V0 V1 V2 V7))) ; Region 1
(assert (= 11 (+ V3 V4 V5))) ; Region 2
(assert (= 360 (* V6 V13 V20 V27))) ; Region 3
(assert (= 13 (+ V8 V15))) ; Region 4
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 5
(assert (= 3 (+ V10 V11))) ; Region 6
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 7
(assert (= 8 (+ V14 V21 V22))) ; Region 8
(assert (or (= 3 (- V17 V18)) (= 3 (- V18 V17)))) ; Region 9
(assert (= 10 (+ V23 V30 V37))) ; Region 10
(assert (or (= 3 (/ V24 V31)) (= 3 (/ V31 V24)))) ; Region 11
(assert (or (= 2 (- V25 V26)) (= 2 (- V26 V25)))) ; Region 12
(assert (or (= 4 (- V28 V35)) (= 4 (- V35 V28)))) ; Region 13
(assert (= 10 (+ V29 V36 V42 V43))) ; Region 14
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 15
(assert (= 13 (+ V33 V34 V41))) ; Region 16
(assert (= 105 (* V38 V44 V45))) ; Region 17
(assert (or (= 2 (/ V46 V47)) (= 2 (/ V47 V46)))) ; Region 19
(check-sat)
