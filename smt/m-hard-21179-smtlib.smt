...
(assert (= 30 (* V2 V8 V9))) ; Region 2
(assert (= 210 (* V3 V4 V10))) ; Region 3
(assert (= 48 (* V5 V6 V12))) ; Region 4
(assert (= 105 (* V11 V17 V18))) ; Region 5
(assert (= 42 (* V13 V19 V20))) ; Region 6
(assert (= 48 (* V14 V15 V16 V22 V23))) ; Region 7
(assert (= 60 (* V21 V28 V35))) ; Region 8
(assert (= 12 (* V24 V25 V31))) ; Region 9
(assert (= 105 (* V26 V27 V34))) ; Region 10
(assert (= 294 (* V29 V30 V37))) ; Region 11
(assert (= 8 (* V32 V33))) ; Region 12
(assert (= 420 (* V36 V42 V43 V44))) ; Region 13
(assert (= 12 (* V38 V45 V46))) ; Region 14
(assert (= 40 (* V39 V40 V41 V48))) ; Region 15
(check-sat)
