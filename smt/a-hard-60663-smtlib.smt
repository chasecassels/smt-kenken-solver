...
(assert (= 5 (+ V4 V11))) ; Region 3
(assert (= 12 (+ V5 V12))) ; Region 4
(assert (= 13 (+ V6 V13))) ; Region 5
(assert (= 5 (+ V7 V8))) ; Region 6
(assert (= 7 (+ V14 V21))) ; Region 8
(assert (= 9 (+ V15 V16))) ; Region 9
(assert (= 10 (+ V17 V23 V24))) ; Region 10
(assert (= 14 (+ V18 V19 V25))) ; Region 11
(assert (= 7 (+ V20 V27))) ; Region 12
(assert (= 10 (+ V22 V29 V36))) ; Region 13
(assert (= 7 (+ V26 V33))) ; Region 14
(assert (= 16 (+ V28 V35 V42))) ; Region 15
(assert (= 12 (+ V30 V31 V32))) ; Region 16
(assert (= 8 (+ V34 V41 V48))) ; Region 17
(assert (= 18 (+ V37 V38 V39))) ; Region 18
(assert (= 5 (+ V40 V47))) ; Region 19
(assert (= 13 (+ V44 V45 V46))) ; Region 21
(check-sat)
