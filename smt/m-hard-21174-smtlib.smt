...
(assert (= 126 (* V0 V1 V2 V7))) ; Region 1
(assert (= 120 (* V3 V4 V5 V6 V10))) ; Region 2
(assert (= 14 (* V8 V9))) ; Region 3
(assert (= 42 (* V11 V18 V19))) ; Region 4
(assert (= 240 (* V12 V13 V20 V27))) ; Region 5
(assert (= 168 (* V14 V15 V21 V22))) ; Region 6
(assert (= 20 (* V16 V23))) ; Region 7
(assert (= 30 (* V17 V24 V25))) ; Region 8
(assert (= 105 (* V26 V33 V34 V40))) ; Region 9
(assert (= 240 (* V28 V29 V35 V42))) ; Region 10
(assert (= 18 (* V30 V37))) ; Region 11
(assert (= 56 (* V31 V32 V38))) ; Region 12
(assert (= 30 (* V36 V43 V44 V45))) ; Region 13
(assert (= 12 (* V39 V46))) ; Region 14
(assert (= 21 (* V41 V48))) ; Region 15
(check-sat)
