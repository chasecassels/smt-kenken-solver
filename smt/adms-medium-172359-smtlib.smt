...
(assert (= 42 (* V3 V10 V17))) ; Region 3
(assert (= 15 (* V4 V11 V12))) ; Region 4
(assert (= 84 (* V5 V6 V13))) ; Region 5
(assert (= 12 (+ V7 V14 V21))) ; Region 6
(assert (or (= 3 (/ V8 V9)) (= 3 (/ V9 V8)))) ; Region 7
(assert (= 11 (+ V15 V16))) ; Region 8
(assert (or (= 1 (- V18 V19)) (= 1 (- V19 V18)))) ; Region 9
(assert (or (= 4 (- V20 V27)) (= 4 (- V27 V20)))) ; Region 10
(assert (= 180 (* V22 V23 V29 V30 V36))) ; Region 11
(assert (or (= 2 (- V24 V31)) (= 2 (- V31 V24)))) ; Region 12
(assert (= 18 (+ V25 V26 V32))) ; Region 13
(assert (= 84 (* V28 V35 V42))) ; Region 14
(assert (= 3 (+ V33 V40))) ; Region 15
(assert (= 13 (+ V34 V41 V48))) ; Region 16
(assert (= 15 (+ V37 V38 V39))) ; Region 17
(assert (= 126 (* V43 V44 V45 V46))) ; Region 18
(check-sat)
