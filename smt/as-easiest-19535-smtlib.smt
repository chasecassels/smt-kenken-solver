...
(assert (= 10 (+ V0 V1))) ; Region 1
(assert (= 8 (+ V2 V3))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (= 10 (+ V6 V13))) ; Region 4
(assert (or (= 6 (- V7 V8)) (= 6 (- V8 V7)))) ; Region 5
(assert (or (= 4 (- V9 V10)) (= 4 (- V10 V9)))) ; Region 6
(assert (= 9 (+ V11 V12))) ; Region 7
(assert (or (= 4 (- V14 V21)) (= 4 (- V21 V14)))) ; Region 8
(assert (or (= 1 (- V15 V22)) (= 1 (- V22 V15)))) ; Region 9
(assert (= 13 (+ V16 V17))) ; Region 10
(assert (= 8 (+ V18 V25))) ; Region 11
(assert (= 5 (+ V19 V20))) ; Region 12
(assert (= 9 (+ V23 V24 V30))) ; Region 13
(assert (= 13 (+ V26 V27))) ; Region 14
(assert (= 9 (+ V28 V29))) ; Region 15
(assert (= 6 (+ V31 V38))) ; Region 16
(assert (= 13 (+ V32 V39))) ; Region 17
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 18
(assert (= 18 (+ V35 V36 V42 V43))) ; Region 19
(assert (or (= 6 (- V37 V44)) (= 6 (- V44 V37)))) ; Region 20
(assert (= 7 (+ V40 V41))) ; Region 21
(assert (= 6 (+ V45 V46))) ; Region 22
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 23
(check-sat)
