...
(assert (= 12 (* V3 V9 V10))) ; Region 2
(assert (= 12 (* V4 V5 V11))) ; Region 3
(assert (= 84 (* V7 V8 V14 V15))) ; Region 5
(assert (= 10 (* V12 V13))) ; Region 6
(assert (= 15 (* V16 V23))) ; Region 7
(assert (= 14 (* V17 V18))) ; Region 8
(assert (= 30 (* V19 V20))) ; Region 9
(assert (= 180 (* V21 V22 V28 V35))) ; Region 10
(assert (= 12 (* V24 V31 V32))) ; Region 11
(assert (= 168 (* V25 V26 V27 V33))) ; Region 12
(assert (= 14 (* V29 V30))) ; Region 13
(assert (= 36 (* V34 V40 V41))) ; Region 14
(assert (= 12 (* V36 V42 V43))) ; Region 15
(assert (= 28 (* V37 V44 V45))) ; Region 16
(assert (= 175 (* V38 V39 V46))) ; Region 17
(assert (= 12 (* V47 V48))) ; Region 18
(check-sat)
