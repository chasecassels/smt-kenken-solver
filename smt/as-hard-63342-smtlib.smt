...
(assert (= 9 (+ V0 V7 V14))) ; Region 1
(assert (= 11 (+ V1 V8))) ; Region 2
(assert (or (= 1 (- V2 V3)) (= 1 (- V3 V2)))) ; Region 3
(assert (= 20 (+ V4 V5 V11 V18))) ; Region 4
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 5
(assert (= 5 (+ V9 V10))) ; Region 6
(assert (= 6 (+ V12 V19 V26))) ; Region 7
(assert (= 17 (+ V15 V21 V22))) ; Region 8
(assert (= 10 (+ V16 V17 V23))) ; Region 9
(assert (= 6 (+ V20 V27))) ; Region 10
(assert (or (= 4 (- V24 V25)) (= 4 (- V25 V24)))) ; Region 11
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 12
(assert (= 10 (+ V30 V37))) ; Region 13
(assert (= 12 (+ V31 V32))) ; Region 14
(assert (= 13 (+ V33 V40))) ; Region 15
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 16
(assert (or (= 2 (- V35 V36)) (= 2 (- V36 V35)))) ; Region 17
(assert (= 4 (+ V38 V39))) ; Region 18
(assert (= 14 (+ V43 V44 V45 V46))) ; Region 20
