...
(assert (= 210 (* V1 V2 V3))) ; Region 2
(assert (or (= 3 (/ V4 V5)) (= 3 (/ V5 V4)))) ; Region 3
(assert (= 12 (* V6 V13))) ; Region 4
(assert (= 84 (* V8 V14 V15))) ; Region 5
(assert (or (= 3 (/ V9 V10)) (= 3 (/ V10 V9)))) ; Region 6
(assert (= 70 (* V11 V12 V18))) ; Region 7
(assert (= 84 (* V16 V17 V22 V23))) ; Region 8
(assert (= 120 (* V19 V20 V26))) ; Region 9
(assert (= 40 (* V21 V28 V29 V36))) ; Region 10
(assert (= 12 (* V25 V32 V33))) ; Region 12
(assert (= 12 (* V27 V34 V41))) ; Region 13
(assert (= 63 (* V30 V31 V37))) ; Region 14
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 15
(assert (= 168 (* V38 V39 V45 V46))) ; Region 16
(assert (= 70 (* V40 V47 V48))) ; Region 17
(assert (= 20 (* V43 V44))) ; Region 18
(check-sat)
