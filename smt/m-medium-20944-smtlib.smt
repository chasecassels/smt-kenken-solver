...
(assert (= 24 (* V3 V4 V11 V12))) ; Region 3
(assert (= 210 (* V5 V6 V13))) ; Region 4
(assert (= 10 (* V7 V8 V14))) ; Region 5
(assert (= 210 (* V15 V21 V22 V23))) ; Region 6
(assert (= 18 (* V16 V17))) ; Region 7
(assert (= 140 (* V18 V19 V20 V25))) ; Region 8
(assert (= 80 (* V24 V31 V38 V39))) ; Region 9
(assert (= 24 (* V26 V27 V34))) ; Region 10
(assert (= 168 (* V28 V35 V36))) ; Region 11
(assert (= 168 (* V29 V30 V37 V43 V44))) ; Region 12
(assert (= 6 (* V32 V33))) ; Region 13
(assert (= 630 (* V40 V45 V46 V47))) ; Region 14
