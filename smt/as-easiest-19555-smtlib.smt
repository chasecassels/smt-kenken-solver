...
(assert (= 4 (+ V5 V6 V12))) ; Region 4
(assert (= 13 (+ V7 V8))) ; Region 5
(assert (or (= 1 (- V11 V18)) (= 1 (- V18 V11)))) ; Region 6
(assert (= 8 (+ V13 V20))) ; Region 7
(assert (or (= 2 (- V14 V15)) (= 2 (- V15 V14)))) ; Region 8
(assert (= 13 (+ V16 V17))) ; Region 9
(assert (= 11 (+ V21 V22 V28))) ; Region 11
(assert (= 3 (+ V24 V31))) ; Region 13
(assert (= 10 (+ V25 V32))) ; Region 14
(assert (= 10 (+ V26 V27))) ; Region 15
(assert (= 10 (+ V29 V36 V43))) ; Region 16
(assert (= 3 (+ V30 V37))) ; Region 17
(assert (= 11 (+ V33 V40))) ; Region 18
(assert (= 10 (+ V34 V41))) ; Region 19
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 20
(assert (or (= 2 (- V38 V39)) (= 2 (- V39 V38)))) ; Region 21
(assert (or (= 4 (- V44 V45)) (= 4 (- V45 V44)))) ; Region 22
(assert (= 11 (+ V46 V47))) ; Region 23
(check-sat)
