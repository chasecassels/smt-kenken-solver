...
(assert (= 504 (* V0 V1 V2 V7 V9))) ; Region 1
(assert (= 10 (* V3 V4 V10))) ; Region 2
(assert (= 24 (* V5 V6))) ; Region 3
(assert (= 140 (* V8 V14 V15 V21))) ; Region 4
(assert (= 240 (* V11 V12 V18 V25 V26))) ; Region 5
(assert (= 126 (* V13 V19 V20))) ; Region 6
(assert (= 210 (* V16 V17 V23 V24))) ; Region 7
(assert (= 96 (* V22 V29 V36 V37))) ; Region 8
(assert (= 6 (* V27 V33 V34))) ; Region 9
(assert (= 630 (* V28 V35 V42 V43 V44))) ; Region 10
(assert (= 20 (* V30 V31))) ; Region 11
(assert (= 42 (* V32 V39))) ; Region 12
(assert (= 18 (* V38 V45 V46))) ; Region 13
(assert (= 28 (* V40 V41 V47))) ; Region 14
(check-sat)
