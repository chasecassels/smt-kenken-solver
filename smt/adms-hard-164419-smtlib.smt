...
(assert (= 42 (* V2 V3 V4))) ; Region 2
(assert (or (= 5 (- V5 V12)) (= 5 (- V12 V5)))) ; Region 3
(assert (= 7 (+ V6 V13))) ; Region 4
(assert (= 5 (+ V7 V8 V14))) ; Region 5
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 6
(assert (= 12 (+ V10 V11))) ; Region 7
(assert (or (= 4 (- V15 V22)) (= 4 (- V22 V15)))) ; Region 8
(assert (= 15 (+ V17 V18 V19))) ; Region 9
(assert (or (= 6 (- V20 V27)) (= 6 (- V27 V20)))) ; Region 10
(assert (= 40 (* V21 V28 V29))) ; Region 11
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 12
(assert (= 10 (+ V25 V31 V32))) ; Region 13
(assert (or (= 4 (- V26 V33)) (= 4 (- V33 V26)))) ; Region 14
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 15
(assert (= 12 (+ V34 V40 V41))) ; Region 16
(assert (= 20 (+ V35 V36 V42 V43))) ; Region 17
(assert (or (= 3 (- V38 V45)) (= 3 (- V45 V38)))) ; Region 18
(assert (= 6 (+ V39 V46))) ; Region 19
