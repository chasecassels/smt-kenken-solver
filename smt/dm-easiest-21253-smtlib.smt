...
(assert (= 35 (* V5 V6))) ; Region 4
(assert (= 24 (* V8 V9))) ; Region 5
(assert (= 5 (* V10 V11))) ; Region 6
(assert (= 21 (* V12 V13 V20))) ; Region 7
(assert (= 35 (* V14 V21))) ; Region 8
(assert (= 21 (* V15 V16))) ; Region 9
(assert (= 24 (* V17 V18))) ; Region 10
(assert (= 6 (* V19 V26))) ; Region 11
(assert (= 140 (* V22 V23 V30))) ; Region 12
(assert (= 8 (* V24 V31))) ; Region 13
(assert (or (= 3 (/ V25 V32)) (= 3 (/ V32 V25)))) ; Region 14
(assert (= 60 (* V27 V34 V41))) ; Region 15
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 16
(assert (= 24 (* V33 V40))) ; Region 17
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 18
(assert (= 35 (* V37 V38 V39))) ; Region 20
(assert (= 105 (* V43 V44 V45))) ; Region 21
(assert (= 8 (* V46 V47 V48))) ; Region 22
(check-sat)
