...
(assert (= 6 (+ V0 V7 V8))) ; Region 1
(assert (or (= 3 (- V2 V9)) (= 3 (- V9 V2)))) ; Region 3
(assert (or (= 1 (- V3 V10)) (= 1 (- V10 V3)))) ; Region 4
(assert (or (= 1 (- V4 V5)) (= 1 (- V5 V4)))) ; Region 5
(assert (= 7 (+ V6 V13))) ; Region 6
(assert (or (= 1 (- V11 V12)) (= 1 (- V12 V11)))) ; Region 7
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 8
(assert (or (= 4 (- V15 V16)) (= 4 (- V16 V15)))) ; Region 9
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 10
(assert (= 14 (+ V18 V19 V26))) ; Region 11
(assert (= 7 (+ V20 V27))) ; Region 12
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 13
(assert (= 8 (+ V23 V30))) ; Region 14
(assert (or (= 2 (- V25 V32)) (= 2 (- V32 V25)))) ; Region 15
(assert (or (= 1 (- V28 V35)) (= 1 (- V35 V28)))) ; Region 16
(assert (= 4 (+ V31 V38))) ; Region 17
(assert (= 17 (+ V33 V34 V41))) ; Region 18
(assert (= 3 (+ V36 V37))) ; Region 19
(assert (= 11 (+ V39 V46))) ; Region 20
(assert (or (= 3 (- V42 V43)) (= 3 (- V43 V42)))) ; Region 22
(assert (or (= 2 (- V44 V45)) (= 2 (- V45 V44)))) ; Region 23
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 24
(check-sat)
