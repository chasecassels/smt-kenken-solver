...
(assert (= 11 (+ V2 V3))) ; Region 2
(assert (or (= 5 (- V4 V5)) (= 5 (- V5 V4)))) ; Region 3
(assert (= 5 (+ V6 V13))) ; Region 4
(assert (= 8 (+ V7 V14))) ; Region 5
(assert (or (= 5 (- V8 V9)) (= 5 (- V9 V8)))) ; Region 6
(assert (= 8 (+ V10 V11))) ; Region 7
(assert (or (= 6 (- V12 V19)) (= 6 (- V19 V12)))) ; Region 8
(assert (= 3 (+ V15 V22))) ; Region 9
(assert (or (= 3 (- V16 V17)) (= 3 (- V17 V16)))) ; Region 10
(assert (= 12 (+ V18 V25 V26))) ; Region 11
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 12
(assert (or (= 6 (- V23 V30)) (= 6 (- V30 V23)))) ; Region 14
(assert (or (= 2 (- V24 V31)) (= 2 (- V31 V24)))) ; Region 15
(assert (= 12 (+ V28 V29))) ; Region 16
(assert (= 7 (+ V33 V34))) ; Region 18
(assert (= 8 (+ V35 V42))) ; Region 19
(assert (= 9 (+ V36 V37))) ; Region 20
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 21
(assert (= 8 (+ V39 V40))) ; Region 22
(assert (= 10 (+ V43 V44))) ; Region 24
(assert (= 6 (+ V46 V47 V48))) ; Region 25
(check-sat)
