...
(assert (= 10 (+ V4 V11))) ; Region 4
(assert (= 4 (+ V5 V12))) ; Region 5
(assert (= 8 (+ V8 V9 V16))) ; Region 7
(assert (= 6 (+ V13 V20))) ; Region 8
(assert (= 16 (+ V14 V21 V22))) ; Region 9
(assert (= 15 (+ V17 V18 V19))) ; Region 11
(assert (or (= 1 (- V23 V30)) (= 1 (- V30 V23)))) ; Region 12
(assert (or (= 4 (- V24 V25)) (= 4 (- V25 V24)))) ; Region 13
(assert (= 17 (+ V26 V27 V34 V41))) ; Region 14
(assert (or (= 1 (- V28 V29)) (= 1 (- V29 V28)))) ; Region 15
(assert (= 18 (+ V31 V32 V33))) ; Region 16
(assert (= 10 (+ V35 V42))) ; Region 17
(assert (or (= 2 (- V36 V43)) (= 2 (- V43 V36)))) ; Region 18
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 19
(assert (or (= 1 (- V38 V45)) (= 1 (- V45 V38)))) ; Region 20
(assert (= 6 (+ V39 V40))) ; Region 21
(assert (= 11 (+ V46 V47 V48))) ; Region 22
(check-sat)
