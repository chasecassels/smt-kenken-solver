...
(assert (or (= 4 (- V3 V4)) (= 4 (- V4 V3)))) ; Region 3
(assert (= 24 (* V5 V12))) ; Region 4
(assert (= 280 (* V6 V13 V19 V20))) ; Region 5
(assert (or (= 3 (/ V8 V9)) (= 3 (/ V9 V8)))) ; Region 6
(assert (or (= 5 (- V10 V11)) (= 5 (- V11 V10)))) ; Region 7
(assert (= 3 (+ V15 V16))) ; Region 8
(assert (= 14 (+ V17 V18 V25))) ; Region 9
(assert (= 5 (+ V21 V28))) ; Region 10
(assert (= 12 (+ V22 V23 V29))) ; Region 11
(assert (= 30 (* V24 V30 V31))) ; Region 12
(assert (= 13 (+ V27 V34))) ; Region 14
(assert (= 12 (+ V32 V33 V39 V40))) ; Region 15
(assert (= 5 (+ V35 V42))) ; Region 16
(assert (or (= 2 (- V36 V43)) (= 2 (- V43 V36)))) ; Region 17
(assert (= 28 (* V37 V44))) ; Region 18
(assert (= 15 (+ V38 V45 V46))) ; Region 19
(assert (= 3 (* V41 V47 V48))) ; Region 20
(check-sat)
