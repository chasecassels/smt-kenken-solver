...
(assert (= 14 (+ V3 V9 V10))) ; Region 2
(assert (= 7 (+ V4 V5 V11))) ; Region 3
(assert (= 9 (+ V6 V13 V20))) ; Region 4
(assert (= 9 (+ V7 V8 V14))) ; Region 5
(assert (= 13 (+ V12 V19 V26))) ; Region 6
(assert (= 11 (+ V15 V16 V23 V30))) ; Region 7
(assert (= 9 (+ V17 V24))) ; Region 8
(assert (= 10 (+ V18 V25))) ; Region 9
(assert (= 8 (+ V21 V28))) ; Region 10
(assert (= 5 (+ V22 V29))) ; Region 11
(assert (= 13 (+ V27 V34))) ; Region 12
(assert (= 3 (+ V31 V38))) ; Region 13
(assert (= 12 (+ V32 V33))) ; Region 14
(assert (= 7 (+ V35 V36))) ; Region 15
(assert (= 10 (+ V37 V44))) ; Region 16
(assert (= 11 (+ V39 V40))) ; Region 17
(assert (= 6 (+ V41 V48))) ; Region 18
(assert (= 12 (+ V42 V43))) ; Region 19
(assert (= 9 (+ V45 V46 V47))) ; Region 20
(check-sat)
