...
(assert (= 18 (* V0 V1))) ; Region 1
(assert (= 105 (* V2 V9 V16))) ; Region 2
(assert (= 10 (* V3 V10 V11))) ; Region 3
(assert (= 20 (* V4 V5))) ; Region 4
(assert (= 42 (* V6 V12 V13))) ; Region 5
(assert (= 8 (* V7 V8 V14))) ; Region 6
(assert (= 245 (* V15 V21 V22))) ; Region 7
(assert (= 24 (* V18 V19 V25))) ; Region 9
(assert (= 48 (* V20 V26 V27))) ; Region 10
(assert (= 24 (* V23 V30))) ; Region 11
(assert (= 21 (* V24 V31 V32))) ; Region 12
(assert (= 8 (* V28 V29 V36))) ; Region 13
(assert (= 90 (* V33 V34 V40))) ; Region 14
(assert (= 15 (* V35 V42))) ; Region 15
(assert (= 12 (* V37 V43 V44))) ; Region 16
(assert (= 24 (* V38 V45))) ; Region 17
(assert (= 35 (* V39 V46 V47))) ; Region 18
