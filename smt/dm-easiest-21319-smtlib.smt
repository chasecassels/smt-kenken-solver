...
(assert (= 15 (* V4 V11))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 5
(assert (= 36 (* V8 V15 V16))) ; Region 6
(assert (= 35 (* V9 V10))) ; Region 7
(assert (= 42 (* V12 V13 V20))) ; Region 8
(assert (= 8 (* V17 V18 V24))) ; Region 9
(assert (= 24 (* V21 V22))) ; Region 11
(assert (or (= 2 (/ V23 V30)) (= 2 (/ V30 V23)))) ; Region 12
(assert (= 15 (* V26 V27))) ; Region 14
(assert (= 35 (* V28 V29 V36))) ; Region 15
(assert (or (= 3 (/ V31 V38)) (= 3 (/ V38 V31)))) ; Region 16
(assert (= 12 (* V32 V39))) ; Region 17
(assert (= 12 (* V33 V34))) ; Region 18
(assert (= 20 (* V37 V44))) ; Region 20
(assert (= 28 (* V40 V46 V47))) ; Region 21
(assert (= 12 (* V41 V48))) ; Region 22
(assert (= 18 (* V42 V43))) ; Region 23
(check-sat)
