...
(assert (= 14 (+ V4 V5 V6))) ; Region 3
(assert (= 10 (+ V8 V15))) ; Region 4
(assert (= 14 (+ V9 V16 V23))) ; Region 5
(assert (= 4 (+ V10 V11))) ; Region 6
(assert (= 10 (+ V12 V18 V19))) ; Region 7
(assert (= 10 (+ V13 V20))) ; Region 8
(assert (= 12 (+ V14 V21))) ; Region 9
(assert (= 10 (+ V17 V24))) ; Region 10
(assert (= 3 (+ V22 V29))) ; Region 11
(assert (= 9 (+ V25 V26))) ; Region 12
(assert (= 19 (+ V28 V35 V36 V42))) ; Region 14
(assert (= 9 (+ V30 V31))) ; Region 15
(assert (= 7 (+ V32 V39))) ; Region 16
(assert (= 7 (+ V33 V40))) ; Region 17
(assert (= 9 (+ V34 V41))) ; Region 18
(assert (= 10 (+ V37 V38))) ; Region 19
(assert (= 5 (+ V43 V44))) ; Region 20
(assert (= 10 (+ V45 V46))) ; Region 21
