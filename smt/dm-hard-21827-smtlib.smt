...
(assert (= 48 (* V0 V1 V2))) ; Region 1
(assert (= 140 (* V3 V4 V5 V11 V12))) ; Region 2
(assert (= 630 (* V6 V13 V20 V27))) ; Region 3
(assert (= 10 (* V7 V8))) ; Region 4
(assert (= 144 (* V9 V10 V16 V17))) ; Region 5
(assert (= 28 (* V14 V21 V28))) ; Region 6
(assert (= 126 (* V15 V22 V29))) ; Region 7
(assert (= 30 (* V18 V19 V26 V33))) ; Region 8
(assert (= 120 (* V23 V24 V25 V30))) ; Region 9
(assert (= 420 (* V31 V38 V45 V46))) ; Region 10
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 12
(assert (= 30 (* V35 V36 V37))) ; Region 13
(assert (= 36 (* V39 V40 V47 V48))) ; Region 14
(assert (= 42 (* V42 V43 V44))) ; Region 15
(check-sat)
