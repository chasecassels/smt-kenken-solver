...
(assert (= 11 (+ V18 V24 V25))) ; Region 11
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 12
(assert (= 168 (* V23 V28 V29 V30))) ; Region 13
(assert (= 8 (+ V26 V33 V34))) ; Region 14
(assert (= 11 (+ V31 V32))) ; Region 15
(assert (= 8 (+ V36 V37))) ; Region 17
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 18
(assert (= 11 (+ V40 V41 V48))) ; Region 19
(assert (= 18 (+ V42 V43 V44))) ; Region 20
(assert (= 12 (* V45 V46 V47))) ; Region 21
(check-sat)
