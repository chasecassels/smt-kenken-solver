...
(assert (= 24 (* V0 V1 V7))) ; Region 1
(assert (= 13 (+ V2 V3))) ; Region 2
(assert (= 16 (+ V4 V5 V6 V12))) ; Region 3
(assert (= 35 (* V8 V9))) ; Region 4
(assert (= 3 (+ V10 V11))) ; Region 5
(assert (= 36 (* V13 V20 V27))) ; Region 6
(assert (= 15 (* V14 V15))) ; Region 7
(assert (or (= 2 (/ V16 V17)) (= 2 (/ V17 V16)))) ; Region 8
(assert (or (= 6 (- V18 V19)) (= 6 (- V19 V18)))) ; Region 9
(assert (or (= 2 (- V21 V22)) (= 2 (- V22 V21)))) ; Region 10
(assert (or (= 2 (- V23 V24)) (= 2 (- V24 V23)))) ; Region 11
(assert (or (= 5 (- V25 V32)) (= 5 (- V32 V25)))) ; Region 12
(assert (or (= 4 (- V26 V33)) (= 4 (- V33 V26)))) ; Region 13
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 14
(assert (or (= 5 (- V29 V30)) (= 5 (- V30 V29)))) ; Region 15
(assert (= 14 (+ V31 V38 V44 V45))) ; Region 16
(assert (= 12 (+ V34 V41))) ; Region 17
(assert (or (= 4 (- V36 V37)) (= 4 (- V37 V36)))) ; Region 18
(assert (= 8 (+ V39 V46))) ; Region 19
(assert (= 32 (* V40 V47 V48))) ; Region 20
(assert (= 13 (+ V42 V43))) ; Region 21
(check-sat)
