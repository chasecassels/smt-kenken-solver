...
(assert (= 14 (+ V0 V1 V2))) ; Region 1
(assert (= 9 (+ V3 V4))) ; Region 2
(assert (= 5 (+ V5 V6))) ; Region 3
(assert (= 7 (+ V7 V8))) ; Region 4
(assert (= 3 (+ V9 V10))) ; Region 5
(assert (= 12 (+ V11 V12))) ; Region 6
(assert (= 13 (+ V13 V20))) ; Region 7
(assert (= 3 (+ V14 V15))) ; Region 8
(assert (= 10 (+ V16 V17))) ; Region 9
(assert (= 8 (+ V18 V19))) ; Region 10
(assert (= 7 (+ V21 V28))) ; Region 11
(assert (= 10 (+ V22 V23))) ; Region 12
(assert (= 3 (+ V24 V25))) ; Region 13
(assert (= 10 (+ V26 V27))) ; Region 14
(assert (= 13 (+ V29 V35 V36))) ; Region 15
(assert (= 12 (+ V30 V31))) ; Region 16
(assert (= 13 (+ V32 V39))) ; Region 17
(assert (= 5 (+ V33 V34))) ; Region 18
(assert (= 5 (+ V37 V38))) ; Region 19
(assert (= 8 (+ V40 V41 V48))) ; Region 20
(assert (= 11 (+ V42 V43))) ; Region 21
(assert (= 11 (+ V44 V45))) ; Region 22
(assert (= 4 (+ V46 V47))) ; Region 23
(check-sat)
