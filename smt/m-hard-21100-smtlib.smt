...
(assert (= 42 (* V0 V1 V8 V9))) ; Region 1
(assert (= 40 (* V2 V3 V4))) ; Region 2
(assert (= 2100 (* V5 V6 V12 V13 V19))) ; Region 3
(assert (= 72 (* V7 V14 V21 V22))) ; Region 4
(assert (= 6 (* V10 V11))) ; Region 5
(assert (= 84 (* V15 V16 V17))) ; Region 6
(assert (= 168 (* V18 V20 V25 V26 V27))) ; Region 7
(assert (= 30 (* V23 V24 V31))) ; Region 8
(assert (= 40 (* V28 V35 V36 V37))) ; Region 9
(assert (= 18 (* V29 V30))) ; Region 10
(assert (= 42 (* V33 V34 V41))) ; Region 12
(assert (= 84 (* V38 V44 V45 V46))) ; Region 13
(assert (= 360 (* V39 V40 V47 V48))) ; Region 14
(assert (= 35 (* V42 V43))) ; Region 15
(check-sat)
