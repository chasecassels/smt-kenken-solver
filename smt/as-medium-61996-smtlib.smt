...
(assert (= 6 (+ V0 V7 V14))) ; Region 1
(assert (or (= 3 (- V1 V2)) (= 3 (- V2 V1)))) ; Region 2
(assert (or (= 1 (- V3 V4)) (= 1 (- V4 V3)))) ; Region 3
(assert (= 8 (+ V5 V12))) ; Region 4
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 5
(assert (or (= 3 (- V8 V15)) (= 3 (- V15 V8)))) ; Region 6
(assert (or (= 5 (- V10 V11)) (= 5 (- V11 V10)))) ; Region 8
(assert (= 10 (+ V16 V17 V24))) ; Region 9
(assert (or (= 1 (- V18 V25)) (= 1 (- V25 V18)))) ; Region 10
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 11
(assert (or (= 6 (- V20 V27)) (= 6 (- V27 V20)))) ; Region 12
(assert (= 18 (+ V21 V28 V29))) ; Region 13
(assert (= 7 (+ V22 V23))) ; Region 14
(assert (= 6 (+ V30 V31 V32))) ; Region 15
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 16
(assert (= 6 (+ V34 V41))) ; Region 17
(assert (= 15 (+ V35 V42 V43))) ; Region 18
(assert (or (= 6 (- V36 V37)) (= 6 (- V37 V36)))) ; Region 19
(assert (or (= 4 (- V39 V46)) (= 4 (- V46 V39)))) ; Region 21
(assert (or (= 6 (- V44 V45)) (= 6 (- V45 V44)))) ; Region 22
