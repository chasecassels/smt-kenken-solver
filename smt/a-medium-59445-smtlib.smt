...
(assert (= 6 (+ V11 V18))) ; Region 6
(assert (= 9 (+ V12 V19))) ; Region 7
(assert (= 18 (+ V13 V20 V27 V34))) ; Region 8
(assert (= 10 (+ V14 V21 V28))) ; Region 9
(assert (= 25 (+ V15 V16 V17 V23))) ; Region 10
(assert (= 16 (+ V22 V29 V30))) ; Region 11
(assert (= 7 (+ V24 V25 V31))) ; Region 12
(assert (= 10 (+ V32 V33))) ; Region 14
(assert (= 13 (+ V35 V36 V37))) ; Region 15
(assert (= 9 (+ V38 V39 V40))) ; Region 16
(assert (= 9 (+ V41 V48))) ; Region 17
(assert (= 7 (+ V42 V43 V44))) ; Region 18
(assert (= 18 (+ V45 V46 V47))) ; Region 19
(check-sat)
