...
(assert (= 120 (* V2 V3 V9))) ; Region 2
(assert (= 84 (* V4 V5 V6 V12))) ; Region 3
(assert (= 20 (* V8 V15))) ; Region 4
(assert (= 21 (* V10 V11))) ; Region 5
(assert (= 24 (* V13 V19 V20 V26))) ; Region 6
(assert (= 42 (* V14 V21 V22 V28 V29))) ; Region 7
(assert (= 84 (* V16 V17 V23))) ; Region 8
(assert (= 30 (* V18 V24 V25))) ; Region 9
(assert (= 120 (* V27 V33 V34))) ; Region 10
(assert (= 2 (* V30 V37))) ; Region 11
(assert (= 84 (* V31 V32 V38))) ; Region 12
(assert (= 24 (* V35 V42))) ; Region 13
(assert (= 42 (* V36 V43))) ; Region 14
(assert (= 20 (* V39 V40 V47))) ; Region 15
(assert (= 21 (* V41 V48))) ; Region 16
(assert (= 30 (* V44 V45 V46))) ; Region 17
(check-sat)
