...
(assert (= 42 (* V0 V1))) ; Region 1
(assert (= 144 (* V2 V9 V16 V23))) ; Region 2
(assert (= 10 (* V3 V10))) ; Region 3
(assert (= 8 (* V4 V5))) ; Region 4
(assert (= 28 (* V6 V12 V13))) ; Region 5
(assert (= 84 (* V7 V8 V14 V15))) ; Region 6
(assert (= 15 (* V11 V18 V19))) ; Region 7
(assert (= 18 (* V17 V24 V25))) ; Region 8
(assert (= 30 (* V20 V27 V34))) ; Region 9
(assert (= 120 (* V21 V22 V28))) ; Region 10
(assert (= 210 (* V26 V32 V33))) ; Region 11
(assert (= 14 (* V29 V30 V31 V37))) ; Region 12
(assert (= 6 (* V35 V42 V43))) ; Region 13
(assert (= 140 (* V38 V44 V45))) ; Region 15
(assert (= 84 (* V39 V40 V46))) ; Region 16
(assert (= 72 (* V41 V47 V48))) ; Region 17
(check-sat)
