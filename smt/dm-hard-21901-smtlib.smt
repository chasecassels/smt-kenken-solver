...
(assert (= 168 (* V0 V1 V2 V7 V9))) ; Region 1
(assert (= 24 (* V3 V10))) ; Region 2
(assert (= 15 (* V4 V5))) ; Region 3
(assert (= 420 (* V6 V11 V12 V13))) ; Region 4
(assert (= 210 (* V8 V15 V16 V17 V18))) ; Region 5
(assert (= 180 (* V14 V21 V28 V29))) ; Region 6
(assert (= 8 (* V19 V20 V27))) ; Region 7
(assert (= 12 (* V22 V23))) ; Region 8
(assert (= 70 (* V24 V30 V31))) ; Region 9
(assert (or (= 3 (/ V25 V26)) (= 3 (/ V26 V25)))) ; Region 10
(assert (= 12 (* V32 V38 V39))) ; Region 11
(assert (= 168 (* V33 V34 V40))) ; Region 12
(assert (= 294 (* V35 V36 V42 V43))) ; Region 13
(assert (= 20 (* V37 V44))) ; Region 14
(assert (= 30 (* V41 V46 V47 V48))) ; Region 15
(check-sat)
