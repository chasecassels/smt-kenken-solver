...
(assert (= 105 (* V0 V7 V14))) ; Region 1
(assert (or (= 3 (/ V1 V8)) (= 3 (/ V8 V1)))) ; Region 2
(assert (= 10 (* V2 V9))) ; Region 3
(assert (= 28 (* V3 V4 V11))) ; Region 4
(assert (= 72 (* V5 V6 V12))) ; Region 5
(assert (= 24 (* V10 V17))) ; Region 6
(assert (or (= 3 (/ V13 V20)) (= 3 (/ V20 V13)))) ; Region 7
(assert (or (= 2 (/ V15 V16)) (= 2 (/ V16 V15)))) ; Region 8
(assert (= 420 (* V18 V24 V25 V32))) ; Region 9
(assert (= 5 (* V19 V26))) ; Region 10
(assert (= 42 (* V21 V22 V23))) ; Region 11
(assert (= 60 (* V27 V33 V34))) ; Region 12
(assert (= 24 (* V28 V35 V42))) ; Region 13
(assert (= 30 (* V29 V36))) ; Region 14
(assert (= 28 (* V30 V37))) ; Region 15
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 16
(assert (= 210 (* V39 V46 V47 V48))) ; Region 17
(assert (= 7 (* V40 V41))) ; Region 18
(assert (= 24 (* V43 V44))) ; Region 19
(check-sat)
