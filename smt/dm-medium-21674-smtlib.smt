...
(assert (= 6 (* V1 V2 V8))) ; Region 2
(assert (= 700 (* V3 V4 V5 V10 V17))) ; Region 3
(assert (= 210 (* V6 V12 V13))) ; Region 4
(assert (= 210 (* V9 V15 V16 V22))) ; Region 5
(assert (or (= 2 (/ V11 V18)) (= 2 (/ V18 V11)))) ; Region 6
(assert (= 210 (* V14 V21 V28 V29))) ; Region 7
(assert (= 576 (* V19 V20 V26 V27 V34))) ; Region 8
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 9
(assert (= 28 (* V25 V32 V33))) ; Region 10
(assert (= 1512 (* V30 V31 V38 V45 V46))) ; Region 11
(assert (= 360 (* V35 V36 V37 V44))) ; Region 12
(assert (= 30 (* V40 V41 V47 V48))) ; Region 14
(assert (= 28 (* V42 V43))) ; Region 15
(check-sat)
