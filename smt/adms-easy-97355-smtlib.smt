...
(assert (or (= 1 (- V4 V5)) (= 1 (- V5 V4)))) ; Region 4
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 5
(assert (= 10 (* V7 V8))) ; Region 6
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 7
(assert (or (= 3 (- V11 V12)) (= 3 (- V12 V11)))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 168 (* V15 V22 V29))) ; Region 10
(assert (= 60 (* V17 V18 V24))) ; Region 11
(assert (= 35 (* V19 V20))) ; Region 12
(assert (= 7 (+ V23 V30))) ; Region 13
(assert (= 84 (* V25 V31 V32))) ; Region 14
(assert (or (= 3 (/ V26 V27)) (= 3 (/ V27 V26)))) ; Region 15
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 16
(assert (= 3 (+ V33 V40))) ; Region 17
(assert (= 15 (* V36 V42 V43))) ; Region 19
(assert (= 7 (+ V37 V44))) ; Region 20
(assert (= 6 (+ V38 V39))) ; Region 21
(assert (or (= 3 (- V41 V48)) (= 3 (- V48 V41)))) ; Region 22
(assert (or (= 1 (- V46 V47)) (= 1 (- V47 V46)))) ; Region 24
(check-sat)
