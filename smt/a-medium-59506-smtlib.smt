...
(assert (= 6 (+ V5 V12 V19))) ; Region 4
(assert (= 16 (+ V6 V13 V20 V27))) ; Region 5
(assert (= 7 (+ V9 V10 V17))) ; Region 6
(assert (= 6 (+ V11 V18))) ; Region 7
(assert (= 11 (+ V14 V21))) ; Region 8
(assert (= 14 (+ V15 V16 V22))) ; Region 9
(assert (= 13 (+ V23 V24 V25))) ; Region 10
(assert (= 11 (+ V26 V33))) ; Region 11
(assert (= 6 (+ V28 V35))) ; Region 12
(assert (= 6 (+ V29 V30 V31))) ; Region 13
(assert (= 13 (+ V32 V39))) ; Region 14
(assert (= 10 (+ V34 V41))) ; Region 15
(assert (= 6 (+ V36 V37))) ; Region 16
(assert (= 15 (+ V38 V44 V45))) ; Region 17
(assert (= 13 (+ V40 V47 V48))) ; Region 18
