...
(assert (= 36 (* V0 V1 V8 V9))) ; Region 1
(assert (= 35 (* V2 V3))) ; Region 2
(assert (= 336 (* V4 V5 V10 V11))) ; Region 3
(assert (= 10 (* V6 V12 V13))) ; Region 4
(assert (= 12 (* V14 V21 V22))) ; Region 6
(assert (= 150 (* V15 V16 V23 V24))) ; Region 7
(assert (= 6 (* V17 V18))) ; Region 8
(assert (= 28 (* V19 V20))) ; Region 9
(assert (= 63 (* V25 V26 V32 V33))) ; Region 10
(assert (= 24 (* V27 V34))) ; Region 11
(assert (= 140 (* V28 V29 V30 V36))) ; Region 12
(assert (= 168 (* V31 V37 V38 V45))) ; Region 13
(assert (= 28 (* V35 V42))) ; Region 14
(assert (= 20 (* V39 V46 V47))) ; Region 15
(assert (= 90 (* V40 V41 V48))) ; Region 16
(assert (= 6 (* V43 V44))) ; Region 17
(check-sat)
