...
(assert (= 20 (* V2 V3))) ; Region 3
(assert (or (= 3 (/ V4 V11)) (= 3 (/ V11 V4)))) ; Region 4
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 5
(assert (or (= 2 (/ V9 V10)) (= 2 (/ V10 V9)))) ; Region 6
(assert (= 140 (* V12 V18 V19))) ; Region 7
(assert (= 48 (* V13 V20 V27))) ; Region 8
(assert (or (= 3 (/ V14 V15)) (= 3 (/ V15 V14)))) ; Region 9
(assert (= 3 (+ V16 V23))) ; Region 10
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 12
(assert (= 13 (+ V22 V29))) ; Region 13
(assert (= 14 (* V24 V25))) ; Region 14
(assert (= 210 (* V30 V31 V37))) ; Region 16
(assert (or (= 2 (/ V32 V33)) (= 2 (/ V33 V32)))) ; Region 17
(assert (= 15 (* V34 V40 V41))) ; Region 18
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 19
(assert (= 5 (+ V36 V43))) ; Region 20
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 21
(assert (or (= 3 (/ V39 V46)) (= 3 (/ V46 V39)))) ; Region 22
