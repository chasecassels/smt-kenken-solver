...
(assert (= 45 (* V0 V1 V7))) ; Region 1
(assert (or (= 6 (- V2 V3)) (= 6 (- V3 V2)))) ; Region 2
(assert (or (= 3 (- V4 V11)) (= 3 (- V11 V4)))) ; Region 3
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 4
(assert (= 15 (+ V8 V14 V15))) ; Region 5
(assert (= 6 (+ V9 V10))) ; Region 6
(assert (or (= 2 (/ V12 V13)) (= 2 (/ V13 V12)))) ; Region 7
(assert (= 9 (+ V16 V23))) ; Region 8
(assert (= 48 (* V17 V24 V25))) ; Region 9
(assert (= 15 (* V18 V19 V26))) ; Region 10
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 11
(assert (= 8 (+ V21 V22))) ; Region 12
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 13
(assert (= 17 (+ V30 V31 V37 V44))) ; Region 14
(assert (= 22 (+ V32 V33 V38 V39))) ; Region 15
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 16
(assert (or (= 2 (- V35 V36)) (= 2 (- V36 V35)))) ; Region 17
(assert (= 6 (+ V42 V43))) ; Region 19
(assert (or (= 1 (- V45 V46)) (= 1 (- V46 V45)))) ; Region 20
(assert (or (= 3 (- V47 V48)) (= 3 (- V48 V47)))) ; Region 21
(check-sat)
