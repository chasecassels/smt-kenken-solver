...
(assert (= 7 (+ V16 V17))) ; Region 9
(assert (= 11 (+ V18 V19))) ; Region 10
(assert (= 13 (+ V21 V28))) ; Region 11
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (= 11 (+ V23 V30))) ; Region 13
(assert (= 11 (+ V24 V25))) ; Region 14
(assert (= 3 (+ V26 V27))) ; Region 15
(assert (= 3 (+ V31 V32))) ; Region 16
(assert (= 7 (+ V33 V34))) ; Region 17
(assert (= 11 (+ V35 V36))) ; Region 18
(assert (= 7 (+ V37 V38))) ; Region 19
(assert (= 5 (+ V39 V46))) ; Region 20
