...
(assert (= 98 (* V2 V3 V10 V11))) ; Region 2
(assert (= 90 (* V5 V6 V13))) ; Region 4
(assert (= 504 (* V7 V14 V15 V21))) ; Region 5
(assert (= 12 (* V8 V9 V16))) ; Region 6
(assert (= 60 (* V12 V17 V18 V19))) ; Region 7
(assert (= 42 (* V20 V26 V27))) ; Region 8
(assert (= 20 (* V22 V23))) ; Region 9
(assert (= 48 (* V24 V25 V31 V38))) ; Region 10
(assert (= 42 (* V28 V35 V36))) ; Region 11
(assert (= 6 (* V29 V30))) ; Region 12
(assert (= 60 (* V32 V39 V40))) ; Region 13
(assert (= 42 (* V33 V34))) ; Region 14
(assert (= 630 (* V37 V44 V45 V46))) ; Region 15
(assert (= 20 (* V41 V47 V48))) ; Region 16
