...
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 3
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 4
(assert (= 42 (* V7 V8 V15))) ; Region 5
(assert (= 16 (+ V10 V17 V18))) ; Region 7
(assert (or (= 2 (/ V11 V12)) (= 2 (/ V12 V11)))) ; Region 8
(assert (= 10 (+ V13 V20))) ; Region 9
(assert (or (= 5 (- V14 V21)) (= 5 (- V21 V14)))) ; Region 10
(assert (= 15 (+ V16 V22 V23))) ; Region 11
(assert (or (= 4 (- V19 V26)) (= 4 (- V26 V19)))) ; Region 12
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 13
(assert (or (= 2 (- V27 V34)) (= 2 (- V34 V27)))) ; Region 14
(assert (= 10 (+ V28 V35 V42))) ; Region 15
(assert (or (= 3 (- V29 V36)) (= 3 (- V36 V29)))) ; Region 16
(assert (or (= 2 (- V30 V37)) (= 2 (- V37 V30)))) ; Region 17
(assert (or (= 3 (/ V31 V38)) (= 3 (/ V38 V31)))) ; Region 18
(assert (or (= 2 (/ V32 V39)) (= 2 (/ V39 V32)))) ; Region 19
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 20
(assert (or (= 6 (- V41 V48)) (= 6 (- V48 V41)))) ; Region 21
(assert (= 84 (* V43 V44 V45))) ; Region 22
(assert (= 20 (* V46 V47))) ; Region 23
(check-sat)
