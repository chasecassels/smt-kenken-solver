...
(assert (= 15 (+ V2 V3 V4 V5))) ; Region 3
(assert (= 13 (+ V6 V13 V20))) ; Region 4
(assert (= 6 (+ V9 V15 V16))) ; Region 5
(assert (= 9 (+ V10 V11))) ; Region 6
(assert (= 7 (+ V12 V19))) ; Region 7
(assert (= 7 (+ V17 V18))) ; Region 8
(assert (= 10 (+ V21 V22))) ; Region 9
(assert (= 8 (+ V23 V24))) ; Region 10
(assert (= 8 (+ V25 V32))) ; Region 11
(assert (= 7 (+ V26 V27))) ; Region 12
(assert (= 3 (+ V28 V29))) ; Region 13
(assert (= 14 (+ V31 V37 V38))) ; Region 15
(assert (= 13 (+ V33 V34))) ; Region 16
(assert (= 5 (+ V35 V42))) ; Region 17
(assert (= 8 (+ V36 V43))) ; Region 18
(assert (= 7 (+ V39 V40 V47))) ; Region 19
(assert (= 7 (+ V41 V48))) ; Region 20
(assert (= 18 (+ V44 V45 V46))) ; Region 21
(check-sat)
