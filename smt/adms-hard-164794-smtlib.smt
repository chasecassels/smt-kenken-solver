...
(assert (= 12 (+ V0 V7 V8))) ; Region 1
(assert (or (= 5 (- V1 V2)) (= 5 (- V2 V1)))) ; Region 2
(assert (or (= 5 (- V3 V10)) (= 5 (- V10 V3)))) ; Region 3
(assert (or (= 2 (- V4 V11)) (= 2 (- V11 V4)))) ; Region 4
(assert (= 20 (* V5 V6))) ; Region 5
(assert (= 18 (+ V9 V16 V23))) ; Region 6
(assert (or (= 3 (/ V12 V13)) (= 3 (/ V13 V12)))) ; Region 7
(assert (or (= 4 (- V14 V15)) (= 4 (- V15 V14)))) ; Region 8
(assert (= 12 (+ V17 V18 V24))) ; Region 9
(assert (or (= 2 (- V19 V20)) (= 2 (- V20 V19)))) ; Region 10
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 11
(assert (= 9 (+ V25 V26 V27))) ; Region 12
(assert (= 6 (* V28 V29))) ; Region 13
(assert (= 7 (+ V30 V37))) ; Region 14
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 15
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 17
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 18
(assert (= 10 (+ V36 V43 V44))) ; Region 19
(assert (or (= 6 (- V39 V40)) (= 6 (- V40 V39)))) ; Region 20
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 21
(assert (or (= 5 (- V46 V47)) (= 5 (- V47 V46)))) ; Region 23
(check-sat)
