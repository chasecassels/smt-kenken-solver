...
(assert (= 9 (+ V6 V12 V13))) ; Region 4
(assert (= 7 (+ V7 V14))) ; Region 5
(assert (= 9 (+ V8 V15))) ; Region 6
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 7
(assert (= 4 (+ V10 V11))) ; Region 8
(assert (= 20 (+ V17 V18 V24))) ; Region 9
(assert (= 9 (+ V19 V20))) ; Region 10
(assert (= 10 (+ V21 V28))) ; Region 11
(assert (= 13 (+ V22 V23 V30))) ; Region 12
(assert (= 3 (+ V25 V26))) ; Region 13
(assert (= 13 (+ V27 V34))) ; Region 14
(assert (or (= 6 (- V29 V36)) (= 6 (- V36 V29)))) ; Region 15
(assert (or (= 1 (- V32 V33)) (= 1 (- V33 V32)))) ; Region 17
(assert (= 10 (+ V35 V42))) ; Region 18
(assert (or (= 2 (- V37 V38)) (= 2 (- V38 V37)))) ; Region 19
(assert (= 8 (+ V39 V46))) ; Region 20
(assert (= 8 (+ V40 V47))) ; Region 21
(assert (= 6 (+ V41 V48))) ; Region 22
(assert (= 11 (+ V43 V44 V45))) ; Region 23
(check-sat)
