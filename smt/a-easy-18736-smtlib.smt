...
(assert (= 15 (+ V3 V4 V5 V11))) ; Region 2
(assert (= 13 (+ V7 V14))) ; Region 4
(assert (= 5 (+ V8 V15))) ; Region 5
...
(assert (= 16 (+ V20 V25 V26 V27))) ; Region 11
(assert (= 9 (+ V21 V22))) ; Region 12
(assert (= 3 (+ V28 V29))) ; Region 13
(assert (= 9 (+ V30 V37 V44))) ; Region 14
(assert (= 4 (+ V31 V38))) ; Region 15
(assert (= 13 (+ V32 V39))) ; Region 16
(assert (= 9 (+ V33 V34))) ; Region 17
(assert (= 7 (+ V35 V42))) ; Region 18
(assert (= 8 (+ V36 V43))) ; Region 19
(assert (= 11 (+ V40 V41))) ; Region 20
