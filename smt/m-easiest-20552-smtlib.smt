...
(assert (= 10 (* V3 V4 V10))) ; Region 3
(assert (= 12 (* V5 V6))) ; Region 4
(assert (= 42 (* V11 V12))) ; Region 6
(assert (= 8 (* V13 V19 V20))) ; Region 7
(assert (= 20 (* V14 V21 V28))) ; Region 8
(assert (= 42 (* V15 V22 V23))) ; Region 9
(assert (= 18 (* V17 V18))) ; Region 11
(assert (= 63 (* V24 V30 V31))) ; Region 12
(assert (= 35 (* V26 V33))) ; Region 14
(assert (= 12 (* V27 V34))) ; Region 15
(assert (= 8 (* V29 V36 V37))) ; Region 16
(assert (= 36 (* V32 V39 V40))) ; Region 17
(assert (= 21 (* V35 V42))) ; Region 18
(assert (= 20 (* V38 V45 V46))) ; Region 19
(assert (= 35 (* V41 V47 V48))) ; Region 20
(assert (= 12 (* V43 V44))) ; Region 21
(check-sat)
