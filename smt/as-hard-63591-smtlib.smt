...
(assert (= 21 (+ V2 V3 V8 V9))) ; Region 2
(assert (= 12 (+ V4 V5 V11 V12))) ; Region 3
(assert (= 15 (+ V6 V13 V20))) ; Region 4
(assert (or (= 2 (- V7 V14)) (= 2 (- V14 V7)))) ; Region 5
(assert (= 7 (+ V10 V17))) ; Region 6
(assert (= 7 (+ V15 V16))) ; Region 7
(assert (= 10 (+ V18 V19))) ; Region 8
(assert (or (= 3 (- V21 V22)) (= 3 (- V22 V21)))) ; Region 9
(assert (= 13 (+ V23 V24 V31))) ; Region 10
(assert (= 13 (+ V25 V26 V32))) ; Region 11
(assert (or (= 2 (- V27 V34)) (= 2 (- V34 V27)))) ; Region 12
(assert (= 7 (+ V28 V35))) ; Region 13
(assert (= 5 (+ V29 V30))) ; Region 14
(assert (= 18 (+ V36 V37 V44))) ; Region 16
(assert (or (= 6 (- V38 V39)) (= 6 (- V39 V38)))) ; Region 17
(assert (= 7 (+ V40 V41))) ; Region 18
(assert (= 6 (+ V42 V43))) ; Region 19
(assert (= 9 (+ V46 V47 V48))) ; Region 21
(check-sat)
