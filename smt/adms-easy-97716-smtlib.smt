...
(assert (= 15 (* V0 V7 V8))) ; Region 1
(assert (= 90 (* V1 V2 V3))) ; Region 2
(assert (= 13 (+ V4 V11))) ; Region 3
(assert (= 10 (+ V5 V6 V12))) ; Region 4
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 5
(assert (= 10 (+ V13 V20 V27))) ; Region 6
(assert (= 6 (+ V14 V15))) ; Region 7
(assert (= 48 (* V16 V23 V30))) ; Region 8
(assert (or (= 1 (- V17 V18)) (= 1 (- V18 V17)))) ; Region 9
(assert (or (= 1 (- V19 V26)) (= 1 (- V26 V19)))) ; Region 10
(assert (or (= 4 (- V21 V22)) (= 4 (- V22 V21)))) ; Region 11
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 12
(assert (= 9 (+ V28 V29))) ; Region 13
(assert (= 90 (* V32 V33 V34))) ; Region 15
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 16
(assert (or (= 2 (- V37 V44)) (= 2 (- V44 V37)))) ; Region 17
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 18
(assert (or (= 6 (- V40 V47)) (= 6 (- V47 V40)))) ; Region 19
(assert (= 8 (+ V41 V48))) ; Region 20
(assert (or (= 2 (- V42 V43)) (= 2 (- V43 V42)))) ; Region 21
(assert (or (= 2 (/ V45 V46)) (= 2 (/ V46 V45)))) ; Region 22
(check-sat)
