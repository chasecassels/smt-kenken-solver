...
(assert (= 20 (* V0 V1))) ; Region 1
(assert (= 84 (* V2 V3 V4))) ; Region 2
(assert (= 3 (* V5 V6))) ; Region 3
(assert (= 28 (* V7 V14))) ; Region 4
(assert (= 35 (* V8 V15))) ; Region 5
(assert (= 4 (* V9 V10))) ; Region 6
(assert (or (= 3 (/ V11 V12)) (= 3 (/ V12 V11)))) ; Region 7
(assert (= 126 (* V13 V20 V27))) ; Region 8
(assert (= 30 (* V16 V23 V30))) ; Region 9
(assert (or (= 2 (/ V17 V24)) (= 2 (/ V24 V17)))) ; Region 10
(assert (= 5 (* V18 V19))) ; Region 11
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 12
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 13
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 14
(assert (= 5 (* V31 V32))) ; Region 15
(assert (= 28 (* V33 V34))) ; Region 16
(assert (= 3 (* V35 V42))) ; Region 17
(assert (= 12 (* V36 V43))) ; Region 18
(assert (= 18 (* V37 V38))) ; Region 19
(assert (= 28 (* V39 V46))) ; Region 20
(assert (= 40 (* V40 V41 V48))) ; Region 21
(assert (= 7 (* V44 V45))) ; Region 22
(check-sat)
