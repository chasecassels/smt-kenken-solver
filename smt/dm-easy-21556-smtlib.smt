...
(assert (= 36 (* V1 V2 V9))) ; Region 2
(assert (= 60 (* V3 V4 V11))) ; Region 3
(assert (= 28 (* V5 V6 V12))) ; Region 4
(assert (or (= 2 (/ V8 V15)) (= 2 (/ V15 V8)))) ; Region 5
(assert (= 42 (* V10 V16 V17))) ; Region 6
(assert (= 30 (* V13 V20))) ; Region 7
(assert (= 280 (* V14 V21 V22 V28))) ; Region 8
(assert (= 6 (* V18 V19))) ; Region 9
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 10
(assert (= 7 (* V25 V32))) ; Region 11
(assert (= 6 (* V26 V33))) ; Region 12
(assert (= 28 (* V27 V34))) ; Region 13
(assert (= 420 (* V29 V30 V36 V37))) ; Region 14
(assert (or (= 2 (/ V31 V38)) (= 2 (/ V38 V31)))) ; Region 15
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 16
(assert (= 60 (* V39 V40 V47))) ; Region 17
(assert (= 6 (* V41 V48))) ; Region 18
(assert (= 7 (* V43 V44))) ; Region 19
(assert (= 20 (* V45 V46))) ; Region 20
(check-sat)
