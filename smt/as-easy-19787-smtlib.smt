...
(assert (or (= 3 (- V4 V5)) (= 3 (- V5 V4)))) ; Region 4
(assert (= 15 (+ V6 V12 V13))) ; Region 5
(assert (= 3 (+ V7 V14))) ; Region 6
(assert (= 5 (+ V8 V9))) ; Region 7
(assert (= 17 (+ V11 V17 V18))) ; Region 8
(assert (or (= 3 (- V15 V16)) (= 3 (- V16 V15)))) ; Region 9
(assert (= 5 (+ V19 V26))) ; Region 10
(assert (or (= 6 (- V20 V27)) (= 6 (- V27 V20)))) ; Region 11
(assert (= 9 (+ V21 V28))) ; Region 12
(assert (= 20 (+ V22 V23 V29 V30))) ; Region 13
(assert (or (= 3 (- V24 V25)) (= 3 (- V25 V24)))) ; Region 14
(assert (= 5 (+ V31 V38))) ; Region 15
(assert (or (= 6 (- V32 V33)) (= 6 (- V33 V32)))) ; Region 16
(assert (= 11 (+ V34 V40 V41))) ; Region 17
(assert (= 20 (+ V35 V36 V42))) ; Region 18
(assert (= 5 (+ V37 V44 V45))) ; Region 19
(assert (= 7 (+ V39 V46))) ; Region 20
