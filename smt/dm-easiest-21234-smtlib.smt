...
(assert (= 70 (* V1 V2 V3))) ; Region 2
(assert (or (= 3 (/ V4 V5)) (= 3 (/ V5 V4)))) ; Region 3
(assert (= 30 (* V6 V13))) ; Region 4
(assert (or (= 2 (/ V8 V9)) (= 2 (/ V9 V8)))) ; Region 5
(assert (= 112 (* V10 V17 V18))) ; Region 6
(assert (= 7 (* V11 V12))) ; Region 7
(assert (= 30 (* V14 V15))) ; Region 8
(assert (= 2 (* V16 V23))) ; Region 9
(assert (= 8 (* V19 V26))) ; Region 10
(assert (= 21 (* V20 V27))) ; Region 11
(assert (= 15 (* V21 V22))) ; Region 12
(assert (= 5 (* V24 V31))) ; Region 13
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 14
(assert (= 7 (* V28 V35))) ; Region 15
(assert (= 8 (* V29 V30 V36))) ; Region 16
(assert (or (= 3 (/ V33 V34)) (= 3 (/ V34 V33)))) ; Region 17
(assert (or (= 2 (/ V37 V38)) (= 2 (/ V38 V37)))) ; Region 18
(assert (= 140 (* V39 V40 V41))) ; Region 19
(assert (= 24 (* V42 V43))) ; Region 20
(assert (= 6 (* V45 V46))) ; Region 22
(assert (= 5 (* V47 V48))) ; Region 23
(check-sat)
