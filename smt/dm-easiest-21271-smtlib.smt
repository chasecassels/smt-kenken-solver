...
(assert (= 20 (* V1 V8))) ; Region 2
(assert (= 196 (* V2 V9 V10))) ; Region 3
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 4
(assert (= 15 (* V5 V6))) ; Region 5
(assert (= 24 (* V11 V18))) ; Region 6
(assert (or (= 2 (/ V12 V13)) (= 2 (/ V13 V12)))) ; Region 7
(assert (= 10 (* V14 V21))) ; Region 8
(assert (= 35 (* V15 V16))) ; Region 9
(assert (= 6 (* V17 V24))) ; Region 10
(assert (= 6 (* V19 V20))) ; Region 11
(assert (= 84 (* V22 V28 V29))) ; Region 12
(assert (or (= 2 (/ V23 V30)) (= 2 (/ V30 V23)))) ; Region 13
(assert (= 28 (* V25 V26 V33))) ; Region 14
(assert (= 20 (* V27 V34))) ; Region 15
(assert (= 10 (* V31 V37 V38))) ; Region 16
(assert (= 21 (* V32 V39))) ; Region 17
(assert (= 4 (* V35 V36))) ; Region 18
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 19
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 20
(assert (= 20 (* V44 V45 V46))) ; Region 21
(assert (= 14 (* V47 V48))) ; Region 22
(check-sat)
