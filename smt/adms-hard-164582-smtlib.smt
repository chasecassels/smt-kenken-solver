...
(assert (= 12 (* V4 V11))) ; Region 3
(assert (= 11 (+ V5 V12))) ; Region 4
(assert (= 16 (+ V6 V13 V20))) ; Region 5
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 6
(assert (= 6 (* V8 V15))) ; Region 7
(assert (or (= 2 (- V9 V10)) (= 2 (- V10 V9)))) ; Region 8
(assert (or (= 2 (/ V17 V24)) (= 2 (/ V24 V17)))) ; Region 10
(assert (= 8 (+ V18 V19))) ; Region 11
(assert (= 8 (+ V21 V22))) ; Region 12
(assert (= 28 (* V23 V30))) ; Region 13
(assert (= 10 (* V25 V26 V32))) ; Region 14
(assert (or (= 2 (/ V27 V34)) (= 2 (/ V34 V27)))) ; Region 15
(assert (= 12 (+ V28 V29 V35))) ; Region 16
(assert (= 16 (+ V31 V38 V39))) ; Region 17
(assert (or (= 2 (/ V33 V40)) (= 2 (/ V40 V33)))) ; Region 18
(assert (or (= 6 (- V36 V37)) (= 6 (- V37 V36)))) ; Region 19
(assert (= 6 (* V41 V47 V48))) ; Region 20
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 21
(assert (= 18 (+ V44 V45 V46))) ; Region 22
(check-sat)
