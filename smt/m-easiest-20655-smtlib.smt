...
(assert (= 6 (* V3 V9 V10))) ; Region 2
(assert (= 40 (* V4 V5 V12))) ; Region 3
(assert (= 42 (* V6 V13 V20))) ; Region 4
(assert (= 24 (* V7 V8 V14))) ; Region 5
(assert (= 15 (* V11 V18 V19))) ; Region 6
(assert (= 18 (* V15 V22))) ; Region 7
(assert (= 28 (* V16 V23))) ; Region 8
(assert (= 15 (* V21 V28))) ; Region 10
(assert (= 12 (* V24 V25))) ; Region 11
(assert (= 7 (* V26 V27 V33))) ; Region 12
(assert (= 14 (* V29 V36 V37))) ; Region 13
(assert (= 35 (* V30 V31))) ; Region 14
(assert (= 126 (* V32 V39 V46))) ; Region 15
(assert (= 8 (* V35 V42 V43))) ; Region 17
(assert (= 15 (* V38 V45))) ; Region 18
(assert (= 180 (* V41 V47 V48))) ; Region 20
(check-sat)
