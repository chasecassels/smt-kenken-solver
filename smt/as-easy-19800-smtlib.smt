...
(assert (= 8 (+ V4 V11))) ; Region 3
(assert (= 4 (+ V5 V12))) ; Region 4
(assert (= 5 (+ V6 V13))) ; Region 5
(assert (= 12 (+ V7 V8))) ; Region 6
(assert (= 10 (+ V9 V10))) ; Region 7
(assert (or (= 5 (- V15 V16)) (= 5 (- V16 V15)))) ; Region 9
(assert (= 4 (+ V17 V18))) ; Region 10
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 8 (+ V23 V24))) ; Region 14
(assert (= 10 (+ V25 V32))) ; Region 15
(assert (= 13 (+ V26 V27 V33))) ; Region 16
(assert (or (= 4 (- V29 V30)) (= 4 (- V30 V29)))) ; Region 17
(assert (= 7 (+ V31 V37 V38))) ; Region 18
(assert (= 13 (+ V34 V41))) ; Region 19
(assert (= 14 (+ V35 V36 V42 V43))) ; Region 20
(assert (or (= 1 (- V39 V46)) (= 1 (- V46 V39)))) ; Region 21
(assert (= 13 (+ V44 V45))) ; Region 23
(assert (= 6 (+ V47 V48))) ; Region 24
(check-sat)
