...
(assert (= 12 (+ V2 V3 V4 V5))) ; Region 2
(assert (= 7 (+ V6 V13))) ; Region 3
(assert (or (= 3 (- V7 V8)) (= 3 (- V8 V7)))) ; Region 4
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 5
(assert (or (= 3 (- V11 V12)) (= 3 (- V12 V11)))) ; Region 6
(assert (= 3 (+ V14 V21))) ; Region 7
(assert (= 11 (+ V15 V22))) ; Region 8
(assert (= 4 (+ V16 V17))) ; Region 9
(assert (= 9 (+ V18 V25 V26))) ; Region 10
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 11
(assert (= 6 (+ V24 V31))) ; Region 13
(assert (= 13 (+ V27 V34 V41))) ; Region 14
(assert (= 7 (+ V28 V29))) ; Region 15
(assert (= 10 (+ V30 V37))) ; Region 16
(assert (or (= 6 (- V32 V33)) (= 6 (- V33 V32)))) ; Region 17
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 18
(assert (or (= 4 (- V38 V39)) (= 4 (- V39 V38)))) ; Region 20
(assert (= 13 (+ V40 V47 V48))) ; Region 21
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 22
(assert (= 8 (+ V45 V46))) ; Region 23
(check-sat)
