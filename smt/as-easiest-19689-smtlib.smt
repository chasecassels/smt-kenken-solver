...
(assert (= 11 (+ V3 V10))) ; Region 3
(assert (= 13 (+ V4 V5))) ; Region 4
(assert (= 9 (+ V6 V13))) ; Region 5
(assert (or (= 6 (- V7 V14)) (= 6 (- V14 V7)))) ; Region 6
(assert (or (= 4 (- V8 V9)) (= 4 (- V9 V8)))) ; Region 7
(assert (or (= 2 (- V11 V12)) (= 2 (- V12 V11)))) ; Region 8
(assert (or (= 2 (- V15 V16)) (= 2 (- V16 V15)))) ; Region 9
(assert (= 10 (+ V17 V24))) ; Region 10
(assert (= 9 (+ V18 V25))) ; Region 11
(assert (= 9 (+ V19 V26 V33))) ; Region 12
(assert (or (= 4 (- V20 V27)) (= 4 (- V27 V20)))) ; Region 13
(assert (= 3 (+ V21 V22))) ; Region 14
(assert (= 10 (+ V28 V35))) ; Region 16
(assert (= 8 (+ V29 V36))) ; Region 17
(assert (= 6 (+ V30 V31))) ; Region 18
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 20
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 21
(assert (or (= 4 (- V39 V40)) (= 4 (- V40 V39)))) ; Region 22
(assert (= 9 (+ V42 V43))) ; Region 23
(assert (= 11 (+ V44 V45 V46))) ; Region 24
(assert (or (= 6 (- V47 V48)) (= 6 (- V48 V47)))) ; Region 25
(check-sat)
