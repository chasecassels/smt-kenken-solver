...
(assert (= 11 (+ V3 V4 V5))) ; Region 3
(assert (= 6 (+ V6 V13))) ; Region 4
(assert (= 15 (+ V8 V14 V15))) ; Region 5
(assert (= 6 (+ V9 V16 V23))) ; Region 6
(assert (= 11 (+ V10 V11 V12))) ; Region 7
(assert (= 13 (+ V17 V18 V24))) ; Region 8
(assert (or (= 5 (- V19 V20)) (= 5 (- V20 V19)))) ; Region 9
(assert (= 11 (+ V21 V28 V35))) ; Region 10
(assert (or (= 5 (- V22 V29)) (= 5 (- V29 V22)))) ; Region 11
(assert (= 10 (+ V26 V27 V34))) ; Region 13
(assert (= 11 (+ V30 V31))) ; Region 14
(assert (or (= 1 (- V32 V33)) (= 1 (- V33 V32)))) ; Region 15
(assert (= 17 (+ V36 V37 V38 V44))) ; Region 16
(assert (= 5 (+ V39 V46))) ; Region 17
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 18
(assert (= 3 (+ V42 V43))) ; Region 19
