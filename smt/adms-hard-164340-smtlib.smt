...
(assert (= 35 (* V7 V8 V15))) ; Region 5
(assert (= 36 (* V9 V16 V17))) ; Region 6
(assert (= 12 (+ V11 V18 V19))) ; Region 7
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 7 (+ V20 V26 V27))) ; Region 10
(assert (= 15 (+ V22 V23 V30))) ; Region 11
(assert (or (= 2 (/ V24 V31)) (= 2 (/ V31 V24)))) ; Region 12
(assert (= 13 (+ V25 V32 V33))) ; Region 13
(assert (or (= 3 (/ V28 V29)) (= 3 (/ V29 V28)))) ; Region 14
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 15
(assert (= 21 (+ V35 V36 V42 V43))) ; Region 16
(assert (= 8 (+ V37 V38 V44))) ; Region 17
(assert (= 28 (* V39 V40))) ; Region 18
(assert (= 9 (+ V46 V47 V48))) ; Region 20
(check-sat)
