...
(assert (= 30 (* V0 V1))) ; Region 1
(assert (= 48 (* V2 V9 V16))) ; Region 2
(assert (= 30 (* V3 V10 V17))) ; Region 3
(assert (= 30 (* V4 V11 V12))) ; Region 4
(assert (= 28 (* V5 V6))) ; Region 5
(assert (= 3 (* V7 V8 V15))) ; Region 6
(assert (= 21 (* V13 V20))) ; Region 7
(assert (= 42 (* V14 V21))) ; Region 8
(assert (= 8 (* V18 V19))) ; Region 9
(assert (= 12 (* V23 V24))) ; Region 11
(assert (= 21 (* V25 V32))) ; Region 12
(assert (= 2 (* V26 V27 V33))) ; Region 13
(assert (= 28 (* V28 V29))) ; Region 14
(assert (= 30 (* V30 V31 V37))) ; Region 15
(assert (= 36 (* V34 V40 V41))) ; Region 16
(assert (= 8 (* V35 V36))) ; Region 17
(assert (= 35 (* V38 V39 V45))) ; Region 18
(assert (= 42 (* V42 V43 V44))) ; Region 19
(assert (= 24 (* V46 V47))) ; Region 20
(check-sat)
