...
(assert (= 126 (* V1 V2 V3))) ; Region 2
(assert (= 84 (* V4 V11 V17 V18))) ; Region 3
(assert (= 6 (+ V5 V12))) ; Region 4
(assert (= 60 (* V6 V13 V20))) ; Region 5
(assert (= 5 (+ V8 V15))) ; Region 6
(assert (or (= 1 (- V9 V10)) (= 1 (- V10 V9)))) ; Region 7
(assert (= 8 (+ V14 V21))) ; Region 8
(assert (= 10 (* V16 V23))) ; Region 9
(assert (= 13 (+ V19 V26))) ; Region 10
(assert (= 70 (* V22 V28 V29))) ; Region 11
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 12
(assert (or (= 6 (- V27 V34)) (= 6 (- V34 V27)))) ; Region 13
(assert (= 24 (* V30 V37 V44))) ; Region 14
(assert (or (= 3 (/ V31 V32)) (= 3 (/ V32 V31)))) ; Region 15
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 17
(assert (or (= 3 (/ V36 V43)) (= 3 (/ V43 V36)))) ; Region 18
(assert (= 30 (* V38 V39))) ; Region 19
(assert (= 72 (* V40 V41 V47 V48))) ; Region 20
(assert (= 12 (+ V45 V46))) ; Region 21
(check-sat)
