...
(assert (= 16 (+ V2 V9 V16))) ; Region 3
(assert (= 8 (+ V3 V10))) ; Region 4
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 5
(assert (= 8 (+ V6 V13))) ; Region 6
(assert (= 4 (+ V8 V15))) ; Region 7
(assert (= 11 (+ V11 V12))) ; Region 8
(assert (= 3 (+ V14 V21))) ; Region 9
(assert (= 10 (+ V17 V18))) ; Region 10
(assert (= 7 (+ V19 V20))) ; Region 11
(assert (= 7 (+ V22 V23))) ; Region 12
(assert (= 15 (+ V24 V25 V32))) ; Region 13
(assert (= 11 (+ V26 V33))) ; Region 14
(assert (or (= 6 (- V27 V34)) (= 6 (- V34 V27)))) ; Region 15
(assert (= 10 (+ V28 V29))) ; Region 16
(assert (= 3 (+ V30 V31))) ; Region 17
(assert (= 8 (+ V35 V42))) ; Region 18
(assert (= 12 (+ V36 V43))) ; Region 19
(assert (= 8 (+ V37 V44))) ; Region 20
(assert (or (= 5 (- V38 V45)) (= 5 (- V45 V38)))) ; Region 21
(assert (= 11 (+ V40 V41 V48))) ; Region 23
(assert (or (= 6 (- V46 V47)) (= 6 (- V47 V46)))) ; Region 24
(check-sat)
