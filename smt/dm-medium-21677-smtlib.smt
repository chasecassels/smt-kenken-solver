...
(assert (= 60 (* V0 V7 V8))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (or (= 2 (/ V3 V10)) (= 2 (/ V10 V3)))) ; Region 3
(assert (= 140 (* V4 V5 V6))) ; Region 4
(assert (= 35 (* V9 V16))) ; Region 5
(assert (= 42 (* V11 V17 V18))) ; Region 6
(assert (= 12 (* V12 V19))) ; Region 7
(assert (= 6 (* V13 V20 V27))) ; Region 8
(assert (= 12 (* V14 V15))) ; Region 9
(assert (= 210 (* V21 V22 V28))) ; Region 10
(assert (= 84 (* V23 V24 V25))) ; Region 11
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 12
(assert (= 180 (* V29 V30 V31 V38))) ; Region 13
(assert (= 42 (* V32 V39 V40))) ; Region 14
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 16
(assert (= 28 (* V36 V37 V43))) ; Region 17
(assert (= 120 (* V41 V47 V48))) ; Region 18
(assert (= 30 (* V44 V45 V46))) ; Region 19
(check-sat)
