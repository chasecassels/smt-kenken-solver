...
(assert (= 1008 (* V3 V9 V10 V16))) ; Region 3
(assert (= 300 (* V4 V5 V6 V13))) ; Region 4
(assert (= 36 (* V8 V14 V15 V21))) ; Region 5
(assert (= 420 (* V11 V12 V17 V18 V19))) ; Region 6
(assert (= 8 (* V20 V27))) ; Region 7
(assert (= 105 (* V23 V24 V30 V31))) ; Region 9
(assert (= 84 (* V25 V32 V38 V39))) ; Region 10
(assert (= 8 (* V26 V33))) ; Region 11
(assert (= 20 (* V28 V29))) ; Region 12
(assert (= 378 (* V34 V40 V41 V47 V48))) ; Region 13
(assert (= 60 (* V35 V42 V43))) ; Region 14
(assert (= 48 (* V36 V37 V44))) ; Region 15
(assert (= 5 (* V45 V46))) ; Region 16
(check-sat)
