...
(assert (or (= 2 (/ V0 V1)) (= 2 (/ V1 V0)))) ; Region 1
(assert (= 15 (* V2 V3))) ; Region 2
(assert (= 13 (+ V4 V11))) ; Region 3
(assert (or (= 3 (/ V5 V12)) (= 3 (/ V12 V5)))) ; Region 4
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 5
(assert (or (= 2 (- V7 V14)) (= 2 (- V14 V7)))) ; Region 6
(assert (= 6 (+ V8 V15))) ; Region 7
(assert (or (= 5 (- V9 V16)) (= 5 (- V16 V9)))) ; Region 8
(assert (= 5 (+ V10 V17))) ; Region 9
(assert (= 60 (* V18 V19 V25))) ; Region 10
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 11
(assert (= 10 (+ V21 V28))) ; Region 12
(assert (or (= 3 (- V22 V23)) (= 3 (- V23 V22)))) ; Region 13
(assert (= 9 (+ V24 V31 V32))) ; Region 14
(assert (or (= 6 (- V26 V33)) (= 6 (- V33 V26)))) ; Region 15
(assert (= 10 (+ V29 V35 V36))) ; Region 16
(assert (or (= 2 (- V30 V37)) (= 2 (- V37 V30)))) ; Region 17
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 18
(assert (= 14 (+ V38 V44 V45))) ; Region 19
(assert (or (= 3 (- V39 V46)) (= 3 (- V46 V39)))) ; Region 20
(assert (= 75 (* V40 V47 V48))) ; Region 21
(assert (= 9 (+ V42 V43))) ; Region 22
(check-sat)
