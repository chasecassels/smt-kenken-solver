...
(assert (= 42 (* V1 V8))) ; Region 2
(assert (= 30 (* V2 V9))) ; Region 3
(assert (= 30 (* V3 V4 V10))) ; Region 4
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 5
(assert (= 28 (* V11 V18))) ; Region 6
(assert (= 4 (* V12 V13 V19))) ; Region 7
(assert (= 35 (* V14 V21))) ; Region 8
(assert (or (= 3 (/ V15 V22)) (= 3 (/ V22 V15)))) ; Region 9
(assert (or (= 3 (/ V16 V17)) (= 3 (/ V17 V16)))) ; Region 10
(assert (= 15 (* V20 V27))) ; Region 11
(assert (= 24 (* V23 V29 V30))) ; Region 12
(assert (= 7 (* V24 V31))) ; Region 13
(assert (or (= 3 (/ V25 V26)) (= 3 (/ V26 V25)))) ; Region 14
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 15
(assert (= 15 (* V33 V40))) ; Region 17
(assert (= 42 (* V34 V41))) ; Region 18
(assert (= 20 (* V36 V43))) ; Region 19
(assert (= 28 (* V37 V38))) ; Region 20
(assert (= 5 (* V39 V46))) ; Region 21
(assert (= 3 (* V44 V45))) ; Region 23
(assert (= 14 (* V47 V48))) ; Region 24
(check-sat)
