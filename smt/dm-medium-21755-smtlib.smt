...
(assert (= 84 (* V0 V1 V8))) ; Region 1
(assert (or (= 3 (/ V2 V9)) (= 3 (/ V9 V2)))) ; Region 2
(assert (= 210 (* V3 V4 V5))) ; Region 3
(assert (= 60 (* V6 V12 V13 V20))) ; Region 4
(assert (= 720 (* V7 V14 V15 V16 V22))) ; Region 5
(assert (= 504 (* V10 V11 V17 V23 V24))) ; Region 6
(assert (or (= 2 (/ V18 V19)) (= 2 (/ V19 V18)))) ; Region 7
(assert (= 280 (* V21 V28 V35 V42))) ; Region 8
(assert (= 42 (* V25 V31 V32))) ; Region 9
(assert (= 168 (* V26 V27 V33 V34))) ; Region 10
(assert (= 2 (* V29 V36))) ; Region 11
(assert (or (= 3 (/ V37 V38)) (= 3 (/ V38 V37)))) ; Region 13
(assert (= 20 (* V39 V45 V46))) ; Region 14
(assert (= 30 (* V40 V47))) ; Region 15
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 16
(assert (= 21 (* V43 V44))) ; Region 17
(check-sat)
