...
(assert (= 24 (* V1 V2 V3))) ; Region 2
(assert (= 13 (+ V4 V11))) ; Region 3
(assert (or (= 3 (- V5 V12)) (= 3 (- V12 V5)))) ; Region 4
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 5
(assert (= 30 (* V8 V15 V22))) ; Region 6
(assert (= 13 (+ V9 V10 V17))) ; Region 7
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 8
(assert (or (= 6 (- V16 V23)) (= 6 (- V23 V16)))) ; Region 9
(assert (= 10 (* V18 V24 V25))) ; Region 10
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 11
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 12
(assert (or (= 6 (- V27 V34)) (= 6 (- V34 V27)))) ; Region 13
(assert (or (= 3 (- V28 V35)) (= 3 (- V35 V28)))) ; Region 14
(assert (or (= 6 (- V29 V36)) (= 6 (- V36 V29)))) ; Region 15
(assert (= 14 (+ V30 V37 V38))) ; Region 16
(assert (= 13 (+ V31 V32 V39))) ; Region 17
(assert (= 16 (+ V40 V41 V48))) ; Region 18
(assert (or (= 3 (- V42 V43)) (= 3 (- V43 V42)))) ; Region 19
(assert (or (= 3 (- V44 V45)) (= 3 (- V45 V44)))) ; Region 20
(assert (or (= 3 (/ V46 V47)) (= 3 (/ V47 V46)))) ; Region 21
(check-sat)
