...
(assert (= 14 (+ V1 V2 V8))) ; Region 2
(assert (= 5 (+ V3 V10))) ; Region 3
(assert (= 11 (+ V4 V11))) ; Region 4
(assert (= 9 (+ V5 V12))) ; Region 5
(assert (= 11 (+ V9 V16))) ; Region 7
(assert (= 8 (+ V13 V20))) ; Region 8
(assert (= 8 (+ V15 V22))) ; Region 9
(assert (= 16 (+ V17 V24 V25))) ; Region 10
(assert (= 3 (+ V18 V19))) ; Region 11
(assert (= 9 (+ V21 V28))) ; Region 12
(assert (= 12 (+ V23 V29 V30))) ; Region 13
(assert (= 5 (+ V26 V27))) ; Region 14
(assert (= 8 (+ V31 V32))) ; Region 15
(assert (= 7 (+ V33 V34))) ; Region 16
(assert (= 6 (+ V35 V36 V37))) ; Region 17
(assert (= 9 (+ V38 V45))) ; Region 18
(assert (= 5 (+ V39 V46))) ; Region 19
(assert (= 9 (+ V40 V47))) ; Region 20
(assert (= 13 (+ V41 V48))) ; Region 21
