...
(assert (= 6 (+ V5 V6))) ; Region 5
(assert (or (= 2 (- V10 V17)) (= 2 (- V17 V10)))) ; Region 6
(assert (or (= 1 (- V11 V12)) (= 1 (- V12 V11)))) ; Region 7
(assert (= 13 (+ V13 V20))) ; Region 8
(assert (= 17 (+ V14 V15 V21 V22))) ; Region 9
(assert (= 60 (* V16 V23 V30))) ; Region 10
(assert (= 8 (* V18 V19 V26))) ; Region 11
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 12
(assert (= 30 (* V28 V29 V35 V42))) ; Region 14
(assert (= 28 (* V31 V38))) ; Region 15
(assert (= 6 (* V32 V33))) ; Region 16
(assert (= 72 (* V34 V41 V47 V48))) ; Region 17
(assert (or (= 1 (- V36 V43)) (= 1 (- V43 V36)))) ; Region 18
(assert (or (= 3 (/ V37 V44)) (= 3 (/ V44 V37)))) ; Region 19
(assert (or (= 6 (- V39 V40)) (= 6 (- V40 V39)))) ; Region 20
(assert (= 9 (+ V45 V46))) ; Region 21
(check-sat)
