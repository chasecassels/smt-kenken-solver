...
(assert (= 16 (+ V1 V8 V15))) ; Region 2
(assert (= 14 (+ V2 V9 V16))) ; Region 3
(assert (= 3 (+ V3 V4))) ; Region 4
(assert (or (= 2 (- V5 V6)) (= 2 (- V6 V5)))) ; Region 5
(assert (or (= 4 (- V10 V11)) (= 4 (- V11 V10)))) ; Region 6
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 7
(assert (= 3 (+ V13 V20))) ; Region 8
(assert (= 3 (+ V14 V21))) ; Region 9
(assert (= 13 (+ V17 V24))) ; Region 10
(assert (= 9 (+ V18 V25))) ; Region 11
(assert (= 10 (+ V22 V23))) ; Region 12
(assert (= 5 (+ V26 V27))) ; Region 13
(assert (= 5 (+ V28 V29))) ; Region 14
(assert (or (= 6 (- V30 V37)) (= 6 (- V37 V30)))) ; Region 15
(assert (or (= 2 (- V31 V32)) (= 2 (- V32 V31)))) ; Region 16
(assert (= 17 (+ V33 V40 V47))) ; Region 17
(assert (= 11 (+ V34 V41))) ; Region 18
(assert (or (= 2 (- V35 V36)) (= 2 (- V36 V35)))) ; Region 19
(assert (= 4 (+ V39 V46))) ; Region 21
(assert (or (= 6 (- V42 V43)) (= 6 (- V43 V42)))) ; Region 22
(assert (= 7 (+ V44 V45))) ; Region 23
(check-sat)
