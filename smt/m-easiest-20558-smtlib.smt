...
(assert (= 18 (* V2 V3))) ; Region 2
(assert (= 6 (* V4 V5 V12))) ; Region 3
(assert (= 24 (* V6 V13))) ; Region 4
(assert (= 12 (* V7 V14 V15))) ; Region 5
(assert (= 14 (* V8 V9))) ; Region 6
(assert (= 40 (* V10 V11 V18))) ; Region 7
(assert (= 7 (* V16 V17))) ; Region 8
(assert (= 60 (* V19 V20 V27))) ; Region 9
(assert (= 30 (* V21 V22 V29))) ; Region 10
(assert (= 6 (* V23 V24 V31))) ; Region 11
(assert (= 28 (* V25 V26))) ; Region 12
(assert (= 48 (* V28 V35 V42))) ; Region 13
(assert (= 18 (* V32 V39))) ; Region 15
(assert (= 105 (* V33 V34 V41))) ; Region 16
(assert (= 6 (* V36 V43))) ; Region 17
(assert (= 35 (* V37 V38))) ; Region 18
(assert (= 7 (* V40 V47 V48))) ; Region 19
(assert (= 24 (* V44 V45))) ; Region 20
(check-sat)
