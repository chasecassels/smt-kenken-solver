...
(assert (or (= 6 (- V2 V9)) (= 6 (- V9 V2)))) ; Region 2
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 3
(assert (= 40 (* V5 V6 V13))) ; Region 4
(assert (= 13 (+ V7 V8))) ; Region 5
(assert (or (= 2 (/ V10 V17)) (= 2 (/ V17 V10)))) ; Region 6
(assert (= 16 (+ V11 V12 V18 V19))) ; Region 7
(assert (= 11 (+ V14 V21))) ; Region 8
(assert (= 6 (* V15 V16 V22))) ; Region 9
(assert (or (= 3 (/ V20 V27)) (= 3 (/ V27 V20)))) ; Region 10
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 11
(assert (= 35 (* V25 V26))) ; Region 12
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 13
(assert (= 12 (+ V30 V36 V37))) ; Region 15
(assert (= 11 (+ V31 V32 V38))) ; Region 16
(assert (= 16 (+ V33 V34 V40))) ; Region 17
(assert (= 14 (+ V39 V46 V47))) ; Region 18
