...
(assert (= 7 (+ V2 V3))) ; Region 3
(assert (= 6 (+ V4 V11))) ; Region 4
(assert (= 12 (+ V5 V6))) ; Region 5
(assert (= 13 (+ V9 V10))) ; Region 6
(assert (= 5 (+ V12 V13))) ; Region 7
(assert (= 7 (+ V14 V15))) ; Region 8
(assert (= 8 (+ V16 V17))) ; Region 9
(assert (= 6 (+ V18 V19))) ; Region 10
(assert (= 13 (+ V20 V27))) ; Region 11
(assert (= 8 (+ V21 V22))) ; Region 12
(assert (= 10 (+ V23 V30))) ; Region 13
(assert (= 6 (+ V24 V31))) ; Region 14
(assert (= 3 (+ V25 V26))) ; Region 15
(assert (= 11 (+ V28 V29))) ; Region 16
(assert (= 11 (+ V32 V33))) ; Region 17
(assert (= 15 (+ V35 V42 V43))) ; Region 19
(assert (= 3 (+ V36 V37))) ; Region 20
(assert (= 8 (+ V38 V39))) ; Region 21
(assert (= 10 (+ V40 V47))) ; Region 22
(assert (= 7 (+ V41 V48))) ; Region 23
(assert (= 6 (+ V44 V45))) ; Region 24
(check-sat)
