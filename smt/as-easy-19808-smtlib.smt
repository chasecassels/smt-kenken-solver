...
(assert (= 13 (+ V1 V2))) ; Region 2
(assert (= 14 (+ V3 V4 V11))) ; Region 3
(assert (= 7 (+ V5 V12))) ; Region 4
(assert (or (= 4 (- V6 V13)) (= 4 (- V13 V6)))) ; Region 5
(assert (= 14 (+ V8 V15 V16))) ; Region 6
(assert (= 3 (+ V9 V10))) ; Region 7
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 8
(assert (= 4 (+ V18 V19))) ; Region 10
(assert (= 13 (+ V20 V27))) ; Region 11
(assert (= 18 (+ V23 V24 V30 V37))) ; Region 13
(assert (or (= 4 (- V25 V26)) (= 4 (- V26 V25)))) ; Region 14
(assert (or (= 2 (- V28 V29)) (= 2 (- V29 V28)))) ; Region 15
(assert (= 8 (+ V31 V38))) ; Region 16
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 17
(assert (or (= 1 (- V34 V41)) (= 1 (- V41 V34)))) ; Region 19
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 20
(assert (= 4 (+ V36 V43))) ; Region 21
(assert (= 11 (+ V40 V46 V47))) ; Region 22
(assert (or (= 6 (- V44 V45)) (= 6 (- V45 V44)))) ; Region 23
(check-sat)
