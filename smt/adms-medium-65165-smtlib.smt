...
(assert (= 10 (+ V2 V3 V10))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (or (= 5 (- V6 V13)) (= 5 (- V13 V6)))) ; Region 4
(assert (= 72 (* V7 V8 V9 V15))) ; Region 5
(assert (or (= 2 (- V11 V12)) (= 2 (- V12 V11)))) ; Region 6
(assert (= 10 (* V14 V21))) ; Region 7
(assert (= 9 (+ V16 V23 V30))) ; Region 8
(assert (= 18 (+ V17 V18 V19))) ; Region 9
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 10
(assert (= 14 (* V22 V29))) ; Region 11
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 12
(assert (= 12 (* V25 V26 V33))) ; Region 13
(assert (= 9 (+ V32 V38 V39))) ; Region 15
(assert (= 126 (* V34 V40 V41))) ; Region 16
(assert (= 5 (+ V35 V42))) ; Region 17
(assert (or (= 5 (- V36 V43)) (= 5 (- V43 V36)))) ; Region 18
(assert (or (= 2 (- V37 V44)) (= 2 (- V44 V37)))) ; Region 19
(assert (or (= 2 (- V45 V46)) (= 2 (- V46 V45)))) ; Region 20
(assert (= 15 (* V47 V48))) ; Region 21
(check-sat)
