...
(assert (= 252 (* V0 V7 V8 V15))) ; Region 1
(assert (or (= 2 (/ V1 V2)) (= 2 (/ V2 V1)))) ; Region 2
(assert (= 42 (* V3 V9 V10))) ; Region 3
(assert (= 60 (* V4 V5 V11))) ; Region 4
(assert (= 15 (* V6 V12 V13))) ; Region 5
(assert (= 30 (* V14 V21 V28))) ; Region 6
(assert (= 120 (* V16 V17 V18 V23 V24))) ; Region 7
(assert (= 84 (* V19 V25 V26))) ; Region 8
(assert (= 336 (* V20 V27 V33 V34))) ; Region 9
(assert (= 12 (* V22 V29 V30))) ; Region 10
(assert (= 105 (* V31 V32 V38))) ; Region 11
(assert (= 560 (* V35 V36 V37 V44))) ; Region 12
(assert (= 24 (* V40 V41 V47 V48))) ; Region 14
(assert (= 15 (* V42 V43))) ; Region 15
(assert (= 42 (* V45 V46))) ; Region 16
(check-sat)
