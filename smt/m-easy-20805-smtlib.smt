...
(assert (= 84 (* V3 V4 V10))) ; Region 3
(assert (= 70 (* V5 V6 V12 V13))) ; Region 4
(assert (= 60 (* V8 V14 V15 V21))) ; Region 5
(assert (= 42 (* V17 V18))) ; Region 7
(assert (= 18 (* V19 V26))) ; Region 8
(assert (= 30 (* V20 V27 V34))) ; Region 9
(assert (= 420 (* V22 V28 V29 V35))) ; Region 10
(assert (= 14 (* V23 V24 V30))) ; Region 11
(assert (= 12 (* V25 V32 V33))) ; Region 12
(assert (= 84 (* V36 V42 V43))) ; Region 14
(assert (= 15 (* V37 V38 V44))) ; Region 15
(assert (= 14 (* V39 V40))) ; Region 16
(assert (= 24 (* V41 V47 V48))) ; Region 17
(assert (= 20 (* V45 V46))) ; Region 18
(check-sat)
