...
(assert (= 11 (+ V3 V10))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (= 9 (+ V6 V13))) ; Region 4
(assert (= 15 (+ V7 V8 V15))) ; Region 5
(assert (= 5 (+ V11 V12))) ; Region 7
(assert (= 12 (+ V16 V23))) ; Region 9
(assert (= 3 (+ V17 V18))) ; Region 10
(assert (= 9 (+ V19 V20))) ; Region 11
(assert (= 3 (+ V21 V22))) ; Region 12
(assert (= 7 (+ V24 V31))) ; Region 13
(assert (= 9 (+ V25 V26))) ; Region 14
(assert (= 5 (+ V27 V34))) ; Region 15
(assert (= 13 (+ V28 V29))) ; Region 16
(assert (= 9 (+ V30 V36 V37))) ; Region 17
(assert (= 8 (+ V32 V33))) ; Region 18
(assert (= 5 (+ V35 V42))) ; Region 19
(assert (= 8 (+ V38 V39))) ; Region 20
(assert (= 13 (+ V40 V41))) ; Region 21
(assert (= 3 (+ V43 V44))) ; Region 22
