...
(assert (= 16 (+ V4 V5 V6))) ; Region 3
(assert (= 10 (+ V7 V8 V9))) ; Region 4
(assert (= 11 (+ V10 V11 V18))) ; Region 5
(assert (= 15 (+ V12 V13 V19))) ; Region 6
(assert (= 13 (+ V14 V15))) ; Region 7
(assert (= 6 (+ V16 V17 V23))) ; Region 8
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 9
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 10
(assert (= 15 (+ V22 V29 V30))) ; Region 11
(assert (or (= 3 (- V24 V31)) (= 3 (- V31 V24)))) ; Region 12
(assert (or (= 6 (- V25 V32)) (= 6 (- V32 V25)))) ; Region 13
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 14
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 15
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 16
(assert (= 7 (+ V36 V43))) ; Region 17
(assert (= 17 (+ V37 V44 V45))) ; Region 18
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 20
(assert (= 6 (+ V40 V47 V48))) ; Region 21
(check-sat)
