...
(assert (= 21 (* V7 V14))) ; Region 6
(assert (or (= 5 (- V8 V15)) (= 5 (- V15 V8)))) ; Region 7
(assert (or (= 5 (- V11 V12)) (= 5 (- V12 V11)))) ; Region 8
(assert (or (= 6 (- V16 V23)) (= 6 (- V23 V16)))) ; Region 9
(assert (= 9 (+ V18 V19 V26))) ; Region 10
(assert (= 9 (+ V20 V27 V34))) ; Region 11
(assert (= 14 (+ V21 V22 V28))) ; Region 12
(assert (or (= 6 (- V24 V31)) (= 6 (- V31 V24)))) ; Region 13
(assert (= 60 (* V25 V32 V33))) ; Region 14
(assert (= 15 (* V29 V30))) ; Region 15
(assert (= 25 (* V35 V42 V43))) ; Region 16
(assert (or (= 5 (- V36 V37)) (= 5 (- V37 V36)))) ; Region 17
(assert (= 13 (+ V38 V39 V46))) ; Region 18
(assert (= 16 (+ V40 V47 V48))) ; Region 19
(assert (= 5 (+ V44 V45))) ; Region 21
(check-sat)
