...
(assert (= 30 (* V2 V3 V9 V15 V16))) ; Region 2
(assert (= 420 (* V4 V5 V6 V12))) ; Region 3
(assert (= 252 (* V7 V14 V21 V28))) ; Region 4
(assert (= 2520 (* V10 V11 V13 V18 V19 V20))) ; Region 5
(assert (= 48 (* V17 V24 V25 V32 V33))) ; Region 6
(assert (= 140 (* V22 V23 V29))) ; Region 7
(assert (= 10 (* V26 V27))) ; Region 8
(assert (= 36 (* V30 V31 V37))) ; Region 9
(assert (= 10 (* V35 V36 V42))) ; Region 11
(assert (= 420 (* V38 V43 V44 V45))) ; Region 12
(assert (= 72 (* V39 V40 V46))) ; Region 13
(assert (= 28 (* V41 V47 V48))) ; Region 14
(check-sat)
