...
(assert (= 17 (+ V2 V7 V8 V9))) ; Region 2
(assert (= 6 (+ V3 V4 V5))) ; Region 3
(assert (= 5 (+ V6 V13))) ; Region 4
(assert (= 14 (+ V10 V11 V17))) ; Region 5
(assert (= 14 (+ V12 V18 V19))) ; Region 6
(assert (= 6 (+ V14 V15))) ; Region 7
(assert (= 14 (+ V16 V23 V24 V31))) ; Region 8
(assert (= 10 (+ V20 V27))) ; Region 9
(assert (= 14 (+ V21 V22 V28))) ; Region 10
(assert (= 6 (+ V25 V32))) ; Region 11
(assert (= 3 (+ V26 V33))) ; Region 12
(assert (= 12 (+ V29 V30))) ; Region 13
(assert (= 11 (+ V34 V41))) ; Region 14
(assert (= 3 (+ V35 V36))) ; Region 15
(assert (= 10 (+ V37 V38))) ; Region 16
(assert (= 10 (+ V39 V40))) ; Region 17
(assert (= 7 (+ V42 V43))) ; Region 18
(assert (= 12 (+ V44 V45 V46))) ; Region 19
(assert (= 9 (+ V47 V48))) ; Region 20
(check-sat)
