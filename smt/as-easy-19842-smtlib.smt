...
(assert (= 22 (+ V2 V9 V10 V16))) ; Region 2
(assert (= 9 (+ V3 V4))) ; Region 3
(assert (= 5 (+ V5 V6))) ; Region 4
(assert (or (= 6 (- V7 V14)) (= 6 (- V14 V7)))) ; Region 5
(assert (= 7 (+ V11 V12 V13))) ; Region 7
(assert (= 7 (+ V15 V22))) ; Region 8
(assert (= 13 (+ V17 V18))) ; Region 9
(assert (= 14 (+ V19 V20 V27))) ; Region 10
(assert (or (= 3 (- V23 V24)) (= 3 (- V24 V23)))) ; Region 12
(assert (or (= 5 (- V25 V26)) (= 5 (- V26 V25)))) ; Region 13
(assert (= 10 (+ V28 V35 V36))) ; Region 14
(assert (= 13 (+ V29 V30))) ; Region 15
(assert (= 3 (+ V31 V38))) ; Region 16
(assert (= 4 (+ V32 V33))) ; Region 17
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 18
(assert (= 8 (+ V37 V44 V45))) ; Region 19
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 20
(assert (= 11 (+ V42 V43))) ; Region 22
