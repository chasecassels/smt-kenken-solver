...
(assert (= 6 (+ V3 V10 V17))) ; Region 2
(assert (= 10 (+ V4 V5))) ; Region 3
(assert (= 18 (+ V6 V13 V20))) ; Region 4
(assert (= 10 (+ V7 V8 V14))) ; Region 5
(assert (= 10 (+ V9 V16))) ; Region 6
(assert (= 9 (+ V11 V18))) ; Region 7
(assert (= 6 (+ V12 V19))) ; Region 8
(assert (= 18 (+ V15 V22 V29))) ; Region 9
(assert (= 11 (+ V21 V28))) ; Region 10
(assert (= 10 (+ V23 V30 V31))) ; Region 11
(assert (= 9 (+ V24 V25))) ; Region 12
(assert (= 5 (+ V26 V27))) ; Region 13
(assert (= 7 (+ V32 V33))) ; Region 14
(assert (= 7 (+ V34 V41 V48))) ; Region 15
(assert (= 9 (+ V35 V42))) ; Region 16
(assert (= 7 (+ V36 V37))) ; Region 17
(assert (= 12 (+ V38 V39 V40))) ; Region 18
(assert (= 6 (+ V43 V44))) ; Region 19
(assert (= 9 (+ V45 V46))) ; Region 20
(check-sat)
