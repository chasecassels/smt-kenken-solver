...
(assert (= 14 (+ V8 V9 V10 V16))) ; Region 6
(assert (= 13 (+ V12 V19))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 8
(assert (= 13 (+ V15 V22 V23))) ; Region 9
(assert (= 5 (+ V17 V24))) ; Region 10
(assert (= 9 (+ V18 V25))) ; Region 11
(assert (= 13 (+ V20 V27))) ; Region 12
(assert (= 6 (+ V26 V33 V34))) ; Region 13
(assert (= 9 (+ V28 V35))) ; Region 14
(assert (= 9 (+ V29 V30))) ; Region 15
(assert (= 10 (+ V31 V32))) ; Region 16
(assert (= 10 (+ V36 V37 V44))) ; Region 17
(assert (= 17 (+ V38 V45 V46))) ; Region 18
(assert (= 7 (+ V39 V40))) ; Region 19
