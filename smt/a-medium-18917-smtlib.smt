...
(assert (= 8 (+ V3 V4))) ; Region 4
(assert (= 10 (+ V5 V6 V12))) ; Region 5
(assert (= 9 (+ V10 V11))) ; Region 6
(assert (= 9 (+ V13 V20 V27))) ; Region 7
(assert (= 7 (+ V14 V21))) ; Region 8
(assert (= 6 (+ V15 V22))) ; Region 9
(assert (= 15 (+ V16 V17 V18))) ; Region 10
(assert (= 13 (+ V19 V26))) ; Region 11
(assert (= 7 (+ V23 V24 V25))) ; Region 12
(assert (= 3 (+ V28 V35))) ; Region 13
(assert (= 11 (+ V29 V30 V31))) ; Region 14
(assert (= 9 (+ V32 V33))) ; Region 15
(assert (= 19 (+ V34 V40 V41 V48))) ; Region 16
(assert (= 10 (+ V36 V37))) ; Region 17
(assert (= 7 (+ V38 V45))) ; Region 18
(assert (= 7 (+ V39 V46 V47))) ; Region 19
