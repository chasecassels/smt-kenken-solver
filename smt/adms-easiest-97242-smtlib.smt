...
(assert (= 8 (+ V1 V2 V9))) ; Region 2
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 3
(assert (= 672 (* V5 V12 V19 V20))) ; Region 4
(assert (or (= 6 (- V6 V13)) (= 6 (- V13 V6)))) ; Region 5
(assert (or (= 2 (- V7 V8)) (= 2 (- V8 V7)))) ; Region 6
(assert (or (= 3 (/ V10 V17)) (= 3 (/ V17 V10)))) ; Region 7
(assert (= 5 (+ V11 V18))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 10
(assert (= 60 (* V16 V23 V30))) ; Region 11
(assert (= 16 (+ V24 V25 V31))) ; Region 12
(assert (= 11 (+ V27 V34))) ; Region 14
(assert (= 8 (* V28 V35 V42))) ; Region 15
(assert (or (= 3 (- V29 V36)) (= 3 (- V36 V29)))) ; Region 16
(assert (= 6 (* V32 V33))) ; Region 17
(assert (= 42 (* V37 V44))) ; Region 18
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 19
(assert (= 8 (+ V39 V46))) ; Region 20
(assert (or (= 3 (/ V40 V41)) (= 3 (/ V41 V40)))) ; Region 21
