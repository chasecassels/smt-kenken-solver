...
(assert (= 126 (* V2 V3 V9 V10))) ; Region 2
(assert (= 35 (* V4 V5 V11))) ; Region 3
(assert (= 360 (* V6 V12 V13 V18 V19))) ; Region 4
(assert (= 32 (* V7 V8 V15 V16))) ; Region 5
(assert (= 147 (* V14 V21 V22 V29))) ; Region 6
(assert (= 210 (* V20 V26 V27))) ; Region 8
(assert (= 12 (* V23 V24))) ; Region 9
(assert (= 48 (* V25 V31 V32))) ; Region 10
(assert (= 60 (* V28 V35 V42))) ; Region 11
(assert (= 420 (* V30 V37 V38 V39))) ; Region 12
(assert (= 12 (* V33 V34 V41 V48))) ; Region 13
(assert (= 30 (* V36 V43 V44))) ; Region 14
(assert (= 12 (* V40 V47))) ; Region 15
(assert (= 14 (* V45 V46))) ; Region 16
(check-sat)
