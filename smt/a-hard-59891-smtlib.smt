...
(assert (= 10 (+ V1 V2 V8))) ; Region 2
(assert (= 6 (+ V3 V4))) ; Region 3
(assert (= 10 (+ V5 V6))) ; Region 4
(assert (= 9 (+ V9 V10 V11))) ; Region 5
(assert (= 10 (+ V12 V19))) ; Region 6
(assert (= 12 (+ V13 V20 V27))) ; Region 7
(assert (= 15 (+ V14 V21 V28))) ; Region 8
(assert (= 7 (+ V15 V16 V22))) ; Region 9
(assert (= 11 (+ V17 V18))) ; Region 10
(assert (= 8 (+ V23 V24))) ; Region 11
(assert (= 9 (+ V25 V26))) ; Region 12
(assert (= 13 (+ V29 V30 V37))) ; Region 13
(assert (= 9 (+ V32 V33))) ; Region 15
(assert (= 7 (+ V34 V41))) ; Region 16
(assert (= 12 (+ V35 V36 V42))) ; Region 17
(assert (= 6 (+ V38 V39 V40))) ; Region 18
(assert (= 12 (+ V43 V44 V45))) ; Region 19
