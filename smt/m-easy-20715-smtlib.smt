...
(assert (= 21 (* V0 V1))) ; Region 1
(assert (= 28 (* V2 V8 V9))) ; Region 2
(assert (= 12 (* V3 V10))) ; Region 3
(assert (= 20 (* V4 V11 V12))) ; Region 4
(assert (= 30 (* V5 V6))) ; Region 5
(assert (= 210 (* V7 V14 V21))) ; Region 6
(assert (= 12 (* V13 V19 V20))) ; Region 7
(assert (= 15 (* V15 V16))) ; Region 8
(assert (= 28 (* V17 V18 V25 V26))) ; Region 9
(assert (= 24 (* V22 V23 V28 V29))) ; Region 10
(assert (= 72 (* V24 V30 V31))) ; Region 11
(assert (= 20 (* V27 V34))) ; Region 12
(assert (= 21 (* V32 V33 V39))) ; Region 13
(assert (= 24 (* V35 V36 V42 V43))) ; Region 14
(assert (= 140 (* V37 V38 V44))) ; Region 15
(assert (= 84 (* V40 V41 V48))) ; Region 16
(assert (= 90 (* V45 V46 V47))) ; Region 17
(check-sat)
