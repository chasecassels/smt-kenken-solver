...
(assert (= 17 (+ V2 V3 V4 V5))) ; Region 2
(assert (= 8 (+ V6 V13))) ; Region 3
(assert (= 11 (+ V7 V8))) ; Region 4
(assert (= 18 (+ V9 V16 V17))) ; Region 5
(assert (= 7 (+ V11 V18))) ; Region 7
(assert (= 3 (+ V12 V19))) ; Region 8
(assert (= 7 (+ V14 V21))) ; Region 9
(assert (= 13 (+ V15 V22))) ; Region 10
(assert (= 8 (+ V20 V27))) ; Region 11
(assert (= 3 (+ V23 V24))) ; Region 12
(assert (= 13 (+ V25 V32))) ; Region 13
(assert (= 11 (+ V26 V33 V34))) ; Region 14
(assert (= 11 (+ V28 V35))) ; Region 15
(assert (= 4 (+ V29 V30))) ; Region 16
(assert (= 7 (+ V31 V38))) ; Region 17
(assert (= 8 (+ V36 V37))) ; Region 18
(assert (= 11 (+ V39 V45 V46))) ; Region 19
(assert (= 10 (+ V40 V47))) ; Region 20
(assert (= 10 (+ V41 V48))) ; Region 21
(assert (= 9 (+ V42 V43 V44))) ; Region 22
(check-sat)
