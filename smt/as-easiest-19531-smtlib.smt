...
(assert (= 3 (+ V3 V10))) ; Region 3
(assert (or (= 6 (- V5 V12)) (= 6 (- V12 V5)))) ; Region 5
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 6
(assert (or (= 1 (- V8 V9)) (= 1 (- V9 V8)))) ; Region 7
(assert (= 9 (+ V11 V18))) ; Region 8
(assert (= 8 (+ V15 V16))) ; Region 9
(assert (or (= 1 (- V17 V24)) (= 1 (- V24 V17)))) ; Region 10
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 11
(assert (= 12 (+ V20 V27))) ; Region 12
(assert (= 3 (+ V21 V22))) ; Region 13
(assert (= 9 (+ V25 V32))) ; Region 15
(assert (= 9 (+ V28 V35))) ; Region 16
(assert (or (= 6 (- V29 V30)) (= 6 (- V30 V29)))) ; Region 17
(assert (= 6 (+ V33 V34))) ; Region 19
(assert (= 9 (+ V36 V43))) ; Region 20
(assert (= 6 (+ V37 V44))) ; Region 21
(assert (or (= 6 (- V38 V39)) (= 6 (- V39 V38)))) ; Region 22
(assert (or (= 4 (- V40 V41)) (= 4 (- V41 V40)))) ; Region 23
(assert (= 9 (+ V45 V46))) ; Region 25
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 26
(check-sat)
