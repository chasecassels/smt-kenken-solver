...
(assert (= 30 (* V2 V3 V9))) ; Region 2
(assert (= 84 (* V4 V5 V6 V12))) ; Region 3
(assert (= 28 (* V7 V8 V14))) ; Region 4
(assert (= 40 (* V10 V11 V17))) ; Region 5
(assert (= 525 (* V13 V20 V26 V27))) ; Region 6
(assert (= 18 (* V15 V16 V21 V22))) ; Region 7
(assert (= 42 (* V18 V19))) ; Region 8
(assert (= 14 (* V23 V30))) ; Region 9
(assert (= 72 (* V24 V25 V32 V39))) ; Region 10
(assert (= 120 (* V28 V29 V35))) ; Region 11
(assert (= 168 (* V31 V38 V44 V45))) ; Region 12
(assert (= 24 (* V33 V34 V41))) ; Region 13
(assert (= 105 (* V36 V37 V42 V43))) ; Region 14
(assert (= 24 (* V40 V47 V48))) ; Region 15
(check-sat)
