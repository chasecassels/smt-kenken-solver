...
(assert (= 18 (+ V4 V5 V11 V12))) ; Region 3
(assert (= 12 (+ V6 V13 V20))) ; Region 4
(assert (or (= 4 (- V7 V14)) (= 4 (- V14 V7)))) ; Region 5
(assert (= 15 (+ V9 V10 V16 V23))) ; Region 7
(assert (= 6 (+ V15 V22))) ; Region 8
(assert (= 13 (+ V17 V18))) ; Region 9
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 11
(assert (or (= 1 (- V25 V26)) (= 1 (- V26 V25)))) ; Region 13
(assert (= 7 (+ V27 V33 V34))) ; Region 14
(assert (= 13 (+ V29 V30))) ; Region 15
(assert (or (= 5 (- V31 V38)) (= 5 (- V38 V31)))) ; Region 16
