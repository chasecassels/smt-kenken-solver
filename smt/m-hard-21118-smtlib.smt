...
(assert (= 210 (* V2 V9 V10 V16))) ; Region 2
(assert (= 24 (* V3 V4))) ; Region 3
(assert (= 420 (* V5 V6 V12 V13))) ; Region 4
(assert (= 192 (* V8 V14 V15 V21))) ; Region 5
(assert (= 420 (* V11 V17 V18 V23 V24))) ; Region 6
(assert (= 126 (* V19 V20 V26 V32 V33))) ; Region 7
(assert (= 90 (* V22 V28 V29 V36 V37))) ; Region 8
(assert (= 24 (* V27 V34))) ; Region 10
(assert (= 10 (* V30 V31))) ; Region 11
(assert (= 245 (* V35 V42 V43))) ; Region 12
(assert (= 120 (* V38 V39 V40 V41 V46))) ; Region 13
(assert (= 12 (* V44 V45))) ; Region 14
(assert (= 12 (* V47 V48))) ; Region 15
(check-sat)
