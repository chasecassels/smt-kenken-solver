...
(assert (= 8 (+ V2 V3 V9))) ; Region 3
(assert (= 7 (+ V4 V5))) ; Region 4
(assert (= 13 (+ V6 V13))) ; Region 5
(assert (= 8 (+ V8 V15))) ; Region 6
(assert (= 18 (+ V10 V17 V18))) ; Region 7
(assert (= 4 (+ V11 V12))) ; Region 8
(assert (= 12 (+ V14 V21 V22))) ; Region 9
(assert (= 13 (+ V16 V23))) ; Region 10
(assert (= 3 (+ V19 V26))) ; Region 11
(assert (= 5 (+ V24 V31))) ; Region 13
(assert (= 12 (+ V25 V32))) ; Region 14
(assert (= 3 (+ V27 V34))) ; Region 15
(assert (= 8 (+ V28 V35))) ; Region 16
(assert (= 13 (+ V29 V36))) ; Region 17
(assert (= 5 (+ V30 V37))) ; Region 18
(assert (= 10 (+ V38 V39 V46))) ; Region 20
(assert (= 9 (+ V40 V41))) ; Region 21
(assert (= 3 (+ V42 V43))) ; Region 22
(assert (= 9 (+ V44 V45))) ; Region 23
(assert (= 12 (+ V47 V48))) ; Region 24
(check-sat)
