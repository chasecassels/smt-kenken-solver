...
(assert (= 56 (* V1 V2 V8))) ; Region 2
(assert (= 12 (* V3 V4))) ; Region 3
(assert (= 42 (* V6 V12 V13))) ; Region 5
(assert (= 3 (* V9 V15 V16))) ; Region 6
(assert (= 10 (* V10 V11))) ; Region 7
(assert (= 12 (* V17 V18 V24))) ; Region 8
(assert (= 40 (* V19 V20 V27))) ; Region 9
(assert (= 12 (* V21 V28))) ; Region 10
(assert (= 20 (* V22 V23))) ; Region 11
(assert (= 21 (* V25 V26))) ; Region 12
(assert (= 42 (* V29 V36))) ; Region 13
(assert (= 35 (* V30 V31))) ; Region 14
(assert (= 24 (* V32 V33 V39))) ; Region 15
(assert (= 84 (* V34 V41 V48))) ; Region 16
(assert (= 12 (* V35 V42 V43))) ; Region 17
(assert (= 12 (* V37 V44))) ; Region 18
