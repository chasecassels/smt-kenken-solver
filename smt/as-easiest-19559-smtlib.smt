...
(assert (= 9 (+ V9 V10))) ; Region 7
(assert (or (= 4 (- V11 V12)) (= 4 (- V12 V11)))) ; Region 8
(assert (= 8 (+ V16 V17))) ; Region 9
(assert (= 9 (+ V19 V26))) ; Region 11
(assert (= 10 (+ V21 V22 V29))) ; Region 12
(assert (= 19 (+ V24 V25 V31))) ; Region 14
(assert (= 3 (+ V27 V34))) ; Region 15
(assert (= 17 (+ V28 V35 V36))) ; Region 16
(assert (or (= 6 (- V30 V37)) (= 6 (- V37 V30)))) ; Region 17
(assert (= 4 (+ V32 V33))) ; Region 18
(assert (= 8 (+ V39 V46))) ; Region 20
(assert (= 11 (+ V40 V41 V48))) ; Region 21
