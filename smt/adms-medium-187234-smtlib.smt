...
(assert (= 60 (* V0 V1 V7 V8))) ; Region 1
(assert (= 1260 (* V2 V3 V10 V11 V12))) ; Region 2
(assert (= 3 (+ V4 V5))) ; Region 3
(assert (= 28 (* V6 V13 V20))) ; Region 4
(assert (= 11 (+ V9 V15 V16))) ; Region 5
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 6
(assert (or (= 6 (- V17 V24)) (= 6 (- V24 V17)))) ; Region 7
(assert (= 18 (+ V19 V25 V26))) ; Region 9
(assert (= 3 (+ V22 V29))) ; Region 10
(assert (= 15 (+ V23 V30 V31))) ; Region 11
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 12
(assert (= 1960 (* V28 V35 V42 V43 V44))) ; Region 13
(assert (= 60 (* V32 V33 V39))) ; Region 14
(assert (= 15 (+ V36 V37 V38 V45 V46))) ; Region 15
(assert (or (= 3 (/ V40 V47)) (= 3 (/ V47 V40)))) ; Region 16
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 17
(check-sat)
