...
(assert (= 392 (* V1 V2 V3 V10 V11))) ; Region 2
(assert (= 60 (* V4 V5 V12))) ; Region 3
(assert (= 120 (* V6 V13 V20 V27))) ; Region 4
(assert (= 5 (* V8 V9))) ; Region 5
(assert (= 24 (* V14 V15 V21 V22 V28))) ; Region 6
(assert (= 168 (* V16 V17 V18))) ; Region 7
(assert (= 210 (* V19 V25 V26 V32))) ; Region 8
(assert (= 12 (* V23 V24))) ; Region 9
(assert (= 120 (* V29 V30 V31 V37))) ; Region 10
(assert (= 84 (* V33 V34 V40))) ; Region 11
(assert (= 1470 (* V35 V36 V42 V43))) ; Region 12
(assert (= 90 (* V38 V39 V45 V46))) ; Region 13
(assert (= 6 (* V41 V47 V48))) ; Region 14
(check-sat)
