...
(assert (= 6 (* V5 V11 V12))) ; Region 3
(assert (= 84 (* V6 V13 V20))) ; Region 4
(assert (= 30 (* V7 V8 V15))) ; Region 5
(assert (= 56 (* V9 V10 V16 V17))) ; Region 6
(assert (= 105 (* V14 V21 V28))) ; Region 7
(assert (= 20 (* V18 V19 V25))) ; Region 8
(assert (= 28 (* V22 V29))) ; Region 9
(assert (= 72 (* V23 V24 V31))) ; Region 10
(assert (= 60 (* V26 V27 V34))) ; Region 11
(assert (= 10 (* V30 V36 V37))) ; Region 12
(assert (= 14 (* V33 V40 V41))) ; Region 14
(assert (= 12 (* V35 V42 V43))) ; Region 15
(assert (= 12 (* V38 V39))) ; Region 16
(assert (= 12 (* V44 V45))) ; Region 17
(assert (= 210 (* V46 V47 V48))) ; Region 18
(check-sat)
