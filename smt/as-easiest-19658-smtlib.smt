...
(assert (= 8 (+ V6 V13))) ; Region 5
(assert (or (= 6 (- V7 V14)) (= 6 (- V14 V7)))) ; Region 6
(assert (= 9 (+ V8 V9 V16))) ; Region 7
(assert (= 12 (+ V11 V12))) ; Region 8
(assert (= 4 (+ V15 V22))) ; Region 9
(assert (= 11 (+ V17 V18 V24))) ; Region 10
(assert (or (= 4 (- V19 V26)) (= 4 (- V26 V19)))) ; Region 11
(assert (= 13 (+ V20 V27))) ; Region 12
(assert (= 11 (+ V21 V28 V35))) ; Region 13
(assert (= 13 (+ V25 V32 V33))) ; Region 15
(assert (= 13 (+ V29 V30))) ; Region 16
(assert (= 7 (+ V34 V41 V48))) ; Region 18
(assert (= 15 (+ V36 V42 V43))) ; Region 19
(assert (= 14 (+ V37 V38 V44))) ; Region 20
(assert (or (= 4 (- V40 V47)) (= 4 (- V47 V40)))) ; Region 22
(assert (or (= 6 (- V45 V46)) (= 6 (- V46 V45)))) ; Region 23
(check-sat)
