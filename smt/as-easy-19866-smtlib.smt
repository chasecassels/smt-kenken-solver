...
(assert (= 10 (+ V1 V2 V3))) ; Region 2
(assert (or (= 6 (- V4 V5)) (= 6 (- V5 V4)))) ; Region 3
(assert (= 6 (+ V6 V13))) ; Region 4
(assert (= 12 (+ V8 V14 V15))) ; Region 5
(assert (= 8 (+ V9 V16))) ; Region 6
(assert (= 13 (+ V10 V17))) ; Region 7
(assert (= 7 (+ V11 V18 V25))) ; Region 8
(assert (= 12 (+ V12 V19))) ; Region 9
(assert (= 14 (+ V20 V26 V27))) ; Region 10
(assert (= 7 (+ V21 V22))) ; Region 11
(assert (= 11 (+ V23 V30))) ; Region 12
(assert (= 3 (+ V24 V31))) ; Region 13
(assert (= 7 (+ V28 V35))) ; Region 14
(assert (= 13 (+ V29 V36))) ; Region 15
(assert (= 14 (+ V32 V38 V39))) ; Region 16
(assert (= 9 (+ V33 V40 V47))) ; Region 17
(assert (or (= 6 (- V34 V41)) (= 6 (- V41 V34)))) ; Region 18
(assert (= 4 (+ V37 V44))) ; Region 19
(assert (or (= 6 (- V42 V43)) (= 6 (- V43 V42)))) ; Region 20
