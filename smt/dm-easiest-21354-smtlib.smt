...
(assert (= 12 (* V0 V1))) ; Region 1
(assert (= 30 (* V2 V3))) ; Region 2
(assert (= 42 (* V4 V11))) ; Region 3
(assert (= 4 (* V5 V12))) ; Region 4
(assert (= 6 (* V6 V13))) ; Region 5
(assert (= 7 (* V7 V14))) ; Region 6
(assert (= 35 (* V8 V9))) ; Region 7
(assert (= 2 (* V10 V17))) ; Region 8
(assert (= 20 (* V15 V16))) ; Region 9
(assert (= 6 (* V18 V19))) ; Region 10
(assert (= 120 (* V20 V27 V34))) ; Region 11
(assert (= 10 (* V21 V28))) ; Region 12
(assert (or (= 2 (/ V22 V23)) (= 2 (/ V23 V22)))) ; Region 13
(assert (= 7 (* V24 V25))) ; Region 14
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 15
(assert (= 28 (* V29 V30 V31))) ; Region 16
(assert (= 12 (* V32 V39))) ; Region 17
(assert (or (= 3 (/ V35 V36)) (= 3 (/ V36 V35)))) ; Region 18
(assert (or (= 3 (/ V37 V38)) (= 3 (/ V38 V37)))) ; Region 19
(assert (= 35 (* V40 V41 V48))) ; Region 20
(assert (= 8 (* V43 V44))) ; Region 22
(assert (= 210 (* V45 V46 V47))) ; Region 23
(check-sat)
