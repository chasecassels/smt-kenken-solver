...
(assert (or (= 1 (- V4 V5)) (= 1 (- V5 V4)))) ; Region 3
(assert (= 10 (+ V6 V13))) ; Region 4
(assert (= 14 (+ V7 V14 V21))) ; Region 5
(assert (= 16 (* V8 V15 V16))) ; Region 6
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 7
(assert (= 11 (+ V11 V18))) ; Region 8
(assert (= 35 (* V17 V24))) ; Region 10
(assert (= 6 (+ V19 V26))) ; Region 11
(assert (or (= 2 (- V20 V27)) (= 2 (- V27 V20)))) ; Region 12
(assert (= 54 (* V22 V23 V30))) ; Region 13
(assert (= 3 (+ V25 V32))) ; Region 14
(assert (= 30 (* V28 V29))) ; Region 15
(assert (= 28 (* V33 V34 V40))) ; Region 17
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 18
(assert (or (= 4 (- V36 V43)) (= 4 (- V43 V36)))) ; Region 19
(assert (= 12 (* V37 V38))) ; Region 20
(assert (= 10 (+ V39 V46))) ; Region 21
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 23
(assert (= 11 (+ V47 V48))) ; Region 24
(check-sat)
