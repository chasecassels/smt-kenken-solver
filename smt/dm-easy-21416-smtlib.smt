...
(assert (= 84 (* V1 V2 V8))) ; Region 2
(assert (= 14 (* V3 V4))) ; Region 3
(assert (= 30 (* V5 V6))) ; Region 4
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 5
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 6
(assert (= 84 (* V12 V13 V19 V20))) ; Region 7
(assert (= 48 (* V14 V15 V21))) ; Region 8
(assert (= 10 (* V17 V24 V31))) ; Region 9
(assert (= 28 (* V18 V25 V26 V32))) ; Region 10
(assert (= 30 (* V22 V23))) ; Region 11
(assert (= 15 (* V27 V34))) ; Region 12
(assert (= 21 (* V28 V29))) ; Region 13
(assert (= 60 (* V30 V35 V36 V37))) ; Region 14
(assert (= 42 (* V33 V39 V40))) ; Region 15
(assert (or (= 2 (/ V41 V48)) (= 2 (/ V48 V41)))) ; Region 17
(assert (or (= 3 (/ V42 V43)) (= 3 (/ V43 V42)))) ; Region 18
(assert (= 840 (* V44 V45 V46 V47))) ; Region 19
(check-sat)
