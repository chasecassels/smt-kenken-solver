...
(assert (= 36 (* V4 V5 V10 V11))) ; Region 3
(assert (= 105 (* V6 V12 V13))) ; Region 4
(assert (= 42 (* V7 V14 V21))) ; Region 5
(assert (or (= 2 (/ V8 V9)) (= 2 (/ V9 V8)))) ; Region 6
(assert (= 60 (* V15 V16 V22))) ; Region 7
(assert (= 84 (* V17 V18 V25))) ; Region 8
(assert (or (= 2 (/ V19 V20)) (= 2 (/ V20 V19)))) ; Region 9
(assert (= 5 (* V23 V24))) ; Region 10
(assert (= 630 (* V26 V27 V33 V40))) ; Region 11
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 12
(assert (or (= 2 (/ V29 V30)) (= 2 (/ V30 V29)))) ; Region 13
(assert (= 210 (* V31 V32 V38 V45))) ; Region 14
(assert (= 4 (* V34 V41))) ; Region 15
(assert (= 7 (* V36 V37))) ; Region 16
(assert (= 120 (* V39 V46 V47 V48))) ; Region 17
(assert (= 42 (* V42 V43 V44))) ; Region 18
(check-sat)
