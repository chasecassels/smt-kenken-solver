...
(assert (= 11 (+ V4 V10 V11))) ; Region 3
(assert (= 3 (+ V6 V13))) ; Region 5
(assert (= 13 (+ V7 V8 V14))) ; Region 6
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 7
(assert (= 8 (+ V12 V19))) ; Region 8
(assert (= 12 (+ V15 V21 V22))) ; Region 9
(assert (or (= 4 (- V17 V24)) (= 4 (- V24 V17)))) ; Region 10
(assert (or (= 6 (- V18 V25)) (= 6 (- V25 V18)))) ; Region 11
(assert (= 10 (+ V23 V30))) ; Region 13
(assert (= 9 (+ V26 V33))) ; Region 14
(assert (= 16 (+ V27 V34 V41))) ; Region 15
(assert (= 7 (+ V28 V29))) ; Region 16
(assert (= 5 (+ V31 V38))) ; Region 17
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 19
(assert (or (= 1 (- V36 V37)) (= 1 (- V37 V36)))) ; Region 20
(assert (= 8 (+ V39 V40))) ; Region 21
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 22
(assert (or (= 4 (- V45 V46)) (= 4 (- V46 V45)))) ; Region 23
(assert (or (= 3 (- V47 V48)) (= 3 (- V48 V47)))) ; Region 24
(check-sat)
