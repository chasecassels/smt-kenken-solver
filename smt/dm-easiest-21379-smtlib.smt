...
(assert (= 168 (* V2 V3 V9))) ; Region 2
(assert (= 140 (* V4 V10 V11))) ; Region 3
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 4
(assert (= 42 (* V7 V8 V15))) ; Region 5
(assert (= 5 (* V12 V13 V20))) ; Region 6
(assert (= 140 (* V14 V21 V28))) ; Region 7
(assert (or (= 3 (/ V16 V17)) (= 3 (/ V17 V16)))) ; Region 8
(assert (= 12 (* V18 V19))) ; Region 9
(assert (or (= 3 (/ V22 V29)) (= 3 (/ V29 V22)))) ; Region 10
(assert (= 15 (* V23 V30))) ; Region 11
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 12
(assert (= 21 (* V26 V27))) ; Region 13
(assert (= 5 (* V31 V32))) ; Region 14
(assert (= 96 (* V33 V34 V40))) ; Region 15
(assert (= 24 (* V35 V42 V43))) ; Region 16
(assert (= 35 (* V36 V37))) ; Region 17
(assert (= 18 (* V38 V39))) ; Region 18
(assert (= 14 (* V41 V48))) ; Region 19
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 20
(assert (= 15 (* V46 V47))) ; Region 21
(check-sat)
