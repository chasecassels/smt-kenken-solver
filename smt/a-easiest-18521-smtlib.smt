...
(assert (= 4 (+ V1 V8))) ; Region 2
(assert (= 6 (+ V2 V3))) ; Region 3
(assert (= 8 (+ V5 V12))) ; Region 5
(assert (= 8 (+ V6 V13))) ; Region 6
(assert (= 13 (+ V10 V11))) ; Region 8
(assert (= 13 (+ V14 V21))) ; Region 9
(assert (= 3 (+ V15 V16))) ; Region 10
(assert (= 11 (+ V17 V23 V24))) ; Region 11
(assert (= 10 (+ V18 V19))) ; Region 12
(assert (= 6 (+ V20 V27))) ; Region 13
(assert (= 13 (+ V22 V29))) ; Region 14
(assert (= 6 (+ V25 V26))) ; Region 15
(assert (= 5 (+ V28 V35))) ; Region 16
(assert (= 12 (+ V30 V37))) ; Region 17
(assert (= 3 (+ V31 V32))) ; Region 18
(assert (= 10 (+ V33 V34 V40))) ; Region 19
(assert (= 9 (+ V38 V39))) ; Region 21
(assert (= 11 (+ V41 V48))) ; Region 22
(assert (= 7 (+ V42 V43))) ; Region 23
(assert (= 7 (+ V44 V45))) ; Region 24
(assert (= 10 (+ V46 V47))) ; Region 25
(check-sat)
