...
(assert (= 15 (+ V2 V9 V10 V16))) ; Region 3
(assert (= 13 (+ V4 V5))) ; Region 5
(assert (= 11 (+ V6 V12 V13))) ; Region 6
(assert (= 18 (+ V11 V17 V18))) ; Region 7
(assert (= 5 (+ V14 V15))) ; Region 8
(assert (= 14 (+ V19 V25 V26))) ; Region 9
(assert (= 6 (+ V20 V27))) ; Region 10
(assert (= 8 (+ V21 V22))) ; Region 11
(assert (= 3 (+ V23 V30))) ; Region 12
(assert (= 11 (+ V24 V31))) ; Region 13
(assert (= 13 (+ V28 V29))) ; Region 14
(assert (= 7 (+ V32 V33))) ; Region 15
(assert (= 13 (+ V34 V41 V48))) ; Region 16
(assert (= 7 (+ V35 V42))) ; Region 17
(assert (= 13 (+ V36 V37))) ; Region 18
(assert (= 12 (+ V38 V44 V45))) ; Region 19
(assert (= 4 (+ V39 V46))) ; Region 20
(assert (= 5 (+ V40 V47))) ; Region 21
(check-sat)
