...
(assert (or (= 3 (/ V1 V8)) (= 3 (/ V8 V1)))) ; Region 2
(assert (or (= 6 (- V2 V9)) (= 6 (- V9 V2)))) ; Region 3
(assert (= 15 (* V3 V10))) ; Region 4
(assert (or (= 1 (- V4 V11)) (= 1 (- V11 V4)))) ; Region 5
(assert (= 10 (+ V5 V6 V12))) ; Region 6
(assert (= 13 (+ V13 V20))) ; Region 7
(assert (= 105 (* V14 V21 V22))) ; Region 8
(assert (or (= 3 (- V15 V16)) (= 3 (- V16 V15)))) ; Region 9
(assert (or (= 3 (/ V18 V19)) (= 3 (/ V19 V18)))) ; Region 11
(assert (= 9 (+ V23 V24 V25))) ; Region 12
(assert (or (= 3 (- V26 V27)) (= 3 (- V27 V26)))) ; Region 13
(assert (or (= 3 (- V28 V29)) (= 3 (- V29 V28)))) ; Region 14
(assert (= 9 (+ V30 V31))) ; Region 15
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 17
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 18
(assert (or (= 1 (- V36 V43)) (= 1 (- V43 V36)))) ; Region 19
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 20
(assert (or (= 3 (/ V38 V45)) (= 3 (/ V45 V38)))) ; Region 21
(assert (or (= 4 (- V39 V46)) (= 4 (- V46 V39)))) ; Region 22
(assert (= 10 (+ V40 V41 V48))) ; Region 23
(check-sat)
