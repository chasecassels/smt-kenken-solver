...
(assert (= 10 (+ V12 V13))) ; Region 7
(assert (= 17 (+ V17 V18 V25))) ; Region 9
(assert (= 16 (+ V19 V20 V26 V33))) ; Region 10
(assert (= 14 (+ V21 V22 V28))) ; Region 11
(assert (= 5 (+ V23 V24))) ; Region 12
(assert (= 9 (+ V27 V34))) ; Region 13
(assert (= 4 (+ V29 V30))) ; Region 14
(assert (= 14 (+ V31 V37 V38))) ; Region 15
(assert (= 9 (+ V32 V39))) ; Region 16
(assert (= 3 (+ V35 V36))) ; Region 17
(assert (= 6 (+ V40 V47))) ; Region 18
(assert (= 6 (+ V41 V48))) ; Region 19
