...
(assert (= 20 (* V0 V1 V7 V8))) ; Region 1
(assert (or (= 3 (/ V2 V3)) (= 3 (/ V3 V2)))) ; Region 2
(assert (= 105 (* V4 V5 V6))) ; Region 3
(assert (= 432 (* V9 V14 V15 V16 V23))) ; Region 4
(assert (= 168 (* V10 V11 V12))) ; Region 5
(assert (= 60 (* V13 V20 V27))) ; Region 6
(assert (= 70 (* V17 V18 V24))) ; Region 7
(assert (or (= 2 (/ V19 V26)) (= 2 (/ V26 V19)))) ; Region 8
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 9
(assert (= 420 (* V22 V29 V30 V31))) ; Region 10
(assert (= 432 (* V25 V32 V39 V40 V41))) ; Region 11
(assert (= 7 (* V33 V34))) ; Region 12
(assert (= 280 (* V35 V36 V42 V43))) ; Region 13
(assert (= 7 (* V37 V44))) ; Region 14
(assert (= 3 (* V38 V45))) ; Region 15
(assert (= 60 (* V46 V47 V48))) ; Region 16
(check-sat)
