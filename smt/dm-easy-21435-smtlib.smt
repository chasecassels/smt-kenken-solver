...
(assert (= 140 (* V1 V8 V9 V10))) ; Region 2
(assert (= 15 (* V2 V3))) ; Region 3
(assert (or (= 3 (/ V4 V11)) (= 3 (/ V11 V4)))) ; Region 4
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 5
(assert (= 210 (* V12 V18 V19 V25))) ; Region 6
(assert (= 18 (* V13 V20 V27))) ; Region 7
(assert (= 72 (* V14 V21 V22))) ; Region 8
(assert (= 10 (* V15 V16))) ; Region 9
(assert (= 196 (* V17 V23 V24))) ; Region 10
(assert (= 210 (* V26 V33 V34 V41))) ; Region 11
(assert (= 7 (* V28 V29))) ; Region 12
(assert (or (= 3 (/ V30 V31)) (= 3 (/ V31 V30)))) ; Region 13
(assert (= 84 (* V32 V39 V46))) ; Region 14
(assert (= 10 (* V35 V36))) ; Region 15
(assert (= 72 (* V37 V38 V45))) ; Region 16
(assert (= 20 (* V40 V47 V48))) ; Region 17
(assert (= 12 (* V42 V43 V44))) ; Region 18
(check-sat)
