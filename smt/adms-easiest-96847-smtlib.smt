...
(assert (= 105 (* V3 V4 V5))) ; Region 3
(assert (= 11 (+ V6 V13))) ; Region 4
(assert (or (= 3 (- V8 V15)) (= 3 (- V15 V8)))) ; Region 5
(assert (= 9 (+ V9 V10))) ; Region 6
(assert (or (= 2 (/ V11 V12)) (= 2 (/ V12 V11)))) ; Region 7
(assert (= 40 (* V14 V21 V28))) ; Region 8
(assert (= 6 (* V16 V23))) ; Region 9
(assert (= 17 (+ V17 V18 V19))) ; Region 10
(assert (= 18 (+ V22 V29 V30))) ; Region 12
(assert (= 3 (+ V24 V31))) ; Region 13
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 14
(assert (= 6 (+ V26 V33))) ; Region 15
(assert (= 90 (* V27 V34 V41))) ; Region 16
(assert (or (= 6 (- V35 V42)) (= 6 (- V42 V35)))) ; Region 17
(assert (= 6 (+ V36 V37))) ; Region 18
(assert (or (= 1 (- V38 V45)) (= 1 (- V45 V38)))) ; Region 19
(assert (or (= 3 (/ V39 V40)) (= 3 (/ V40 V39)))) ; Region 20
(assert (or (= 1 (- V43 V44)) (= 1 (- V44 V43)))) ; Region 21
(assert (or (= 2 (/ V47 V48)) (= 2 (/ V48 V47)))) ; Region 23
(check-sat)
