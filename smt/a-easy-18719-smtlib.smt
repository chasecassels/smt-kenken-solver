...
(assert (= 14 (+ V6 V12 V13))) ; Region 5
(assert (= 7 (+ V9 V16))) ; Region 6
(assert (= 12 (+ V10 V17))) ; Region 7
(assert (= 5 (+ V11 V18))) ; Region 8
(assert (= 7 (+ V15 V22))) ; Region 9
(assert (= 13 (+ V19 V25 V26))) ; Region 10
(assert (= 3 (+ V20 V27))) ; Region 11
(assert (= 15 (+ V21 V28 V29))) ; Region 12
(assert (= 8 (+ V23 V30))) ; Region 13
(assert (= 11 (+ V24 V31 V38))) ; Region 14
(assert (= 12 (+ V32 V39))) ; Region 15
(assert (= 10 (+ V33 V34))) ; Region 16
(assert (= 10 (+ V35 V42 V43))) ; Region 17
(assert (= 3 (+ V36 V37))) ; Region 18
(assert (= 9 (+ V41 V48))) ; Region 20
(assert (= 6 (+ V44 V45))) ; Region 21
(assert (= 10 (+ V46 V47))) ; Region 22
(check-sat)
