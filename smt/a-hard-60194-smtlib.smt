...
(assert (= 3 (+ V5 V6))) ; Region 4
(assert (= 6 (+ V8 V9 V10))) ; Region 5
(assert (= 9 (+ V11 V18))) ; Region 6
(assert (= 13 (+ V12 V19))) ; Region 7
(assert (= 11 (+ V13 V20 V27))) ; Region 8
(assert (= 6 (+ V14 V15))) ; Region 9
(assert (= 9 (+ V16 V23))) ; Region 10
(assert (= 5 (+ V17 V24))) ; Region 11
(assert (= 15 (+ V21 V22 V28))) ; Region 12
(assert (= 10 (+ V25 V32))) ; Region 13
(assert (= 7 (+ V26 V33))) ; Region 14
(assert (= 14 (+ V29 V30 V31 V37))) ; Region 15
(assert (= 13 (+ V34 V40 V41))) ; Region 16
(assert (= 9 (+ V35 V36))) ; Region 17
(assert (= 10 (+ V38 V39 V46))) ; Region 18
(assert (= 8 (+ V42 V43))) ; Region 19
(assert (= 9 (+ V44 V45))) ; Region 20
(assert (= 9 (+ V47 V48))) ; Region 21
(check-sat)
