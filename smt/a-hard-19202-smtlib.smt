...
(assert (= 12 (+ V8 V9 V15))) ; Region 6
(assert (= 10 (+ V11 V18 V25))) ; Region 7
(assert (= 11 (+ V12 V13))) ; Region 8
(assert (= 10 (+ V14 V21))) ; Region 9
(assert (= 12 (+ V16 V17))) ; Region 10
(assert (= 11 (+ V19 V26 V33))) ; Region 11
(assert (= 12 (+ V20 V27 V34))) ; Region 12
(assert (= 7 (+ V22 V23))) ; Region 13
(assert (= 5 (+ V24 V31))) ; Region 14
(assert (= 18 (+ V28 V29 V30))) ; Region 15
(assert (= 18 (+ V32 V38 V39 V46))) ; Region 16
(assert (= 8 (+ V35 V36 V42))) ; Region 17
(assert (= 8 (+ V37 V44 V45))) ; Region 18
(assert (= 12 (+ V40 V41))) ; Region 19
