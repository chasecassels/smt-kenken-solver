...
(assert (= 9 (+ V3 V4 V5))) ; Region 4
(assert (= 14 (+ V6 V13 V20))) ; Region 5
(assert (or (= 2 (- V10 V11)) (= 2 (- V11 V10)))) ; Region 6
(assert (= 11 (+ V12 V19))) ; Region 7
(assert (= 17 (+ V14 V15 V21))) ; Region 8
(assert (or (= 4 (- V16 V23)) (= 4 (- V23 V16)))) ; Region 9
(assert (or (= 3 (- V17 V24)) (= 3 (- V24 V17)))) ; Region 10
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 11
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 12
(assert (= 3 (+ V26 V33))) ; Region 13
(assert (= 8 (+ V28 V35))) ; Region 15
(assert (or (= 1 (- V30 V37)) (= 1 (- V37 V30)))) ; Region 16
(assert (= 13 (+ V31 V32))) ; Region 17
(assert (= 12 (+ V34 V41 V48))) ; Region 18
(assert (= 13 (+ V38 V39 V40))) ; Region 20
(assert (= 14 (+ V42 V43 V44 V45))) ; Region 21
