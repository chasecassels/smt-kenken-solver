...
(assert (= 1050 (* V3 V8 V9 V10))) ; Region 3
(assert (= 72 (* V4 V5 V11 V12))) ; Region 4
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 5
(assert (= 7 (* V15 V16))) ; Region 6
(assert (or (= 3 (/ V18 V19)) (= 3 (/ V19 V18)))) ; Region 8
(assert (= 60 (* V20 V26 V27))) ; Region 9
(assert (= 24 (* V21 V22 V28))) ; Region 10
(assert (= 84 (* V23 V24 V30))) ; Region 11
(assert (= 105 (* V25 V32 V33 V34))) ; Region 12
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 13
(assert (= 12 (* V31 V38 V45))) ; Region 14
(assert (= 4 (* V35 V42))) ; Region 15
(assert (= 60 (* V37 V43 V44))) ; Region 16
(assert (= 98 (* V39 V40 V46))) ; Region 17
(assert (= 30 (* V41 V47 V48))) ; Region 18
(check-sat)
