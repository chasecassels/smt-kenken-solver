...
(assert (= 15 (+ V2 V3 V4 V10))) ; Region 2
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 3
(assert (or (= 6 (- V7 V14)) (= 6 (- V14 V7)))) ; Region 4
(assert (or (= 1 (- V8 V9)) (= 1 (- V9 V8)))) ; Region 5
(assert (= 11 (+ V11 V18 V25))) ; Region 6
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 7
(assert (= 12 (+ V13 V20))) ; Region 8
(assert (or (= 2 (- V15 V22)) (= 2 (- V22 V15)))) ; Region 9
(assert (= 5 (+ V16 V17))) ; Region 10
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 11
(assert (= 10 (+ V23 V24))) ; Region 12
(assert (= 11 (+ V26 V27 V34))) ; Region 13
(assert (= 6 (+ V30 V31))) ; Region 15
(assert (= 8 (+ V32 V33))) ; Region 16
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 17
(assert (or (= 2 (- V36 V37)) (= 2 (- V37 V36)))) ; Region 18
(assert (or (= 6 (- V38 V39)) (= 6 (- V39 V38)))) ; Region 19
(assert (or (= 4 (- V40 V41)) (= 4 (- V41 V40)))) ; Region 20
(assert (= 9 (+ V43 V44 V45))) ; Region 21
