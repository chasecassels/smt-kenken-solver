...
(assert (= 15 (+ V2 V9 V10 V11))) ; Region 2
(assert (= 19 (+ V3 V4 V5 V6))) ; Region 3
(assert (= 8 (+ V7 V14))) ; Region 4
(assert (= 6 (+ V8 V15))) ; Region 5
(assert (= 11 (+ V12 V13 V20))) ; Region 6
(assert (= 9 (+ V16 V17))) ; Region 7
(assert (= 9 (+ V18 V19))) ; Region 8
(assert (= 15 (+ V21 V28 V35))) ; Region 9
(assert (= 5 (+ V22 V23))) ; Region 10
(assert (= 7 (+ V24 V25))) ; Region 11
(assert (= 9 (+ V26 V32 V33))) ; Region 12
(assert (= 10 (+ V27 V34))) ; Region 13
(assert (= 13 (+ V29 V36))) ; Region 14
(assert (= 10 (+ V30 V31))) ; Region 15
(assert (= 6 (+ V37 V38 V39))) ; Region 16
(assert (= 9 (+ V40 V41))) ; Region 17
(assert (= 6 (+ V42 V43))) ; Region 18
(assert (= 10 (+ V44 V45))) ; Region 19
(assert (= 12 (+ V46 V47 V48))) ; Region 20
(check-sat)
