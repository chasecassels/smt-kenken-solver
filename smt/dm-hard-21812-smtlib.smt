...
(assert (= 120 (* V1 V2 V8 V9))) ; Region 2
(assert (= 168 (* V3 V4 V5 V10))) ; Region 3
(assert (= 84 (* V6 V13 V19 V20))) ; Region 4
(assert (= 120 (* V11 V12 V18 V25))) ; Region 5
(assert (= 280 (* V14 V15 V16 V23))) ; Region 6
(assert (= 60 (* V17 V24 V31 V32))) ; Region 7
(assert (= 252 (* V21 V22 V29 V36))) ; Region 8
(assert (= 315 (* V26 V27 V33 V34))) ; Region 9
(assert (= 140 (* V28 V35 V42))) ; Region 10
(assert (= 18 (* V30 V37 V44))) ; Region 11
(assert (= 5 (* V38 V39))) ; Region 12
(assert (= 192 (* V40 V41 V47 V48))) ; Region 13
(assert (= 21 (* V45 V46))) ; Region 15
(check-sat)
