...
(assert (= 360 (* V5 V6 V12 V13))) ; Region 4
(assert (= 60 (* V8 V9 V14 V15))) ; Region 5
(assert (= 84 (* V10 V16 V17))) ; Region 6
(assert (= 21 (* V11 V18 V19))) ; Region 7
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 8
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 9
(assert (= 42 (* V22 V23))) ; Region 10
(assert (= 4 (* V24 V31))) ; Region 11
(assert (= 630 (* V25 V26 V33 V34))) ; Region 12
(assert (= 120 (* V29 V30 V37))) ; Region 13
(assert (= 30 (* V32 V38 V39))) ; Region 14
(assert (= 8 (* V35 V42))) ; Region 15
(assert (= 84 (* V36 V43 V44))) ; Region 16
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 17
(assert (= 42 (* V46 V47 V48))) ; Region 19
(check-sat)
