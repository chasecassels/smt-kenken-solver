...
(assert (= 3 (+ V2 V9))) ; Region 2
(assert (= 8 (+ V3 V4))) ; Region 3
(assert (= 9 (+ V5 V6))) ; Region 4
(assert (= 12 (+ V7 V8))) ; Region 5
(assert (= 4 (+ V10 V11))) ; Region 6
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 7
(assert (= 14 (+ V13 V20 V27))) ; Region 8
(assert (= 5 (+ V14 V15 V21))) ; Region 9
(assert (= 16 (+ V16 V17 V24))) ; Region 10
(assert (= 6 (+ V22 V29))) ; Region 12
(assert (= 9 (+ V23 V30))) ; Region 13
(assert (or (= 1 (- V25 V26)) (= 1 (- V26 V25)))) ; Region 14
(assert (= 13 (+ V28 V35 V42))) ; Region 15
(assert (= 5 (+ V31 V38))) ; Region 16
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 17
(assert (or (= 6 (- V33 V34)) (= 6 (- V34 V33)))) ; Region 18
(assert (or (= 3 (- V36 V37)) (= 3 (- V37 V36)))) ; Region 19
(assert (= 5 (+ V40 V41 V47))) ; Region 20
