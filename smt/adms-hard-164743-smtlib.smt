...
(assert (= 15 (* V0 V1))) ; Region 1
(assert (= 9 (+ V2 V3 V4))) ; Region 2
(assert (or (= 1 (- V5 V12)) (= 1 (- V12 V5)))) ; Region 3
(assert (= 16 (+ V6 V13 V20))) ; Region 4
(assert (or (= 3 (- V7 V14)) (= 3 (- V14 V7)))) ; Region 5
(assert (or (= 5 (- V9 V10)) (= 5 (- V10 V9)))) ; Region 7
(assert (= 24 (* V11 V17 V18))) ; Region 8
(assert (= 9 (+ V15 V16 V23))) ; Region 9
(assert (= 14 (+ V19 V26 V27))) ; Region 10
(assert (= 14 (* V21 V22))) ; Region 11
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 12
(assert (= 13 (+ V28 V29 V35 V36))) ; Region 13
(assert (= 120 (* V30 V31 V32))) ; Region 14
(assert (= 5 (+ V33 V34))) ; Region 15
(assert (= 5 (+ V37 V44))) ; Region 16
(assert (= 15 (+ V38 V45 V46))) ; Region 17
(assert (= 18 (+ V39 V40 V41))) ; Region 18
