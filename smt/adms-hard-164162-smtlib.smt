...
(assert (= 13 (+ V2 V9 V16))) ; Region 2
(assert (or (= 2 (- V3 V10)) (= 2 (- V10 V3)))) ; Region 3
(assert (= 7 (+ V4 V11))) ; Region 4
(assert (= 6 (* V5 V6))) ; Region 5
(assert (= 10 (+ V7 V8 V15))) ; Region 6
(assert (= 12 (* V12 V19))) ; Region 7
(assert (= 8 (+ V13 V20))) ; Region 8
(assert (= 630 (* V14 V21 V22 V28))) ; Region 9
(assert (or (= 3 (/ V17 V18)) (= 3 (/ V18 V17)))) ; Region 10
(assert (or (= 4 (- V23 V30)) (= 4 (- V30 V23)))) ; Region 11
(assert (= 40 (* V24 V25 V31))) ; Region 12
(assert (= 28 (* V26 V27))) ; Region 13
(assert (= 6 (+ V29 V36 V37))) ; Region 14
(assert (or (= 3 (- V32 V33)) (= 3 (- V33 V32)))) ; Region 15
(assert (or (= 3 (/ V34 V41)) (= 3 (/ V41 V34)))) ; Region 16
(assert (= 24 (* V35 V42 V43))) ; Region 17
(assert (= 42 (* V38 V44 V45))) ; Region 18
(assert (or (= 2 (- V39 V40)) (= 2 (- V40 V39)))) ; Region 19
(assert (= 10 (+ V46 V47 V48))) ; Region 20
(check-sat)
