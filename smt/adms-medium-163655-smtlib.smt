...
(assert (or (= 3 (- V0 V1)) (= 3 (- V1 V0)))) ; Region 1
(assert (= 30 (* V2 V3))) ; Region 2
(assert (or (= 3 (/ V4 V5)) (= 3 (/ V5 V4)))) ; Region 3
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 4
(assert (or (= 1 (- V7 V8)) (= 1 (- V8 V7)))) ; Region 5
(assert (or (= 4 (- V9 V16)) (= 4 (- V16 V9)))) ; Region 6
(assert (= 13 (+ V10 V17))) ; Region 7
(assert (or (= 1 (- V11 V12)) (= 1 (- V12 V11)))) ; Region 8
(assert (= 15 (* V14 V15 V22))) ; Region 9
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 10
(assert (or (= 3 (- V19 V20)) (= 3 (- V20 V19)))) ; Region 11
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 12
(assert (= 10 (+ V23 V24))) ; Region 13
(assert (= 6 (+ V26 V27 V34))) ; Region 14
(assert (= 14 (+ V29 V36 V43))) ; Region 15
(assert (or (= 2 (/ V30 V31)) (= 2 (/ V31 V30)))) ; Region 16
(assert (or (= 6 (- V32 V33)) (= 6 (- V33 V32)))) ; Region 17
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 18
(assert (= 3 (+ V37 V38))) ; Region 19
(assert (= 126 (* V39 V46 V47))) ; Region 20
(assert (= 16 (+ V40 V41 V48))) ; Region 21
(assert (or (= 1 (- V44 V45)) (= 1 (- V45 V44)))) ; Region 22
(check-sat)
