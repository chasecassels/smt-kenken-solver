...
(assert (= 84 (* V0 V1 V7))) ; Region 1
(assert (= 24 (* V2 V9))) ; Region 2
(assert (= 70 (* V3 V10 V11))) ; Region 3
(assert (= 5 (* V5 V6 V12))) ; Region 5
(assert (= 18 (* V8 V15))) ; Region 6
(assert (= 14 (* V13 V20))) ; Region 7
(assert (= 60 (* V14 V21 V28))) ; Region 8
(assert (= 20 (* V16 V17 V24))) ; Region 9
(assert (= 12 (* V18 V19 V25))) ; Region 10
(assert (= 6 (* V22 V23))) ; Region 11
(assert (= 28 (* V26 V27))) ; Region 12
(assert (= 30 (* V29 V30 V31))) ; Region 13
(assert (= 84 (* V32 V39 V40))) ; Region 14
(assert (= 12 (* V33 V34))) ; Region 15
(assert (= 4 (* V36 V42 V43))) ; Region 17
(assert (= 14 (* V37 V44))) ; Region 18
(assert (= 15 (* V38 V45))) ; Region 19
(assert (= 30 (* V41 V48))) ; Region 20
