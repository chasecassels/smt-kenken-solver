...
(assert (= 13 (+ V6 V13))) ; Region 4
(assert (= 7 (+ V7 V8))) ; Region 5
(assert (= 3 (+ V9 V10))) ; Region 6
(assert (= 12 (+ V11 V12))) ; Region 7
(assert (= 6 (+ V14 V21))) ; Region 8
(assert (= 9 (+ V15 V16))) ; Region 9
(assert (= 13 (+ V17 V18))) ; Region 10
(assert (= 5 (+ V19 V20))) ; Region 11
(assert (= 10 (+ V22 V23))) ; Region 12
(assert (= 3 (+ V24 V25))) ; Region 13
(assert (= 10 (+ V26 V27))) ; Region 14
(assert (= 3 (+ V28 V29))) ; Region 15
(assert (= 13 (+ V30 V37))) ; Region 16
(assert (= 12 (+ V31 V38))) ; Region 17
(assert (= 7 (+ V32 V39))) ; Region 18
(assert (= 8 (+ V33 V34))) ; Region 19
(assert (= 8 (+ V35 V36))) ; Region 20
(assert (= 10 (+ V40 V46 V47))) ; Region 21
(assert (= 3 (+ V41 V48))) ; Region 22
(assert (= 13 (+ V42 V43))) ; Region 23
(assert (= 7 (+ V44 V45))) ; Region 24
(check-sat)
