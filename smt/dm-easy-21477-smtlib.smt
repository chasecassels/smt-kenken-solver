...
(assert (= 84 (* V0 V1 V7 V8))) ; Region 1
(assert (= 20 (* V2 V9))) ; Region 2
(assert (= 168 (* V3 V4 V10 V11))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (= 20 (* V12 V13 V20))) ; Region 5
(assert (or (= 2 (/ V14 V15)) (= 2 (/ V15 V14)))) ; Region 6
(assert (= 126 (* V16 V17 V23 V30))) ; Region 7
(assert (= 105 (* V18 V19 V26))) ; Region 8
(assert (= 20 (* V21 V22))) ; Region 9
(assert (= 24 (* V24 V25 V32))) ; Region 10
(assert (= 14 (* V27 V34))) ; Region 11
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 12
(assert (= 35 (* V29 V36))) ; Region 13
(assert (= 72 (* V33 V40 V41))) ; Region 15
(assert (= 280 (* V37 V38 V44 V45))) ; Region 16
(assert (= 5 (* V39 V46))) ; Region 17
