...
(assert (= 42 (* V0 V1 V7))) ; Region 1
(assert (= 72 (* V2 V8 V9))) ; Region 2
(assert (or (= 2 (- V4 V11)) (= 2 (- V11 V4)))) ; Region 4
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 5
(assert (or (= 1 (- V10 V17)) (= 1 (- V17 V10)))) ; Region 6
(assert (or (= 6 (- V12 V19)) (= 6 (- V19 V12)))) ; Region 7
(assert (= 6 (* V13 V20))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 9 (+ V15 V22))) ; Region 10
(assert (or (= 2 (- V16 V23)) (= 2 (- V23 V16)))) ; Region 11
(assert (or (= 4 (- V18 V25)) (= 4 (- V25 V18)))) ; Region 12
(assert (= 9 (+ V24 V31 V38))) ; Region 13
(assert (= 5 (+ V26 V27))) ; Region 14
(assert (or (= 3 (- V28 V29)) (= 3 (- V29 V28)))) ; Region 15
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 17
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 18
(assert (= 15 (* V35 V42))) ; Region 19
(assert (= 3 (+ V36 V37))) ; Region 20
(assert (= 210 (* V40 V41 V48))) ; Region 21
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 23
(assert (= 24 (* V46 V47))) ; Region 24
(check-sat)
