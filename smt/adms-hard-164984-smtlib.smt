...
(assert (= 10 (+ V0 V7 V14))) ; Region 1
(assert (= 15 (* V1 V2))) ; Region 2
(assert (= 48 (* V3 V4 V5))) ; Region 3
(assert (or (= 4 (- V6 V13)) (= 4 (- V13 V6)))) ; Region 4
(assert (= 8 (+ V8 V9))) ; Region 5
(assert (= 10 (+ V10 V11 V18))) ; Region 6
(assert (= 18 (+ V12 V19 V26))) ; Region 7
(assert (= 10 (* V15 V16 V23))) ; Region 8
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 9
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 10
(assert (or (= 3 (- V21 V22)) (= 3 (- V22 V21)))) ; Region 11
(assert (= 14 (* V25 V32))) ; Region 12
(assert (= 11 (+ V28 V29 V30))) ; Region 13
(assert (= 6 (+ V31 V38))) ; Region 14
(assert (or (= 3 (- V33 V34)) (= 3 (- V34 V33)))) ; Region 15
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 16
(assert (or (= 1 (- V36 V43)) (= 1 (- V43 V36)))) ; Region 17
(assert (or (= 2 (- V37 V44)) (= 2 (- V44 V37)))) ; Region 18
(assert (or (= 3 (- V39 V40)) (= 3 (- V40 V39)))) ; Region 19
(assert (or (= 5 (- V41 V48)) (= 5 (- V48 V41)))) ; Region 20
(assert (= 21 (* V45 V46 V47))) ; Region 21
(check-sat)
