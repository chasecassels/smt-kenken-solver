...
(assert (= 168 (* V4 V10 V11))) ; Region 3
(assert (or (= 5 (- V5 V12)) (= 5 (- V12 V5)))) ; Region 4
(assert (= 84 (* V6 V13 V20))) ; Region 5
(assert (= 10 (* V7 V8 V15))) ; Region 6
(assert (= 15 (+ V9 V16 V22 V23))) ; Region 7
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 8
(assert (or (= 3 (- V17 V24)) (= 3 (- V24 V17)))) ; Region 9
(assert (= 98 (* V18 V19 V25 V32))) ; Region 10
(assert (or (= 2 (- V26 V27)) (= 2 (- V27 V26)))) ; Region 11
(assert (or (= 2 (- V28 V35)) (= 2 (- V35 V28)))) ; Region 12
(assert (or (= 1 (- V29 V36)) (= 1 (- V36 V29)))) ; Region 13
(assert (or (= 2 (/ V30 V31)) (= 2 (/ V31 V30)))) ; Region 14
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 15
(assert (= 9 (+ V37 V44))) ; Region 16
(assert (= 20 (* V38 V45 V46))) ; Region 17
(assert (= 10 (+ V39 V40 V47))) ; Region 18
(assert (or (= 5 (- V41 V48)) (= 5 (- V48 V41)))) ; Region 19
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 20
(check-sat)
