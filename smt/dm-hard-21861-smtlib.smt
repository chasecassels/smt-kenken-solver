...
(assert (= 90 (* V2 V8 V9 V10))) ; Region 3
(assert (= 630 (* V3 V4 V11 V18))) ; Region 4
(assert (= 112 (* V5 V6 V12))) ; Region 5
(assert (= 42 (* V13 V19 V20))) ; Region 6
(assert (= 24 (* V14 V21 V28))) ; Region 7
(assert (= 30 (* V15 V16 V17 V22))) ; Region 8
(assert (= 28 (* V23 V24))) ; Region 9
(assert (= 10 (* V25 V26))) ; Region 10
(assert (= 36 (* V27 V33 V34))) ; Region 11
(assert (= 28 (* V29 V36))) ; Region 12
(assert (= 42 (* V30 V37 V44))) ; Region 13
(assert (= 20 (* V31 V32 V39))) ; Region 14
(assert (= 210 (* V35 V42 V43))) ; Region 15
(assert (= 24 (* V38 V45 V46))) ; Region 16
(assert (or (= 3 (/ V40 V47)) (= 3 (/ V47 V40)))) ; Region 17
(assert (= 10 (* V41 V48))) ; Region 18
(check-sat)
