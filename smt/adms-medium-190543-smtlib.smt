...
(assert (or (= 1 (- V0 V7)) (= 1 (- V7 V0)))) ; Region 1
(assert (= 3 (+ V1 V2))) ; Region 2
(assert (= 35 (* V3 V10))) ; Region 3
(assert (= 6 (+ V4 V11))) ; Region 4
(assert (or (= 4 (- V5 V12)) (= 4 (- V12 V5)))) ; Region 5
(assert (= 28 (* V6 V13))) ; Region 6
(assert (or (= 2 (/ V8 V9)) (= 2 (/ V9 V8)))) ; Region 7
(assert (or (= 2 (- V14 V15)) (= 2 (- V15 V14)))) ; Region 8
(assert (= 210 (* V16 V21 V22 V23))) ; Region 9
(assert (or (= 3 (- V17 V18)) (= 3 (- V18 V17)))) ; Region 10
(assert (= 6 (+ V19 V20))) ; Region 11
(assert (= 13 (+ V25 V32))) ; Region 13
(assert (or (= 1 (- V26 V27)) (= 1 (- V27 V26)))) ; Region 14
(assert (or (= 2 (- V28 V29)) (= 2 (- V29 V28)))) ; Region 15
(assert (or (= 2 (- V30 V31)) (= 2 (- V31 V30)))) ; Region 16
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 17
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 18
(assert (= 5 (+ V36 V43))) ; Region 19
(assert (= 6 (+ V37 V44))) ; Region 20
(assert (or (= 2 (- V38 V45)) (= 2 (- V45 V38)))) ; Region 21
(assert (or (= 2 (/ V39 V40)) (= 2 (/ V40 V39)))) ; Region 22
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 23
(assert (or (= 3 (- V46 V47)) (= 3 (- V47 V46)))) ; Region 24
(check-sat)
