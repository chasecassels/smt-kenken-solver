...
(assert (= 8 (+ V0 V1))) ; Region 1
(assert (or (= 1 (- V2 V9)) (= 1 (- V9 V2)))) ; Region 2
(assert (or (= 6 (- V3 V4)) (= 6 (- V4 V3)))) ; Region 3
(assert (= 10 (+ V5 V6))) ; Region 4
(assert (= 15 (+ V7 V8 V14))) ; Region 5
(assert (or (= 3 (- V10 V11)) (= 3 (- V11 V10)))) ; Region 6
(assert (= 13 (+ V13 V20 V27))) ; Region 8
(assert (or (= 6 (- V15 V22)) (= 6 (- V22 V15)))) ; Region 9
(assert (or (= 1 (- V16 V23)) (= 1 (- V23 V16)))) ; Region 10
(assert (= 16 (+ V17 V18 V19))) ; Region 11
(assert (= 6 (+ V21 V28))) ; Region 12
(assert (= 13 (+ V24 V31))) ; Region 13
(assert (= 6 (+ V25 V26 V32))) ; Region 14
(assert (= 8 (+ V29 V30))) ; Region 15
(assert (= 15 (+ V33 V34 V41))) ; Region 16
(assert (= 7 (+ V35 V42))) ; Region 17
(assert (or (= 2 (- V36 V43)) (= 2 (- V43 V36)))) ; Region 18
(assert (or (= 2 (- V37 V44)) (= 2 (- V44 V37)))) ; Region 19
(assert (or (= 2 (- V38 V45)) (= 2 (- V45 V38)))) ; Region 20
(assert (or (= 1 (- V39 V40)) (= 1 (- V40 V39)))) ; Region 21
(assert (= 9 (+ V46 V47 V48))) ; Region 22
(check-sat)
