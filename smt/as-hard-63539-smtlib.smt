...
(assert (= 9 (+ V0 V7))) ; Region 1
(assert (= 5 (+ V1 V8 V9))) ; Region 2
(assert (or (= 4 (- V2 V3)) (= 4 (- V3 V2)))) ; Region 3
(assert (= 11 (+ V4 V10 V11))) ; Region 4
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 5
(assert (= 10 (+ V12 V13))) ; Region 6
(assert (or (= 4 (- V14 V21)) (= 4 (- V21 V14)))) ; Region 7
(assert (or (= 3 (- V15 V22)) (= 3 (- V22 V15)))) ; Region 8
(assert (= 5 (+ V16 V23))) ; Region 9
(assert (= 9 (+ V17 V18))) ; Region 10
(assert (= 12 (+ V19 V20 V26))) ; Region 11
(assert (or (= 1 (- V24 V25)) (= 1 (- V25 V24)))) ; Region 12
(assert (= 10 (+ V27 V34 V41 V48))) ; Region 13
(assert (= 18 (+ V28 V29 V30))) ; Region 14
(assert (or (= 2 (- V32 V33)) (= 2 (- V33 V32)))) ; Region 16
(assert (= 11 (+ V35 V36 V37))) ; Region 17
(assert (= 6 (+ V38 V45))) ; Region 18
(assert (= 13 (+ V39 V40))) ; Region 19
(assert (= 14 (+ V42 V43 V44))) ; Region 20
(assert (= 5 (+ V46 V47))) ; Region 21
(check-sat)
