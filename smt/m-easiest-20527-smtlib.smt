...
(assert (= 28 (* V0 V1 V7))) ; Region 1
(assert (= 18 (* V2 V3 V9))) ; Region 2
(assert (= 10 (* V4 V5))) ; Region 3
(assert (= 14 (* V6 V13))) ; Region 4
(assert (= 8 (* V8 V14 V15))) ; Region 5
(assert (= 90 (* V10 V11 V18))) ; Region 6
(assert (= 12 (* V12 V19))) ; Region 7
(assert (= 35 (* V16 V17 V24))) ; Region 8
(assert (= 24 (* V20 V27))) ; Region 9
(assert (= 18 (* V21 V22))) ; Region 10
(assert (= 6 (* V23 V30))) ; Region 11
(assert (= 28 (* V25 V32 V33))) ; Region 12
(assert (= 14 (* V28 V29))) ; Region 14
(assert (= 15 (* V34 V41 V48))) ; Region 16
(assert (= 15 (* V35 V42))) ; Region 17
(assert (= 120 (* V36 V43 V44))) ; Region 18
(assert (= 56 (* V37 V38 V45))) ; Region 19
(assert (= 42 (* V40 V46 V47))) ; Region 21
(check-sat)
