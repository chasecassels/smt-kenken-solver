...
(assert (= 8 (+ V5 V6 V13 V20))) ; Region 3
(assert (= 6 (+ V7 V8 V9))) ; Region 4
(assert (= 19 (+ V11 V12 V18))) ; Region 5
(assert (= 18 (+ V14 V15 V21 V22))) ; Region 6
(assert (= 7 (+ V16 V17))) ; Region 7
(assert (= 12 (+ V19 V26 V33))) ; Region 8
(assert (= 14 (+ V23 V24 V25 V32 V39))) ; Region 9
(assert (= 21 (+ V27 V34 V40 V41))) ; Region 10
(assert (= 21 (+ V29 V36 V43 V44))) ; Region 12
(assert (or (= 4 (- V30 V31)) (= 4 (- V31 V30)))) ; Region 13
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 14
(assert (= 7 (+ V37 V38))) ; Region 15
(assert (or (= 1 (- V45 V46)) (= 1 (- V46 V45)))) ; Region 16
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 17
(check-sat)
