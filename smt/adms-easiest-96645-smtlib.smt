...
(assert (= 18 (+ V0 V7 V14 V15))) ; Region 1
(assert (= 36 (* V1 V2 V8))) ; Region 2
(assert (= 7 (+ V3 V4 V5))) ; Region 3
(assert (or (= 6 (- V6 V13)) (= 6 (- V13 V6)))) ; Region 4
(assert (= 420 (* V9 V10 V11 V12))) ; Region 5
(assert (or (= 2 (/ V16 V23)) (= 2 (/ V23 V16)))) ; Region 6
(assert (= 7 (+ V17 V18))) ; Region 7
(assert (= 17 (+ V19 V20 V27))) ; Region 8
(assert (or (= 5 (- V21 V28)) (= 5 (- V28 V21)))) ; Region 9
(assert (or (= 6 (- V22 V29)) (= 6 (- V29 V22)))) ; Region 10
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 11
(assert (= 200 (* V26 V33 V34 V41))) ; Region 12
(assert (= 45 (* V30 V31 V38 V45))) ; Region 13
(assert (= 13 (+ V32 V39))) ; Region 14
(assert (or (= 4 (- V35 V36)) (= 4 (- V36 V35)))) ; Region 15
(assert (= 28 (* V37 V44))) ; Region 16
(assert (= 18 (* V40 V47 V48))) ; Region 17
(assert (or (= 2 (- V42 V43)) (= 2 (- V43 V42)))) ; Region 18
(check-sat)
