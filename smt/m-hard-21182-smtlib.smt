...
(assert (= 48 (* V3 V4 V5 V11))) ; Region 4
(assert (= 75 (* V10 V15 V16 V17))) ; Region 6
(assert (= 112 (* V12 V13 V19 V20))) ; Region 7
(assert (= 70 (* V18 V25 V26))) ; Region 9
(assert (= 120 (* V21 V28 V29 V30))) ; Region 10
(assert (= 24 (* V22 V23 V24))) ; Region 11
(assert (= 36 (* V27 V33 V34))) ; Region 12
(assert (= 84 (* V31 V32 V37 V38 V45))) ; Region 13
(assert (= 28 (* V35 V36 V42))) ; Region 14
(assert (= 15 (* V39 V40))) ; Region 15
(assert (= 252 (* V41 V46 V47 V48))) ; Region 16
(assert (= 20 (* V43 V44))) ; Region 17
(check-sat)
