...
(assert (= 168 (* V0 V7 V8 V14))) ; Region 1
(assert (= 210 (* V1 V2 V3 V9))) ; Region 2
(assert (= 240 (* V4 V5 V6 V12))) ; Region 3
(assert (= 35 (* V10 V17))) ; Region 4
(assert (= 24 (* V13 V19 V20))) ; Region 6
(assert (= 6 (* V15 V16))) ; Region 7
(assert (= 6 (* V18 V25 V26))) ; Region 8
(assert (= 70 (* V21 V22 V23))) ; Region 9
(assert (= 8 (* V24 V31))) ; Region 10
(assert (= 21 (* V27 V34))) ; Region 11
(assert (= 18 (* V28 V29))) ; Region 12
(assert (= 5 (* V30 V37))) ; Region 13
(assert (= 210 (* V32 V38 V39))) ; Region 14
(assert (= 84 (* V33 V40 V47))) ; Region 15
(assert (= 24 (* V36 V42 V43 V44))) ; Region 17
