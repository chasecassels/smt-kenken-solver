...
(assert (= 28 (* V2 V9))) ; Region 2
(assert (= 18 (+ V3 V4 V5))) ; Region 3
(assert (= 7 (+ V6 V13))) ; Region 4
(assert (or (= 4 (- V7 V8)) (= 4 (- V8 V7)))) ; Region 5
(assert (or (= 4 (- V10 V17)) (= 4 (- V17 V10)))) ; Region 6
(assert (= 12 (+ V11 V18 V25))) ; Region 7
(assert (= 11 (+ V12 V19 V20))) ; Region 8
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 9
(assert (= 11 (+ V15 V22))) ; Region 10
(assert (or (= 2 (/ V16 V23)) (= 2 (/ V23 V16)))) ; Region 11
(assert (or (= 4 (- V24 V31)) (= 4 (- V31 V24)))) ; Region 12
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 13
(assert (= 13 (+ V27 V34 V41))) ; Region 14
(assert (or (= 4 (- V28 V29)) (= 4 (- V29 V28)))) ; Region 15
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 17
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 18
(assert (= 13 (+ V36 V43 V44))) ; Region 19
(assert (or (= 2 (- V37 V38)) (= 2 (- V38 V37)))) ; Region 20
(assert (= 17 (+ V40 V47 V48))) ; Region 21
(assert (= 5 (+ V45 V46))) ; Region 22
(check-sat)
