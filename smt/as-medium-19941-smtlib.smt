...
(assert (= 10 (+ V4 V5 V6))) ; Region 4
(assert (= 15 (+ V8 V14 V15))) ; Region 5
(assert (= 16 (+ V9 V16 V17 V24))) ; Region 6
(assert (= 3 (+ V10 V11))) ; Region 7
(assert (= 7 (+ V12 V13))) ; Region 8
(assert (or (= 4 (- V18 V19)) (= 4 (- V19 V18)))) ; Region 9
(assert (= 12 (+ V20 V26 V27))) ; Region 10
(assert (= 8 (+ V21 V22 V28))) ; Region 11
(assert (= 13 (+ V25 V32 V39))) ; Region 13
(assert (= 11 (+ V29 V36 V43))) ; Region 14
(assert (or (= 1 (- V30 V31)) (= 1 (- V31 V30)))) ; Region 15
(assert (= 13 (+ V33 V34))) ; Region 16
(assert (or (= 3 (- V35 V42)) (= 3 (- V42 V35)))) ; Region 17
(assert (or (= 6 (- V37 V38)) (= 6 (- V38 V37)))) ; Region 18
