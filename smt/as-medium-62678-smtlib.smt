...
(assert (= 15 (+ V1 V2 V3))) ; Region 2
(assert (= 10 (+ V4 V5 V12))) ; Region 3
(assert (= 4 (+ V6 V13))) ; Region 4
(assert (= 13 (+ V8 V9))) ; Region 5
(assert (or (= 2 (- V10 V11)) (= 2 (- V11 V10)))) ; Region 6
(assert (or (= 1 (- V14 V21)) (= 1 (- V21 V14)))) ; Region 7
(assert (= 3 (+ V15 V16))) ; Region 8
(assert (= 11 (+ V17 V18 V25))) ; Region 9
(assert (= 13 (+ V19 V20))) ; Region 10
(assert (= 12 (+ V22 V28 V29))) ; Region 11
(assert (= 13 (+ V23 V30 V37))) ; Region 12
(assert (= 11 (+ V24 V31))) ; Region 13
(assert (= 13 (+ V26 V33 V40))) ; Region 14
(assert (or (= 4 (- V27 V34)) (= 4 (- V34 V27)))) ; Region 15
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 16
(assert (= 12 (+ V35 V42 V43))) ; Region 17
(assert (= 8 (+ V38 V44 V45))) ; Region 19
(assert (= 9 (+ V41 V48))) ; Region 20
(assert (= 7 (+ V46 V47))) ; Region 21
(check-sat)
