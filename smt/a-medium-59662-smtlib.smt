...
(assert (= 11 (+ V7 V8))) ; Region 6
(assert (= 17 (+ V10 V11 V18))) ; Region 7
(assert (= 9 (+ V14 V15 V21))) ; Region 8
(assert (= 12 (+ V16 V17 V23))) ; Region 9
(assert (= 13 (+ V19 V20 V27))) ; Region 10
(assert (= 3 (+ V22 V29))) ; Region 11
(assert (= 11 (+ V25 V26 V32))) ; Region 13
(assert (= 15 (+ V28 V35 V42))) ; Region 14
(assert (= 8 (+ V30 V31))) ; Region 15
(assert (= 19 (+ V33 V34 V40 V47))) ; Region 16
(assert (= 10 (+ V36 V43))) ; Region 17
(assert (= 6 (+ V37 V38 V39))) ; Region 18
(assert (= 5 (+ V41 V48))) ; Region 19
(assert (= 18 (+ V44 V45 V46))) ; Region 20
(check-sat)
