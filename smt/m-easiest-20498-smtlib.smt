...
(assert (= 15 (* V2 V9 V16))) ; Region 2
(assert (= 14 (* V3 V4 V10))) ; Region 3
(assert (= 144 (* V5 V6 V13))) ; Region 4
(assert (= 84 (* V7 V8 V14))) ; Region 5
(assert (= 12 (* V12 V19))) ; Region 7
(assert (= 24 (* V15 V22 V23))) ; Region 8
(assert (= 8 (* V17 V18 V25))) ; Region 9
(assert (= 14 (* V20 V27))) ; Region 10
(assert (= 140 (* V21 V28 V29))) ; Region 11
(assert (= 45 (* V24 V31 V32))) ; Region 12
(assert (= 14 (* V26 V33 V34))) ; Region 13
(assert (= 48 (* V30 V36 V37))) ; Region 14
(assert (= 6 (* V35 V42 V43))) ; Region 15
(assert (= 24 (* V39 V46 V47))) ; Region 17
(assert (= 75 (* V40 V41 V48))) ; Region 18
(assert (= 42 (* V44 V45))) ; Region 19
(check-sat)
