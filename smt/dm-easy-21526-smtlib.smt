...
(assert (= 60 (* V5 V6 V13 V20))) ; Region 4
(assert (= 84 (* V9 V16 V23 V30))) ; Region 5
(assert (= 20 (* V10 V11))) ; Region 6
(assert (= 14 (* V12 V19))) ; Region 7
(assert (= 30 (* V14 V15))) ; Region 8
(assert (= 15 (* V17 V24 V31))) ; Region 9
(assert (or (= 2 (/ V18 V25)) (= 2 (/ V25 V18)))) ; Region 10
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 11
(assert (= 630 (* V26 V32 V33 V34))) ; Region 12
(assert (= 12 (* V28 V29 V35))) ; Region 14
(assert (= 20 (* V36 V42 V43))) ; Region 15
(assert (= 35 (* V37 V38))) ; Region 16
(assert (= 168 (* V39 V40 V41 V46))) ; Region 17
(assert (= 24 (* V44 V45))) ; Region 18
(assert (or (= 3 (/ V47 V48)) (= 3 (/ V48 V47)))) ; Region 19
(check-sat)
