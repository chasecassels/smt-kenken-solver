...
(assert (= 30 (* V0 V1 V2))) ; Region 1
(assert (= 6 (* V3 V4))) ; Region 2
(assert (= 28 (* V5 V6))) ; Region 3
(assert (= 12 (* V7 V8))) ; Region 4
(assert (= 7 (* V9 V10))) ; Region 5
(assert (= 210 (* V12 V13 V20))) ; Region 7
(assert (= 20 (* V14 V15))) ; Region 8
(assert (or (= 2 (/ V16 V17)) (= 2 (/ V17 V16)))) ; Region 9
(assert (or (= 2 (/ V18 V19)) (= 2 (/ V19 V18)))) ; Region 10
(assert (or (= 3 (/ V21 V28)) (= 3 (/ V28 V21)))) ; Region 11
(assert (= 20 (* V22 V23))) ; Region 12
(assert (= 210 (* V24 V25 V31))) ; Region 13
(assert (or (= 3 (/ V26 V27)) (= 3 (/ V27 V26)))) ; Region 14
(assert (= 21 (* V29 V30))) ; Region 15
(assert (= 120 (* V32 V39 V40))) ; Region 16
(assert (or (= 2 (/ V33 V34)) (= 2 (/ V34 V33)))) ; Region 17
(assert (= 7 (* V35 V36))) ; Region 18
(assert (or (= 2 (/ V37 V44)) (= 2 (/ V44 V37)))) ; Region 19
(assert (= 72 (* V41 V47 V48))) ; Region 21
(assert (= 6 (* V42 V43))) ; Region 22
(assert (= 35 (* V45 V46))) ; Region 23
(check-sat)
