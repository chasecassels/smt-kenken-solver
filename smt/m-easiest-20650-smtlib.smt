...
(assert (= 36 (* V0 V1 V2))) ; Region 1
(assert (= 10 (* V3 V10))) ; Region 2
(assert (= 28 (* V4 V5 V11))) ; Region 3
(assert (= 24 (* V7 V14))) ; Region 5
(assert (= 105 (* V8 V9 V16))) ; Region 6
(assert (= 30 (* V12 V13 V19))) ; Region 7
(assert (= 14 (* V15 V22 V23))) ; Region 8
(assert (= 18 (* V17 V18 V24))) ; Region 9
(assert (= 12 (* V20 V27))) ; Region 10
(assert (= 35 (* V21 V28))) ; Region 11
(assert (= 10 (* V25 V32))) ; Region 12
(assert (= 12 (* V26 V33))) ; Region 13
(assert (= 8 (* V29 V30))) ; Region 14
(assert (= 20 (* V31 V37 V38))) ; Region 15
(assert (= 84 (* V34 V40 V41))) ; Region 16
(assert (= 3 (* V35 V36 V42))) ; Region 17
(assert (= 126 (* V39 V45 V46))) ; Region 18
(assert (= 24 (* V43 V44))) ; Region 19
(assert (= 10 (* V47 V48))) ; Region 20
(check-sat)
