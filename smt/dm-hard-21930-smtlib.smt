...
(assert (= 40 (* V0 V1 V2 V8))) ; Region 1
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 2
(assert (= 168 (* V5 V10 V11 V12))) ; Region 3
(assert (= 35 (* V6 V13))) ; Region 4
(assert (= 84 (* V7 V14 V15))) ; Region 5
(assert (= 90 (* V9 V16 V17 V18))) ; Region 6
(assert (= 4 (* V19 V20))) ; Region 7
(assert (= 525 (* V21 V22 V29 V36))) ; Region 8
(assert (= 1176 (* V23 V24 V30 V37 V38))) ; Region 9
(assert (= 24 (* V25 V26 V27))) ; Region 10
(assert (= 72 (* V28 V35 V42 V43 V44))) ; Region 11
(assert (= 70 (* V32 V39 V45 V46))) ; Region 13
(assert (= 6 (* V33 V34))) ; Region 14
(assert (= 360 (* V40 V41 V47 V48))) ; Region 15
(check-sat)
