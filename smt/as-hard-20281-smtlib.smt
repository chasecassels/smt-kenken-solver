...
(assert (= 13 (+ V0 V1 V7))) ; Region 1
(assert (or (= 3 (- V2 V3)) (= 3 (- V3 V2)))) ; Region 2
(assert (= 15 (+ V4 V5 V12))) ; Region 3
(assert (= 6 (+ V6 V13))) ; Region 4
(assert (or (= 1 (- V8 V9)) (= 1 (- V9 V8)))) ; Region 5
(assert (or (= 6 (- V10 V11)) (= 6 (- V11 V10)))) ; Region 6
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 7
(assert (or (= 1 (- V15 V22)) (= 1 (- V22 V15)))) ; Region 8
(assert (or (= 4 (- V16 V17)) (= 4 (- V17 V16)))) ; Region 9
(assert (= 10 (+ V18 V19))) ; Region 10
(assert (= 18 (+ V20 V27 V34))) ; Region 11
(assert (or (= 5 (- V23 V30)) (= 5 (- V30 V23)))) ; Region 12
(assert (= 8 (+ V24 V25))) ; Region 13
(assert (= 11 (+ V26 V33 V40))) ; Region 14
(assert (= 7 (+ V28 V29))) ; Region 15
(assert (= 15 (+ V31 V32 V39))) ; Region 16
(assert (= 23 (+ V35 V36 V37 V44))) ; Region 17
(assert (= 5 (+ V41 V47 V48))) ; Region 19
(assert (= 11 (+ V42 V43))) ; Region 20
