...
(assert (= 11 (+ V1 V2))) ; Region 2
(assert (= 13 (+ V4 V11 V18))) ; Region 4
(assert (= 14 (+ V5 V6 V12 V13))) ; Region 5
(assert (or (= 6 (- V8 V9)) (= 6 (- V9 V8)))) ; Region 6
(assert (or (= 4 (- V10 V17)) (= 4 (- V17 V10)))) ; Region 7
(assert (= 9 (+ V14 V21))) ; Region 8
(assert (= 8 (+ V15 V16))) ; Region 9
(assert (= 18 (+ V19 V26 V33))) ; Region 10
(assert (= 6 (+ V20 V27))) ; Region 11
(assert (= 8 (+ V22 V23))) ; Region 12
(assert (or (= 4 (- V24 V31)) (= 4 (- V31 V24)))) ; Region 13
(assert (or (= 5 (- V25 V32)) (= 5 (- V32 V25)))) ; Region 14
(assert (= 7 (+ V28 V29 V30))) ; Region 15
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 16
(assert (or (= 5 (- V35 V36)) (= 5 (- V36 V35)))) ; Region 17
(assert (= 10 (+ V37 V44))) ; Region 18
(assert (or (= 1 (- V38 V39)) (= 1 (- V39 V38)))) ; Region 19
(assert (= 10 (+ V40 V47 V48))) ; Region 20
(assert (= 6 (+ V42 V43))) ; Region 21
(assert (= 11 (+ V45 V46))) ; Region 22
(check-sat)
