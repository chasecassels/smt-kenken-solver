...
(assert (or (= 4 (- V0 V1)) (= 4 (- V1 V0)))) ; Region 1
(assert (or (= 4 (- V2 V9)) (= 4 (- V9 V2)))) ; Region 2
(assert (= 11 (+ V3 V4))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 4
(assert (or (= 3 (- V7 V14)) (= 3 (- V14 V7)))) ; Region 5
(assert (= 18 (+ V8 V15 V22))) ; Region 6
(assert (= 15 (+ V10 V16 V17))) ; Region 7
(assert (= 6 (+ V11 V18 V25))) ; Region 8
(assert (= 8 (+ V12 V13))) ; Region 9
(assert (= 9 (+ V19 V26))) ; Region 10
(assert (or (= 6 (- V20 V27)) (= 6 (- V27 V20)))) ; Region 11
(assert (= 16 (+ V21 V28 V29))) ; Region 12
(assert (or (= 1 (- V23 V24)) (= 1 (- V24 V23)))) ; Region 13
(assert (or (= 4 (- V30 V37)) (= 4 (- V37 V30)))) ; Region 14
(assert (or (= 4 (- V31 V32)) (= 4 (- V32 V31)))) ; Region 15
(assert (= 15 (+ V34 V41 V48))) ; Region 17
(assert (= 9 (+ V35 V36 V42))) ; Region 18
(assert (or (= 2 (- V38 V45)) (= 2 (- V45 V38)))) ; Region 19
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 20
(assert (or (= 2 (- V40 V47)) (= 2 (- V47 V40)))) ; Region 21
(assert (or (= 5 (- V43 V44)) (= 5 (- V44 V43)))) ; Region 22
(check-sat)
