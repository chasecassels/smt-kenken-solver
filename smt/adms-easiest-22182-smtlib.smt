...
(assert (= 35 (* V2 V3))) ; Region 2
(assert (or (= 6 (- V4 V11)) (= 6 (- V11 V4)))) ; Region 3
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 4
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 5
(assert (= 13 (+ V8 V15))) ; Region 6
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 7
(assert (= 3 (+ V10 V17))) ; Region 8
(assert (= 11 (+ V12 V13 V20))) ; Region 9
(assert (= 32 (* V18 V19 V26))) ; Region 10
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 11
(assert (= 50 (* V22 V29 V30))) ; Region 12
(assert (= 7 (+ V24 V31))) ; Region 14
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 15
(assert (= 13 (+ V27 V34))) ; Region 16
(assert (or (= 6 (- V33 V40)) (= 6 (- V40 V33)))) ; Region 17
(assert (= 18 (* V36 V42 V43))) ; Region 19
(assert (or (= 5 (- V37 V38)) (= 5 (- V38 V37)))) ; Region 20
(assert (= 30 (* V39 V46 V47))) ; Region 21
(assert (or (= 2 (/ V41 V48)) (= 2 (/ V48 V41)))) ; Region 22
(assert (= 28 (* V44 V45))) ; Region 23
(check-sat)
