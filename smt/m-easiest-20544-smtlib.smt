...
(assert (= 168 (* V0 V7 V14))) ; Region 1
(assert (= 3 (* V2 V8 V9))) ; Region 3
(assert (= 60 (* V3 V4 V5))) ; Region 4
(assert (= 10 (* V6 V13))) ; Region 5
(assert (= 24 (* V10 V11))) ; Region 6
(assert (= 10 (* V12 V19 V20))) ; Region 7
(assert (= 24 (* V15 V22))) ; Region 8
(assert (= 84 (* V16 V17 V23))) ; Region 9
(assert (= 6 (* V18 V25))) ; Region 10
(assert (= 30 (* V21 V28 V29))) ; Region 11
(assert (= 35 (* V24 V30 V31))) ; Region 12
(assert (= 42 (* V27 V34))) ; Region 14
(assert (= 4 (* V32 V33 V39))) ; Region 15
(assert (= 15 (* V36 V42 V43))) ; Region 17
(assert (= 8 (* V37 V44))) ; Region 18
(assert (= 30 (* V38 V45))) ; Region 19
(assert (= 42 (* V40 V47))) ; Region 20
