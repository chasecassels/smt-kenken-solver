...
(assert (= 12 (+ V4 V5))) ; Region 4
(assert (= 16 (+ V6 V13 V20))) ; Region 5
(assert (= 9 (+ V8 V15 V22))) ; Region 6
(assert (= 9 (+ V11 V12))) ; Region 8
(assert (= 9 (+ V14 V21))) ; Region 9
(assert (= 9 (+ V16 V23))) ; Region 10
(assert (= 7 (+ V17 V24))) ; Region 11
(assert (= 3 (+ V18 V19))) ; Region 12
(assert (= 11 (+ V25 V32))) ; Region 13
(assert (= 7 (+ V26 V27))) ; Region 14
(assert (= 6 (+ V28 V35 V42))) ; Region 15
(assert (= 13 (+ V29 V36))) ; Region 16
(assert (= 11 (+ V30 V31))) ; Region 17
(assert (= 7 (+ V33 V34 V41))) ; Region 18
(assert (= 11 (+ V37 V44))) ; Region 19
(assert (= 6 (+ V39 V40))) ; Region 21
(assert (= 4 (+ V45 V46))) ; Region 23
