...
(assert (= 90 (* V0 V1 V7))) ; Region 1
(assert (= 7 (* V2 V3 V10))) ; Region 2
(assert (= 8 (* V4 V11))) ; Region 3
(assert (= 20 (* V5 V6))) ; Region 4
(assert (= 42 (* V8 V9 V16))) ; Region 5
(assert (= 12 (* V12 V13 V20))) ; Region 6
(assert (= 168 (* V14 V21 V22))) ; Region 7
(assert (= 105 (* V17 V18 V25))) ; Region 9
(assert (= 18 (* V19 V26 V33))) ; Region 10
(assert (= 30 (* V23 V24 V31))) ; Region 11
(assert (= 28 (* V27 V34))) ; Region 12
(assert (= 48 (* V28 V29 V30))) ; Region 13
(assert (= 42 (* V32 V39 V40))) ; Region 14
(assert (= 7 (* V35 V42 V43))) ; Region 15
(assert (= 40 (* V36 V37 V44))) ; Region 16
(assert (= 24 (* V38 V45))) ; Region 17
(assert (= 6 (* V41 V48))) ; Region 18
(assert (= 15 (* V46 V47))) ; Region 19
(check-sat)
