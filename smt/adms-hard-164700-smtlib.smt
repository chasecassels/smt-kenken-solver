...
(assert (= 70 (* V0 V1 V7 V8))) ; Region 1
(assert (= 16 (+ V2 V3 V9))) ; Region 2
(assert (= 14 (+ V4 V11 V18))) ; Region 3
(assert (= 6 (+ V5 V6 V13))) ; Region 4
(assert (= 13 (+ V10 V16 V17))) ; Region 5
(assert (= 15 (+ V12 V19 V20))) ; Region 6
(assert (= 5 (+ V14 V15))) ; Region 7
(assert (= 14 (+ V21 V22 V23))) ; Region 8
(assert (= 10 (* V25 V32 V39))) ; Region 10
(assert (or (= 3 (- V26 V27)) (= 3 (- V27 V26)))) ; Region 11
(assert (= 16 (+ V28 V29 V30 V37))) ; Region 12
(assert (or (= 3 (/ V31 V38)) (= 3 (/ V38 V31)))) ; Region 13
(assert (= 6 (* V33 V34))) ; Region 14
(assert (= 120 (* V35 V36 V42))) ; Region 15
(assert (or (= 4 (- V40 V47)) (= 4 (- V47 V40)))) ; Region 16
(assert (or (= 3 (- V41 V48)) (= 3 (- V48 V41)))) ; Region 17
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 18
(assert (or (= 2 (- V45 V46)) (= 2 (- V46 V45)))) ; Region 19
(check-sat)
