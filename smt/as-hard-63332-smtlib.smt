...
(assert (= 8 (+ V0 V1 V2))) ; Region 1
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 2
(assert (or (= 5 (- V5 V12)) (= 5 (- V12 V5)))) ; Region 3
(assert (or (= 5 (- V6 V13)) (= 5 (- V13 V6)))) ; Region 4
(assert (= 9 (+ V7 V8))) ; Region 5
(assert (= 17 (+ V9 V15 V16))) ; Region 6
(assert (= 6 (+ V10 V17 V24))) ; Region 7
(assert (or (= 4 (- V11 V18)) (= 4 (- V18 V11)))) ; Region 8
(assert (or (= 5 (- V14 V21)) (= 5 (- V21 V14)))) ; Region 9
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 10
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 11
(assert (= 16 (+ V25 V32 V33))) ; Region 12
(assert (= 10 (+ V27 V34))) ; Region 14
(assert (= 9 (+ V28 V29 V36))) ; Region 15
(assert (or (= 3 (- V30 V37)) (= 3 (- V37 V30)))) ; Region 16
(assert (= 17 (+ V31 V38 V45))) ; Region 17
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 18
(assert (= 9 (+ V39 V40 V46))) ; Region 19
(assert (= 9 (+ V41 V47 V48))) ; Region 20
(assert (= 8 (+ V43 V44))) ; Region 21
(check-sat)
