...
(assert (= 12 (+ V1 V2 V9))) ; Region 2
(assert (= 14 (+ V3 V4 V5))) ; Region 3
(assert (= 3 (+ V6 V13))) ; Region 4
(assert (= 13 (+ V8 V15 V22))) ; Region 5
(assert (= 6 (+ V10 V17))) ; Region 6
(assert (= 10 (+ V11 V12 V19))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 8
(assert (= 13 (+ V16 V23))) ; Region 9
(assert (= 7 (+ V18 V25))) ; Region 10
(assert (= 14 (+ V20 V26 V27))) ; Region 11
(assert (= 10 (+ V24 V31))) ; Region 12
(assert (= 12 (+ V28 V35 V42))) ; Region 13
(assert (= 3 (+ V29 V30))) ; Region 14
(assert (= 11 (+ V32 V39))) ; Region 15
(assert (= 11 (+ V33 V40))) ; Region 16
(assert (= 12 (+ V34 V41))) ; Region 17
(assert (= 15 (+ V36 V37 V43 V44))) ; Region 18
(assert (= 5 (+ V38 V45))) ; Region 19
(assert (= 3 (+ V46 V47))) ; Region 20
(check-sat)
