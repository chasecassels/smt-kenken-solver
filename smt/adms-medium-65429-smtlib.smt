...
(assert (= 24 (* V2 V3 V9))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (= 18 (* V6 V13 V20))) ; Region 4
(assert (or (= 5 (- V7 V8)) (= 5 (- V8 V7)))) ; Region 5
(assert (or (= 2 (/ V10 V11)) (= 2 (/ V11 V10)))) ; Region 6
(assert (= 14 (+ V12 V18 V19))) ; Region 7
(assert (= 7 (+ V14 V21))) ; Region 8
(assert (= 120 (* V15 V22 V29 V36))) ; Region 9
(assert (= 30 (* V16 V17 V23))) ; Region 10
(assert (or (= 2 (- V24 V25)) (= 2 (- V25 V24)))) ; Region 11
(assert (or (= 6 (- V26 V27)) (= 6 (- V27 V26)))) ; Region 12
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 13
(assert (or (= 3 (/ V30 V37)) (= 3 (/ V37 V30)))) ; Region 14
(assert (or (= 2 (- V31 V38)) (= 2 (- V38 V31)))) ; Region 15
(assert (or (= 6 (- V32 V39)) (= 6 (- V39 V32)))) ; Region 16
(assert (or (= 1 (- V33 V34)) (= 1 (- V34 V33)))) ; Region 17
(assert (= 144 (* V40 V41 V47 V48))) ; Region 18
(assert (or (= 2 (- V42 V43)) (= 2 (- V43 V42)))) ; Region 19
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 20
(check-sat)
