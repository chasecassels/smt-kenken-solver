...
(assert (= 11 (+ V0 V1 V2))) ; Region 1
(assert (= 6 (+ V3 V10))) ; Region 2
(assert (= 6 (+ V4 V5))) ; Region 3
(assert (= 14 (+ V6 V12 V13))) ; Region 4
(assert (= 12 (+ V7 V14))) ; Region 5
(assert (= 11 (+ V8 V9 V15))) ; Region 6
(assert (= 6 (+ V11 V18 V25))) ; Region 7
(assert (= 8 (+ V16 V17))) ; Region 8
(assert (= 15 (+ V19 V20 V27))) ; Region 9
(assert (= 15 (+ V21 V28 V29))) ; Region 10
(assert (= 8 (+ V22 V23 V30))) ; Region 11
(assert (= 7 (+ V24 V31))) ; Region 12
(assert (= 12 (+ V32 V39 V40))) ; Region 14
(assert (= 9 (+ V33 V34))) ; Region 15
(assert (= 7 (+ V35 V42))) ; Region 16
(assert (= 6 (+ V36 V43))) ; Region 17
(assert (= 8 (+ V37 V44))) ; Region 18
(assert (= 13 (+ V38 V45))) ; Region 19
(assert (= 3 (+ V41 V48))) ; Region 20
(assert (= 12 (+ V46 V47))) ; Region 21
(check-sat)
