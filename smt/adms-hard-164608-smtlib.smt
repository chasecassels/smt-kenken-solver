...
(assert (= 5 (+ V2 V3))) ; Region 2
(assert (= 84 (* V4 V5 V6))) ; Region 3
(assert (= 9 (+ V7 V8 V9))) ; Region 4
(assert (or (= 1 (- V10 V11)) (= 1 (- V11 V10)))) ; Region 5
(assert (or (= 6 (- V12 V13)) (= 6 (- V13 V12)))) ; Region 6
(assert (or (= 4 (- V14 V21)) (= 4 (- V21 V14)))) ; Region 7
(assert (or (= 5 (- V15 V16)) (= 5 (- V16 V15)))) ; Region 8
(assert (= 19 (+ V17 V18 V24 V25))) ; Region 9
(assert (or (= 2 (- V19 V26)) (= 2 (- V26 V19)))) ; Region 10
(assert (= 5 (+ V22 V23))) ; Region 12
(assert (= 9 (+ V27 V33 V34))) ; Region 13
(assert (or (= 3 (/ V28 V29)) (= 3 (/ V29 V28)))) ; Region 14
(assert (= 105 (* V30 V31 V38))) ; Region 15
(assert (= 12 (* V32 V39 V46))) ; Region 16
(assert (= 210 (* V35 V36 V37))) ; Region 17
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 18
(assert (or (= 4 (- V42 V43)) (= 4 (- V43 V42)))) ; Region 19
(assert (or (= 5 (- V44 V45)) (= 5 (- V45 V44)))) ; Region 20
(assert (or (= 2 (- V47 V48)) (= 2 (- V48 V47)))) ; Region 21
(check-sat)
