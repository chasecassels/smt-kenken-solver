...
(assert (= 60 (* V4 V5 V6))) ; Region 3
(assert (= 60 (* V9 V10 V11 V18))) ; Region 4
(assert (= 60 (* V12 V13 V19 V20))) ; Region 5
(assert (= 84 (* V14 V15 V16 V22))) ; Region 6
(assert (= 48 (* V17 V23 V24))) ; Region 7
(assert (= 30 (* V21 V28))) ; Region 8
(assert (= 84 (* V25 V31 V32 V33))) ; Region 9
(assert (= 18 (* V26 V27))) ; Region 10
(assert (= 30 (* V30 V37 V38 V44))) ; Region 12
(assert (= 245 (* V34 V40 V41))) ; Region 13
(assert (= 12 (* V35 V42))) ; Region 14
(assert (= 15 (* V36 V43))) ; Region 15
(assert (= 84 (* V39 V45 V46))) ; Region 16
(assert (= 8 (* V47 V48))) ; Region 17
(check-sat)
