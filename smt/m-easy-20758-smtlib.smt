...
(assert (= 48 (* V1 V2 V3))) ; Region 2
(assert (= 168 (* V4 V5 V11 V18))) ; Region 3
(assert (= 140 (* V6 V12 V13 V20))) ; Region 4
(assert (= 12 (* V9 V10 V17))) ; Region 5
(assert (= 42 (* V14 V15))) ; Region 6
(assert (= 30 (* V16 V23))) ; Region 7
(assert (= 15 (* V19 V26 V27))) ; Region 8
(assert (= 12 (* V21 V22 V28))) ; Region 9
(assert (= 14 (* V24 V25))) ; Region 10
(assert (= 42 (* V29 V30 V37))) ; Region 11
(assert (= 840 (* V32 V33 V34 V40))) ; Region 13
(assert (= 14 (* V35 V42))) ; Region 14
(assert (= 20 (* V36 V43 V44))) ; Region 15
(assert (= 10 (* V38 V45))) ; Region 16
(assert (= 12 (* V39 V46 V47))) ; Region 17
(assert (= 18 (* V41 V48))) ; Region 18
(check-sat)
