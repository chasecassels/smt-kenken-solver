...
(assert (or (= 5 (- V2 V3)) (= 5 (- V3 V2)))) ; Region 2
(assert (= 12 (+ V4 V5 V11 V12))) ; Region 3
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 4
(assert (= 18 (+ V7 V14 V21))) ; Region 5
(assert (= 12 (+ V8 V9 V10))) ; Region 6
(assert (= 3 (+ V15 V16))) ; Region 7
(assert (= 11 (+ V17 V18))) ; Region 8
(assert (= 6 (+ V19 V26 V33))) ; Region 9
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 10
(assert (or (= 2 (- V22 V29)) (= 2 (- V29 V22)))) ; Region 11
(assert (= 12 (+ V23 V30 V37))) ; Region 12
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 13
(assert (or (= 4 (- V25 V32)) (= 4 (- V32 V25)))) ; Region 14
(assert (or (= 3 (- V28 V35)) (= 3 (- V35 V28)))) ; Region 15
(assert (= 3 (+ V34 V41))) ; Region 16
(assert (= 13 (+ V36 V42 V43))) ; Region 17
(assert (= 10 (+ V38 V45 V46))) ; Region 18
(assert (or (= 1 (- V39 V40)) (= 1 (- V40 V39)))) ; Region 19
