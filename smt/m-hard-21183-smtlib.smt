...
(assert (= 56 (* V1 V2 V8 V9))) ; Region 2
(assert (= 30 (* V3 V10 V11))) ; Region 3
(assert (= 84 (* V4 V5 V6))) ; Region 4
(assert (= 42 (* V7 V14 V21 V22))) ; Region 5
(assert (= 24 (* V12 V13 V19))) ; Region 6
(assert (= 18 (* V16 V17 V24))) ; Region 8
(assert (= 48 (* V18 V25 V26))) ; Region 9
(assert (= 35 (* V20 V27))) ; Region 10
(assert (= 42 (* V23 V30 V31))) ; Region 11
(assert (= 48 (* V28 V29 V35))) ; Region 12
(assert (= 30 (* V32 V33 V34))) ; Region 13
(assert (= 30 (* V36 V37 V44))) ; Region 14
(assert (= 28 (* V38 V45))) ; Region 15
(assert (= 210 (* V39 V40 V41 V46 V48))) ; Region 16
(assert (= 12 (* V42 V43))) ; Region 17
(check-sat)
