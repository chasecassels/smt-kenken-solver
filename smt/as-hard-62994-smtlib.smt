...
(assert (or (= 6 (- V15 V16)) (= 6 (- V16 V15)))) ; Region 9
(assert (= 15 (+ V17 V24 V25))) ; Region 10
(assert (= 6 (+ V18 V19))) ; Region 11
(assert (= 16 (+ V22 V23 V30))) ; Region 12
(assert (= 7 (+ V26 V27))) ; Region 13
(assert (= 10 (+ V28 V29 V35 V36))) ; Region 14
(assert (or (= 3 (- V32 V33)) (= 3 (- V33 V32)))) ; Region 16
(assert (= 20 (+ V34 V40 V41))) ; Region 17
(assert (= 6 (+ V37 V38 V44))) ; Region 18
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 20
(assert (or (= 4 (- V45 V46)) (= 4 (- V46 V45)))) ; Region 21
