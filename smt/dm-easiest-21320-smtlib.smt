...
(assert (= 21 (* V0 V7 V14))) ; Region 1
(assert (or (= 3 (/ V1 V8)) (= 3 (/ V8 V1)))) ; Region 2
(assert (= 42 (* V2 V9))) ; Region 3
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 4
(assert (= 20 (* V5 V6 V13))) ; Region 5
(assert (= 15 (* V10 V11))) ; Region 6
(assert (or (= 2 (/ V12 V19)) (= 2 (/ V19 V12)))) ; Region 7
(assert (= 28 (* V15 V16))) ; Region 8
(assert (= 12 (* V17 V24))) ; Region 9
(assert (= 63 (* V18 V25 V26))) ; Region 10
(assert (= 30 (* V20 V27))) ; Region 11
(assert (= 4 (* V21 V22))) ; Region 12
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 14
(assert (= 30 (* V29 V30 V36))) ; Region 15
(assert (= 140 (* V31 V38 V39))) ; Region 16
(assert (= 28 (* V32 V33 V34))) ; Region 17
(assert (or (= 3 (/ V37 V44)) (= 3 (/ V44 V37)))) ; Region 18
(assert (or (= 2 (/ V40 V41)) (= 2 (/ V41 V40)))) ; Region 19
(assert (= 20 (* V42 V43))) ; Region 20
(assert (= 6 (* V45 V46))) ; Region 21
