...
(assert (or (= 2 (- V1 V8)) (= 2 (- V8 V1)))) ; Region 2
(assert (or (= 1 (- V2 V9)) (= 1 (- V9 V2)))) ; Region 3
(assert (= 13 (+ V3 V4))) ; Region 4
(assert (= 10 (+ V5 V6 V13))) ; Region 5
(assert (= 12 (+ V10 V11))) ; Region 6
(assert (= 13 (+ V12 V19 V20))) ; Region 7
(assert (or (= 3 (- V14 V21)) (= 3 (- V21 V14)))) ; Region 8
(assert (= 7 (+ V15 V16 V17))) ; Region 9
(assert (or (= 2 (- V18 V25)) (= 2 (- V25 V18)))) ; Region 10
(assert (or (= 6 (- V22 V23)) (= 6 (- V23 V22)))) ; Region 11
(assert (= 8 (+ V24 V31 V32))) ; Region 12
(assert (or (= 1 (- V26 V27)) (= 1 (- V27 V26)))) ; Region 13
(assert (or (= 2 (- V28 V29)) (= 2 (- V29 V28)))) ; Region 14
(assert (= 13 (+ V30 V37))) ; Region 15
(assert (or (= 2 (- V33 V34)) (= 2 (- V34 V33)))) ; Region 16
(assert (= 11 (+ V35 V42))) ; Region 17
(assert (= 12 (+ V36 V43 V44))) ; Region 18
(assert (or (= 4 (- V39 V40)) (= 4 (- V40 V39)))) ; Region 20
(assert (= 5 (+ V41 V48))) ; Region 21
