...
(assert (or (= 4 (- V0 V7)) (= 4 (- V7 V0)))) ; Region 1
(assert (or (= 4 (- V1 V8)) (= 4 (- V8 V1)))) ; Region 2
(assert (= 6 (+ V2 V3 V4))) ; Region 3
(assert (= 14 (+ V5 V6 V13))) ; Region 4
(assert (or (= 2 (- V9 V16)) (= 2 (- V16 V9)))) ; Region 5
(assert (= 17 (+ V10 V11 V17))) ; Region 6
(assert (or (= 1 (- V12 V19)) (= 1 (- V19 V12)))) ; Region 7
(assert (= 10 (+ V14 V15 V22))) ; Region 8
(assert (or (= 3 (- V18 V25)) (= 3 (- V25 V18)))) ; Region 9
(assert (or (= 2 (- V20 V27)) (= 2 (- V27 V20)))) ; Region 10
(assert (or (= 3 (- V21 V28)) (= 3 (- V28 V21)))) ; Region 11
(assert (= 8 (+ V23 V30 V37))) ; Region 12
(assert (= 8 (+ V24 V31 V32))) ; Region 13
(assert (= 18 (+ V26 V33 V40))) ; Region 14
(assert (= 15 (+ V29 V35 V36))) ; Region 15
(assert (= 9 (+ V34 V41))) ; Region 16
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 17
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 18
(assert (or (= 2 (- V43 V44)) (= 2 (- V44 V43)))) ; Region 20
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 21
(check-sat)
