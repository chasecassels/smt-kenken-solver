...
(assert (= 60 (* V0 V1 V7))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (= 7 (* V4 V5))) ; Region 3
(assert (= 630 (* V6 V11 V12 V13))) ; Region 4
(assert (or (= 2 (/ V8 V9)) (= 2 (/ V9 V8)))) ; Region 5
(assert (= 360 (* V10 V17 V24 V25))) ; Region 6
(assert (= 168 (* V14 V15 V21 V28))) ; Region 7
(assert (= 126 (* V16 V22 V23))) ; Region 8
(assert (or (= 3 (/ V18 V19)) (= 3 (/ V19 V18)))) ; Region 9
(assert (= 2 (* V20 V27))) ; Region 10
(assert (= 20 (* V26 V33))) ; Region 11
(assert (= 18 (* V29 V30 V37))) ; Region 12
(assert (= 14 (* V31 V32))) ; Region 13
(assert (= 140 (* V35 V36 V42 V43))) ; Region 15
(assert (= 12 (* V38 V39 V46))) ; Region 16
(assert (or (= 2 (/ V40 V47)) (= 2 (/ V47 V40)))) ; Region 17
(assert (= 28 (* V41 V48))) ; Region 18
(assert (= 5 (* V44 V45))) ; Region 19
(check-sat)
