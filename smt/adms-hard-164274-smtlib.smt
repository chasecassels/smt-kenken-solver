...
(assert (= 300 (* V0 V7 V8 V9))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (or (= 1 (- V3 V4)) (= 1 (- V4 V3)))) ; Region 3
(assert (= 8 (+ V5 V6))) ; Region 4
(assert (= 8 (+ V10 V17 V18))) ; Region 5
(assert (= 13 (+ V11 V12))) ; Region 6
(assert (= 8 (+ V13 V20 V27))) ; Region 7
(assert (= 18 (+ V14 V15 V21 V22))) ; Region 8
(assert (= 15 (+ V16 V23 V30))) ; Region 9
(assert (or (= 2 (/ V19 V26)) (= 2 (/ V26 V19)))) ; Region 10
(assert (= 7 (+ V24 V31))) ; Region 11
(assert (= 11 (+ V25 V32))) ; Region 12
(assert (or (= 3 (- V28 V29)) (= 3 (- V29 V28)))) ; Region 13
(assert (= 105 (* V33 V40 V41))) ; Region 14
(assert (= 24 (* V35 V42))) ; Region 16
(assert (= 8 (+ V36 V37))) ; Region 17
(assert (or (= 3 (- V38 V45)) (= 3 (- V45 V38)))) ; Region 18
(assert (or (= 1 (- V39 V46)) (= 1 (- V46 V39)))) ; Region 19
