...
(assert (= 9 (+ V4 V5))) ; Region 4
(assert (= 11 (+ V6 V13))) ; Region 5
(assert (= 12 (+ V7 V14 V15))) ; Region 6
(assert (= 7 (+ V11 V18))) ; Region 8
(assert (= 3 (+ V12 V19))) ; Region 9
(assert (= 6 (+ V16 V23))) ; Region 10
(assert (= 11 (+ V17 V24))) ; Region 11
(assert (= 11 (+ V20 V27))) ; Region 12
(assert (= 10 (+ V21 V28))) ; Region 13
(assert (= 11 (+ V22 V29 V30))) ; Region 14
(assert (= 13 (+ V25 V26))) ; Region 15
(assert (or (= 1 (- V31 V32)) (= 1 (- V32 V31)))) ; Region 16
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 17
(assert (= 10 (+ V35 V36))) ; Region 18
(assert (= 15 (+ V37 V43 V44))) ; Region 19
(assert (= 3 (+ V38 V45))) ; Region 20
(assert (= 12 (+ V39 V40))) ; Region 21
(assert (= 5 (+ V41 V48))) ; Region 22
(assert (= 5 (+ V46 V47))) ; Region 24
(check-sat)
