...
(assert (= 17 (+ V2 V3 V4 V10))) ; Region 2
(assert (or (= 6 (- V5 V6)) (= 6 (- V6 V5)))) ; Region 3
(assert (= 13 (+ V7 V14 V15))) ; Region 4
(assert (= 6 (+ V8 V9))) ; Region 5
(assert (= 13 (+ V11 V12))) ; Region 6
(assert (= 5 (+ V13 V20))) ; Region 7
(assert (= 13 (+ V16 V17))) ; Region 8
(assert (= 7 (+ V18 V25 V32))) ; Region 9
(assert (= 4 (+ V19 V26))) ; Region 10
(assert (= 9 (+ V21 V28))) ; Region 11
(assert (= 18 (+ V22 V23 V29))) ; Region 12
(assert (= 9 (+ V27 V34))) ; Region 14
(assert (or (= 6 (- V30 V31)) (= 6 (- V31 V30)))) ; Region 15
(assert (= 19 (+ V33 V40 V41 V48))) ; Region 16
(assert (or (= 6 (- V35 V36)) (= 6 (- V36 V35)))) ; Region 17
(assert (= 9 (+ V38 V45))) ; Region 19
(assert (= 14 (+ V39 V46 V47))) ; Region 20
(assert (= 6 (+ V42 V43 V44))) ; Region 21
(check-sat)
