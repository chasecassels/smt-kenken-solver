...
(assert (= 13 (+ V0 V1 V8))) ; Region 1
(assert (= 3 (+ V2 V3))) ; Region 2
(assert (= 18 (+ V4 V5 V6))) ; Region 3
(assert (= 13 (+ V7 V14 V15))) ; Region 4
(assert (or (= 2 (- V9 V16)) (= 2 (- V16 V9)))) ; Region 5
(assert (= 7 (+ V10 V17))) ; Region 6
(assert (or (= 5 (- V12 V13)) (= 5 (- V13 V12)))) ; Region 8
(assert (= 7 (+ V18 V19))) ; Region 9
(assert (= 8 (+ V20 V27))) ; Region 10
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 11
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 12
(assert (or (= 6 (- V24 V31)) (= 6 (- V31 V24)))) ; Region 13
(assert (or (= 2 (- V25 V26)) (= 2 (- V26 V25)))) ; Region 14
(assert (= 3 (+ V29 V30))) ; Region 15
(assert (= 13 (+ V32 V33 V34))) ; Region 16
(assert (= 3 (+ V35 V42))) ; Region 17
(assert (or (= 4 (- V36 V43)) (= 4 (- V43 V36)))) ; Region 18
(assert (= 10 (+ V37 V38))) ; Region 19
(assert (or (= 3 (- V39 V46)) (= 3 (- V46 V39)))) ; Region 20
(assert (or (= 1 (- V40 V47)) (= 1 (- V47 V40)))) ; Region 21
(assert (or (= 6 (- V41 V48)) (= 6 (- V48 V41)))) ; Region 22
(assert (or (= 1 (- V44 V45)) (= 1 (- V45 V44)))) ; Region 23
(check-sat)
