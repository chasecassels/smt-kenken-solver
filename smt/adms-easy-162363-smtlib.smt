...
(assert (= 21 (* V2 V3 V10))) ; Region 2
(assert (= 24 (* V5 V6))) ; Region 4
(assert (or (= 3 (- V7 V14)) (= 3 (- V14 V7)))) ; Region 5
(assert (or (= 2 (- V8 V15)) (= 2 (- V15 V8)))) ; Region 6
(assert (= 3 (+ V9 V16))) ; Region 7
(assert (or (= 3 (- V11 V18)) (= 3 (- V18 V11)))) ; Region 8
(assert (= 35 (* V12 V13))) ; Region 9
(assert (= 12 (+ V17 V23 V24))) ; Region 10
(assert (= 10 (* V19 V20))) ; Region 11
(assert (= 6 (+ V21 V22))) ; Region 12
(assert (= 140 (* V25 V32 V39))) ; Region 13
(assert (or (= 3 (/ V26 V33)) (= 3 (/ V33 V26)))) ; Region 14
(assert (or (= 3 (/ V27 V34)) (= 3 (/ V34 V27)))) ; Region 15
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 16
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 17
(assert (= 120 (* V31 V38 V45))) ; Region 18
(assert (= 30 (* V36 V37 V44))) ; Region 19
(assert (= 84 (* V40 V41 V48))) ; Region 20
(assert (= 10 (+ V42 V43))) ; Region 21
(assert (= 3 (+ V46 V47))) ; Region 22
(check-sat)
