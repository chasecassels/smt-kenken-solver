...
(assert (= 11 (+ V0 V1))) ; Region 1
(assert (= 10 (+ V2 V9 V16))) ; Region 2
(assert (= 11 (+ V3 V4))) ; Region 3
(assert (or (= 6 (- V5 V12)) (= 6 (- V12 V5)))) ; Region 4
(assert (or (= 2 (- V6 V13)) (= 2 (- V13 V6)))) ; Region 5
(assert (= 4 (+ V7 V8))) ; Region 6
(assert (= 11 (+ V10 V11))) ; Region 7
(assert (= 3 (+ V14 V15))) ; Region 8
(assert (= 8 (+ V17 V24))) ; Region 9
(assert (or (= 1 (- V18 V19)) (= 1 (- V19 V18)))) ; Region 10
(assert (or (= 6 (- V20 V27)) (= 6 (- V27 V20)))) ; Region 11
(assert (= 11 (+ V21 V28))) ; Region 12
(assert (= 11 (+ V22 V23))) ; Region 13
(assert (or (= 2 (- V25 V32)) (= 2 (- V32 V25)))) ; Region 14
(assert (= 7 (+ V29 V30))) ; Region 16
(assert (or (= 2 (- V31 V38)) (= 2 (- V38 V31)))) ; Region 17
(assert (= 8 (+ V33 V34))) ; Region 18
(assert (= 12 (+ V35 V36 V42))) ; Region 19
(assert (= 7 (+ V39 V40))) ; Region 21
(assert (= 8 (+ V41 V48))) ; Region 22
(assert (or (= 6 (- V43 V44)) (= 6 (- V44 V43)))) ; Region 23
(assert (= 11 (+ V45 V46 V47))) ; Region 24
(check-sat)
