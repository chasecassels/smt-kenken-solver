...
(assert (= 42 (* V0 V7))) ; Region 1
(assert (or (= 2 (/ V1 V8)) (= 2 (/ V8 V1)))) ; Region 2
(assert (= 20 (* V2 V9))) ; Region 3
(assert (= 21 (* V3 V10))) ; Region 4
(assert (or (= 2 (/ V4 V11)) (= 2 (/ V11 V4)))) ; Region 5
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 6
(assert (= 30 (* V12 V13))) ; Region 7
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 8
(assert (= 21 (* V15 V16))) ; Region 9
(assert (= 12 (* V17 V18))) ; Region 10
(assert (= 42 (* V19 V26 V33))) ; Region 11
(assert (= 140 (* V20 V27 V34))) ; Region 12
(assert (= 30 (* V22 V23 V24))) ; Region 13
(assert (= 12 (* V25 V31 V32))) ; Region 14
(assert (= 5 (* V28 V35))) ; Region 15
(assert (= 15 (* V29 V36))) ; Region 16
(assert (= 48 (* V30 V37 V38))) ; Region 17
(assert (= 35 (* V39 V46))) ; Region 18
(assert (= 6 (* V40 V41))) ; Region 19
