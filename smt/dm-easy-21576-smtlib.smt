...
(assert (= 56 (* V2 V3 V4 V9))) ; Region 2
(assert (= 60 (* V5 V6 V13))) ; Region 3
(assert (= 735 (* V7 V8 V14 V21))) ; Region 4
(assert (= 180 (* V10 V11 V16 V17))) ; Region 5
(assert (= 168 (* V12 V19 V20 V27))) ; Region 6
(assert (or (= 3 (/ V15 V22)) (= 3 (/ V22 V15)))) ; Region 7
(assert (= 60 (* V18 V25 V26 V33))) ; Region 8
(assert (= 2 (* V23 V24))) ; Region 9
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 10
(assert (= 840 (* V29 V36 V37 V44))) ; Region 11
(assert (= 210 (* V30 V31 V32))) ; Region 12
(assert (= 21 (* V34 V40 V41))) ; Region 13
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 14
(assert (= 4 (* V42 V43))) ; Region 15
(assert (= 36 (* V45 V46 V47))) ; Region 16
(check-sat)
