...
(assert (= 13 (+ V2 V3 V10))) ; Region 2
(assert (= 8 (+ V4 V11))) ; Region 3
(assert (= 11 (+ V5 V6))) ; Region 4
(assert (= 7 (+ V7 V14))) ; Region 5
(assert (= 8 (+ V8 V15))) ; Region 6
(assert (= 13 (+ V9 V16))) ; Region 7
(assert (= 5 (+ V12 V13))) ; Region 8
(assert (= 9 (+ V17 V23 V24))) ; Region 9
(assert (= 7 (+ V18 V25))) ; Region 10
(assert (= 7 (+ V19 V26))) ; Region 11
(assert (= 5 (+ V20 V27))) ; Region 12
(assert (= 12 (+ V21 V22))) ; Region 13
(assert (= 3 (+ V28 V29))) ; Region 14
(assert (= 7 (+ V31 V38))) ; Region 16
(assert (= 10 (+ V32 V39))) ; Region 17
(assert (= 10 (+ V33 V40))) ; Region 18
(assert (= 14 (+ V34 V41 V48))) ; Region 19
(assert (= 6 (+ V35 V36))) ; Region 20
(assert (= 9 (+ V37 V44 V45))) ; Region 21
(assert (= 13 (+ V42 V43))) ; Region 22
(assert (= 7 (+ V46 V47))) ; Region 23
(check-sat)
