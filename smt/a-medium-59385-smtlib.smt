...
(assert (= 12 (+ V2 V9))) ; Region 3
(assert (= 13 (+ V3 V4))) ; Region 4
(assert (= 5 (+ V5 V6))) ; Region 5
(assert (= 9 (+ V10 V11 V18))) ; Region 6
(assert (= 14 (+ V12 V13 V19))) ; Region 7
(assert (= 10 (+ V15 V16))) ; Region 8
(assert (= 5 (+ V17 V24 V25))) ; Region 9
(assert (= 12 (+ V20 V26 V27))) ; Region 10
(assert (= 14 (+ V21 V28 V35 V42))) ; Region 11
(assert (= 8 (+ V22 V29))) ; Region 12
(assert (= 12 (+ V30 V31 V38))) ; Region 14
(assert (= 13 (+ V32 V33))) ; Region 15
(assert (= 7 (+ V34 V41))) ; Region 16
(assert (= 5 (+ V36 V37))) ; Region 17
(assert (= 8 (+ V39 V40))) ; Region 18
(assert (= 15 (+ V43 V44 V45))) ; Region 19
