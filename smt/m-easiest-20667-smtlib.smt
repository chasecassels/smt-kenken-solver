...
(assert (= 12 (* V2 V9 V10))) ; Region 2
(assert (= 42 (* V3 V4))) ; Region 3
(assert (= 20 (* V5 V6))) ; Region 4
(assert (= 140 (* V7 V8 V15))) ; Region 5
(assert (= 18 (* V11 V18))) ; Region 6
(assert (= 14 (* V12 V13 V19))) ; Region 7
(assert (= 28 (* V14 V21 V22))) ; Region 8
(assert (= 20 (* V16 V17 V24))) ; Region 9
(assert (= 18 (* V20 V27))) ; Region 10
(assert (= 14 (* V23 V30))) ; Region 11
(assert (= 15 (* V25 V26))) ; Region 12
(assert (= 6 (* V28 V29))) ; Region 13
(assert (= 6 (* V31 V32 V39))) ; Region 14
(assert (= 24 (* V33 V40))) ; Region 15
(assert (= 70 (* V34 V41 V48))) ; Region 16
(assert (= 90 (* V35 V42 V43))) ; Region 17
(assert (= 10 (* V36 V37))) ; Region 18
(assert (= 28 (* V45 V46 V47))) ; Region 21
(check-sat)
