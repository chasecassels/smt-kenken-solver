...
(assert (= 84 (* V0 V7 V8))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (= 7 (* V3 V4))) ; Region 3
(assert (= 20 (* V5 V6 V13))) ; Region 4
(assert (= 18 (* V10 V11))) ; Region 6
(assert (= 48 (* V12 V18 V19))) ; Region 7
(assert (= 15 (* V14 V15))) ; Region 8
(assert (or (= 2 (/ V16 V23)) (= 2 (/ V23 V16)))) ; Region 9
(assert (= 5 (* V17 V24))) ; Region 10
(assert (= 21 (* V20 V27))) ; Region 11
(assert (= 42 (* V21 V22 V28))) ; Region 12
(assert (= 42 (* V25 V26 V32))) ; Region 13
(assert (= 30 (* V29 V30 V36))) ; Region 14
(assert (= 144 (* V31 V37 V38 V45))) ; Region 15
(assert (= 24 (* V33 V34))) ; Region 16
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 17
(assert (= 35 (* V39 V46))) ; Region 18
(assert (= 30 (* V41 V47 V48))) ; Region 20
(assert (= 28 (* V43 V44))) ; Region 21
(check-sat)
