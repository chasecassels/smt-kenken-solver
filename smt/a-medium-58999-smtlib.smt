...
(assert (= 16 (+ V3 V9 V10))) ; Region 3
(assert (= 8 (+ V4 V5))) ; Region 4
(assert (= 11 (+ V6 V12 V13))) ; Region 5
(assert (= 14 (+ V11 V17 V18))) ; Region 6
(assert (= 15 (+ V14 V15 V16))) ; Region 7
(assert (= 12 (+ V20 V27 V34))) ; Region 9
(assert (= 11 (+ V21 V28))) ; Region 10
(assert (= 13 (+ V22 V29 V30))) ; Region 11
(assert (= 10 (+ V23 V24))) ; Region 12
(assert (= 3 (+ V25 V26))) ; Region 13
(assert (= 3 (+ V31 V38))) ; Region 14
(assert (= 9 (+ V32 V39))) ; Region 15
(assert (= 10 (+ V33 V40))) ; Region 16
(assert (= 4 (+ V35 V42))) ; Region 17
(assert (= 5 (+ V36 V43))) ; Region 18
(assert (= 12 (+ V37 V44))) ; Region 19
(assert (= 13 (+ V41 V47 V48))) ; Region 20
