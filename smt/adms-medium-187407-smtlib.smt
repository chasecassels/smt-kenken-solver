...
(assert (= 40 (* V0 V1 V7 V8))) ; Region 1
(assert (= 30 (* V2 V9 V16))) ; Region 2
(assert (= 15 (+ V3 V4 V11))) ; Region 3
(assert (= 36 (* V5 V6 V12))) ; Region 4
(assert (= 3 (+ V10 V17))) ; Region 5
(assert (= 20 (+ V13 V20 V27 V34 V41))) ; Region 6
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 7
(assert (= 630 (* V15 V22 V23 V29))) ; Region 8
(assert (or (= 2 (- V18 V19)) (= 2 (- V19 V18)))) ; Region 9
(assert (= 120 (* V24 V25 V26))) ; Region 10
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 11
(assert (= 11 (+ V30 V31 V38))) ; Region 12
(assert (or (= 5 (- V32 V33)) (= 5 (- V33 V32)))) ; Region 13
(assert (= 14 (+ V36 V42 V43))) ; Region 14
(assert (or (= 1 (- V37 V44)) (= 1 (- V44 V37)))) ; Region 15
(assert (= 12 (+ V39 V45 V46))) ; Region 16
(assert (or (= 6 (- V40 V47)) (= 6 (- V47 V40)))) ; Region 17
(check-sat)
