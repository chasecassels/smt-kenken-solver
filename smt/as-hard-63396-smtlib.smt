...
(assert (= 7 (+ V0 V1 V7))) ; Region 1
(assert (= 12 (+ V2 V8 V9))) ; Region 2
(assert (= 11 (+ V3 V10))) ; Region 3
(assert (= 6 (+ V4 V11 V18))) ; Region 4
(assert (= 19 (+ V5 V6 V12))) ; Region 5
(assert (or (= 1 (- V13 V20)) (= 1 (- V20 V13)))) ; Region 6
(assert (= 15 (+ V15 V16 V17))) ; Region 8
(assert (= 9 (+ V19 V25 V26))) ; Region 9
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 10
(assert (= 7 (+ V22 V29))) ; Region 11
(assert (= 15 (+ V23 V24 V30))) ; Region 12
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 13
(assert (= 5 (+ V31 V37 V38))) ; Region 14
(assert (= 15 (+ V32 V33 V40))) ; Region 15
(assert (or (= 4 (- V35 V36)) (= 4 (- V36 V35)))) ; Region 16
(assert (= 13 (+ V39 V46 V47))) ; Region 17
(assert (= 12 (+ V41 V48))) ; Region 18
