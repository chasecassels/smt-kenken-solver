...
(assert (= 294 (* V0 V1 V7 V8))) ; Region 1
(assert (= 144 (* V2 V3 V4 V5 V12))) ; Region 2
(assert (= 4200 (* V6 V13 V18 V19 V20))) ; Region 3
(assert (= 6 (* V9 V10 V17))) ; Region 4
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 6
(assert (= 1080 (* V15 V16 V22 V23 V24))) ; Region 7
(assert (= 14 (* V25 V26 V27))) ; Region 8
(assert (= 30 (* V28 V29 V35))) ; Region 9
(assert (= 210 (* V30 V37 V38))) ; Region 10
(assert (= 7 (* V31 V32))) ; Region 11
(assert (= 72 (* V33 V34 V40 V41))) ; Region 12
(assert (= 20 (* V36 V42 V43))) ; Region 13
(assert (= 96 (* V39 V44 V45 V46))) ; Region 14
(assert (= 21 (* V47 V48))) ; Region 15
(check-sat)
