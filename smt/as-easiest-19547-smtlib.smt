...
(assert (or (= 5 (- V0 V1)) (= 5 (- V1 V0)))) ; Region 1
(assert (= 13 (+ V3 V10))) ; Region 3
(assert (= 8 (+ V4 V5 V6))) ; Region 4
(assert (= 8 (+ V7 V14))) ; Region 5
(assert (= 3 (+ V9 V16))) ; Region 7
(assert (= 15 (+ V11 V17 V18))) ; Region 8
(assert (or (= 4 (- V12 V19)) (= 4 (- V19 V12)))) ; Region 9
(assert (= 10 (+ V13 V20))) ; Region 10
(assert (= 14 (+ V15 V22 V29))) ; Region 11
(assert (= 3 (+ V21 V28))) ; Region 12
(assert (= 13 (+ V23 V30))) ; Region 13
(assert (= 6 (+ V24 V25))) ; Region 14
(assert (or (= 1 (- V26 V33)) (= 1 (- V33 V26)))) ; Region 15
(assert (or (= 1 (- V27 V34)) (= 1 (- V34 V27)))) ; Region 16
(assert (= 6 (+ V32 V39))) ; Region 18
(assert (= 10 (+ V35 V36))) ; Region 19
(assert (= 5 (+ V37 V38))) ; Region 20
(assert (or (= 6 (- V40 V41)) (= 6 (- V41 V40)))) ; Region 21
(assert (= 9 (+ V43 V44))) ; Region 23
(assert (or (= 6 (- V45 V46)) (= 6 (- V46 V45)))) ; Region 24
