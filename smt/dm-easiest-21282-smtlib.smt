...
(assert (= 24 (* V0 V7))) ; Region 1
(assert (= 210 (* V1 V2 V8))) ; Region 2
(assert (or (= 3 (/ V3 V10)) (= 3 (/ V10 V3)))) ; Region 3
(assert (= 14 (* V4 V11))) ; Region 4
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 5
(assert (= 112 (* V9 V15 V16))) ; Region 6
(assert (= 10 (* V12 V19))) ; Region 7
(assert (= 15 (* V13 V20))) ; Region 8
(assert (or (= 2 (/ V14 V21)) (= 2 (/ V21 V14)))) ; Region 9
(assert (= 210 (* V17 V24 V31))) ; Region 10
(assert (= 60 (* V18 V25 V26))) ; Region 11
(assert (or (= 2 (/ V22 V23)) (= 2 (/ V23 V22)))) ; Region 12
(assert (= 4 (* V27 V34))) ; Region 13
(assert (= 105 (* V28 V35 V42))) ; Region 14
(assert (or (= 2 (/ V29 V30)) (= 2 (/ V30 V29)))) ; Region 15
(assert (= 18 (* V32 V33))) ; Region 16
(assert (= 10 (* V36 V43))) ; Region 17
(assert (= 12 (* V37 V38 V39))) ; Region 18
(assert (= 42 (* V40 V41))) ; Region 19
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 20
(assert (= 24 (* V46 V47))) ; Region 21
(check-sat)
