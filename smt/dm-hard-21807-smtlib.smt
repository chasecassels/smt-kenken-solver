...
(assert (= 420 (* V0 V7 V14 V21))) ; Region 1
(assert (= 30 (* V1 V8 V9))) ; Region 2
(assert (= 8 (* V2 V3 V10))) ; Region 3
(assert (= 84 (* V4 V11 V18))) ; Region 4
(assert (= 210 (* V5 V6 V12 V13))) ; Region 5
(assert (= 288 (* V15 V16 V17 V22))) ; Region 6
(assert (= 7 (* V19 V20))) ; Region 7
(assert (= 150 (* V23 V24 V31 V32))) ; Region 8
(assert (or (= 2 (/ V25 V26)) (= 2 (/ V26 V25)))) ; Region 9
(assert (= 24 (* V27 V33 V34))) ; Region 10
(assert (= 168 (* V28 V29 V35 V36))) ; Region 11
(assert (= 21 (* V30 V37 V44))) ; Region 12
(assert (= 35 (* V38 V45))) ; Region 13
(assert (= 8 (* V39 V46 V47))) ; Region 14
(assert (= 12 (* V40 V41))) ; Region 15
(assert (= 6 (* V42 V43))) ; Region 16
(check-sat)
