...
(assert (= 210 (* V1 V2 V9 V16 V17))) ; Region 2
(assert (= 40 (* V3 V4 V10))) ; Region 3
(assert (= 18 (* V5 V6))) ; Region 4
(assert (= 20 (* V11 V12 V19))) ; Region 5
(assert (= 21 (* V13 V20))) ; Region 6
(assert (= 12 (* V14 V15))) ; Region 7
(assert (= 140 (* V18 V25 V26))) ; Region 8
(assert (= 140 (* V21 V28 V29 V35))) ; Region 9
(assert (= 6 (* V22 V23))) ; Region 10
(assert (= 18 (* V24 V31))) ; Region 11
(assert (= 8 (* V27 V34))) ; Region 12
(assert (= 12 (* V30 V37))) ; Region 13
(assert (= 126 (* V32 V33 V39 V46))) ; Region 14
(assert (= 120 (* V36 V42 V43 V44))) ; Region 15
(assert (= 14 (* V38 V45))) ; Region 16
(assert (= 12 (* V40 V41 V47))) ; Region 17
(check-sat)
