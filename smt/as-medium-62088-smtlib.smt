...
(assert (= 17 (+ V0 V7 V14))) ; Region 1
(assert (= 11 (+ V1 V2 V9 V10))) ; Region 2
(assert (= 9 (+ V3 V4 V5))) ; Region 3
(assert (or (= 2 (- V6 V13)) (= 2 (- V13 V6)))) ; Region 4
(assert (or (= 1 (- V8 V15)) (= 1 (- V15 V8)))) ; Region 5
(assert (or (= 6 (- V11 V12)) (= 6 (- V12 V11)))) ; Region 6
(assert (or (= 2 (- V16 V23)) (= 2 (- V23 V16)))) ; Region 7
(assert (= 6 (+ V17 V24))) ; Region 8
(assert (= 5 (+ V18 V25))) ; Region 9
(assert (= 7 (+ V19 V26 V27))) ; Region 10
(assert (= 10 (+ V21 V22))) ; Region 12
(assert (= 3 (+ V28 V35))) ; Region 13
(assert (or (= 4 (- V29 V30)) (= 4 (- V30 V29)))) ; Region 14
(assert (or (= 1 (- V31 V32)) (= 1 (- V32 V31)))) ; Region 15
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 16
(assert (= 8 (+ V36 V42 V43))) ; Region 17
(assert (or (= 1 (- V37 V38)) (= 1 (- V38 V37)))) ; Region 18
(assert (= 17 (+ V39 V46 V47 V48))) ; Region 19
(assert (or (= 4 (- V40 V41)) (= 4 (- V41 V40)))) ; Region 20
(assert (or (= 6 (- V44 V45)) (= 6 (- V45 V44)))) ; Region 21
(check-sat)
