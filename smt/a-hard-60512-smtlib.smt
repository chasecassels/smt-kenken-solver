...
(assert (= 11 (+ V1 V8 V9))) ; Region 2
(assert (= 15 (+ V2 V3 V10))) ; Region 3
(assert (= 15 (+ V4 V5 V6 V11))) ; Region 4
(assert (= 6 (+ V12 V19))) ; Region 5
(assert (= 16 (+ V13 V20 V27 V34))) ; Region 6
(assert (= 11 (+ V14 V21))) ; Region 7
(assert (= 7 (+ V15 V22))) ; Region 8
(assert (= 7 (+ V16 V23))) ; Region 9
(assert (= 13 (+ V17 V18))) ; Region 10
(assert (= 4 (+ V24 V25))) ; Region 11
(assert (= 10 (+ V26 V33))) ; Region 12
(assert (= 6 (+ V28 V29 V30))) ; Region 13
(assert (= 12 (+ V31 V32))) ; Region 14
(assert (= 16 (+ V35 V36 V42))) ; Region 15
(assert (= 3 (+ V37 V38))) ; Region 16
(assert (= 7 (+ V39 V40))) ; Region 17
(assert (= 11 (+ V41 V47 V48))) ; Region 18
(assert (= 12 (+ V43 V44))) ; Region 19
(assert (= 7 (+ V45 V46))) ; Region 20
(check-sat)
