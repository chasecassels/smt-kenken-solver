...
(assert (= 18 (+ V3 V10 V11))) ; Region 3
(assert (= 6 (+ V4 V5 V6))) ; Region 4
(assert (= 3 (+ V7 V8))) ; Region 5
(assert (= 13 (+ V12 V18 V19))) ; Region 6
(assert (= 9 (+ V13 V20))) ; Region 7
(assert (= 16 (+ V14 V15 V22))) ; Region 8
(assert (= 3 (+ V16 V17))) ; Region 9
(assert (= 5 (+ V21 V28))) ; Region 10
(assert (= 9 (+ V23 V24))) ; Region 11
(assert (= 6 (+ V25 V32))) ; Region 12
(assert (= 8 (+ V26 V33))) ; Region 13
(assert (= 11 (+ V27 V34))) ; Region 14
(assert (= 14 (+ V29 V36 V37))) ; Region 15
(assert (= 9 (+ V30 V31 V38))) ; Region 16
(assert (= 12 (+ V35 V42))) ; Region 17
(assert (= 12 (+ V39 V40 V41))) ; Region 18
