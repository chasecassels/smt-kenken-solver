...
(assert (= 13 (+ V0 V7 V14))) ; Region 1
(assert (or (= 6 (- V1 V8)) (= 6 (- V8 V1)))) ; Region 2
(assert (or (= 2 (- V2 V9)) (= 2 (- V9 V2)))) ; Region 3
(assert (or (= 2 (- V3 V4)) (= 2 (- V4 V3)))) ; Region 4
(assert (= 3 (+ V5 V6))) ; Region 5
(assert (= 9 (+ V10 V17))) ; Region 6
(assert (= 11 (+ V11 V18))) ; Region 7
(assert (or (= 4 (- V12 V13)) (= 4 (- V13 V12)))) ; Region 8
(assert (= 14 (+ V15 V21 V22))) ; Region 9
(assert (= 5 (+ V16 V23 V24))) ; Region 10
(assert (= 9 (+ V19 V20 V27))) ; Region 11
(assert (= 10 (+ V25 V32 V33))) ; Region 12
(assert (or (= 6 (- V28 V35)) (= 6 (- V35 V28)))) ; Region 14
(assert (= 14 (+ V29 V30 V31))) ; Region 15
(assert (or (= 4 (- V34 V41)) (= 4 (- V41 V34)))) ; Region 16
(assert (or (= 2 (- V36 V37)) (= 2 (- V37 V36)))) ; Region 17
(assert (or (= 6 (- V38 V45)) (= 6 (- V45 V38)))) ; Region 18
(assert (or (= 2 (- V39 V40)) (= 2 (- V40 V39)))) ; Region 19
(assert (= 15 (+ V42 V43 V44))) ; Region 20
(assert (= 12 (+ V46 V47 V48))) ; Region 21
(check-sat)
