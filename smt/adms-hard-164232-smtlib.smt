...
(assert (= 8 (+ V0 V7 V8))) ; Region 1
(assert (= 120 (* V1 V2 V3))) ; Region 2
(assert (= 21 (* V4 V11))) ; Region 3
(assert (= 13 (+ V5 V6 V13 V20))) ; Region 4
(assert (= 252 (* V9 V16 V22 V23))) ; Region 5
(assert (or (= 3 (- V10 V17)) (= 3 (- V17 V10)))) ; Region 6
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 7
(assert (= 360 (* V14 V15 V21 V28))) ; Region 8
(assert (or (= 2 (/ V18 V25)) (= 2 (/ V25 V18)))) ; Region 9
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 10
(assert (or (= 4 (- V26 V27)) (= 4 (- V27 V26)))) ; Region 11
(assert (= 6 (+ V30 V37 V38))) ; Region 13
(assert (= 30 (* V32 V39))) ; Region 14
(assert (= 12 (+ V33 V34 V40 V41))) ; Region 15
(assert (or (= 1 (- V35 V36)) (= 1 (- V36 V35)))) ; Region 16
(assert (= 6 (+ V42 V43 V44))) ; Region 17
(assert (= 28 (* V45 V46))) ; Region 18
(assert (or (= 1 (- V47 V48)) (= 1 (- V48 V47)))) ; Region 19
(check-sat)
