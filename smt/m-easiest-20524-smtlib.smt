...
(assert (= 18 (* V1 V2))) ; Region 2
(assert (= 28 (* V3 V4))) ; Region 3
(assert (= 18 (* V5 V11 V12))) ; Region 4
(assert (= 20 (* V6 V13))) ; Region 5
(assert (= 24 (* V8 V14 V15))) ; Region 6
(assert (= 10 (* V9 V10))) ; Region 7
(assert (= 18 (* V17 V24))) ; Region 9
(assert (= 10 (* V18 V19 V20))) ; Region 10
(assert (= 5 (* V21 V28))) ; Region 11
(assert (= 14 (* V22 V23 V29))) ; Region 12
(assert (= 28 (* V25 V26))) ; Region 13
(assert (= 18 (* V27 V34))) ; Region 14
(assert (= 30 (* V30 V37 V38))) ; Region 15
(assert (= 60 (* V32 V33 V39))) ; Region 17
(assert (= 12 (* V35 V36))) ; Region 18
(assert (= 12 (* V40 V47))) ; Region 19
(assert (= 14 (* V41 V48))) ; Region 20
(assert (= 20 (* V43 V44))) ; Region 22
