...
(assert (= 9 (+ V2 V3))) ; Region 2
(assert (= 13 (+ V4 V5))) ; Region 3
(assert (= 8 (+ V6 V13))) ; Region 4
(assert (= 10 (+ V7 V14 V21))) ; Region 5
(assert (= 3 (+ V8 V9))) ; Region 6
(assert (= 11 (+ V10 V17))) ; Region 7
(assert (= 10 (+ V11 V18))) ; Region 8
(assert (or (= 6 (- V12 V19)) (= 6 (- V19 V12)))) ; Region 9
(assert (= 14 (+ V15 V16 V22))) ; Region 10
...
(assert (= 10 (+ V28 V29))) ; Region 16
(assert (= 13 (+ V30 V36 V37))) ; Region 17
(assert (or (= 1 (- V34 V41)) (= 1 (- V41 V34)))) ; Region 18
(assert (= 25 (+ V35 V42 V43 V44))) ; Region 19
(assert (= 4 (+ V38 V39))) ; Region 20
(assert (or (= 2 (- V40 V47)) (= 2 (- V47 V40)))) ; Region 21
(assert (= 3 (+ V45 V46))) ; Region 22
(check-sat)
