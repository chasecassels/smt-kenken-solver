...
(assert (= 9 (+ V3 V10 V11))) ; Region 3
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 4
(assert (= 7 (+ V7 V8))) ; Region 6
(assert (= 14 (+ V12 V13 V20))) ; Region 7
(assert (= 12 (+ V14 V21 V22))) ; Region 8
(assert (or (= 4 (- V15 V16)) (= 4 (- V16 V15)))) ; Region 9
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 10
(assert (or (= 6 (- V19 V26)) (= 6 (- V26 V19)))) ; Region 12
(assert (= 14 (+ V23 V29 V30 V31))) ; Region 13
(assert (or (= 6 (- V25 V32)) (= 6 (- V32 V25)))) ; Region 14
(assert (= 15 (+ V27 V33 V34))) ; Region 15
(assert (= 13 (+ V28 V35))) ; Region 16
(assert (or (= 6 (- V36 V43)) (= 6 (- V43 V36)))) ; Region 17
(assert (= 14 (+ V37 V44 V45))) ; Region 18
(assert (= 14 (+ V38 V39 V46))) ; Region 19
(assert (or (= 1 (- V40 V41)) (= 1 (- V41 V40)))) ; Region 20
(assert (= 7 (+ V47 V48))) ; Region 22
(check-sat)
