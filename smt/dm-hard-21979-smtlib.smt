...
(assert (= 168 (* V0 V1 V7 V14))) ; Region 1
(assert (= 90 (* V2 V3 V4 V11))) ; Region 2
(assert (= 28 (* V5 V6))) ; Region 3
(assert (= 180 (* V8 V15 V16 V17))) ; Region 4
(assert (or (= 3 (/ V9 V10)) (= 3 (/ V10 V9)))) ; Region 5
(assert (= 12 (* V12 V19 V26))) ; Region 6
(assert (= 5 (* V13 V20))) ; Region 7
(assert (= 42 (* V18 V24 V25))) ; Region 8
(assert (= 40 (* V21 V22 V23 V30))) ; Region 9
(assert (= 126 (* V27 V34 V41))) ; Region 10
(assert (= 210 (* V28 V29 V36 V37))) ; Region 11
(assert (= 224 (* V31 V32 V38 V39))) ; Region 12
(assert (= 300 (* V33 V40 V46 V47))) ; Region 13
(assert (= 252 (* V35 V42 V43 V44 V45))) ; Region 14
(check-sat)
