...
(assert (= 42 (* V0 V1 V8))) ; Region 1
(assert (or (= 5 (- V2 V9)) (= 5 (- V9 V2)))) ; Region 2
(assert (or (= 3 (- V3 V10)) (= 3 (- V10 V3)))) ; Region 3
(assert (or (= 2 (- V4 V5)) (= 2 (- V5 V4)))) ; Region 4
(assert (= 24 (* V6 V13 V20))) ; Region 5
(assert (or (= 1 (- V7 V14)) (= 1 (- V14 V7)))) ; Region 6
(assert (= 15 (+ V11 V18 V19))) ; Region 7
(assert (or (= 2 (/ V15 V22)) (= 2 (/ V22 V15)))) ; Region 9
(assert (or (= 4 (- V16 V23)) (= 4 (- V23 V16)))) ; Region 10
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 11
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 12
(assert (= 168 (* V25 V26 V27))) ; Region 13
(assert (= 12 (+ V29 V35 V36))) ; Region 14
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 15
(assert (= 8 (+ V31 V32))) ; Region 16
(assert (= 12 (+ V33 V40 V47))) ; Region 17
(assert (= 48 (* V38 V44 V45))) ; Region 19
(assert (or (= 3 (- V39 V46)) (= 3 (- V46 V39)))) ; Region 20
(assert (or (= 4 (- V41 V48)) (= 4 (- V48 V41)))) ; Region 21
(assert (= 21 (* V42 V43))) ; Region 22
(check-sat)
