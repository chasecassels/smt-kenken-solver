...
(assert (= 6 (+ V3 V10 V17))) ; Region 3
(assert (= 11 (+ V4 V5))) ; Region 4
(assert (= 9 (+ V6 V13))) ; Region 5
(assert (= 8 (+ V8 V9))) ; Region 6
(assert (= 9 (+ V11 V18))) ; Region 7
(assert (= 6 (+ V12 V19))) ; Region 8
(assert (= 11 (+ V14 V15 V22))) ; Region 9
(assert (= 12 (+ V16 V23 V24))) ; Region 10
(assert (= 9 (+ V20 V27))) ; Region 11
(assert (= 10 (+ V25 V26))) ; Region 13
(assert (= 15 (+ V28 V29 V35))) ; Region 14
(assert (= 11 (+ V31 V38 V39))) ; Region 16
(assert (= 3 (+ V32 V33))) ; Region 17
(assert (= 17 (+ V34 V40 V41 V48))) ; Region 18
(assert (= 8 (+ V36 V37 V44))) ; Region 19
(assert (= 9 (+ V42 V43))) ; Region 20
(assert (= 16 (+ V45 V46 V47))) ; Region 21
(check-sat)
