...
(assert (= 20 (* V1 V2))) ; Region 2
(assert (= 120 (* V3 V10 V11 V12))) ; Region 3
(assert (= 42 (* V4 V5 V6))) ; Region 4
(assert (or (= 3 (/ V8 V9)) (= 3 (/ V9 V8)))) ; Region 5
(assert (= 2352 (* V13 V17 V18 V19 V20))) ; Region 6
(assert (= 1050 (* V14 V21 V28 V29))) ; Region 7
(assert (or (= 3 (/ V15 V16)) (= 3 (/ V16 V15)))) ; Region 8
(assert (= 72 (* V22 V23 V30))) ; Region 9
(assert (= 140 (* V24 V25 V26 V31))) ; Region 10
(assert (= 4 (* V27 V33 V34))) ; Region 11
(assert (or (= 2 (/ V32 V39)) (= 2 (/ V39 V32)))) ; Region 12
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 13
(assert (= 14 (* V36 V37 V43))) ; Region 14
(assert (= 126 (* V38 V44 V45))) ; Region 15
(assert (= 300 (* V40 V41 V47 V48))) ; Region 16
(check-sat)
