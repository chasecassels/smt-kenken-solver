...
(assert (= 17 (+ V0 V7 V8))) ; Region 1
(assert (= 9 (+ V1 V2 V9))) ; Region 2
(assert (= 15 (+ V3 V4 V10))) ; Region 3
(assert (= 8 (+ V6 V12 V13))) ; Region 5
(assert (= 14 (+ V11 V18 V19 V20))) ; Region 6
(assert (= 11 (+ V14 V21 V22))) ; Region 7
(assert (= 7 (+ V15 V16))) ; Region 8
(assert (= 11 (+ V23 V24))) ; Region 10
(assert (= 16 (+ V25 V26 V33))) ; Region 11
(assert (= 7 (+ V27 V34))) ; Region 12
(assert (= 8 (+ V28 V35))) ; Region 13
(assert (= 10 (+ V29 V36))) ; Region 14
(assert (= 6 (+ V30 V31 V32))) ; Region 15
(assert (= 6 (+ V37 V44))) ; Region 16
(assert (= 4 (+ V38 V45))) ; Region 17
(assert (= 10 (+ V39 V46))) ; Region 18
(assert (= 9 (+ V40 V41))) ; Region 19
