...
(assert (= 13 (+ V12 V19))) ; Region 7
(assert (= 6 (+ V13 V20))) ; Region 8
(assert (= 8 (+ V14 V21))) ; Region 9
(assert (= 14 (+ V16 V17 V18 V25))) ; Region 10
(assert (= 14 (+ V22 V29 V30))) ; Region 11
(assert (= 8 (+ V23 V24))) ; Region 12
(assert (= 7 (+ V26 V33))) ; Region 13
(assert (= 8 (+ V27 V34))) ; Region 14
(assert (= 11 (+ V28 V35 V42))) ; Region 15
(assert (= 13 (+ V31 V38))) ; Region 16
(assert (= 4 (+ V32 V39))) ; Region 17
(assert (= 19 (+ V36 V37 V43))) ; Region 18
(assert (= 13 (+ V40 V41 V48))) ; Region 19
(assert (= 7 (+ V44 V45))) ; Region 20
(assert (= 3 (+ V46 V47))) ; Region 21
(check-sat)
