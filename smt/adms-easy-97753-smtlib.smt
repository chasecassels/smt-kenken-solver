...
(assert (or (= 1 (- V1 V8)) (= 1 (- V8 V1)))) ; Region 2
(assert (or (= 1 (- V2 V3)) (= 1 (- V3 V2)))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 5
(assert (or (= 3 (- V10 V17)) (= 3 (- V17 V10)))) ; Region 7
(assert (= 60 (* V11 V12 V13))) ; Region 8
(assert (= 10 (+ V15 V16 V22))) ; Region 9
(assert (= 3 (+ V18 V25))) ; Region 10
(assert (= 13 (+ V19 V26))) ; Region 11
(assert (or (= 3 (- V20 V27)) (= 3 (- V27 V20)))) ; Region 12
(assert (or (= 2 (- V21 V28)) (= 2 (- V28 V21)))) ; Region 13
(assert (or (= 3 (- V23 V30)) (= 3 (- V30 V23)))) ; Region 14
(assert (or (= 6 (- V29 V36)) (= 6 (- V36 V29)))) ; Region 16
(assert (or (= 2 (/ V31 V32)) (= 2 (/ V32 V31)))) ; Region 17
(assert (or (= 4 (- V33 V34)) (= 4 (- V34 V33)))) ; Region 18
(assert (= 210 (* V35 V42 V43))) ; Region 19
(assert (or (= 3 (- V37 V44)) (= 3 (- V44 V37)))) ; Region 20
(assert (or (= 3 (/ V38 V39)) (= 3 (/ V39 V38)))) ; Region 21
(assert (= 10 (+ V40 V41 V48))) ; Region 22
(assert (= 5 (+ V45 V46))) ; Region 23
(check-sat)
