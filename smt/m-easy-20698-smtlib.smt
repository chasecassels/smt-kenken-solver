...
(assert (= 40 (* V3 V4 V11 V12))) ; Region 3
(assert (= 42 (* V5 V6 V13))) ; Region 4
(assert (= 21 (* V9 V16))) ; Region 5
(assert (= 20 (* V10 V17))) ; Region 6
(assert (= 20 (* V14 V15 V21))) ; Region 7
(assert (= 90 (* V18 V25 V26))) ; Region 8
(assert (= 6 (* V19 V20 V27))) ; Region 9
(assert (= 90 (* V22 V29 V36))) ; Region 10
(assert (= 84 (* V23 V24 V30 V31))) ; Region 11
(assert (= 14 (* V32 V39))) ; Region 13
(assert (= 20 (* V33 V34))) ; Region 14
(assert (= 42 (* V35 V42 V43))) ; Region 15
(assert (= 20 (* V37 V38 V44))) ; Region 16
(assert (= 42 (* V40 V46 V47))) ; Region 17
(assert (= 24 (* V41 V48))) ; Region 18
(check-sat)
