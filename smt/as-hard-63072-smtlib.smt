...
(assert (= 20 (+ V4 V5 V6 V11))) ; Region 3
(assert (= 13 (+ V8 V9 V15))) ; Region 4
(assert (or (= 1 (- V10 V17)) (= 1 (- V17 V10)))) ; Region 5
(assert (or (= 6 (- V12 V13)) (= 6 (- V13 V12)))) ; Region 6
(assert (or (= 1 (- V14 V21)) (= 1 (- V21 V14)))) ; Region 7
(assert (= 8 (+ V16 V23))) ; Region 8
(assert (= 11 (+ V18 V19 V20))) ; Region 9
(assert (= 12 (+ V22 V28 V29))) ; Region 10
(assert (or (= 3 (- V24 V25)) (= 3 (- V25 V24)))) ; Region 11
(assert (or (= 5 (- V26 V33)) (= 5 (- V33 V26)))) ; Region 12
(assert (= 9 (+ V27 V34))) ; Region 13
(assert (= 3 (+ V30 V31))) ; Region 14
(assert (= 12 (+ V32 V39 V46))) ; Region 15
(assert (= 6 (+ V35 V42 V43))) ; Region 16
(assert (or (= 1 (- V37 V38)) (= 1 (- V38 V37)))) ; Region 18
(assert (= 13 (+ V40 V41 V47))) ; Region 19
(assert (= 13 (+ V44 V45))) ; Region 20
(check-sat)
