...
(assert (= 6 (+ V4 V5))) ; Region 3
(assert (= 5 (+ V7 V14))) ; Region 5
(assert (= 3 (+ V8 V9))) ; Region 6
(assert (= 9 (+ V10 V11))) ; Region 7
(assert (= 11 (+ V12 V19))) ; Region 8
(assert (= 13 (+ V13 V20))) ; Region 9
(assert (= 8 (+ V15 V16 V17))) ; Region 10
(assert (= 19 (+ V21 V28 V29))) ; Region 12
(assert (= 10 (+ V22 V23))) ; Region 13
(assert (= 3 (+ V25 V26))) ; Region 15
(assert (= 8 (+ V27 V34))) ; Region 16
(assert (= 3 (+ V30 V31))) ; Region 17
(assert (= 17 (+ V32 V33 V40))) ; Region 18
(assert (= 3 (+ V35 V36))) ; Region 19
(assert (= 12 (+ V37 V44))) ; Region 20
(assert (= 13 (+ V38 V39 V45))) ; Region 21
(assert (= 5 (+ V41 V48))) ; Region 22
(assert (= 11 (+ V42 V43))) ; Region 23
