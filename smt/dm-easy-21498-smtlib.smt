...
(assert (= 40 (* V0 V1 V7 V14))) ; Region 1
(assert (= 84 (* V2 V8 V9))) ; Region 2
(assert (or (= 3 (/ V3 V10)) (= 3 (/ V10 V3)))) ; Region 3
(assert (= 15 (* V4 V5))) ; Region 4
(assert (= 210 (* V6 V13 V20 V27))) ; Region 5
(assert (or (= 2 (/ V11 V12)) (= 2 (/ V12 V11)))) ; Region 6
(assert (= 196 (* V15 V16 V17 V24))) ; Region 7
(assert (or (= 2 (/ V18 V19)) (= 2 (/ V19 V18)))) ; Region 8
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 9
(assert (= 48 (* V22 V23 V29))) ; Region 10
(assert (= 140 (* V25 V26 V32 V33))) ; Region 11
(assert (= 75 (* V30 V31 V38))) ; Region 12
(assert (or (= 2 (/ V34 V41)) (= 2 (/ V41 V34)))) ; Region 13
(assert (= 70 (* V35 V36 V42 V43))) ; Region 14
(assert (= 18 (* V37 V44 V45))) ; Region 15
(assert (= 28 (* V39 V46))) ; Region 16
(assert (= 12 (* V40 V47))) ; Region 17
(check-sat)
