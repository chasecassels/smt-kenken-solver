...
(assert (= 105 (* V1 V8 V9))) ; Region 2
(assert (= 672 (* V2 V3 V10 V11))) ; Region 3
(assert (= 30 (* V4 V5 V12))) ; Region 4
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 5
(assert (= 210 (* V14 V15 V16))) ; Region 6
(assert (= 21 (* V17 V24 V25 V26))) ; Region 7
(assert (or (= 2 (/ V18 V19)) (= 2 (/ V19 V18)))) ; Region 8
(assert (or (= 2 (/ V20 V27)) (= 2 (/ V27 V20)))) ; Region 9
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 10
(assert (= 60 (* V23 V30 V31))) ; Region 11
(assert (= 84 (* V28 V29 V35 V42))) ; Region 12
(assert (= 5880 (* V33 V34 V40 V41 V48))) ; Region 14
(assert (= 24 (* V36 V37 V43))) ; Region 15
(assert (or (= 2 (/ V38 V39)) (= 2 (/ V39 V38)))) ; Region 16
(assert (= 90 (* V44 V45 V46 V47))) ; Region 17
(check-sat)
