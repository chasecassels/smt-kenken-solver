...
(assert (= 1050 (* V2 V3 V10 V11))) ; Region 2
(assert (or (= 2 (/ V4 V5)) (= 2 (/ V5 V4)))) ; Region 3
(assert (= 6 (* V6 V13))) ; Region 4
(assert (= 420 (* V8 V9 V15 V16))) ; Region 5
(assert (= 24 (* V12 V19 V20))) ; Region 6
(assert (= 42 (* V14 V21 V22))) ; Region 7
(assert (= 84 (* V17 V18 V24 V31))) ; Region 8
(assert (= 24 (* V23 V29 V30))) ; Region 9
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 10
(assert (= 140 (* V26 V27 V34))) ; Region 11
(assert (= 60 (* V28 V35 V42))) ; Region 12
(assert (= 30 (* V33 V38 V39 V40))) ; Region 13
(assert (= 42 (* V36 V37 V43))) ; Region 14
(assert (or (= 2 (/ V44 V45)) (= 2 (/ V45 V44)))) ; Region 16
(assert (= 140 (* V46 V47 V48))) ; Region 17
(check-sat)
