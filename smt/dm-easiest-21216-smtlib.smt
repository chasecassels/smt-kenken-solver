...
(assert (= 28 (* V1 V8))) ; Region 2
(assert (= 35 (* V3 V4 V11))) ; Region 4
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 5
(assert (= 84 (* V9 V10 V16))) ; Region 6
(assert (= 8 (* V12 V19))) ; Region 7
(assert (= 6 (* V13 V20))) ; Region 8
(assert (= 15 (* V14 V15))) ; Region 9
(assert (or (= 2 (/ V17 V18)) (= 2 (/ V18 V17)))) ; Region 10
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 11
(assert (or (= 3 (/ V22 V29)) (= 3 (/ V29 V22)))) ; Region 12
(assert (= 30 (* V23 V24))) ; Region 13
(assert (= 84 (* V25 V26 V27))) ; Region 14
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 15
(assert (= 126 (* V31 V32 V39))) ; Region 16
(assert (= 20 (* V33 V34 V40))) ; Region 17
(assert (= 35 (* V35 V36))) ; Region 18
(assert (= 24 (* V38 V45))) ; Region 19
(assert (= 15 (* V41 V48))) ; Region 20
(assert (= 12 (* V42 V43 V44))) ; Region 21
(assert (= 14 (* V46 V47))) ; Region 22
(check-sat)
