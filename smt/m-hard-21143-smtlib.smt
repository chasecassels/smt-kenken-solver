...
(assert (= 42 (* V2 V8 V9))) ; Region 2
(assert (= 20 (* V3 V4 V10))) ; Region 3
(assert (= 72 (* V5 V12 V19))) ; Region 4
(assert (= 28 (* V6 V13))) ; Region 5
(assert (= 60 (* V7 V14 V15 V21 V22))) ; Region 6
(assert (= 168 (* V16 V17 V18 V24))) ; Region 8
(assert (= 126 (* V20 V25 V26 V27))) ; Region 9
(assert (= 210 (* V23 V30 V31 V32))) ; Region 10
(assert (= 840 (* V28 V29 V35 V42))) ; Region 11
(assert (= 6 (* V33 V34))) ; Region 12
(assert (= 21 (* V36 V37 V43))) ; Region 13
(assert (= 120 (* V38 V39 V40))) ; Region 14
(assert (= 10 (* V41 V47 V48))) ; Region 15
(assert (= 24 (* V44 V45 V46))) ; Region 16
(check-sat)
