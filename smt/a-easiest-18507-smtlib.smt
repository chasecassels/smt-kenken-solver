...
(assert (= 6 (+ V4 V11))) ; Region 3
(assert (= 14 (+ V5 V6 V13))) ; Region 4
(assert (= 10 (+ V7 V14))) ; Region 5
(assert (= 13 (+ V8 V9 V15))) ; Region 6
(assert (= 6 (+ V10 V17))) ; Region 7
(assert (= 13 (+ V18 V19))) ; Region 10
(assert (= 5 (+ V20 V27))) ; Region 11
(assert (= 6 (+ V21 V28))) ; Region 12
(assert (= 10 (+ V22 V23))) ; Region 13
(assert (= 12 (+ V25 V26))) ; Region 15
(assert (= 12 (+ V29 V36 V43))) ; Region 16
(assert (= 3 (+ V30 V31))) ; Region 17
(assert (= 9 (+ V32 V33))) ; Region 18
(assert (= 12 (+ V34 V41))) ; Region 19
(assert (= 11 (+ V35 V42))) ; Region 20
(assert (= 9 (+ V37 V44))) ; Region 21
(assert (= 12 (+ V38 V45))) ; Region 22
(assert (= 3 (+ V39 V40))) ; Region 23
