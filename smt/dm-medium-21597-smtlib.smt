...
(assert (= 140 (* V0 V1 V2 V7 V9))) ; Region 1
(assert (= 840 (* V3 V10 V16 V17 V23))) ; Region 2
(assert (= 420 (* V4 V5 V6 V13))) ; Region 3
(assert (= 720 (* V8 V14 V15 V21))) ; Region 4
(assert (or (= 2 (/ V11 V18)) (= 2 (/ V18 V11)))) ; Region 5
(assert (= 6 (* V12 V19 V20))) ; Region 6
(assert (or (= 2 (/ V22 V29)) (= 2 (/ V29 V22)))) ; Region 7
(assert (= 42 (* V24 V25 V26))) ; Region 8
(assert (= 126 (* V28 V35 V36 V42 V43))) ; Region 10
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 11
(assert (= 4200 (* V31 V38 V39 V44 V45 V46))) ; Region 12
(assert (= 24 (* V32 V33 V34))) ; Region 13
(assert (= 35 (* V40 V41))) ; Region 14
(assert (= 8 (* V47 V48))) ; Region 15
(check-sat)
