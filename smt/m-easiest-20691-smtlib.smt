...
(assert (= 6 (* V0 V1 V8))) ; Region 1
(assert (= 35 (* V2 V3))) ; Region 2
(assert (= 7 (* V4 V11))) ; Region 3
(assert (= 24 (* V5 V6))) ; Region 4
(assert (= 168 (* V7 V14 V15))) ; Region 5
(assert (= 18 (* V9 V10))) ; Region 6
(assert (= 10 (* V12 V13 V20))) ; Region 7
(assert (= 21 (* V16 V23 V24))) ; Region 8
(assert (= 10 (* V17 V18))) ; Region 9
(assert (= 32 (* V19 V25 V26))) ; Region 10
(assert (= 30 (* V21 V22))) ; Region 11
(assert (= 21 (* V27 V34))) ; Region 12
(assert (= 20 (* V28 V29 V35))) ; Region 13
(assert (= 12 (* V30 V31))) ; Region 14
(assert (= 6 (* V32 V33 V39))) ; Region 15
(assert (= 42 (* V36 V42 V43))) ; Region 16
(assert (= 20 (* V37 V38 V44))) ; Region 17
(assert (= 42 (* V40 V41))) ; Region 18
(assert (= 90 (* V46 V47 V48))) ; Region 20
(check-sat)
