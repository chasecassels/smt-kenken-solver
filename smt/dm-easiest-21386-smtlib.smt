...
(assert (= 35 (* V4 V5))) ; Region 4
(assert (= 54 (* V6 V12 V13))) ; Region 5
(assert (= 6 (* V8 V15))) ; Region 6
(assert (= 15 (* V14 V21))) ; Region 8
(assert (or (= 2 (/ V16 V17)) (= 2 (/ V17 V16)))) ; Region 9
(assert (or (= 2 (/ V18 V25)) (= 2 (/ V25 V18)))) ; Region 10
(assert (= 28 (* V19 V20))) ; Region 11
(assert (= 196 (* V22 V28 V29))) ; Region 12
(assert (= 10 (* V23 V30))) ; Region 13
(assert (or (= 3 (/ V24 V31)) (= 3 (/ V31 V24)))) ; Region 14
(assert (= 8 (* V26 V27))) ; Region 15
(assert (= 30 (* V32 V33 V34))) ; Region 16
(assert (= 24 (* V35 V42))) ; Region 17
(assert (= 12 (* V37 V38))) ; Region 19
(assert (= 7 (* V39 V40))) ; Region 20
(assert (= 2 (* V41 V48))) ; Region 21
(assert (or (= 2 (/ V43 V44)) (= 2 (/ V44 V43)))) ; Region 22
(assert (= 70 (* V45 V46 V47))) ; Region 23
(check-sat)
