...
(assert (= 6 (+ V10 V11 V12))) ; Region 8
(assert (or (= 6 (- V14 V21)) (= 6 (- V21 V14)))) ; Region 9
(assert (= 18 (+ V17 V23 V24))) ; Region 10
(assert (= 14 (+ V18 V19 V26))) ; Region 11
(assert (= 6 (+ V20 V27))) ; Region 12
(assert (= 16 (+ V22 V29 V36))) ; Region 13
(assert (= 9 (+ V28 V35))) ; Region 15
(assert (= 5 (+ V30 V37))) ; Region 16
(assert (or (= 3 (- V31 V32)) (= 3 (- V32 V31)))) ; Region 17
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 18
(assert (= 9 (+ V34 V41))) ; Region 19
(assert (or (= 6 (- V38 V39)) (= 6 (- V39 V38)))) ; Region 20
(assert (= 8 (+ V42 V43))) ; Region 21
(assert (= 12 (+ V44 V45 V46))) ; Region 22
(assert (or (= 6 (- V47 V48)) (= 6 (- V48 V47)))) ; Region 23
(check-sat)
