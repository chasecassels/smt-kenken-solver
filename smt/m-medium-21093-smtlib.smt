...
(assert (= 70 (* V0 V7 V8 V14))) ; Region 1
(assert (= 30 (* V1 V2 V3))) ; Region 2
(assert (= 126 (* V4 V5 V11))) ; Region 3
(assert (= 60 (* V6 V12 V13 V20))) ; Region 4
(assert (= 168 (* V9 V10 V17))) ; Region 5
(assert (= 6 (* V15 V16))) ; Region 6
(assert (= 60 (* V18 V25 V26))) ; Region 7
(assert (= 36 (* V21 V22 V28 V29))) ; Region 9
(assert (= 15 (* V23 V30))) ; Region 10
(assert (= 20 (* V24 V31 V38 V39))) ; Region 11
(assert (= 28 (* V32 V33))) ; Region 13
(assert (= 12 (* V34 V41))) ; Region 14
(assert (= 84 (* V35 V42 V43))) ; Region 15
(assert (= 28 (* V36 V37))) ; Region 16
(assert (= 30 (* V40 V46 V47 V48))) ; Region 17
(assert (= 12 (* V44 V45))) ; Region 18
(check-sat)
