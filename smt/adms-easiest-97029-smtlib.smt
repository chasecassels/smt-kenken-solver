...
(assert (= 144 (* V2 V3 V10))) ; Region 2
(assert (or (= 2 (- V4 V11)) (= 2 (- V11 V4)))) ; Region 3
(assert (= 6 (* V5 V6))) ; Region 4
(assert (= 540 (* V7 V14 V15 V22))) ; Region 5
(assert (or (= 6 (- V8 V9)) (= 6 (- V9 V8)))) ; Region 6
(assert (or (= 2 (/ V12 V13)) (= 2 (/ V13 V12)))) ; Region 7
(assert (= 56 (* V16 V17 V18))) ; Region 8
(assert (= 6 (+ V19 V20))) ; Region 9
(assert (or (= 1 (- V21 V28)) (= 1 (- V28 V21)))) ; Region 10
(assert (= 7 (+ V23 V30))) ; Region 11
(assert (= 3 (+ V24 V31))) ; Region 12
(assert (or (= 6 (- V25 V32)) (= 6 (- V32 V25)))) ; Region 13
(assert (or (= 3 (- V26 V27)) (= 3 (- V27 V26)))) ; Region 14
(assert (= 7 (+ V29 V36))) ; Region 15
(assert (= 13 (+ V33 V40))) ; Region 16
(assert (= 14 (+ V34 V41 V48))) ; Region 17
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 18
(assert (or (= 2 (- V37 V38)) (= 2 (- V38 V37)))) ; Region 19
(assert (= 11 (+ V39 V46 V47))) ; Region 20
(assert (= 11 (+ V43 V44))) ; Region 21
(check-sat)
