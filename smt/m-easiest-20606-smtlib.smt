...
(assert (= 18 (* V1 V2 V8))) ; Region 2
(assert (= 168 (* V4 V11 V18))) ; Region 4
(assert (= 70 (* V5 V6 V12))) ; Region 5
(assert (= 6 (* V9 V10))) ; Region 6
(assert (= 2 (* V13 V19 V20))) ; Region 7
(assert (= 21 (* V14 V15))) ; Region 8
(assert (= 20 (* V16 V17 V24))) ; Region 9
(assert (= 42 (* V21 V28))) ; Region 10
(assert (= 35 (* V22 V23))) ; Region 11
(assert (= 36 (* V26 V27 V34))) ; Region 13
(assert (= 60 (* V29 V30 V31))) ; Region 14
(assert (= 21 (* V32 V38 V39))) ; Region 15
(assert (= 24 (* V33 V40))) ; Region 16
(assert (= 2 (* V35 V42 V43))) ; Region 17
(assert (= 8 (* V36 V37))) ; Region 18
(assert (= 30 (* V41 V48))) ; Region 19
(assert (= 12 (* V44 V45))) ; Region 20
(assert (= 35 (* V46 V47))) ; Region 21
(check-sat)
