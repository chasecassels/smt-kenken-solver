...
(assert (= 16 (+ V3 V4 V10 V11))) ; Region 3
(assert (= 16 (+ V5 V6 V13))) ; Region 4
(assert (= 3 (+ V7 V14))) ; Region 5
(assert (= 12 (+ V8 V15))) ; Region 6
(assert (= 10 (+ V12 V19 V20))) ; Region 7
(assert (= 9 (+ V16 V17))) ; Region 8
(assert (= 11 (+ V18 V24 V25))) ; Region 9
(assert (= 11 (+ V21 V22 V23))) ; Region 10
(assert (= 7 (+ V26 V33))) ; Region 11
(assert (= 13 (+ V27 V34))) ; Region 12
(assert (= 5 (+ V28 V29))) ; Region 13
(assert (= 15 (+ V30 V36 V37))) ; Region 14
(assert (= 3 (+ V31 V38))) ; Region 15
(assert (= 10 (+ V32 V39))) ; Region 16
(assert (= 13 (+ V35 V42 V43))) ; Region 17
(assert (= 7 (+ V40 V41 V48))) ; Region 18
(assert (= 11 (+ V44 V45))) ; Region 19
(assert (= 8 (+ V46 V47))) ; Region 20
(check-sat)
