...
(assert (= 8 (+ V7 V14))) ; Region 6
(assert (= 13 (+ V8 V15))) ; Region 7
(assert (= 3 (+ V9 V16))) ; Region 8
(assert (= 10 (+ V12 V19))) ; Region 9
(assert (= 6 (+ V17 V24))) ; Region 10
(assert (= 12 (+ V18 V25 V32))) ; Region 11
(assert (= 11 (+ V20 V27))) ; Region 12
(assert (= 9 (+ V21 V28))) ; Region 13
(assert (= 6 (+ V22 V23))) ; Region 14
(assert (= 3 (+ V26 V33))) ; Region 15
(assert (= 11 (+ V29 V30))) ; Region 16
(assert (= 13 (+ V31 V38))) ; Region 17
(assert (= 6 (+ V34 V41 V48))) ; Region 18
(assert (= 11 (+ V35 V36))) ; Region 19
(assert (= 10 (+ V37 V44))) ; Region 20
(assert (= 5 (+ V39 V40))) ; Region 21
(assert (= 7 (+ V42 V43))) ; Region 22
(assert (= 12 (+ V46 V47))) ; Region 24
(check-sat)
