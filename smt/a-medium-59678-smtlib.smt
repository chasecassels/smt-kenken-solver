...
(assert (= 12 (+ V0 V1 V8))) ; Region 1
(assert (= 10 (+ V2 V9 V10))) ; Region 2
(assert (= 8 (+ V3 V4))) ; Region 3
(assert (= 19 (+ V5 V6 V12 V13))) ; Region 4
(assert (= 10 (+ V7 V14))) ; Region 5
(assert (= 9 (+ V15 V16))) ; Region 7
(assert (= 11 (+ V17 V23 V24))) ; Region 8
(assert (= 15 (+ V18 V25 V32))) ; Region 9
(assert (= 6 (+ V19 V26 V33))) ; Region 10
(assert (= 6 (+ V20 V27))) ; Region 11
(assert (= 7 (+ V21 V28))) ; Region 12
(assert (= 6 (+ V22 V29))) ; Region 13
(assert (= 11 (+ V30 V31))) ; Region 14
(assert (= 13 (+ V34 V41))) ; Region 15
(assert (= 10 (+ V35 V42))) ; Region 16
(assert (= 8 (+ V36 V43))) ; Region 17
(assert (= 6 (+ V37 V38 V39))) ; Region 18
(assert (= 12 (+ V40 V47 V48))) ; Region 19
(assert (= 13 (+ V44 V45 V46))) ; Region 20
(check-sat)
