...
(assert (= 11 (+ V0 V7 V8))) ; Region 1
(assert (= 13 (+ V1 V2))) ; Region 2
(assert (= 6 (+ V3 V10))) ; Region 3
(assert (= 5 (+ V4 V5))) ; Region 4
(assert (= 14 (+ V6 V13 V20))) ; Region 5
(assert (= 13 (+ V9 V15 V16))) ; Region 6
(assert (= 4 (+ V11 V12))) ; Region 7
(assert (= 12 (+ V14 V21 V28))) ; Region 8
(assert (= 13 (+ V17 V18))) ; Region 9
(assert (= 7 (+ V19 V26))) ; Region 10
(assert (= 7 (+ V22 V23))) ; Region 11
(assert (= 15 (+ V24 V25 V31))) ; Region 12
(assert (= 8 (+ V27 V34))) ; Region 13
(assert (= 3 (+ V29 V30))) ; Region 14
(assert (= 9 (+ V32 V33))) ; Region 15
(assert (= 10 (+ V35 V36))) ; Region 16
(assert (= 3 (+ V37 V38))) ; Region 17
(assert (= 15 (+ V39 V46 V47))) ; Region 18
