...
(assert (= 9 (+ V1 V2))) ; Region 2
(assert (= 7 (+ V3 V4))) ; Region 3
(assert (= 3 (+ V5 V12))) ; Region 4
(assert (= 7 (+ V6 V13))) ; Region 5
(assert (= 13 (+ V8 V9))) ; Region 6
(assert (= 7 (+ V10 V11))) ; Region 7
(assert (= 11 (+ V14 V21 V22))) ; Region 8
(assert (= 14 (+ V15 V16 V17))) ; Region 9
(assert (= 8 (+ V18 V25))) ; Region 10
(assert (= 7 (+ V19 V26))) ; Region 11
(assert (= 13 (+ V20 V27))) ; Region 12
(assert (= 3 (+ V23 V24))) ; Region 13
(assert (= 3 (+ V28 V29))) ; Region 14
(assert (= 9 (+ V30 V31))) ; Region 15
(assert (= 12 (+ V32 V39 V46))) ; Region 16
(assert (= 18 (+ V33 V34 V40 V41))) ; Region 17
(assert (= 11 (+ V35 V42))) ; Region 18
(assert (= 7 (+ V36 V43))) ; Region 19
(assert (= 5 (+ V37 V38))) ; Region 20
(assert (= 11 (+ V44 V45))) ; Region 21
(assert (= 8 (+ V47 V48))) ; Region 22
(check-sat)
