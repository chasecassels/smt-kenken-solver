...
(assert (= 126 (* V0 V7 V14))) ; Region 1
(assert (= 6 (+ V1 V2 V3))) ; Region 2
(assert (= 11 (+ V4 V5))) ; Region 3
(assert (= 168 (* V6 V13 V20))) ; Region 4
(assert (or (= 3 (- V8 V9)) (= 3 (- V9 V8)))) ; Region 5
(assert (= 12 (+ V10 V11 V12))) ; Region 6
(assert (or (= 3 (- V15 V16)) (= 3 (- V16 V15)))) ; Region 7
(assert (or (= 3 (- V17 V18)) (= 3 (- V18 V17)))) ; Region 8
(assert (or (= 1 (- V19 V26)) (= 1 (- V26 V19)))) ; Region 9
(assert (= 16 (* V21 V28 V29))) ; Region 10
(assert (= 210 (* V22 V23 V24))) ; Region 11
(assert (or (= 3 (- V25 V32)) (= 3 (- V32 V25)))) ; Region 12
(assert (or (= 4 (- V27 V34)) (= 4 (- V34 V27)))) ; Region 13
(assert (or (= 2 (/ V30 V37)) (= 2 (/ V37 V30)))) ; Region 14
(assert (= 5 (+ V31 V38))) ; Region 15
(assert (or (= 3 (- V33 V40)) (= 3 (- V40 V33)))) ; Region 16
(assert (or (= 2 (- V35 V36)) (= 2 (- V36 V35)))) ; Region 17
(assert (= 8 (+ V39 V46))) ; Region 18
(assert (= 30 (* V41 V47 V48))) ; Region 19
(assert (or (= 3 (/ V42 V43)) (= 3 (/ V43 V42)))) ; Region 20
