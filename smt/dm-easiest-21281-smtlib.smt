...
(assert (= 210 (* V3 V9 V10))) ; Region 3
(assert (= 21 (* V4 V11))) ; Region 4
(assert (= 4 (* V5 V6))) ; Region 5
(assert (or (= 2 (/ V7 V14)) (= 2 (/ V14 V7)))) ; Region 6
(assert (= 112 (* V8 V15 V16))) ; Region 7
(assert (= 3 (* V12 V13))) ; Region 8
(assert (= 6 (* V17 V18))) ; Region 9
(assert (or (= 2 (/ V19 V26)) (= 2 (/ V26 V19)))) ; Region 10
(assert (= 20 (* V20 V27))) ; Region 11
(assert (= 42 (* V21 V28))) ; Region 12
(assert (= 15 (* V22 V29))) ; Region 13
(assert (= 14 (* V23 V30))) ; Region 14
(assert (= 6 (* V24 V25 V32))) ; Region 15
(assert (= 40 (* V31 V38 V45))) ; Region 16
(assert (= 84 (* V34 V41 V48))) ; Region 18
(assert (or (= 2 (/ V35 V36)) (= 2 (/ V36 V35)))) ; Region 19
(assert (or (= 3 (/ V37 V44)) (= 3 (/ V44 V37)))) ; Region 20
(assert (or (= 2 (/ V39 V40)) (= 2 (/ V40 V39)))) ; Region 21
(assert (= 4 (* V42 V43))) ; Region 22
(assert (= 35 (* V46 V47))) ; Region 23
(check-sat)
