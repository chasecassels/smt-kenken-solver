...
(assert (= 18 (+ V2 V3 V10))) ; Region 2
(assert (= 10 (+ V5 V6 V13))) ; Region 4
(assert (= 9 (+ V7 V14))) ; Region 5
(assert (= 6 (+ V8 V9))) ; Region 6
(assert (= 13 (+ V11 V18))) ; Region 7
(assert (= 3 (+ V15 V16))) ; Region 9
(assert (= 8 (+ V17 V24))) ; Region 10
(assert (= 10 (+ V19 V20))) ; Region 11
(assert (= 13 (+ V21 V28))) ; Region 12
(assert (= 10 (+ V22 V29))) ; Region 13
(assert (= 5 (+ V23 V30))) ; Region 14
(assert (= 7 (+ V25 V32))) ; Region 15
(assert (= 3 (+ V26 V27))) ; Region 16
(assert (= 3 (+ V31 V38))) ; Region 17
(assert (= 12 (+ V33 V34))) ; Region 18
(assert (= 4 (+ V35 V42))) ; Region 19
(assert (= 13 (+ V36 V37))) ; Region 20
(assert (= 3 (+ V39 V46))) ; Region 21
(assert (= 9 (+ V40 V41))) ; Region 22
(assert (= 15 (+ V43 V44 V45))) ; Region 23
