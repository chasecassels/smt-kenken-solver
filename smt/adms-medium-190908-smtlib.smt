...
(assert (or (= 1 (- V0 V1)) (= 1 (- V1 V0)))) ; Region 1
(assert (or (= 2 (- V2 V3)) (= 2 (- V3 V2)))) ; Region 2
(assert (= 84 (* V4 V5 V6))) ; Region 3
(assert (= 3 (+ V7 V14))) ; Region 4
(assert (= 17 (+ V8 V9 V10))) ; Region 5
(assert (or (= 2 (/ V11 V18)) (= 2 (/ V18 V11)))) ; Region 6
(assert (or (= 3 (- V12 V13)) (= 3 (- V13 V12)))) ; Region 7
(assert (= 13 (+ V15 V16 V23))) ; Region 8
(assert (= 56 (* V17 V24 V31))) ; Region 9
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 10
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 11
(assert (or (= 4 (- V21 V28)) (= 4 (- V28 V21)))) ; Region 12
(assert (or (= 2 (/ V22 V29)) (= 2 (/ V29 V22)))) ; Region 13
(assert (= 10 (+ V25 V32 V33))) ; Region 14
(assert (or (= 5 (- V30 V37)) (= 5 (- V37 V30)))) ; Region 15
(assert (= 5 (+ V34 V41))) ; Region 16
(assert (or (= 3 (/ V35 V36)) (= 3 (/ V36 V35)))) ; Region 17
(assert (= 15 (* V38 V39 V40))) ; Region 18
(assert (= 11 (+ V42 V43 V44))) ; Region 19
(assert (or (= 3 (- V45 V46)) (= 3 (- V46 V45)))) ; Region 20
(assert (= 10 (+ V47 V48))) ; Region 21
(check-sat)
