...
(assert (= 168 (* V4 V5 V6 V11 V13))) ; Region 3
(assert (= 60 (* V8 V9 V10 V16))) ; Region 4
(assert (= 8 (* V12 V19))) ; Region 5
(assert (= 42 (* V14 V15 V21))) ; Region 6
(assert (= 24 (* V17 V24 V31 V32))) ; Region 7
(assert (= 140 (* V20 V27 V34))) ; Region 9
(assert (= 6 (* V22 V23))) ; Region 10
(assert (= 210 (* V25 V26 V33))) ; Region 11
(assert (= 10 (* V28 V29))) ; Region 12
(assert (= 168 (* V30 V37 V44 V45))) ; Region 13
(assert (= 20 (* V35 V36 V42))) ; Region 14
(assert (= 12 (* V38 V39))) ; Region 15
(assert (= 90 (* V40 V46 V47))) ; Region 16
(assert (= 6 (* V41 V48))) ; Region 17
(check-sat)
