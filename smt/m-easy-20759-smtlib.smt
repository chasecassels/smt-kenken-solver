...
(assert (= 144 (* V2 V8 V9 V16))) ; Region 2
(assert (= 42 (* V3 V4 V10))) ; Region 3
(assert (= 28 (* V5 V6))) ; Region 4
(assert (= 75 (* V11 V12 V19 V20))) ; Region 5
(assert (= 28 (* V14 V15 V21))) ; Region 7
(assert (= 14 (* V17 V18 V24))) ; Region 8
(assert (= 30 (* V23 V29 V30))) ; Region 10
(assert (= 12 (* V25 V32))) ; Region 11
(assert (= 168 (* V26 V27 V33 V34))) ; Region 12
(assert (= 15 (* V28 V35))) ; Region 13
(assert (= 30 (* V31 V38 V39))) ; Region 14
(assert (= 196 (* V36 V37 V42 V43))) ; Region 15
(assert (= 12 (* V40 V41))) ; Region 16
(assert (= 72 (* V44 V45 V46))) ; Region 17
(assert (= 10 (* V47 V48))) ; Region 18
(check-sat)
