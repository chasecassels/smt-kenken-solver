...
(assert (= 2940 (* V0 V1 V2 V3 V7 V8))) ; Region 1
(assert (= 60 (* V4 V11 V12 V13))) ; Region 2
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 3
(assert (= 240 (* V9 V16 V23 V24))) ; Region 4
(assert (= 126 (* V10 V17 V18 V19))) ; Region 5
(assert (= 336 (* V14 V15 V21 V28 V29))) ; Region 6
(assert (= 21 (* V20 V27))) ; Region 7
(assert (= 12 (* V25 V26 V32))) ; Region 9
(assert (= 10 (* V30 V31))) ; Region 10
(assert (or (= 2 (/ V33 V34)) (= 2 (/ V34 V33)))) ; Region 11
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 12
(assert (= 252 (* V36 V37 V43 V44))) ; Region 13
(assert (= 840 (* V38 V39 V40 V41))) ; Region 14
(assert (or (= 2 (/ V45 V46)) (= 2 (/ V46 V45)))) ; Region 15
(assert (= 20 (* V47 V48))) ; Region 16
(check-sat)
