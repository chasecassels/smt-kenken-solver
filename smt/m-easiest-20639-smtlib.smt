...
(assert (= 72 (* V0 V7 V8))) ; Region 1
(assert (= 15 (* V2 V3 V9))) ; Region 3
(assert (= 40 (* V4 V5 V12))) ; Region 4
(assert (= 6 (* V6 V13 V20))) ; Region 5
(assert (= 14 (* V11 V18))) ; Region 7
(assert (= 126 (* V14 V21 V22))) ; Region 8
(assert (= 96 (* V15 V16 V23))) ; Region 9
(assert (= 10 (* V17 V24 V25))) ; Region 10
(assert (= 35 (* V19 V26 V27))) ; Region 11
(assert (= 2 (* V29 V30 V36))) ; Region 13
(assert (= 126 (* V31 V32 V33))) ; Region 14
(assert (= 168 (* V34 V41 V48))) ; Region 15
(assert (= 10 (* V35 V42 V43))) ; Region 16
(assert (= 56 (* V37 V44 V45))) ; Region 17
(assert (= 12 (* V38 V39))) ; Region 18
(assert (= 30 (* V40 V47))) ; Region 19
(check-sat)
