...
(assert (= 11 (+ V0 V1 V2 V9))) ; Region 1
(assert (= 7 (+ V3 V4))) ; Region 2
(assert (= 12 (+ V5 V6))) ; Region 3
(assert (= 4 (+ V7 V8))) ; Region 4
(assert (= 18 (+ V10 V11 V12))) ; Region 5
(assert (= 9 (+ V13 V20))) ; Region 6
(assert (= 11 (+ V14 V15 V22))) ; Region 7
(assert (= 5 (+ V16 V17))) ; Region 8
(assert (= 10 (+ V18 V19))) ; Region 9
(assert (= 18 (+ V21 V28 V35))) ; Region 10
(assert (= 12 (+ V23 V29 V30))) ; Region 11
(assert (= 5 (+ V24 V31))) ; Region 12
(assert (= 9 (+ V25 V26))) ; Region 13
(assert (= 7 (+ V27 V34))) ; Region 14
(assert (= 8 (+ V32 V33))) ; Region 15
(assert (= 13 (+ V36 V42 V43))) ; Region 16
(assert (= 9 (+ V37 V38))) ; Region 17
(assert (= 6 (+ V40 V41 V48))) ; Region 19
