...
(assert (or (= 6 (- V0 V7)) (= 6 (- V7 V0)))) ; Region 1
(assert (= 24 (* V1 V8 V9))) ; Region 2
(assert (= 8 (+ V2 V3 V10))) ; Region 3
(assert (= 13 (+ V4 V11))) ; Region 4
(assert (or (= 2 (- V5 V6)) (= 2 (- V6 V5)))) ; Region 5
(assert (= 120 (* V12 V18 V19))) ; Region 6
(assert (or (= 2 (- V13 V20)) (= 2 (- V20 V13)))) ; Region 7
(assert (or (= 3 (- V14 V15)) (= 3 (- V15 V14)))) ; Region 8
(assert (= 10 (+ V16 V23))) ; Region 9
(assert (= 10 (* V17 V24))) ; Region 10
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 11
(assert (= 3 (+ V25 V26))) ; Region 12
(assert (or (= 3 (- V27 V34)) (= 3 (- V34 V27)))) ; Region 13
(assert (or (= 1 (- V28 V35)) (= 1 (- V35 V28)))) ; Region 14
(assert (= 21 (+ V29 V36 V42 V43))) ; Region 15
(assert (= 15 (+ V30 V31 V32))) ; Region 16
(assert (or (= 5 (- V33 V40)) (= 5 (- V40 V33)))) ; Region 17
(assert (or (= 1 (- V38 V39)) (= 1 (- V39 V38)))) ; Region 19
(assert (or (= 3 (/ V41 V48)) (= 3 (/ V48 V41)))) ; Region 20
(assert (or (= 1 (- V44 V45)) (= 1 (- V45 V44)))) ; Region 21
(assert (or (= 3 (/ V46 V47)) (= 3 (/ V47 V46)))) ; Region 22
(check-sat)
