...
(assert (= 7 (+ V2 V3))) ; Region 2
(assert (= 9 (+ V4 V11))) ; Region 3
(assert (= 9 (+ V5 V12 V13))) ; Region 4
(assert (= 8 (+ V7 V14 V21))) ; Region 6
(assert (= 13 (+ V8 V9))) ; Region 7
(assert (= 8 (+ V10 V17 V18))) ; Region 8
(assert (= 9 (+ V15 V16 V23))) ; Region 9
(assert (= 13 (+ V19 V20))) ; Region 10
(assert (= 11 (+ V22 V29 V30))) ; Region 11
(assert (= 13 (+ V24 V25))) ; Region 12
(assert (= 5 (+ V26 V27))) ; Region 13
(assert (= 13 (+ V28 V35))) ; Region 14
(assert (= 9 (+ V31 V32))) ; Region 15
(assert (= 11 (+ V33 V40 V47))) ; Region 16
(assert (= 11 (+ V34 V41 V48))) ; Region 17
(assert (= 10 (+ V36 V37))) ; Region 18
(assert (= 12 (+ V38 V45))) ; Region 19
