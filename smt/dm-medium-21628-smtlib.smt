...
(assert (= 840 (* V1 V2 V3 V4 V10))) ; Region 2
(assert (or (= 2 (/ V5 V6)) (= 2 (/ V6 V5)))) ; Region 3
(assert (= 90 (* V8 V9 V16))) ; Region 4
(assert (= 294 (* V11 V12 V17 V18 V19))) ; Region 5
(assert (= 12 (* V13 V20))) ; Region 6
(assert (= 560 (* V14 V15 V21 V22))) ; Region 7
(assert (or (= 2 (/ V23 V24)) (= 2 (/ V24 V23)))) ; Region 8
(assert (= 450 (* V25 V26 V27 V34))) ; Region 9
(assert (= 360 (* V29 V30 V31 V38 V39))) ; Region 11
(assert (= 24 (* V32 V33 V40))) ; Region 12
(assert (or (= 3 (/ V35 V36)) (= 3 (/ V36 V35)))) ; Region 13
(assert (= 14 (* V37 V44))) ; Region 14
(assert (= 7 (* V41 V48))) ; Region 15
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 16
(assert (= 20 (* V45 V46 V47))) ; Region 17
(check-sat)
