...
(assert (= 210 (* V0 V1 V7 V8))) ; Region 1
(assert (or (= 2 (/ V2 V3)) (= 2 (/ V3 V2)))) ; Region 2
(assert (= 84 (* V4 V5 V6))) ; Region 3
(assert (= 360 (* V9 V14 V15 V16))) ; Region 4
(assert (= 28 (* V10 V17))) ; Region 5
(assert (= 30 (* V11 V12 V13))) ; Region 6
(assert (= 70 (* V19 V20 V26 V27))) ; Region 8
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 9
(assert (= 180 (* V22 V23 V30 V31))) ; Region 10
(assert (= 42 (* V24 V25 V32))) ; Region 11
(assert (= 63 (* V29 V35 V36))) ; Region 12
(assert (= 120 (* V33 V34 V41 V48))) ; Region 13
(assert (= 280 (* V37 V38 V44 V45))) ; Region 14
(assert (or (= 3 (/ V39 V46)) (= 3 (/ V46 V39)))) ; Region 15
(assert (= 24 (* V40 V47))) ; Region 16
(assert (= 2 (* V42 V43))) ; Region 17
(check-sat)
