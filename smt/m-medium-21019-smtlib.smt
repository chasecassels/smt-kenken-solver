...
(assert (= 30 (* V0 V1 V8 V15))) ; Region 1
(assert (= 35 (* V2 V3))) ; Region 2
(assert (= 48 (* V4 V5 V12))) ; Region 3
(assert (= 6 (* V6 V13))) ; Region 4
(assert (= 20 (* V7 V14))) ; Region 5
(assert (= 6 (* V9 V16))) ; Region 6
(assert (= 168 (* V10 V11 V17 V24))) ; Region 7
(assert (= 126 (* V18 V19 V20))) ; Region 8
(assert (= 42 (* V21 V28 V35))) ; Region 9
(assert (= 12 (* V22 V23 V29))) ; Region 10
(assert (= 14 (* V25 V26 V33))) ; Region 11
(assert (= 20 (* V27 V34))) ; Region 12
(assert (= 60 (* V30 V31 V32 V39))) ; Region 13
(assert (= 84 (* V36 V37 V38))) ; Region 14
(assert (= 210 (* V40 V41 V47 V48))) ; Region 15
(assert (= 60 (* V42 V43 V44))) ; Region 16
(assert (= 12 (* V45 V46))) ; Region 17
(check-sat)
