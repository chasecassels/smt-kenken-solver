...
(assert (= 120 (* V5 V6 V12 V13))) ; Region 4
(assert (= 12 (* V9 V10 V16))) ; Region 5
(assert (= 12 (* V11 V18))) ; Region 6
(assert (= 1050 (* V14 V15 V21 V22 V29))) ; Region 7
(assert (= 5 (* V17 V24))) ; Region 8
(assert (= 126 (* V19 V20 V27 V34))) ; Region 9
(assert (or (= 2 (/ V23 V30)) (= 2 (/ V30 V23)))) ; Region 10
(assert (= 84 (* V25 V31 V32))) ; Region 11
(assert (= 4 (* V26 V33))) ; Region 12
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 13
(assert (= 15 (* V36 V37 V43))) ; Region 14
(assert (= 1680 (* V38 V44 V45 V46 V47))) ; Region 15
(assert (= 84 (* V39 V40 V41 V48))) ; Region 16
(check-sat)
