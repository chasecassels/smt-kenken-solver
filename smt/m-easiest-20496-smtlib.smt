...
(assert (= 30 (* V1 V2 V8))) ; Region 2
(assert (= 18 (* V3 V10 V11))) ; Region 3
(assert (= 28 (* V4 V5))) ; Region 4
(assert (= 126 (* V6 V13 V20))) ; Region 5
(assert (= 20 (* V7 V14))) ; Region 6
(assert (= 6 (* V9 V15 V16))) ; Region 7
(assert (= 8 (* V12 V19))) ; Region 8
(assert (= 42 (* V17 V24))) ; Region 9
(assert (= 63 (* V21 V22 V28))) ; Region 11
(assert (= 14 (* V23 V30))) ; Region 12
(assert (= 10 (* V25 V31 V32))) ; Region 13
(assert (= 20 (* V26 V27 V34))) ; Region 14
(assert (= 24 (* V29 V35 V36))) ; Region 15
(assert (= 18 (* V33 V40))) ; Region 16
(assert (= 32 (* V38 V44 V45))) ; Region 18
(assert (= 21 (* V39 V46 V47))) ; Region 19
(assert (= 10 (* V41 V48))) ; Region 20
(assert (= 42 (* V42 V43))) ; Region 21
(check-sat)
