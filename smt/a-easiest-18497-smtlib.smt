...
(assert (= 12 (+ V2 V3))) ; Region 3
(assert (= 10 (+ V4 V11 V12))) ; Region 4
(assert (= 4 (+ V5 V6))) ; Region 5
(assert (= 13 (+ V9 V10))) ; Region 6
(assert (= 9 (+ V13 V20))) ; Region 7
(assert (= 8 (+ V14 V15))) ; Region 8
(assert (= 3 (+ V16 V17))) ; Region 9
(assert (= 13 (+ V18 V19))) ; Region 10
(assert (= 13 (+ V21 V22))) ; Region 11
(assert (= 10 (+ V23 V24 V30))) ; Region 12
(assert (= 7 (+ V25 V26))) ; Region 13
(assert (= 3 (+ V27 V34))) ; Region 14
(assert (= 11 (+ V28 V29))) ; Region 15
(assert (= 7 (+ V31 V38))) ; Region 16
(assert (= 6 (+ V32 V33))) ; Region 17
(assert (= 10 (+ V36 V42 V43))) ; Region 19
(assert (= 7 (+ V37 V44))) ; Region 20
(assert (= 9 (+ V39 V40))) ; Region 21
(assert (= 20 (+ V41 V47 V48))) ; Region 22
