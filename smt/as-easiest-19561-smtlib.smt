...
(assert (= 13 (+ V2 V9))) ; Region 3
(assert (= 3 (+ V3 V10))) ; Region 4
(assert (= 12 (+ V4 V5 V6 V13))) ; Region 5
(assert (= 11 (+ V11 V12))) ; Region 6
(assert (= 13 (+ V14 V21 V28))) ; Region 7
(assert (= 5 (+ V15 V16))) ; Region 8
(assert (or (= 6 (- V17 V18)) (= 6 (- V18 V17)))) ; Region 9
(assert (= 6 (+ V19 V26))) ; Region 10
(assert (= 11 (+ V20 V27))) ; Region 11
(assert (or (= 4 (- V22 V29)) (= 4 (- V29 V22)))) ; Region 12
(assert (= 3 (+ V23 V30))) ; Region 13
(assert (= 9 (+ V24 V31))) ; Region 14
(assert (or (= 5 (- V32 V33)) (= 5 (- V33 V32)))) ; Region 16
(assert (= 5 (+ V34 V41))) ; Region 17
(assert (or (= 1 (- V35 V36)) (= 1 (- V36 V35)))) ; Region 18
(assert (= 14 (+ V37 V38 V39))) ; Region 19
(assert (= 6 (+ V43 V44))) ; Region 22
(assert (or (= 2 (- V45 V46)) (= 2 (- V46 V45)))) ; Region 23
(assert (= 10 (+ V47 V48))) ; Region 24
(check-sat)
