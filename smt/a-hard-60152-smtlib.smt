...
(assert (= 6 (+ V2 V3 V4))) ; Region 2
(assert (= 7 (+ V5 V12))) ; Region 3
(assert (= 10 (+ V6 V13))) ; Region 4
(assert (= 16 (+ V8 V15 V22))) ; Region 5
(assert (= 13 (+ V9 V10 V17))) ; Region 6
(assert (= 10 (+ V11 V18 V25))) ; Region 7
(assert (= 11 (+ V14 V21))) ; Region 8
(assert (= 10 (+ V16 V23 V29 V30))) ; Region 9
(assert (= 9 (+ V19 V20))) ; Region 10
(assert (= 18 (+ V24 V31 V38))) ; Region 11
(assert (= 10 (+ V26 V33))) ; Region 12
(assert (= 7 (+ V27 V34))) ; Region 13
(assert (= 5 (+ V28 V35))) ; Region 14
(assert (= 11 (+ V32 V39))) ; Region 15
(assert (= 13 (+ V36 V37 V44))) ; Region 16
(assert (= 7 (+ V40 V41 V48))) ; Region 17
(assert (= 8 (+ V42 V43))) ; Region 18
(assert (= 11 (+ V46 V47))) ; Region 20
(check-sat)
