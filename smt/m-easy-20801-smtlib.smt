...
(assert (= 7 (* V2 V9 V10))) ; Region 2
(assert (= 504 (* V3 V4 V5 V12))) ; Region 3
(assert (= 20 (* V8 V14 V15))) ; Region 5
(assert (= 24 (* V11 V18 V25))) ; Region 6
(assert (= 30 (* V13 V20))) ; Region 7
(assert (= 21 (* V16 V17))) ; Region 8
(assert (= 20 (* V19 V26 V27))) ; Region 9
(assert (= 28 (* V21 V28 V29))) ; Region 10
(assert (= 24 (* V22 V23 V30))) ; Region 11
(assert (= 90 (* V24 V31 V32))) ; Region 12
(assert (= 42 (* V33 V34 V40))) ; Region 13
(assert (= 540 (* V35 V42 V43 V44))) ; Region 14
(assert (= 28 (* V36 V37))) ; Region 15
(assert (= 140 (* V38 V39 V45 V46))) ; Region 16
(assert (= 6 (* V41 V47 V48))) ; Region 17
(check-sat)
