...
(assert (= 18 (+ V0 V7 V14))) ; Region 1
(assert (= 9 (+ V1 V2 V8))) ; Region 2
(assert (= 84 (* V3 V4 V5))) ; Region 3
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 4
(assert (or (= 6 (- V9 V10)) (= 6 (- V10 V9)))) ; Region 5
(assert (or (= 1 (- V11 V12)) (= 1 (- V12 V11)))) ; Region 6
(assert (or (= 2 (/ V15 V16)) (= 2 (/ V16 V15)))) ; Region 7
(assert (or (= 2 (- V17 V18)) (= 2 (- V18 V17)))) ; Region 8
(assert (= 6 (+ V19 V26 V33))) ; Region 9
(assert (or (= 1 (- V20 V27)) (= 1 (- V27 V20)))) ; Region 10
(assert (or (= 1 (- V21 V22)) (= 1 (- V22 V21)))) ; Region 11
(assert (or (= 1 (- V23 V24)) (= 1 (- V24 V23)))) ; Region 12
(assert (= 7 (+ V25 V32))) ; Region 13
(assert (= 14 (* V28 V29))) ; Region 14
(assert (or (= 3 (- V30 V37)) (= 3 (- V37 V30)))) ; Region 15
(assert (= 5 (+ V31 V38))) ; Region 16
(assert (= 6 (+ V34 V41))) ; Region 17
(assert (or (= 2 (- V35 V42)) (= 2 (- V42 V35)))) ; Region 18
(assert (or (= 2 (- V36 V43)) (= 2 (- V43 V36)))) ; Region 19
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 20
(assert (= 105 (* V40 V47 V48))) ; Region 21
(assert (= 13 (+ V44 V45))) ; Region 22
(check-sat)
