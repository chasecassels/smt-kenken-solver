...
(assert (= 84 (* V0 V1 V2))) ; Region 1
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 2
(assert (= 9 (+ V5 V12 V13 V20))) ; Region 3
(assert (or (= 5 (- V7 V14)) (= 5 (- V14 V7)))) ; Region 5
(assert (= 168 (* V8 V15 V22))) ; Region 6
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 7
(assert (or (= 1 (- V10 V11)) (= 1 (- V11 V10)))) ; Region 8
(assert (= 8 (+ V17 V24))) ; Region 9
(assert (or (= 2 (/ V18 V25)) (= 2 (/ V25 V18)))) ; Region 10
(assert (or (= 3 (- V19 V26)) (= 3 (- V26 V19)))) ; Region 11
(assert (or (= 3 (- V21 V28)) (= 3 (- V28 V21)))) ; Region 12
(assert (or (= 2 (/ V23 V30)) (= 2 (/ V30 V23)))) ; Region 13
(assert (= 21 (+ V27 V33 V34 V40))) ; Region 14
(assert (= 12 (+ V29 V36 V37))) ; Region 15
(assert (or (= 3 (/ V31 V32)) (= 3 (/ V32 V31)))) ; Region 16
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 17
(assert (= 13 (+ V38 V39))) ; Region 18
(assert (or (= 6 (- V41 V48)) (= 6 (- V48 V41)))) ; Region 19
(assert (= 3 (+ V43 V44))) ; Region 20
(assert (= 90 (* V45 V46 V47))) ; Region 21
(check-sat)
