...
(assert (= 11 (+ V2 V3 V10))) ; Region 2
(assert (= 11 (+ V4 V5 V6))) ; Region 3
(assert (= 9 (+ V8 V15 V22))) ; Region 4
(assert (= 13 (+ V9 V16))) ; Region 5
(assert (= 11 (+ V11 V12))) ; Region 6
(assert (= 3 (+ V13 V20))) ; Region 7
(assert (= 13 (+ V14 V21))) ; Region 8
(assert (= 5 (+ V17 V18))) ; Region 9
(assert (= 16 (+ V19 V25 V26))) ; Region 10
(assert (= 6 (+ V23 V24))) ; Region 11
(assert (= 7 (+ V27 V34))) ; Region 12
(assert (= 6 (+ V28 V35))) ; Region 13
(assert (= 10 (+ V29 V30))) ; Region 14
(assert (= 13 (+ V31 V37 V38))) ; Region 15
(assert (= 3 (+ V32 V33))) ; Region 16
(assert (= 9 (+ V39 V46))) ; Region 18
(assert (= 13 (+ V40 V41))) ; Region 19
