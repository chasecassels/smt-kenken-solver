...
(assert (= 40 (* V0 V1 V2))) ; Region 1
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 2
(assert (= 18 (* V5 V12))) ; Region 3
(assert (= 168 (* V6 V13 V19 V20))) ; Region 4
(assert (= 70 (* V7 V8 V14 V15))) ; Region 5
(assert (= 35 (* V9 V10))) ; Region 6
(assert (= 420 (* V11 V18 V25 V26 V27))) ; Region 7
(assert (= 12 (* V16 V17))) ; Region 8
(assert (= 840 (* V21 V28 V29 V35))) ; Region 9
(assert (= 12 (* V22 V23 V30))) ; Region 10
(assert (= 120 (* V24 V31 V32 V33))) ; Region 11
(assert (= 6 (* V34 V41))) ; Region 12
(assert (= 216 (* V36 V37 V42 V43 V44))) ; Region 13
(assert (= 12 (* V38 V39 V46))) ; Region 14
(assert (= 140 (* V40 V47 V48))) ; Region 15
(check-sat)
