...
(assert (or (= 5 (- V0 V7)) (= 5 (- V7 V0)))) ; Region 1
(assert (= 7 (+ V1 V8))) ; Region 2
(assert (= 17 (+ V2 V3 V9 V10))) ; Region 3
(assert (or (= 6 (- V4 V5)) (= 6 (- V5 V4)))) ; Region 4
(assert (or (= 1 (- V6 V13)) (= 1 (- V13 V6)))) ; Region 5
(assert (or (= 1 (- V11 V18)) (= 1 (- V18 V11)))) ; Region 6
(assert (= 17 (+ V12 V19 V20))) ; Region 7
(assert (or (= 3 (- V14 V21)) (= 3 (- V21 V14)))) ; Region 8
(assert (= 8 (+ V15 V16 V17))) ; Region 9
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 10
(assert (= 7 (+ V24 V31 V38))) ; Region 11
(assert (or (= 2 (- V25 V32)) (= 2 (- V32 V25)))) ; Region 12
(assert (= 10 (+ V26 V33 V34))) ; Region 13
(assert (= 18 (+ V28 V29 V30))) ; Region 15
(assert (= 5 (+ V35 V42))) ; Region 16
(assert (or (= 3 (- V36 V43)) (= 3 (- V43 V36)))) ; Region 17
(assert (= 11 (+ V37 V44))) ; Region 18
(assert (or (= 4 (- V39 V46)) (= 4 (- V46 V39)))) ; Region 19
(assert (= 10 (+ V40 V47))) ; Region 20
