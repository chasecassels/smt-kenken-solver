...
(assert (= 12 (* V2 V3 V9))) ; Region 2
(assert (= 10 (* V4 V5))) ; Region 3
(assert (= 105 (* V6 V12 V13 V20))) ; Region 4
(assert (= 42 (* V7 V8))) ; Region 5
(assert (= 168 (* V11 V17 V18 V19))) ; Region 7
(assert (= 20 (* V14 V15 V21))) ; Region 8
(assert (= 126 (* V16 V23 V24))) ; Region 9
(assert (= 20 (* V22 V28 V29))) ; Region 10
(assert (= 42 (* V25 V26 V31 V32))) ; Region 11
(assert (= 30 (* V27 V34))) ; Region 12
(assert (= 20 (* V30 V37))) ; Region 13
(assert (= 18 (* V33 V40))) ; Region 14
(assert (= 126 (* V35 V36 V42 V43 V44))) ; Region 15
(assert (= 30 (* V38 V39 V45))) ; Region 16
(assert (= 8 (* V41 V48))) ; Region 17
(assert (= 28 (* V46 V47))) ; Region 18
(check-sat)
