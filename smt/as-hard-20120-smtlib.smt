...
(assert (= 18 (+ V2 V3 V4))) ; Region 2
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 3
(assert (= 19 (+ V7 V14 V15 V16))) ; Region 4
(assert (or (= 1 (- V9 V10)) (= 1 (- V10 V9)))) ; Region 6
(assert (= 9 (+ V11 V18 V19))) ; Region 7
(assert (= 3 (+ V12 V13))) ; Region 8
(assert (= 15 (+ V17 V24 V25))) ; Region 9
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 12
(assert (= 12 (+ V26 V27))) ; Region 13
(assert (= 10 (+ V28 V35))) ; Region 14
(assert (or (= 2 (- V29 V36)) (= 2 (- V36 V29)))) ; Region 15
(assert (or (= 4 (- V30 V37)) (= 4 (- V37 V30)))) ; Region 16
(assert (= 6 (+ V31 V38))) ; Region 17
(assert (= 14 (+ V32 V33 V34))) ; Region 18
(assert (= 16 (+ V39 V45 V46 V47))) ; Region 19
(assert (= 9 (+ V40 V41 V48))) ; Region 20
(assert (= 15 (+ V42 V43 V44))) ; Region 21
(check-sat)
