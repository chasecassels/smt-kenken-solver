...
(assert (= 120 (* V4 V10 V11 V17))) ; Region 3
(assert (= 210 (* V5 V6 V12 V13))) ; Region 4
(assert (= 1470 (* V7 V14 V15 V21))) ; Region 5
(assert (= 36 (* V8 V9 V16))) ; Region 6
(assert (= 72 (* V19 V20 V26 V27))) ; Region 8
(assert (= 48 (* V22 V28 V29))) ; Region 9
(assert (= 10 (* V23 V24))) ; Region 10
(assert (or (= 2 (/ V25 V32)) (= 2 (/ V32 V25)))) ; Region 11
(assert (= 42 (* V30 V31 V37))) ; Region 12
(assert (= 35 (* V33 V34))) ; Region 13
(assert (or (= 3 (/ V35 V42)) (= 3 (/ V42 V35)))) ; Region 14
(assert (= 60 (* V36 V43 V44))) ; Region 15
(assert (= 15 (* V38 V39))) ; Region 16
(assert (= 6 (* V40 V47))) ; Region 17
(assert (or (= 2 (/ V41 V48)) (= 2 (/ V48 V41)))) ; Region 18
(assert (= 28 (* V45 V46))) ; Region 19
(check-sat)
