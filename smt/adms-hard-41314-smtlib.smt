...
(assert (or (= 4 (- V1 V2)) (= 4 (- V2 V1)))) ; Region 2
(assert (or (= 2 (- V3 V10)) (= 2 (- V10 V3)))) ; Region 3
(assert (= 6 (+ V4 V5))) ; Region 4
(assert (= 15 (* V6 V12 V13))) ; Region 5
(assert (= 21 (* V8 V15))) ; Region 6
(assert (or (= 3 (- V9 V16)) (= 3 (- V16 V9)))) ; Region 7
(assert (or (= 2 (- V11 V18)) (= 2 (- V18 V11)))) ; Region 8
(assert (or (= 3 (/ V14 V21)) (= 3 (/ V21 V14)))) ; Region 9
(assert (or (= 2 (- V17 V24)) (= 2 (- V24 V17)))) ; Region 10
(assert (or (= 1 (- V19 V20)) (= 1 (- V20 V19)))) ; Region 11
(assert (or (= 2 (- V22 V23)) (= 2 (- V23 V22)))) ; Region 12
(assert (or (= 1 (- V25 V26)) (= 1 (- V26 V25)))) ; Region 13
(assert (= 15 (+ V28 V29 V30))) ; Region 15
(assert (= 6 (+ V31 V32 V33))) ; Region 16
(assert (= 168 (* V34 V40 V41))) ; Region 17
(assert (= 50 (* V35 V36 V42 V43))) ; Region 18
(assert (or (= 2 (- V37 V38)) (= 2 (- V38 V37)))) ; Region 19
(assert (= 9 (+ V39 V46))) ; Region 20
(assert (or (= 3 (- V44 V45)) (= 3 (- V45 V44)))) ; Region 21
(assert (or (= 3 (- V47 V48)) (= 3 (- V48 V47)))) ; Region 22
(check-sat)
