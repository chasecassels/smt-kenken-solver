...
(assert (= 12 (+ V2 V3 V10))) ; Region 2
(assert (= 11 (+ V4 V5))) ; Region 3
(assert (= 15 (+ V6 V12 V13))) ; Region 4
(assert (= 13 (+ V7 V14))) ; Region 5
(assert (= 3 (+ V8 V9))) ; Region 6
(assert (= 15 (+ V11 V18 V19 V20))) ; Region 7
(assert (= 5 (+ V15 V16))) ; Region 8
(assert (= 12 (+ V17 V24))) ; Region 9
(assert (= 12 (+ V21 V22 V23))) ; Region 10
(assert (= 8 (+ V25 V26))) ; Region 11
(assert (= 9 (+ V27 V34 V41))) ; Region 12
(assert (= 8 (+ V28 V29))) ; Region 13
(assert (= 13 (+ V30 V36 V37))) ; Region 14
(assert (= 10 (+ V31 V38))) ; Region 15
(assert (= 10 (+ V32 V39))) ; Region 16
(assert (= 3 (+ V33 V40))) ; Region 17
(assert (= 7 (+ V35 V42))) ; Region 18
(assert (= 11 (+ V43 V44))) ; Region 19
(assert (= 3 (+ V45 V46))) ; Region 20
