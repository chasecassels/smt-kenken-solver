...
(assert (= 13 (+ V4 V5 V6))) ; Region 4
(assert (= 11 (+ V9 V15 V16))) ; Region 5
(assert (= 18 (+ V10 V11 V17 V18))) ; Region 6
(assert (= 7 (+ V12 V13))) ; Region 7
(assert (= 15 (+ V19 V26 V33))) ; Region 8
(assert (= 9 (+ V20 V27))) ; Region 9
(assert (= 11 (+ V21 V28))) ; Region 10
(assert (= 10 (+ V22 V29))) ; Region 11
(assert (= 6 (+ V23 V30))) ; Region 12
(assert (= 3 (+ V24 V25))) ; Region 13
(assert (= 5 (+ V31 V38))) ; Region 14
(assert (= 13 (+ V34 V41 V48))) ; Region 16
(assert (= 5 (+ V35 V42))) ; Region 17
(assert (= 13 (+ V36 V37))) ; Region 18
(assert (= 6 (+ V39 V46))) ; Region 19
(assert (= 5 (+ V40 V47))) ; Region 20
(assert (= 14 (+ V43 V44 V45))) ; Region 21
(check-sat)
