...
(assert (= 40 (* V0 V1 V7))) ; Region 1
(assert (= 36 (* V2 V3 V9))) ; Region 2
(assert (= 168 (* V4 V5 V6 V11))) ; Region 3
(assert (= 140 (* V8 V14 V15 V22))) ; Region 4
(assert (= 420 (* V10 V16 V17 V24))) ; Region 5
(assert (= 21 (* V12 V13 V20))) ; Region 6
(assert (= 12 (* V18 V19 V25))) ; Region 7
(assert (= 12 (* V21 V28))) ; Region 8
(assert (= 35 (* V23 V30 V31))) ; Region 9
(assert (= 24 (* V26 V32 V33))) ; Region 10
(assert (= 30 (* V27 V34))) ; Region 11
(assert (= 72 (* V29 V36 V37 V44))) ; Region 12
(assert (= 21 (* V35 V42 V43))) ; Region 13
(assert (= 6 (* V38 V39))) ; Region 14
(assert (= 30 (* V40 V47))) ; Region 15
(assert (= 14 (* V41 V48))) ; Region 16
(assert (= 20 (* V45 V46))) ; Region 17
(check-sat)
