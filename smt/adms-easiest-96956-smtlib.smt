...
(assert (= 112 (* V5 V6 V13))) ; Region 4
(assert (or (= 1 (- V7 V8)) (= 1 (- V8 V7)))) ; Region 5
(assert (or (= 6 (- V9 V16)) (= 6 (- V16 V9)))) ; Region 6
(assert (or (= 5 (- V10 V17)) (= 5 (- V17 V10)))) ; Region 7
(assert (or (= 2 (/ V11 V18)) (= 2 (/ V18 V11)))) ; Region 8
(assert (or (= 2 (- V12 V19)) (= 2 (- V19 V12)))) ; Region 9
(assert (or (= 2 (- V14 V21)) (= 2 (- V21 V14)))) ; Region 10
(assert (or (= 3 (/ V15 V22)) (= 3 (/ V22 V15)))) ; Region 11
(assert (= 6 (* V20 V26 V27))) ; Region 12
(assert (or (= 1 (- V23 V24)) (= 1 (- V24 V23)))) ; Region 13
(assert (= 28 (* V29 V30))) ; Region 16
(assert (= 6 (* V31 V32))) ; Region 17
(assert (= 13 (+ V33 V40))) ; Region 18
(assert (= 12 (+ V34 V41 V48))) ; Region 19
(assert (= 96 (* V35 V36 V37 V42))) ; Region 20
(assert (or (= 4 (- V38 V39)) (= 4 (- V39 V38)))) ; Region 21
(assert (= 13 (+ V44 V45))) ; Region 23
(assert (= 10 (* V46 V47))) ; Region 24
(check-sat)
