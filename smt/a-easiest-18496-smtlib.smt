...
(assert (= 15 (+ V5 V12 V19))) ; Region 5
(assert (= 11 (+ V6 V13))) ; Region 6
(assert (= 9 (+ V8 V9))) ; Region 7
(assert (= 3 (+ V10 V17))) ; Region 8
(assert (= 6 (+ V14 V21))) ; Region 9
(assert (= 11 (+ V15 V16 V22))) ; Region 10
(assert (= 14 (+ V18 V24 V25))) ; Region 11
(assert (= 11 (+ V20 V27))) ; Region 12
(assert (= 6 (+ V23 V30))) ; Region 13
(assert (= 13 (+ V28 V35))) ; Region 15
(assert (= 9 (+ V31 V32))) ; Region 17
(assert (= 5 (+ V33 V40))) ; Region 18
(assert (= 5 (+ V34 V41))) ; Region 19
(assert (= 3 (+ V36 V37))) ; Region 20
(assert (= 12 (+ V38 V39))) ; Region 21
(assert (= 11 (+ V42 V43))) ; Region 22
(assert (= 10 (+ V44 V45))) ; Region 23
(assert (= 3 (+ V47 V48))) ; Region 25
(check-sat)
