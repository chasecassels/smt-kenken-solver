...
(assert (= 5 (* V5 V12))) ; Region 4
(assert (= 24 (* V6 V13))) ; Region 5
(assert (= 70 (* V7 V8 V15))) ; Region 6
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 7
(assert (= 18 (* V10 V17))) ; Region 8
(assert (= 120 (* V14 V21 V28))) ; Region 10
(assert (= 15 (* V18 V19))) ; Region 11
(assert (= 3 (* V20 V27))) ; Region 12
(assert (= 7 (* V23 V24))) ; Region 14
(assert (or (= 3 (/ V25 V26)) (= 3 (/ V26 V25)))) ; Region 15
(assert (= 45 (* V29 V30 V37))) ; Region 16
(assert (= 4 (* V31 V38))) ; Region 17
(assert (= 28 (* V32 V33))) ; Region 18
(assert (= 20 (* V34 V40 V41))) ; Region 19
(assert (= 7 (* V35 V36))) ; Region 20
(assert (= 18 (* V39 V46))) ; Region 21
(assert (or (= 2 (/ V42 V43)) (= 2 (/ V43 V42)))) ; Region 22
(assert (= 30 (* V44 V45))) ; Region 23
(assert (= 28 (* V47 V48))) ; Region 24
(check-sat)
