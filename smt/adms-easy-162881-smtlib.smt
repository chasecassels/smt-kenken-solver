...
(assert (= 360 (* V0 V1 V2 V7))) ; Region 1
(assert (or (= 3 (/ V3 V4)) (= 3 (/ V4 V3)))) ; Region 2
(assert (or (= 5 (- V5 V6)) (= 5 (- V6 V5)))) ; Region 3
(assert (= 12 (+ V8 V9 V10))) ; Region 4
(assert (= 17 (+ V11 V12 V13 V18))) ; Region 5
(assert (= 10 (* V14 V21))) ; Region 6
(assert (= 13 (+ V15 V22))) ; Region 7
(assert (= 9 (+ V16 V23 V29 V30))) ; Region 8
(assert (= 3 (+ V17 V24))) ; Region 9
(assert (= 315 (* V19 V25 V26 V32))) ; Region 10
(assert (or (= 2 (- V20 V27)) (= 2 (- V27 V20)))) ; Region 11
(assert (or (= 6 (- V28 V35)) (= 6 (- V35 V28)))) ; Region 12
(assert (or (= 1 (- V31 V38)) (= 1 (- V38 V31)))) ; Region 13
(assert (= 16 (+ V33 V34 V40 V41 V48))) ; Region 14
(assert (= 60 (* V36 V42 V43))) ; Region 15
(assert (= 13 (+ V39 V46 V47))) ; Region 17
(assert (= 14 (* V44 V45))) ; Region 18
(check-sat)
