...
(assert (= 24 (* V0 V1 V8))) ; Region 1
(assert (= 15 (* V2 V3))) ; Region 2
(assert (= 36 (* V4 V10 V11))) ; Region 3
(assert (= 196 (* V5 V6 V12))) ; Region 4
(assert (= 210 (* V7 V14 V15))) ; Region 5
(assert (= 20 (* V9 V16 V17))) ; Region 6
(assert (= 6 (* V13 V20))) ; Region 7
(assert (= 2 (* V18 V19 V26))) ; Region 8
(assert (= 28 (* V21 V28 V29))) ; Region 9
(assert (= 18 (* V22 V23))) ; Region 10
(assert (= 10 (* V24 V25))) ; Region 11
(assert (= 20 (* V27 V34))) ; Region 12
(assert (= 168 (* V31 V32 V38))) ; Region 14
(assert (= 18 (* V33 V40 V41))) ; Region 15
(assert (= 10 (* V35 V36))) ; Region 16
(assert (= 42 (* V37 V43 V44))) ; Region 17
(assert (= 28 (* V39 V45 V46))) ; Region 18
(assert (= 30 (* V47 V48))) ; Region 20
(check-sat)
