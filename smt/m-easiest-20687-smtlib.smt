...
(assert (= 21 (* V1 V8 V9))) ; Region 2
(assert (= 5 (* V3 V10))) ; Region 4
(assert (= 36 (* V4 V5 V6))) ; Region 5
(assert (= 140 (* V11 V18 V19))) ; Region 6
(assert (= 10 (* V12 V13 V20))) ; Region 7
(assert (= 12 (* V14 V15))) ; Region 8
(assert (= 12 (* V16 V17))) ; Region 9
(assert (= 28 (* V21 V22))) ; Region 10
(assert (= 54 (* V23 V24 V31))) ; Region 11
(assert (= 10 (* V25 V26 V27))) ; Region 12
(assert (= 12 (* V28 V29))) ; Region 13
(assert (= 10 (* V30 V37))) ; Region 14
(assert (= 24 (* V32 V33 V40))) ; Region 15
(assert (= 28 (* V34 V41))) ; Region 16
(assert (= 10 (* V35 V36 V43))) ; Region 17
(assert (= 28 (* V38 V44 V45))) ; Region 18
(assert (= 18 (* V39 V46))) ; Region 19
(assert (= 21 (* V47 V48))) ; Region 21
(check-sat)
