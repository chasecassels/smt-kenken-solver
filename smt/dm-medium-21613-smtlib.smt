...
(assert (= 4200 (* V0 V1 V2 V7 V14))) ; Region 1
(assert (= 504 (* V3 V4 V8 V9 V10))) ; Region 2
(assert (= 36 (* V5 V11 V12))) ; Region 3
(assert (or (= 2 (/ V6 V13)) (= 2 (/ V13 V6)))) ; Region 4
(assert (= 6 (* V15 V16 V17))) ; Region 5
(assert (= 196 (* V18 V19 V25))) ; Region 6
(assert (= 210 (* V20 V26 V27 V34))) ; Region 7
(assert (= 4 (* V21 V28))) ; Region 8
(assert (= 180 (* V22 V23 V24 V29))) ; Region 9
(assert (= 336 (* V30 V31 V37 V38))) ; Region 10
(assert (= 75 (* V32 V33 V39))) ; Region 11
(assert (= 6 (* V35 V42))) ; Region 12
(assert (or (= 2 (/ V36 V43)) (= 2 (/ V43 V36)))) ; Region 13
(assert (= 12 (* V40 V41))) ; Region 14
(assert (= 35 (* V44 V45))) ; Region 15
(assert (= 24 (* V46 V47 V48))) ; Region 16
(check-sat)
