...
(assert (= 72 (* V0 V1 V2 V8 V9))) ; Region 1
(assert (= 150 (* V3 V4 V5 V12))) ; Region 2
(assert (= 42 (* V6 V13))) ; Region 3
(assert (= 120 (* V7 V14 V21))) ; Region 4
(assert (= 14 (* V10 V11 V18))) ; Region 5
(assert (= 24 (* V15 V16 V23))) ; Region 6
(assert (= 60 (* V17 V24 V31 V32))) ; Region 7
(assert (= 588 (* V19 V20 V25 V26))) ; Region 8
(assert (= 42 (* V22 V29 V30))) ; Region 9
(assert (= 60 (* V27 V33 V34))) ; Region 10
(assert (= 14 (* V28 V35))) ; Region 11
(assert (= 210 (* V36 V42 V43 V44))) ; Region 12
(assert (= 360 (* V37 V38 V39 V40 V45))) ; Region 13
(assert (= 4 (* V41 V48))) ; Region 14
(assert (or (= 3 (/ V46 V47)) (= 3 (/ V47 V46)))) ; Region 15
(check-sat)
