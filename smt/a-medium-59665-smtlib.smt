...
(assert (= 3 (+ V5 V12))) ; Region 5
(assert (= 6 (+ V6 V13))) ; Region 6
(assert (= 13 (+ V7 V14))) ; Region 7
(assert (= 10 (+ V8 V15))) ; Region 8
(assert (= 12 (+ V9 V16 V23))) ; Region 9
(assert (= 11 (+ V17 V24))) ; Region 10
(assert (= 5 (+ V18 V19))) ; Region 11
(assert (= 12 (+ V20 V26 V27))) ; Region 12
(assert (= 6 (+ V21 V28))) ; Region 13
(assert (= 7 (+ V22 V29))) ; Region 14
(assert (= 9 (+ V25 V32))) ; Region 15
(assert (= 9 (+ V30 V31 V36 V37))) ; Region 16
(assert (= 10 (+ V33 V34))) ; Region 17
(assert (= 7 (+ V35 V42 V43))) ; Region 18
(assert (= 15 (+ V38 V39 V40))) ; Region 19
(assert (= 9 (+ V41 V48))) ; Region 20
(assert (= 7 (+ V44 V45))) ; Region 21
(assert (= 13 (+ V46 V47))) ; Region 22
(check-sat)
