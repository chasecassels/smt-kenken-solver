...
(assert (= 4 (+ V0 V7))) ; Region 1
(assert (= 7 (+ V1 V2))) ; Region 2
(assert (= 10 (+ V3 V4))) ; Region 3
(assert (= 10 (+ V6 V13))) ; Region 5
(assert (= 10 (+ V8 V15))) ; Region 6
(assert (= 6 (+ V9 V10))) ; Region 7
(assert (= 9 (+ V11 V12))) ; Region 8
(assert (= 13 (+ V14 V21))) ; Region 9
(assert (= 3 (+ V16 V17))) ; Region 10
(assert (= 6 (+ V18 V25))) ; Region 11
(assert (= 8 (+ V19 V20))) ; Region 12
(assert (= 3 (+ V22 V29))) ; Region 13
(assert (= 9 (+ V23 V24))) ; Region 14
(assert (= 11 (+ V26 V27 V34))) ; Region 15
(assert (= 7 (+ V28 V35))) ; Region 16
(assert (= 7 (+ V30 V31))) ; Region 17
(assert (= 13 (+ V32 V33))) ; Region 18
(assert (= 13 (+ V36 V37))) ; Region 19
(assert (= 9 (+ V38 V39 V46))) ; Region 20
(assert (= 9 (+ V40 V41))) ; Region 21
(assert (= 7 (+ V42 V43))) ; Region 22
(assert (= 13 (+ V44 V45))) ; Region 23
(assert (= 3 (+ V47 V48))) ; Region 24
(check-sat)
