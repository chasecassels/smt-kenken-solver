...
(assert (= 240 (* V3 V10 V11 V12))) ; Region 3
(assert (= 3 (+ V4 V5))) ; Region 4
(assert (or (= 3 (/ V6 V13)) (= 3 (/ V13 V6)))) ; Region 5
(assert (= 15 (+ V8 V9 V16))) ; Region 6
(assert (= 35 (* V14 V15))) ; Region 7
(assert (= 11 (+ V17 V18 V25))) ; Region 8
(assert (= 60 (* V19 V20 V27))) ; Region 9
(assert (= 3 (+ V21 V22))) ; Region 10
(assert (= 105 (* V23 V24 V31))) ; Region 11
(assert (= 13 (+ V26 V33))) ; Region 12
(assert (= 10 (+ V28 V35 V36))) ; Region 13
(assert (or (= 3 (- V29 V30)) (= 3 (- V30 V29)))) ; Region 14
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 15
(assert (= 10 (+ V34 V40 V41))) ; Region 16
(assert (= 20 (* V37 V38 V44))) ; Region 17
(assert (or (= 5 (- V42 V43)) (= 5 (- V43 V42)))) ; Region 18
(assert (= 6 (* V45 V46))) ; Region 19
(assert (or (= 2 (- V47 V48)) (= 2 (- V48 V47)))) ; Region 20
(check-sat)
