...
(assert (= 13 (+ V2 V8 V9 V16))) ; Region 2
...
(assert (= 12 (+ V15 V22))) ; Region 9
(assert (= 13 (+ V17 V24))) ; Region 10
(assert (= 3 (+ V18 V19))) ; Region 11
(assert (= 8 (+ V23 V30))) ; Region 12
(assert (= 13 (+ V25 V26 V32))) ; Region 13
(assert (= 9 (+ V27 V33 V34))) ; Region 14
(assert (= 6 (+ V28 V29 V36))) ; Region 15
(assert (= 9 (+ V31 V38 V39))) ; Region 16
(assert (= 12 (+ V35 V42))) ; Region 17
(assert (= 14 (+ V37 V43 V44))) ; Region 18
(assert (= 13 (+ V40 V47))) ; Region 19
