...
(assert (= 11 (+ V10 V17 V24))) ; Region 6
(assert (= 14 (+ V11 V12 V13 V20))) ; Region 7
(assert (= 7 (+ V14 V15))) ; Region 8
(assert (= 3 (+ V18 V25))) ; Region 10
(assert (= 16 (+ V19 V26 V27))) ; Region 11
(assert (= 13 (+ V21 V28))) ; Region 12
(assert (= 4 (+ V22 V29))) ; Region 13
(assert (= 7 (+ V23 V30))) ; Region 14
(assert (= 12 (+ V31 V32 V33))) ; Region 15
(assert (= 8 (+ V34 V41 V48))) ; Region 16
(assert (= 16 (+ V35 V36 V37))) ; Region 17
(assert (= 10 (+ V38 V39 V40))) ; Region 18
(assert (= 7 (+ V42 V43))) ; Region 19
(assert (= 7 (+ V44 V45))) ; Region 20
(assert (= 13 (+ V46 V47))) ; Region 21
(check-sat)
