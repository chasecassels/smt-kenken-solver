...
(assert (= 21 (* V1 V8))) ; Region 2
(assert (= 35 (* V2 V3))) ; Region 3
(assert (= 12 (* V4 V10 V11))) ; Region 4
(assert (= 6 (* V5 V6))) ; Region 5
(assert (or (= 2 (/ V9 V16)) (= 2 (/ V16 V9)))) ; Region 6
(assert (= 420 (* V12 V17 V18 V19))) ; Region 7
(assert (or (= 2 (/ V13 V20)) (= 2 (/ V20 V13)))) ; Region 8
(assert (= 20 (* V14 V15 V22))) ; Region 9
(assert (or (= 2 (/ V21 V28)) (= 2 (/ V28 V21)))) ; Region 10
(assert (= 7 (* V23 V30))) ; Region 11
(assert (= 60 (* V24 V31 V32))) ; Region 12
(assert (= 6 (* V25 V26))) ; Region 13
(assert (= 10 (* V27 V34))) ; Region 14
(assert (= 12 (* V29 V36 V37))) ; Region 15
(assert (= 84 (* V33 V40 V47))) ; Region 16
(assert (= 210 (* V35 V42 V43))) ; Region 17
(assert (= 6 (* V38 V44 V45))) ; Region 18
(assert (= 10 (* V39 V46))) ; Region 19
(assert (= 28 (* V41 V48))) ; Region 20
(check-sat)
