...
(assert (= 10 (+ V0 V1 V2))) ; Region 1
(assert (= 9 (+ V4 V11))) ; Region 3
(assert (or (= 3 (- V5 V6)) (= 3 (- V6 V5)))) ; Region 4
(assert (or (= 2 (- V7 V8)) (= 2 (- V8 V7)))) ; Region 5
(assert (= 14 (+ V9 V10 V16))) ; Region 6
(assert (or (= 2 (- V12 V13)) (= 2 (- V13 V12)))) ; Region 7
(assert (= 13 (+ V14 V15))) ; Region 8
(assert (= 8 (+ V17 V24 V25))) ; Region 9
(assert (= 4 (+ V18 V19))) ; Region 10
(assert (= 11 (+ V20 V27))) ; Region 11
(assert (or (= 6 (- V21 V28)) (= 6 (- V28 V21)))) ; Region 12
(assert (or (= 3 (- V22 V23)) (= 3 (- V23 V22)))) ; Region 13
(assert (= 11 (+ V26 V33 V40))) ; Region 14
(assert (= 12 (+ V29 V36 V43))) ; Region 15
(assert (= 13 (+ V30 V31))) ; Region 16
(assert (or (= 1 (- V32 V39)) (= 1 (- V39 V32)))) ; Region 17
(assert (or (= 3 (- V34 V41)) (= 3 (- V41 V34)))) ; Region 18
(assert (or (= 1 (- V35 V42)) (= 1 (- V42 V35)))) ; Region 19
(assert (or (= 2 (- V37 V38)) (= 2 (- V38 V37)))) ; Region 20
(assert (= 11 (+ V44 V45 V46))) ; Region 21
(assert (or (= 5 (- V47 V48)) (= 5 (- V48 V47)))) ; Region 22
(check-sat)
