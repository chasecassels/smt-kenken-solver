...
(assert (= 5 (+ V2 V3))) ; Region 3
(assert (= 14 (+ V4 V5 V12))) ; Region 4
(assert (= 15 (+ V9 V10 V16 V17))) ; Region 6
(assert (= 15 (+ V13 V20 V27))) ; Region 8
(assert (= 9 (+ V14 V21))) ; Region 9
(assert (= 3 (+ V15 V22))) ; Region 10
(assert (or (= 6 (- V18 V25)) (= 6 (- V25 V18)))) ; Region 11
(assert (= 9 (+ V19 V26))) ; Region 12
(assert (= 19 (+ V23 V24 V31))) ; Region 13
(assert (or (= 1 (- V28 V35)) (= 1 (- V35 V28)))) ; Region 14
(assert (= 13 (+ V30 V36 V37))) ; Region 16
(assert (= 15 (+ V32 V33 V40))) ; Region 17
