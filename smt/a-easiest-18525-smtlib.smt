...
(assert (= 15 (+ V3 V4 V10))) ; Region 3
(assert (= 11 (+ V6 V13))) ; Region 5
(assert (= 7 (+ V7 V8))) ; Region 6
(assert (= 3 (+ V11 V12))) ; Region 7
(assert (= 3 (+ V14 V21))) ; Region 8
(assert (= 8 (+ V15 V22))) ; Region 9
(assert (= 13 (+ V16 V17 V18))) ; Region 10
(assert (= 11 (+ V19 V26))) ; Region 11
(assert (= 6 (+ V20 V27))) ; Region 12
(assert (= 13 (+ V23 V30))) ; Region 13
(assert (= 4 (+ V24 V31))) ; Region 14
(assert (= 8 (+ V25 V32))) ; Region 15
(assert (= 12 (+ V28 V35))) ; Region 16
(assert (= 5 (+ V29 V36))) ; Region 17
(assert (= 7 (+ V33 V34))) ; Region 18
(assert (= 6 (+ V37 V44))) ; Region 19
(assert (= 7 (+ V38 V45))) ; Region 20
(assert (= 13 (+ V39 V40))) ; Region 21
(assert (= 9 (+ V41 V48))) ; Region 22
(assert (= 10 (+ V42 V43))) ; Region 23
