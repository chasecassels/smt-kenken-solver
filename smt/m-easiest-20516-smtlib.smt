...
(assert (= 126 (* V1 V2 V8))) ; Region 2
(assert (= 12 (* V3 V4))) ; Region 3
(assert (= 2 (* V5 V6 V12))) ; Region 4
(assert (= 8 (* V9 V10))) ; Region 5
(assert (= 42 (* V13 V19 V20))) ; Region 7
(assert (= 28 (* V14 V21))) ; Region 8
(assert (= 20 (* V16 V22 V23))) ; Region 10
(assert (= 12 (* V17 V18 V24))) ; Region 11
(assert (= 15 (* V25 V26))) ; Region 12
(assert (= 18 (* V27 V34))) ; Region 13
(assert (= 2 (* V28 V29 V35))) ; Region 14
(assert (= 20 (* V30 V31))) ; Region 15
(assert (= 252 (* V32 V33 V39))) ; Region 16
(assert (= 10 (* V36 V43))) ; Region 17
(assert (= 18 (* V37 V44 V45))) ; Region 18
(assert (= 20 (* V40 V41))) ; Region 20
(assert (= 56 (* V46 V47 V48))) ; Region 22
(check-sat)
