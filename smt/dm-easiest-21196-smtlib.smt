...
(assert (= 7 (* V0 V7))) ; Region 1
(assert (= 30 (* V2 V8 V9))) ; Region 3
(assert (= 4 (* V3 V10))) ; Region 4
(assert (= 21 (* V4 V11))) ; Region 5
(assert (or (= 3 (/ V5 V6)) (= 3 (/ V6 V5)))) ; Region 6
(assert (= 24 (* V12 V13))) ; Region 7
(assert (or (= 2 (/ V14 V15)) (= 2 (/ V15 V14)))) ; Region 8
(assert (= 24 (* V16 V17))) ; Region 9
(assert (= 30 (* V18 V25))) ; Region 10
(assert (= 14 (* V19 V26))) ; Region 11
(assert (= 28 (* V21 V22))) ; Region 13
(assert (= 3 (* V23 V24))) ; Region 14
(assert (= 35 (* V27 V34))) ; Region 15
(assert (or (= 2 (/ V28 V35)) (= 2 (/ V35 V28)))) ; Region 16
(assert (= 12 (* V29 V36))) ; Region 17
(assert (or (= 3 (/ V30 V31)) (= 3 (/ V31 V30)))) ; Region 18
(assert (= 5 (* V32 V33 V40))) ; Region 19
(assert (= 245 (* V37 V38 V45))) ; Region 20
(assert (or (= 2 (/ V39 V46)) (= 2 (/ V46 V39)))) ; Region 21
(assert (= 12 (* V41 V47 V48))) ; Region 22
(assert (or (= 3 (/ V43 V44)) (= 3 (/ V44 V43)))) ; Region 24
(check-sat)
