...
(assert (= 6 (+ V0 V1 V2))) ; Region 1
(assert (= 19 (+ V3 V4 V10))) ; Region 2
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 3
(assert (= 14 (+ V7 V8 V15))) ; Region 4
(assert (= 7 (+ V9 V16 V17))) ; Region 5
(assert (= 10 (+ V11 V18 V19))) ; Region 6
(assert (= 7 (+ V12 V13))) ; Region 7
(assert (= 6 (+ V14 V21))) ; Region 8
(assert (= 9 (+ V20 V27))) ; Region 9
(assert (= 9 (+ V22 V28 V29))) ; Region 10
(assert (= 10 (+ V23 V24))) ; Region 11
(assert (= 12 (+ V25 V26))) ; Region 12
(assert (= 14 (+ V30 V37 V38))) ; Region 13
(assert (= 14 (+ V32 V33 V40))) ; Region 15
(assert (or (= 2 (- V34 V41)) (= 2 (- V41 V34)))) ; Region 16
(assert (= 10 (+ V35 V42))) ; Region 17
(assert (= 18 (+ V36 V43 V44 V45))) ; Region 18
(assert (= 5 (+ V39 V46))) ; Region 19
(assert (or (= 4 (- V47 V48)) (= 4 (- V48 V47)))) ; Region 20
(check-sat)
