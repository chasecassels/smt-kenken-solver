...
(assert (= 60 (* V0 V7 V14))) ; Region 1
(assert (or (= 3 (/ V1 V2)) (= 3 (/ V2 V1)))) ; Region 2
(assert (or (= 2 (/ V3 V4)) (= 2 (/ V4 V3)))) ; Region 3
(assert (= 735 (* V5 V6 V13 V20))) ; Region 4
(assert (= 24 (* V8 V9 V10))) ; Region 5
(assert (= 252 (* V11 V18 V19 V25))) ; Region 6
(assert (= 140 (* V15 V16 V17))) ; Region 8
(assert (or (= 2 (/ V21 V22)) (= 2 (/ V22 V21)))) ; Region 9
(assert (= 40 (* V23 V24 V30 V37))) ; Region 10
(assert (or (= 2 (/ V26 V27)) (= 2 (/ V27 V26)))) ; Region 11
(assert (= 7 (* V28 V29))) ; Region 12
(assert (= 42 (* V31 V38))) ; Region 13
(assert (= 300 (* V32 V33 V40 V47))) ; Region 14
(assert (= 48 (* V34 V41 V48))) ; Region 15
(assert (= 84 (* V35 V36 V42))) ; Region 16
(assert (= 6 (* V39 V46))) ; Region 17
(assert (= 30 (* V43 V44 V45))) ; Region 18
(check-sat)
