...
(assert (= 18 (+ V0 V7 V8))) ; Region 1
(assert (= 9 (+ V2 V9))) ; Region 3
(assert (= 6 (+ V3 V10))) ; Region 4
(assert (= 6 (+ V4 V11 V18))) ; Region 5
(assert (= 7 (+ V5 V12))) ; Region 6
(assert (= 5 (+ V6 V13))) ; Region 7
(assert (= 8 (+ V14 V21))) ; Region 8
(assert (= 13 (+ V15 V16 V17))) ; Region 9
(assert (= 9 (+ V19 V20))) ; Region 10
(assert (= 8 (+ V22 V23))) ; Region 11
(assert (= 14 (+ V24 V30 V31))) ; Region 12
(assert (= 9 (+ V25 V26))) ; Region 13
(assert (= 8 (+ V27 V34))) ; Region 14
(assert (= 5 (+ V28 V35))) ; Region 15
(assert (= 9 (+ V29 V36 V37))) ; Region 16
(assert (= 13 (+ V32 V39))) ; Region 17
(assert (= 13 (+ V33 V40 V41))) ; Region 18
(assert (= 13 (+ V38 V44 V45))) ; Region 19
