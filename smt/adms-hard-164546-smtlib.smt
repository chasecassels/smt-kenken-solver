...
(assert (= 120 (* V1 V2 V3))) ; Region 2
(assert (or (= 3 (/ V4 V5)) (= 3 (/ V5 V4)))) ; Region 3
(assert (= 7 (+ V6 V13))) ; Region 4
(assert (= 6 (+ V8 V9 V10))) ; Region 5
(assert (= 18 (+ V11 V12 V19 V20))) ; Region 6
(assert (= 21 (+ V14 V15 V21 V22))) ; Region 7
(assert (= 28 (* V16 V23))) ; Region 8
(assert (or (= 1 (- V17 V24)) (= 1 (- V24 V17)))) ; Region 9
(assert (= 6 (+ V18 V25))) ; Region 10
(assert (or (= 3 (- V26 V33)) (= 3 (- V33 V26)))) ; Region 11
(assert (= 16 (+ V27 V34 V41))) ; Region 12
(assert (or (= 2 (/ V28 V29)) (= 2 (/ V29 V28)))) ; Region 13
(assert (= 10 (+ V30 V35 V36 V37))) ; Region 14
(assert (or (= 1 (- V31 V32)) (= 1 (- V32 V31)))) ; Region 15
(assert (or (= 2 (- V38 V45)) (= 2 (- V45 V38)))) ; Region 16
(assert (= 15 (+ V39 V40 V46))) ; Region 17
(assert (or (= 1 (- V42 V43)) (= 1 (- V43 V42)))) ; Region 18
(assert (= 5 (+ V47 V48))) ; Region 20
(check-sat)
