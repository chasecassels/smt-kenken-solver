...
(assert (= 112 (* V4 V5 V6 V13))) ; Region 3
(assert (= 144 (* V8 V9 V14 V15))) ; Region 4
(assert (= 30 (* V11 V18 V19))) ; Region 5
(assert (= 35 (* V16 V17))) ; Region 7
(assert (= 420 (* V20 V26 V27 V34))) ; Region 8
(assert (= 18 (* V21 V28))) ; Region 9
(assert (= 28 (* V22 V29 V30))) ; Region 10
(assert (= 60 (* V23 V24 V25))) ; Region 11
(assert (= 36 (* V31 V32 V33 V40))) ; Region 12
(assert (= 20 (* V35 V36))) ; Region 13
(assert (= 6 (* V37 V44))) ; Region 14
(assert (= 21 (* V38 V39 V45))) ; Region 15
(assert (= 30 (* V41 V47 V48))) ; Region 16
(assert (= 14 (* V42 V43))) ; Region 17
(check-sat)
