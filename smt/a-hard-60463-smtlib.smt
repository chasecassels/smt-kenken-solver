...
(assert (= 19 (+ V3 V4 V5 V12))) ; Region 3
(assert (= 16 (+ V6 V13 V20))) ; Region 4
(assert (= 21 (+ V8 V15 V21 V22))) ; Region 5
(assert (= 19 (+ V9 V16 V17 V23))) ; Region 6
(assert (= 10 (+ V10 V11))) ; Region 7
(assert (= 17 (+ V18 V19 V25 V26 V27))) ; Region 8
(assert (= 18 (+ V24 V29 V30 V31))) ; Region 9
(assert (= 12 (+ V28 V35 V36))) ; Region 10
(assert (= 4 (+ V32 V39))) ; Region 11
(assert (= 3 (+ V33 V34))) ; Region 12
(assert (= 8 (+ V37 V38 V44))) ; Region 13
(assert (= 13 (+ V40 V41))) ; Region 14
(assert (= 10 (+ V42 V43))) ; Region 15
(assert (= 10 (+ V46 V47 V48))) ; Region 17
(check-sat)
