...
(assert (= 15 (+ V2 V9 V10))) ; Region 2
(assert (or (= 3 (- V4 V11)) (= 3 (- V11 V4)))) ; Region 4
(assert (= 72 (* V5 V6 V12))) ; Region 5
(assert (= 9 (+ V7 V8 V15))) ; Region 6
(assert (= 210 (* V13 V20 V27))) ; Region 7
(assert (or (= 1 (- V14 V21)) (= 1 (- V21 V14)))) ; Region 8
(assert (or (= 3 (/ V17 V18)) (= 3 (/ V18 V17)))) ; Region 10
(assert (or (= 6 (- V19 V26)) (= 6 (- V26 V19)))) ; Region 11
(assert (or (= 4 (- V22 V23)) (= 4 (- V23 V22)))) ; Region 12
(assert (or (= 2 (/ V24 V25)) (= 2 (/ V25 V24)))) ; Region 13
(assert (or (= 3 (/ V28 V35)) (= 3 (/ V35 V28)))) ; Region 14
(assert (= 13 (+ V29 V30 V37))) ; Region 15
(assert (or (= 6 (- V31 V32)) (= 6 (- V32 V31)))) ; Region 16
(assert (= 30 (* V33 V34 V40))) ; Region 17
(assert (= 42 (* V36 V42 V43))) ; Region 18
(assert (= 16 (+ V38 V44 V45))) ; Region 19
(assert (or (= 2 (- V39 V46)) (= 2 (- V46 V39)))) ; Region 20
(assert (or (= 1 (- V41 V48)) (= 1 (- V48 V41)))) ; Region 21
(check-sat)
