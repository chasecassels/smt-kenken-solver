...
(assert (= 28 (* V2 V3))) ; Region 2
(assert (or (= 2 (/ V4 V11)) (= 2 (/ V11 V4)))) ; Region 3
(assert (= 10 (* V5 V6))) ; Region 4
(assert (= 10 (* V7 V8 V14))) ; Region 5
(assert (= 24 (* V9 V10))) ; Region 6
(assert (= 7 (* V12 V19))) ; Region 7
(assert (= 28 (* V13 V20))) ; Region 8
(assert (= 15 (* V15 V22))) ; Region 9
(assert (= 60 (* V16 V17 V18))) ; Region 10
(assert (= 294 (* V21 V28 V29))) ; Region 11
(assert (= 3 (* V23 V30))) ; Region 12
(assert (= 5 (* V24 V31))) ; Region 13
(assert (= 12 (* V26 V27))) ; Region 15
(assert (or (= 2 (/ V32 V33)) (= 2 (/ V33 V32)))) ; Region 16
(assert (= 15 (* V34 V41 V48))) ; Region 17
(assert (or (= 2 (/ V35 V42)) (= 2 (/ V42 V35)))) ; Region 18
(assert (= 28 (* V36 V37))) ; Region 19
(assert (or (= 3 (/ V38 V39)) (= 3 (/ V39 V38)))) ; Region 20
(assert (= 18 (* V40 V47))) ; Region 21
(assert (= 30 (* V43 V44))) ; Region 22
(assert (= 14 (* V45 V46))) ; Region 23
(check-sat)
