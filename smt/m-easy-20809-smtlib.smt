...
(assert (= 14 (* V0 V7 V8))) ; Region 1
(assert (= 84 (* V1 V2 V9))) ; Region 2
(assert (= 36 (* V3 V10 V17))) ; Region 3
(assert (= 150 (* V4 V5 V11 V12))) ; Region 4
(assert (= 24 (* V6 V13))) ; Region 5
(assert (= 210 (* V14 V21 V22 V28))) ; Region 6
(assert (= 8 (* V15 V16))) ; Region 7
(assert (= 12 (* V18 V19 V25))) ; Region 8
(assert (= 10 (* V20 V27))) ; Region 9
(assert (= 84 (* V23 V24 V31))) ; Region 10
(assert (= 10 (* V29 V30))) ; Region 12
(assert (= 42 (* V32 V33 V39))) ; Region 13
(assert (= 28 (* V34 V40 V41))) ; Region 14
(assert (= 12 (* V35 V42))) ; Region 15
(assert (= 30 (* V36 V43 V44))) ; Region 16
(assert (= 6 (* V37 V38))) ; Region 17
(assert (= 35 (* V45 V46))) ; Region 18
(assert (= 6 (* V47 V48))) ; Region 19
(check-sat)
