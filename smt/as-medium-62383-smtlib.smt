...
(assert (= 10 (+ V5 V11 V12))) ; Region 4
(assert (= 5 (+ V6 V13))) ; Region 5
(assert (= 7 (+ V8 V9))) ; Region 6
(assert (or (= 2 (- V14 V15)) (= 2 (- V15 V14)))) ; Region 7
(assert (= 5 (+ V16 V23 V24))) ; Region 8
(assert (= 13 (+ V17 V18 V25))) ; Region 9
(assert (or (= 6 (- V19 V20)) (= 6 (- V20 V19)))) ; Region 10
(assert (or (= 3 (- V21 V22)) (= 3 (- V22 V21)))) ; Region 11
(assert (or (= 1 (- V26 V27)) (= 1 (- V27 V26)))) ; Region 12
(assert (or (= 4 (- V28 V35)) (= 4 (- V35 V28)))) ; Region 13
(assert (or (= 1 (- V29 V30)) (= 1 (- V30 V29)))) ; Region 14
(assert (= 14 (+ V31 V32 V33))) ; Region 15
(assert (= 14 (+ V34 V41 V47 V48))) ; Region 16
(assert (= 12 (+ V36 V37 V38))) ; Region 17
(assert (or (= 6 (- V39 V40)) (= 6 (- V40 V39)))) ; Region 18
(assert (= 5 (+ V42 V43))) ; Region 19
(assert (= 7 (+ V44 V45))) ; Region 20
(check-sat)
