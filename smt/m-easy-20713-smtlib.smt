...
(assert (= 180 (* V0 V7 V14 V15))) ; Region 1
(assert (= 20 (* V1 V8 V9))) ; Region 2
(assert (= 21 (* V2 V3))) ; Region 3
(assert (= 10 (* V4 V11))) ; Region 4
(assert (= 48 (* V5 V6 V13))) ; Region 5
(assert (= 28 (* V10 V17 V18))) ; Region 6
(assert (= 21 (* V12 V19 V20))) ; Region 7
(assert (= 30 (* V16 V23))) ; Region 8
(assert (= 28 (* V21 V28))) ; Region 9
(assert (= 24 (* V24 V31 V32 V33))) ; Region 11
(assert (= 210 (* V25 V26 V27 V34))) ; Region 12
(assert (= 12 (* V29 V30))) ; Region 13
(assert (= 2 (* V35 V42))) ; Region 14
(assert (= 28 (* V36 V43 V44))) ; Region 15
(assert (= 42 (* V37 V38))) ; Region 16
(assert (= 180 (* V40 V41 V47 V48))) ; Region 18
(assert (= 20 (* V45 V46))) ; Region 19
(check-sat)
