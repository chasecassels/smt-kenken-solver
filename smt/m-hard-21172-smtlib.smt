...
(assert (= 24 (* V4 V11 V18))) ; Region 3
(assert (= 35 (* V5 V6))) ; Region 4
(assert (= 196 (* V9 V10 V15 V16 V22))) ; Region 5
(assert (= 12 (* V12 V13 V19))) ; Region 6
(assert (= 36 (* V14 V21 V28))) ; Region 7
(assert (= 24 (* V17 V23 V24))) ; Region 8
(assert (= 30 (* V20 V27))) ; Region 9
(assert (= 35 (* V25 V26))) ; Region 10
(assert (= 60 (* V29 V36 V37 V43))) ; Region 11
(assert (= 84 (* V30 V31 V32))) ; Region 12
(assert (= 48 (* V33 V34 V40 V47))) ; Region 13
(assert (= 28 (* V35 V42))) ; Region 14
(assert (= 30 (* V38 V39 V46))) ; Region 15
(assert (= 6 (* V41 V48))) ; Region 16
(assert (= 35 (* V44 V45))) ; Region 17
(check-sat)
