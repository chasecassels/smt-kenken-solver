...
(assert (= 3 (+ V0 V1))) ; Region 1
(assert (= 12 (+ V2 V8 V9))) ; Region 2
(assert (or (= 4 (- V3 V10)) (= 4 (- V10 V3)))) ; Region 3
(assert (= 17 (+ V4 V5 V6))) ; Region 4
(assert (= 15 (+ V7 V14 V15))) ; Region 5
(assert (= 9 (+ V11 V12 V13))) ; Region 6
(assert (or (= 6 (- V16 V23)) (= 6 (- V23 V16)))) ; Region 7
(assert (or (= 2 (- V17 V18)) (= 2 (- V18 V17)))) ; Region 8
(assert (or (= 4 (- V19 V26)) (= 4 (- V26 V19)))) ; Region 9
(assert (= 12 (+ V20 V27 V34))) ; Region 10
(assert (or (= 3 (- V21 V28)) (= 3 (- V28 V21)))) ; Region 11
(assert (or (= 6 (- V22 V29)) (= 6 (- V29 V22)))) ; Region 12
(assert (= 3 (+ V24 V31))) ; Region 13
(assert (= 7 (+ V25 V32))) ; Region 14
(assert (= 13 (+ V30 V36 V37))) ; Region 15
(assert (= 9 (+ V35 V42))) ; Region 17
(assert (or (= 2 (- V38 V45)) (= 2 (- V45 V38)))) ; Region 18
(assert (= 4 (+ V39 V46))) ; Region 19
(assert (or (= 2 (- V40 V41)) (= 2 (- V41 V40)))) ; Region 20
(assert (or (= 3 (- V43 V44)) (= 3 (- V44 V43)))) ; Region 21
