...
(assert (= 16 (+ V4 V5 V12))) ; Region 3
(assert (= 8 (+ V6 V13))) ; Region 4
(assert (= 8 (+ V7 V14))) ; Region 5
(assert (= 8 (+ V8 V9))) ; Region 6
(assert (= 6 (+ V11 V18 V25))) ; Region 7
(assert (= 12 (+ V15 V16))) ; Region 8
(assert (= 10 (+ V17 V23 V24))) ; Region 9
(assert (= 17 (+ V19 V20 V27))) ; Region 10
(assert (= 6 (+ V21 V28))) ; Region 11
(assert (= 10 (+ V22 V29))) ; Region 12
(assert (= 15 (+ V26 V32 V33))) ; Region 13
(assert (= 14 (+ V30 V31 V36 V37))) ; Region 14
(assert (= 6 (+ V34 V41))) ; Region 15
(assert (= 14 (+ V35 V42 V43))) ; Region 16
(assert (= 12 (+ V38 V39 V46))) ; Region 17
(assert (= 6 (+ V40 V47 V48))) ; Region 18
(assert (= 12 (+ V44 V45))) ; Region 19
(check-sat)
