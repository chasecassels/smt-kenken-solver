...
(assert (= 48 (* V0 V1 V7 V14))) ; Region 1
(assert (= 6 (* V2 V3))) ; Region 2
(assert (= 84 (* V4 V5 V12))) ; Region 3
(assert (= 20 (* V6 V13))) ; Region 4
(assert (= 12 (* V9 V15 V16 V17))) ; Region 6
(assert (= 21 (* V10 V11))) ; Region 7
(assert (= 150 (* V18 V19 V24 V25))) ; Region 8
(assert (= 84 (* V20 V26 V27))) ; Region 9
(assert (= 84 (* V21 V22 V23))) ; Region 10
(assert (= 84 (* V28 V29 V36))) ; Region 11
(assert (= 30 (* V30 V31))) ; Region 12
(assert (= 20 (* V32 V33 V39))) ; Region 13
(assert (= 12 (* V34 V41))) ; Region 14
(assert (= 30 (* V35 V42 V43))) ; Region 15
(assert (= 14 (* V37 V44))) ; Region 16
(assert (= 21 (* V40 V47 V48))) ; Region 18
(assert (= 8 (* V45 V46))) ; Region 19
(check-sat)
