...
(assert (= 7 (+ V4 V5 V6))) ; Region 3
(assert (= 9 (+ V7 V14 V21))) ; Region 4
(assert (= 10 (+ V8 V9 V10))) ; Region 5
(assert (or (= 2 (/ V11 V18)) (= 2 (/ V18 V11)))) ; Region 6
(assert (or (= 1 (- V12 V13)) (= 1 (- V13 V12)))) ; Region 7
(assert (= 21 (+ V15 V22 V23 V30))) ; Region 8
(assert (= 13 (+ V16 V17 V24))) ; Region 9
(assert (= 8 (+ V19 V20))) ; Region 10
(assert (or (= 5 (- V25 V26)) (= 5 (- V26 V25)))) ; Region 11
(assert (= 17 (+ V28 V35 V42 V43))) ; Region 13
(assert (or (= 2 (/ V29 V36)) (= 2 (/ V36 V29)))) ; Region 14
(assert (or (= 2 (- V31 V32)) (= 2 (- V32 V31)))) ; Region 15
(assert (or (= 1 (- V33 V34)) (= 1 (- V34 V33)))) ; Region 16
(assert (= 42 (* V37 V38))) ; Region 17
(assert (= 12 (+ V39 V46))) ; Region 18
(assert (= 6 (* V40 V41))) ; Region 19
(assert (or (= 2 (- V44 V45)) (= 2 (- V45 V44)))) ; Region 20
(assert (= 11 (+ V47 V48))) ; Region 21
(check-sat)
