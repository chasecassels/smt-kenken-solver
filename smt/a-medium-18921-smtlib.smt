...
(assert (= 15 (+ V0 V1 V2))) ; Region 1
(assert (= 5 (+ V3 V10))) ; Region 2
(assert (= 11 (+ V4 V5 V6))) ; Region 3
(assert (= 11 (+ V7 V14 V15))) ; Region 4
(assert (= 10 (+ V8 V9))) ; Region 5
(assert (= 8 (+ V11 V12))) ; Region 6
(assert (= 17 (+ V13 V19 V20))) ; Region 7
(assert (= 3 (+ V16 V23))) ; Region 8
(assert (= 5 (+ V17 V18))) ; Region 9
(assert (= 10 (+ V21 V22))) ; Region 10
(assert (= 7 (+ V24 V25))) ; Region 11
(assert (= 11 (+ V26 V33))) ; Region 12
(assert (= 9 (+ V27 V34))) ; Region 13
(assert (= 3 (+ V28 V29))) ; Region 14
(assert (= 7 (+ V30 V37))) ; Region 15
(assert (= 12 (+ V31 V32))) ; Region 16
(assert (= 12 (+ V35 V42))) ; Region 17
(assert (= 6 (+ V36 V43))) ; Region 18
(assert (= 10 (+ V38 V39 V40))) ; Region 19
(assert (= 6 (+ V41 V48))) ; Region 20
(assert (= 13 (+ V44 V45))) ; Region 21
(assert (= 5 (+ V46 V47))) ; Region 22
(check-sat)
