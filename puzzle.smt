...
(assert (= 35 (* V4 V11))) ; Region 3
(assert (or (= 1 (- V5 V6)) (= 1 (- V6 V5)))) ; Region 4
(assert (or (= 2 (- V8 V9)) (= 2 (- V9 V8)))) ; Region 6
(assert (= 10 (+ V10 V17 V18))) ; Region 7
(assert (or (= 3 (/ V12 V13)) (= 3 (/ V13 V12)))) ; Region 8
(assert (= 14 (* V14 V21))) ; Region 9
(assert (or (= 4 (- V15 V22)) (= 4 (- V22 V15)))) ; Region 10
(assert (or (= 1 (- V16 V23)) (= 1 (- V23 V16)))) ; Region 11
(assert (= 72 (* V19 V25 V26))) ; Region 12
(assert (or (= 2 (- V20 V27)) (= 2 (- V27 V20)))) ; Region 13
(assert (or (= 1 (- V24 V31)) (= 1 (- V31 V24)))) ; Region 14
(assert (= 60 (* V28 V35 V42))) ; Region 15
(assert (= 35 (* V29 V30))) ; Region 16
(assert (or (= 3 (/ V32 V39)) (= 3 (/ V39 V32)))) ; Region 17
(assert (= 13 (+ V34 V41))) ; Region 19
(assert (= 18 (* V36 V43 V44))) ; Region 20
(assert (or (= 3 (- V37 V38)) (= 3 (- V38 V37)))) ; Region 21
(assert (= 11 (+ V40 V47 V48))) ; Region 22
(assert (= 9 (+ V45 V46))) ; Region 23
(check-sat)
